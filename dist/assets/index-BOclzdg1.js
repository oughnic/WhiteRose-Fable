...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function vd(i,e,t){const n=new Float32Array(ai),r=new F(0,1,0);return new Sn({name:"SphericalGaussianBlur",defines:{n:ai,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Jr(),fragmentShader:`
	...
	`}function Md(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Vs||l===Ws,u=l===ui||l===Ni;if(c||u){let h=e.get(a);const f=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return t===null&&(t=new Na(i)),h=c?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const p=a.image;return c&&p&&p.height>0||u&&p&&r(p)?(t===null&&(t=new Na(i)),h=c?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",s),h.texture):null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Sd(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&lr("WebGLRenderer: "+n+" extension not supported."),r}}}function bd(i,e,t,n){const r={},s=new WeakMap;function o(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const x in f.attributes)e.remove(f.attributes[x]);f.removeEventListener("dispose",o),delete r[f.id];const p=s.get(f);p&&(e.remove(p),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function a(h,f){return r[f.id]===!0||(f.addEventListener("dispose",o),r[f.id]=!0,t.memory.geometries++),f}function l(h){const f=h.attributes;for(const p in f)e.update(f[p],i.ARRAY_BUFFER)}function c(h){const f=[],p=h.index,x=h.attributes.position;let v=0;if(p!==null){const y=p.array;v=p.version;for(let A=0,R=y.length;A<R;A+=3){const C=y[A+0],T=y[A+1],P=y[A+2];f.push(C,T,T,P,P,C)}}else if(x!==void 0){const y=x.array;v=x.version;for(let A=0,R=y.length/3-1;A<R;A+=3){const C=A+0,T=A+1,P=A+2;f.push(C,T,T,P,P,C)}}else return;const m=new(Il(f)?Fl:Nl)(f,1);m.version=v;const d=s.get(h);d&&e.remove(d),s.set(h,m)}function u(h){const f=s.get(h);if(f){const p=h.index;p!==null&&f.version<p.version&&c(h)}else c(h);return s.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function Ed(i,e,t){let n;function r(f){n=f}let s,o;function a(f){s=f.type,o=f.bytesPerElement}function l(f,p){i.drawElements(n,p,s,f*o),t.update(p,n,1)}function c(f,p,x){x!==0&&(i.drawElementsInstanced(n,p,s,f*o,x),t.update(p,n,x))}function u(f,p,x){if(x===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,s,f,0,x);let m=0;for(let d=0;d<x;d++)m+=p[d];t.update(m,n,1)}function h(f,p,x,v){if(x===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)c(f[d]/o,p[d],v[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,s,f,0,v,0,x);let d=0;for(let y=0;y<x;y++)d+=p[y]*v[y];t.update(d,n,1)}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function yd(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:ot("WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Td(i,e,t){const n=new WeakMap,r=new bt;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let f=n.get(a);if(f===void 0||f.count!==h){let S=function(){O.dispose(),n.delete(a),a.removeEventListener("dispose",S)};var p=S;f!==void 0&&f.texture.dispose();const x=a.morphAttributes.position!==void 0,v=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],y=a.morphAttributes.normal||[],A=a.morphAttributes.color||[];let R=0;x===!0&&(R=1),v===!0&&(R=2),m===!0&&(R=3);let C=a.attributes.position.count*R,T=1;C>e.maxTextureSize&&(T=Math.ceil(C/e.maxTextureSize),C=e.maxTextureSize);const P=new Float32Array(C*T*4*h),O=new Ll(P,C,T,h);O.type=dn,O.needsUpdate=!0;const g=R*4;for(let b=0;b<h;b++){const D=d[b],k=y[b],W=A[b],H=C*T*4*b;for(let K=0;K<D.count;K++){const V=K*g;x===!0&&(r.fromBufferAttribute(D,K),P[H+V+0]=r.x,P[H+V+1]=r.y,P[H+V+2]=r.z,P[H+V+3]=0),v===!0&&(r.fromBufferAttribute(k,K),P[H+V+4]=r.x,P[H+V+5]=r.y,P[H+V+6]=r.z,P[H+V+7]=0),m===!0&&(r.fromBufferAttribute(W,K),P[H+V+8]=r.x,P[H+V+9]=r.y,P[H+V+10]=r.z,P[H+V+11]=W.itemSize===4?r.w:1)}}f={count:h,texture:O,size:new lt(C,T)},n.set(a,f),a.addEventListener("dispose",S)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let x=0;for(let m=0;m<c.length;m++)x+=c[m];const v=a.morphTargetsRelative?1:1-x;l.getUniforms().setValue(i,"morphTargetBaseInfluence",v),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:s}}function wd(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(r.get(h)!==c&&(e.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==c&&(f.update(),r.set(f,c))}return h}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}const Ad={[gl]:"LINEAR_TONE_MAPPING",[_l]:"REINHARD_TONE_MAPPING",[xl]:"CINEON_TONE_MAPPING",[vl]:"ACES_FILMIC_TONE_MAPPING",[Sl]:"AGX_TONE_MAPPING",[bl]:"NEUTRAL_TONE_MAPPING",[Ml]:"CUSTOM_TONE_MAPPING"};function Rd(i,e,t,n,r){const s=new xn(e,t,{type:i,depthBuffer:n,stencilBuffer:r}),o=new xn(e,t,{type:On,depthBuffer:!1,stencilBuffer:!1}),a=new bn;a.setAttribute("position",new Fn([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new Fn([0,2,0,0,2,0],2));const l=new du({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new Pt(a,l),u=new Zo(-1,1,1,-1,0,1);let h=null,f=null,p=!1,x,v=null,m=[],d=!1;this.setSize=function(y,A){s.setSize(y,A),o.setSize(y,A);for(let R=0;R<m.length;R++){const C=m[R];C.setSize&&C.setSize(y,A)}},this.setEffects=function(y){m=y,d=m.length>0&&m[0].isRenderPass===!0;const A=s.width,R=s.height;for(let C=0;C<m.length;C++){const T=m[C];T.setSize&&T.setSize(A,R)}},this.begin=function(y,A){if(p||y.toneMapping===_n&&m.length===0)return!1;if(v=A,A!==null){const R=A.width,C=A.height;(s.width!==R||s.height!==C)&&this.setSize(R,C)}return d===!1&&y.setRenderTarget(s),x=y.toneMapping,y.toneMapping=_n,!0},this.hasRenderPass=function(){return d},this.end=function(y,A){y.toneMapping=x,p=!0;let R=s,C=o;for(let T=0;T<m.length;T++){const P=m[T];if(P.enabled!==!1&&(P.render(y,C,R,A),P.needsSwap!==!1)){const O=R;R=C,C=O}}if(h!==y.outputColorSpace||f!==y.toneMapping){h=y.outputColorSpace,f=y.toneMapping,l.defines={},at.getTransfer(h)===ht&&(l.defines.SRGB_TRANSFER="");const T=Ad[f];T&&(l.defines[T]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=R.texture,y.setRenderTarget(v),y.render(c,u),v=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){s.dispose(),o.dispose(),a.dispose(),l.dispose()}}const Vl=new Dt,Ao=new cr(1,1),Wl=new Ll,Xl=new Hc,Yl=new zl,za=[],ka=[],Ga=new Float32Array(16),Ha=new Float32Array(9),Va=new Float32Array(4);function Hi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=za[r];if(s===void 0&&(s=new Float32Array(r),za[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function wt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function At(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Qr(i,e){let t=ka[e];t===void 0&&(t=new Int32Array(e),ka[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Cd(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Pd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2fv(this.addr,e),At(t,e)}}function Id(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(wt(t,e))return;i.uniform3fv(this.addr,e),At(t,e)}}function Ld(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4fv(this.addr,e),At(t,e)}}function Dd(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),At(t,e)}else{if(wt(t,n))return;Va.set(n),i.uniformMatrix2fv(this.addr,!1,Va),At(t,n)}}function Ud(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),At(t,e)}else{if(wt(t,n))return;Ha.set(n),i.uniformMatrix3fv(this.addr,!1,Ha),At(t,n)}}function Nd(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(wt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),At(t,e)}else{if(wt(t,n))return;Ga.set(n),i.uniformMatrix4fv(this.addr,!1,Ga),At(t,n)}}function Fd(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Od(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2iv(this.addr,e),At(t,e)}}function Bd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;i.uniform3iv(this.addr,e),At(t,e)}}function zd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4iv(this.addr,e),At(t,e)}}function kd(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Gd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;i.uniform2uiv(this.addr,e),At(t,e)}}function Hd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;i.uniform3uiv(this.addr,e),At(t,e)}}function Vd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;i.uniform4uiv(this.addr,e),At(t,e)}}function Wd(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(Ao.compareFunction=t.isReversedDepthBuffer()?Vo:Ho,s=Ao):s=Vl,t.setTexture2D(e||s,r)}function Xd(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Xl,r)}function Yd(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Yl,r)}function $d(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Wl,r)}function qd(i){switch(i){case 5126:return Cd;case 35664:return Pd;case 35665:return Id;case 35666:return Ld;case 35674:return Dd;case 35675:return Ud;case 35676:return Nd;case 5124:case 35670:return Fd;case 35667:case 35671:return Od;case 35668:case 35672:return Bd;case 35669:case 35673:return zd;case 5125:return kd;case 36294:return Gd;case 36295:return Hd;case 36296:return Vd;case 35678:case 36198:case 36298:case 36306:case 35682:return Wd;case 35679:case 36299:case 36307:return Xd;case 35680:case 36300:case 36308:case 36293:return Yd;case 36289:case 36303:case 36311:case 36292:return $d}}function Zd(i,e){i.uniform1fv(this.addr,e)}function Kd(i,e){const t=Hi(e,this.size,2);i.uniform2fv(this.addr,t)}function jd(i,e){const t=Hi(e,this.size,3);i.uniform3fv(this.addr,t)}function Jd(i,e){const t=Hi(e,this.size,4);i.uniform4fv(this.addr,t)}function Qd(i,e){const t=Hi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function ep(i,e){const t=Hi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function tp(i,e){const t=Hi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function np(i,e){i.uniform1iv(this.addr,e)}function ip(i,e){i.uniform2iv(this.addr,e)}function rp(i,e){i.uniform3iv(this.addr,e)}function sp(i,e){i.uniform4iv(this.addr,e)}function op(i,e){i.uniform1uiv(this.addr,e)}function ap(i,e){i.uniform2uiv(this.addr,e)}function lp(i,e){i.uniform3uiv(this.addr,e)}function cp(i,e){i.uniform4uiv(this.addr,e)}function up(i,e,t){const n=this.cache,r=e.length,s=Qr(t,r);wt(n,s)||(i.uniform1iv(this.addr,s),At(n,s));let o;this.type===i.SAMPLER_2D_SHADOW?o=Ao:o=Vl;for(let a=0;a!==r;++a)t.setTexture2D(e[a]||o,s[a])}function hp(i,e,t){const n=this.cache,r=e.length,s=Qr(t,r);wt(n,s)||(i.uniform1iv(this.addr,s),At(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Xl,s[o])}function fp(i,e,t){const n=this.cache,r=e.length,s=Qr(t,r);wt(n,s)||(i.uniform1iv(this.addr,s),At(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Yl,s[o])}function dp(i,e,t){const n=this.cache,r=e.length,s=Qr(t,r);wt(n,s)||(i.uniform1iv(this.addr,s),At(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Wl,s[o])}function pp(i){switch(i){case 5126:return Zd;case 35664:return Kd;case 35665:return jd;case 35666:return Jd;case 35674:return Qd;case 35675:return ep;case 35676:return tp;case 5124:case 35670:return np;case 35667:case 35671:return ip;case 35668:case 35672:return rp;case 35669:case 35673:return sp;case 5125:return op;case 36294:return ap;case 36295:return lp;case 36296:return cp;case 35678:case 36198:case 36298:case 36306:case 35682:return up;case 35679:case 36299:case 36307:return hp;case 35680:case 36300:case 36308:case 36293:return fp;case 36289:case 36303:case 36311:case 36292:return dp}}class mp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=qd(t.type)}}class gp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=pp(t.type)}}class _p{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Is=/(\w+)(\])?(\[|\.)?/g;function Wa(i,e){i.seq.push(e),i.map[e.id]=e}function xp(i,e,t){const n=i.name,r=n.length;for(Is.lastIndex=0;;){const s=Is.exec(n),o=Is.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){Wa(t,c===void 0?new mp(a,i,e):new gp(a,i,e));break}else{let h=t.map[a];h===void 0&&(h=new _p(a),Wa(t,h)),t=h}}}class Hr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let o=0;o<n;++o){const a=e.getActiveUniform(t,o),l=e.getUniformLocation(t,a.name);xp(a,l,this)}const r=[],s=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(o):s.push(o);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Xa(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const vp=37297;let Mp=0;function Sp(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const Ya=new Je;function bp(i){at._getMatrix(Ya,at.workingColorSpace,i);const e=`mat3( ${Ya.elements.map(t=>t.toFixed(4))} )`;switch(at.getTransfer(i)){case Vr:return[e,"LinearTransferOETF"];case ht:return[e,"sRGBTransferOETF"];default:return qe("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function $a(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`

`+s+`

`+Sp(i.getShaderSource(e),a)}else return s}function Ep(i,e){const t=bp(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const yp={[gl]:"Linear",[_l]:"Reinhard",[xl]:"Cineon",[vl]:"ACESFilmic",[Sl]:"AgX",[bl]:"Neutral",[Ml]:"Custom"};function Tp(i,e){const t=yp[e];return t===void 0?(qe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Nr=new F;function wp(){at.getLuminanceCoefficients(Nr);const i=Nr.x.toFixed(4),e=Nr.y.toFixed(4),t=Nr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const Np={[Or]:"SHADOWMAP_TYPE_PCF",[Qi]:"SHADOWMAP_TYPE_VSM"};function Fp(i){return Np[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Op={[ui]:"ENVMAP_TYPE_CUBE",[Ni]:"ENVMAP_TYPE_CUBE",[jr]:"ENVMAP_TYPE_CUBE_UV"};function Bp(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Op[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const zp={[Ni]:"ENVMAP_MODE_REFRACTION"};function kp(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":zp[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Gp={[Kr]:"ENVMAP_BLENDING_MULTIPLY",[Ec]:"ENVMAP_BLENDING_MIX",[yc]:"ENVMAP_BLENDING_ADD"};function Hp(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Gp[i.combine]||"ENVMAP_BLENDING_NONE"}function Vp(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Wp(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Fp(t),c=Bp(t),u=kp(t),h=Hp(t),f=Vp(t),p=Ap(t),x=Rp(s),v=r.createProgram();let m,d,y=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
               ...
               <h3>Your own deck</h3>
               <p>Export slides as PNG/JPG (1920×1080), copy them into <code>slides/</code>, and list them in <code>slides/manifest.json</code> — video clips (.mp4) can be listed too.</p>`:"<p>The hospital street: a racetrack loop of two parallel streets joined by glazed cloisters across the courtyard — take whichever way round is shorter. Wing entrances open off the outside of each street; the courtyard holds the lawn and the Postgraduate Medical Centre.</p>";else{q+=`<p>${E(w.description??"Definition pending.")}</p>`;const Z=[];w.plural&&Z.push(`<strong>Plural:</strong> ${E(w.plural)}`),w.alsoKnownAs.length&&Z.push(`<strong>Also known as:</strong> ${E(w.alsoKnownAs.join("; "))}`),w.deprecated.length&&Z.push(`<strong>Deprecated terms:</strong> ${E(w.deprecated.join("; "))}`),w.termClause&&Z.push(`<strong>Clause:</strong> ${E(w.termClause)}`),w.source&&Z.push(`<span class="small"><strong>Source:</strong> ${E(w.source)}</span>`),Z.length&&(q+=`<p>${Z.join("<br>")}</p>`),w.notes.length&&(q+=`<h3>Notes</h3><ol>${w.notes.map(fe=>`<li>${E(fe.text)}</li>`).join("")}</ol>`),w.examples.length&&(q+=`<h3>Examples</h3><ol>${w.examples.map(fe=>`<li>${E(fe.text)}</li>`).join("")}</ol>`);const _e=fe=>E(e.get(fe)?.label??"?");(w.out.length||w.self.length)&&(q+=`<h3>Outbound associations (doors on the right wall)</h3><ul>${[...w.out.map(fe=>`<li>${E(qr(w.label,fe.label,e.get(fe.targetId)?.label??"?",fe))}</li>`),...w.self.map(fe=>`<li>${E(fe.label)} → ${E(w.label)} (end wall)</li>`)].join("")}</ul>`),w.in.length&&(q+=`<h3>Inbound associations (doors on the left wall)</h3><ul>${w.in.map(fe=>`<li>${E(qr(e.get(fe.sourceId)?.label??"?",fe.label,w.label,fe))}</li>`).join("")}</ul>`),w.supers.length&&(q+=`<h3>Generalisations (stairs up)</h3><ul>${w.supers.map(fe=>`<li>${_e(fe)}</li>`).join("")}</ul>`),w.subs.length&&(q+=`<h3>Specialisations (stairs down)</h3><ul>${w.subs.map(fe=>`<li>${_e(fe)}</li>`).join("")}</ul>`),q+=`<p><a href="${l0(w.label)}" target="_blank" rel="noopener">Full definition — contsys.org/concept/${E(Zl(w.label))}</a></p>`}$e.innerHTML=q,Ie=b.controls.isLocked,Ie&&b.controls.unlock(),ye.style.display="flex",Ke=!0}ye.addEventListener("click",w=>{w.target===ye&&_()});let ne=null;function ae(){Cn()||Ke||ne?.kind==="lift"&&se(ne)}function te(w){const q=new Set;for(const Z of H.interactables){if(Math.abs(Z.triggerPos.y-w.y)>2)continue;const _e=Math.abs(w.x-Z.triggerPos.x),fe=Math.abs(w.z-Z.triggerPos.z);Z.halfX!==void 0?_e<=Z.halfX&&fe<=(Z.halfZ??Z.halfX)&&q.add(Z):_e*_e+fe*fe<=Z.radius*Z.radius&&q.add(Z)}return q}let Le=new Set;function ve(){if(V){ne=null,Ci.style.opacity="0";return}const w=performance.now(),q=te(b.floorPosition);let Z=null;for(const _e of q){if(!_e.auto){Z=_e;continue}if(!Le.has(_e)&&!(w-$<c0)){_e.kind==="stair-up"||_e.kind==="stair-down"?de(_e.targetIds[0],`${_e.label} (portal)`):Ge(_e);return}}Le=q,ne=Z,Ci.textContent=Z?Z.prompt??`E — ${Z.label}`:"",Ci.style.opacity=Z?"1":"0"}const Ne=new yu,We=new lt;function he(w,q){const Z=H.boards;if(!Z?.length)return null;b.camera.updateMatrixWorld(),We.set(w,q),Ne.setFromCamera(We,b.camera);for(const _e of Z){_e.mesh.updateWorldMatrix(!0,!1);const fe=Ne.intersectObject(_e.mesh,!1)[0];if(!(!fe?.uv||fe.distance>(_e.kind==="screen"?16:4.2)))for(const ke of _e.cells){const[Xe,gt,It,tn]=ke.rect;if(fe.uv.x>=Xe&&fe.uv.x<=It&&fe.uv.y>=gt&&fe.uv.y<=tn)return{...ke,kind:_e.kind}}}return null}function Me(w,q){if(V||Cn()||Ke||performance.now()-$<400)return!1;const Z=he(w,q);if(!Z)return!1;if(Z.kind==="screen")Z.id==="next"?C.next():C.prev(),Bt(C.label);else if(Z.kind==="lift"){const _e=H;_e.liftPos&&b.floorPosition.distanceTo(_e.liftPos)<1.2?Ue(_e,Z.id):tt(Z.id)}else de(Z.id,`→ ${v.get(Z.id)?.label??Z.label}`);return!0}p.domElement.addEventListener("click",()=>{b.controls.isLocked&&Me(0,0)});let De=0,Oe=0,Se=0;p.domElement.addEventListener("pointerdown",w=>{De=w.clientX,Oe=w.clientY,Se=performance.now()}),p.domElement.addEventListener("pointerup",w=>{b.controls.isLocked||Math.hypot(w.clientX-De,w.clientY-Oe)>8||performance.now()-Se>600||Me(w.clientX/innerWidth*2-1,-(w.clientY/innerHeight)*2+1)}),addEventListener("keydown",w=>{if(Ke){(w.code==="Escape"||w.code==="KeyR")&&_();return}Cn()||(w.code==="KeyE"&&ae(),w.code==="KeyR"&&U(),w.code==="KeyM"&&xe(),w.code==="KeyB"&&pe(),w.code==="KeyF"&&b.dash(12)>.3&&Pi(),w.code==="KeyH"&&(document.body.classList.toggle("filming")||Bt("Interface restored")),H.id===Pn&&((w.code==="ArrowRight"||w.code==="PageDown")&&(w.preventDefault(),C.next(),Bt(C.label)),(w.code==="ArrowLeft"||w.code==="PageUp")&&(w.preventDefault(),C.prev(),Bt(C.label)),w.code==="KeyL"&&(Ze=!Ze,A.setHouseLights(Ze),Bt(Ze?"House lights up":"House lights dimmed — L restores"))))});let Ze=!0;if(Ci.addEventListener("click",ae),b.enableDragLook(p.domElement),ge){const w=document.getElementById("joy"),q=document.getElementById("joy-knob");let Z=null;const _e=()=>{Z=null,q.style.transform="",b.setTouchMove(0,0)},fe=ke=>{const Xe=w.getBoundingClientRect();let gt=ke.clientX-(Xe.left+Xe.width/2),It=ke.clientY-(Xe.top+Xe.height/2);if(!Number.isFinite(gt)||!Number.isFinite(It))return;const tn=Math.hypot(gt,It),Be=44;tn>Be&&(gt*=Be/tn,It*=Be/tn),q.style.transform=`translate(${gt}px, ${It}px)`,b.setTouchMove(-It/Be,gt/Be)};w.addEventListener("pointerdown",ke=>{ke.preventDefault(),Z=ke.pointerId,fe(ke);try{w.setPointerCapture(ke.pointerId)}catch{}}),w.addEventListener("pointermove",ke=>{ke.pointerId===Z&&(ke.preventDefault(),fe(ke))}),w.addEventListener("pointerup",_e),w.addEventListener("pointercancel",_e),document.getElementById("btn-read").addEventListener("click",()=>Ke?_():U()),document.getElementById("btn-porter").addEventListener("click",()=>{!Cn()&&!Ke&&xe()}),document.getElementById("btn-dash").addEventListener("click",()=>{!Cn()&&!Ke&&b.dash(12)>.3&&Pi()}),document.getElementById("btn-back").addEventListener("click",pe)}const N=new Eu;let Te=0;const me={logic:0,render:0},Ce=performance.now();let ue=12,le=0;p.setAnimationLoop(()=>{const w=performance.now(),q=Math.min(N.getDelta(),.05);Cn()||b.update(q),re(q);for(const fe of D){const ke=fe.owner.group.visible;fe.w.group.visible=ke,ke&&fe.w.update(q)}const Z=ee(b.floorPosition);if(Z&&Z!==H&&K(Z),ve(),b.controls.isLocked&&!V&&!Cn()){const fe=he(0,0);fe&&(Ci.textContent=fe.kind==="screen"?`Click — ${fe.label}`:`Click — ${fe.kind==="lift"?"lift to":"go to"} ${fe.label}`,Ci.style.opacity="1")}if(Te+=q,Te>.4&&(Te=0,x.update(b.position,a?40:55,a?100:120,a?5:8),W(),performance.now()-Ce>12e3&&D.length)){if(le===0&&ue>26){le=1;for(let fe=D.length-1;fe>=0;fe-=2)h.remove(D[fe].w.group),D.splice(fe,1);Bt("Trimmed ward activity to keep things smooth")}else if(le===1&&ue>30){le=2;for(const fe of D)h.remove(fe.w.group);D.length=0,Bt("Paused ward activity for performance")}}const _e=performance.now();p.render(h,b.camera),me.logic=_e-w,me.render=performance.now()-_e,ue=ue*.96+(me.logic+me.render)*.04}),addEventListener("resize",()=>{b.camera.aspect=innerWidth/innerHeight,b.camera.updateProjectionMatrix(),p.setSize(innerWidth,innerHeight)});function be(){const w={areas:i.classes.length+4,doorOut:i.classes.reduce((Be,rt)=>Be+rt.out.length,0),doorIn:i.classes.reduce((Be,rt)=>Be+rt.in.length,0),doorSelf:i.classes.reduce((Be,rt)=>Be+rt.self.length,0),notices:i.classes.reduce((Be,rt)=>Be+rt.notes.length+rt.examples.length,0),stairUpPortals:i.classes.reduce((Be,rt)=>Be+Math.max(0,rt.supers.length-1),0),stairDownPortals:i.classes.reduce((Be,rt)=>Be+(rt.subs.length-(r.homeChildren[rt.id]?.length??0)),0),lifts:i.classes.filter(Be=>Be.supers.length||Be.subs.length).length,realStairwells:Object.keys(r.landings).length},q=Be=>O.filter(rt=>rt.kind===Be).length,Z={areas:v.size,doorOut:q("door-out"),doorIn:q("door-in"),doorSelf:q("door-self"),notices:[...v.values()].reduce((Be,rt)=>Be+(rt.notices??0),0),stairUpPortals:q("stair-up"),stairDownPortals:q("stair-down"),lifts:q("lift"),realStairwells:Object.keys(r.landings).length},_e=O.filter(Be=>(Be.kind==="door-out"||Be.kind==="door-in")&&!S(Be)),fe=new Map,ke=(Be,rt)=>{fe.has(Be)||fe.set(Be,new Set),fe.get(Be).add(rt)};ke(on,Do),ke(on,Pn),ke(Pn,on),ke(Pn,ir),ke(ir,Pn);for(const Be of r.wings){const rt=Be.street==="gallery"?ir:Do;for(const Wt of Be.rootIds)ke(rt,Wt),ke(Wt,rt)}for(const[Be,rt]of Object.entries(r.homeChildren))for(const Wt of rt)ke(Be,Wt),ke(Wt,Be);for(const Be of O){for(const rt of Be.targetIds)ke(Be.areaId,rt);if(Be.kind==="lift"){const rt=e.get(Be.areaId);for(const Wt of Lo(rt,e))ke(Be.areaId,Wt.id);for(const Wt of rt.subs)ke(Be.areaId,Wt);ke(Be.areaId,on)}}const Xe=new Set([on]),gt=[on];for(;gt.length;)for(const Be of fe.get(gt.pop())??[])Xe.has(Be)||(Xe.add(Be),gt.push(Be));const It=[...v.keys()].filter(Be=>!Xe.has(Be)).map(Be=>v.get(Be).label);return{pass:Z.areas===w.areas&&Z.doorOut===w.doorOut&&Z.doorIn===w.doorIn&&Z.doorSelf===w.doorSelf&&Z.notices===w.notices&&Z.stairUpPortals===w.stairUpPortals&&Z.stairDownPortals===w.stairDownPortals&&Z.lifts===w.lifts&&_e.length===0&&It.length===0,expect:w,built:Z,unpaired:_e.length,unreachable:It,signs:x.count}}window.__hospital={world:i,layout:r,player:b,areas:v,interactables:O,audit:be,openSearch:xe,perf:()=>({...me,avg:+ue.toFixed(1),drawCalls:p.info.render.calls,triangles:p.info.render.triangles}),people:()=>({tier:c,walkers:D.length,demoteStage:le}),tickPeople(w=.1,q=1){for(let Z=0;Z<q;Z++)for(const _e of D)_e.w.update(w)},tickDoors(w=.1,q=1){for(let Z=0;Z<q;Z++)re(w);return H.lift?+H.lift.doors.openness.toFixed(2):null},bench(w=30){const q=performance.now();for(let Z=0;Z<w;Z++)p.render(h,b.camera);return{msPerFrame:+((performance.now()-q)/w).toFixed(2),drawCalls:p.info.render.calls,triangles:p.info.render.triangles}},currentArea:()=>H.label,pick:(w,q)=>he(w,q),tapPick:(w,q)=>Me(w,q),slides:()=>({label:C.label,total:C.count}),nextSlide:()=>(C.next(),C.label),prevSlide:()=>(C.prev(),C.label),houseLights:w=>A.setHouseLights(w),goto(w){const q=w==="Reception"?d:w==="Hospital Street"?y:w==="Postgraduate Medical Centre"?A:t.get(w)&&v.get(t.get(w).id)||null;return q?(de(q.id),q.label):`unknown area: ${w}`},walk(w){const q=Math.ceil(Math.abs(w)/.1);for(let _e=0;_e<q;_e++){const fe=b.camera.rotation.y,ke=b.camera.position;ke.x+=-Math.sin(fe)*.1*Math.sign(w),ke.z+=-Math.cos(fe)*.1*Math.sign(w),b.snapGround();const Xe=ee(b.floorPosition);Xe&&Xe!==H&&K(Xe),ve()}const Z=b.camera.position;return{x:+Z.x.toFixed(2),y:+(Z.y-1.7).toFixed(2),z:+Z.z.toFixed(2),area:H.label}}},console.info(`[hospital] built ${v.size} areas, ${O.length} interactables, ${x.count} signs, loop ${Math.round(r.street.x1)}m × 2 + ${r.loop.C}m courtyard`)}p0().catch(i=>{console.error(i);const e=document.createElement("p");e.style.cssText="color:#fff;padding:24px;font-family:Arial",e.textContent=String(i),si.replaceChildren(e)});
