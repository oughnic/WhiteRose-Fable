...
`)+`
`+d);const w=T+m+o,A=T+d+a,P=Wa(r,r.VERTEX_SHADER,w),R=Wa(r,r.FRAGMENT_SHADER,A);r.attachShader(v,P),r.attachShader(v,R),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function C(E){if(i.debug.checkShaderErrors){const D=r.getProgramInfoLog(v)||"",L=r.getShaderInfoLog(P)||"",O=r.getShaderInfoLog(R)||"",X=D.trim(),q=L.trim(),z=O.trim();let te=!0,Z=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(te=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,P,R);else{const V=Ya(r,P,"vertex"),Q=Ya(r,R,"fragment");nt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
}`,nm=[new B(1,0,0),new B(-1,0,0),new B(0,1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1)],im=[new B(0,-1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1),new B(0,-1,0),new B(0,-1,0)],el=new gt,Ki=new B,Ls=new B;function rm(i,e,t){let n=new Yo;const r=new rt,s=new rt,o=new Mt,a=new hu,l=new fu,c={},u=t.maxTextureSize,h={[Yn]:Vt,[Vt]:Yn,[An]:An},f=new _n({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new rt},radius:{value:4}},vertexShader:em,fragmentShader:tm}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const x=new xn;x.setAttribute("position",new Jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Pt(x,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ur;let d=this.type;this.render=function(R,C,G){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;R.type===ec&&($e("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),R.type=Ur);const M=i.getRenderTarget(),g=i.getActiveCubeFace(),E=i.getActiveMipmapLevel(),D=i.state;D.setBlending(Pn),D.buffers.depth.getReversed()===!0?D.buffers.color.setClear(0,0,0,0):D.buffers.color.setClear(1,1,1,1),D.buffers.depth.setTest(!0),D.setScissorTest(!1);const L=d!==this.type;L&&C.traverse(function(O){O.material&&(Array.isArray(O.material)?O.material.forEach(X=>X.needsUpdate=!0):O.material.needsUpdate=!0)});for(let O=0,X=R.length;O<X;O++){const q=R[O],z=q.shadow;if(z===void 0){$e("WebGLShadowMap:",q,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const te=z.getFrameExtents();if(r.multiply(te),s.copy(z.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/te.x),r.x=s.x*te.x,z.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/te.y),r.y=s.y*te.y,z.mapSize.y=s.y)),z.map===null||L===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Ji){if(q.isPointLight){$e("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new pn(r.x,r.y,{format:Ni,type:Un,minFilter:St,magFilter:St,generateMipmaps:!1}),z.map.texture.name=q.name+".shadowMap",z.map.depthTexture=new ar(r.x,r.y,un),z.map.depthTexture.name=q.name+".shadowMapDepth",z.map.depthTexture.format=Nn,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=It,z.map.depthTexture.magFilter=It}else{q.isPointLight?(z.map=new Ol(r.x),z.map.depthTexture=new lu(r.x,mn)):(z.map=new pn(r.x,r.y),z.map.depthTexture=new ar(r.x,r.y,mn)),z.map.depthTexture.name=q.name+".shadowMap",z.map.depthTexture.format=Nn;const V=i.state.buffers.depth.getReversed();this.type===Ur?(z.map.depthTexture.compareFunction=V?Go:Ho,z.map.depthTexture.minFilter=St,z.map.depthTexture.magFilter=St):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=It,z.map.depthTexture.magFilter=It)}z.camera.updateProjectionMatrix()}const Z=z.map.isWebGLCubeRenderTarget?6:1;for(let V=0;V<Z;V++){if(z.map.isWebGLCubeRenderTarget)i.setRenderTarget(z.map,V),i.clear();else{V===0&&(i.setRenderTarget(z.map),i.clear());const Q=z.getViewport(V);o.set(s.x*Q.x,s.y*Q.y,s.x*Q.z,s.y*Q.w),D.viewport(o)}if(q.isPointLight){const Q=z.camera,me=z.matrix,Te=q.distance||Q.far;Te!==Q.far&&(Q.far=Te,Q.updateProjectionMatrix()),Ki.setFromMatrixPosition(q.matrixWorld),Q.position.copy(Ki),Ls.copy(Q.position),Ls.add(nm[V]),Q.up.copy(im[V]),Q.lookAt(Ls),Q.updateMatrixWorld(),me.makeTranslation(-Ki.x,-Ki.y,-Ki.z),el.multiplyMatrices(Q.projectionMatrix,Q.matrixWorldInverse),z._frustum.setFromProjectionMatrix(el,Q.coordinateSystem,Q.reversedDepth)}else z.updateMatrices(q);n=z.getFrustum(),A(C,G,z.camera,q,this.type)}z.isPointLightShadow!==!0&&this.type===Ji&&T(z,G),z.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(M,g,E)};function T(R,C){const G=e.update(v);f.defines.VSM_SAMPLES!==R.blurSamples&&(f.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new pn(r.x,r.y,{format:Ni,type:Un})),f.uniforms.shadow_pass.value=R.map.depthTexture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(C,null,G,f,v,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(C,null,G,p,v,null)}function w(R,C,G,M){let g=null;const E=G.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(E!==void 0)g=E;else if(g=G.isPointLight===!0?l:a,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const D=g.uuid,L=C.uuid;let O=c[D];O===void 0&&(O={},c[D]=O);let X=O[L];X===void 0&&(X=g.clone(),O[L]=X,C.addEventListener("dispose",P)),g=X}if(g.visible=C.visible,g.wireframe=C.wireframe,M===Ji?g.side=C.shadowSide!==null?C.shadowSide:C.side:g.side=C.shadowSide!==null?C.shadowSide:h[C.side],g.alphaMap=C.alphaMap,g.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,g.map=C.map,g.clipShadows=C.clipShadows,g.clippingPlanes=C.clippingPlanes,g.clipIntersection=C.clipIntersection,g.displacementMap=C.displacementMap,g.displacementScale=C.displacementScale,g.displacementBias=C.displacementBias,g.wireframeLinewidth=C.wireframeLinewidth,g.linewidth=C.linewidth,G.isPointLight===!0&&g.isMeshDistanceMaterial===!0){const D=i.properties.get(g);D.light=G}return g}function A(R,C,G,M,g){if(R.visible===!1)return;if(R.layers.test(C.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&g===Ji)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,R.matrixWorld);const L=e.update(R),O=R.material;if(Array.isArray(O)){const X=L.groups;for(let q=0,z=X.length;q<z;q++){const te=X[q],Z=O[te.materialIndex];if(Z&&Z.visible){const V=w(R,Z,M,g);R.onBeforeShadow(i,R,C,G,L,V,te),i.renderBufferDirect(G,null,L,V,R,te),R.onAfterShadow(i,R,C,G,L,V,te)}}}else if(O.visible){const X=w(R,O,M,g);R.onBeforeShadow(i,R,C,G,L,X,null),i.renderBufferDirect(G,null,L,X,R,null),R.onAfterShadow(i,R,C,G,L,X,null)}}const D=R.children;for(let L=0,O=D.length;L<O;L++)A(D[L],C,G,M,g)}function P(R){R.target.removeEventListener("dispose",P);for(const G in c){const M=c[G],g=R.target.uuid;g in M&&(M[g].dispose(),delete M[g])}}}const sm={[Fs]:Os,[Bs]:Hs,[zs]:Gs,[Di]:ks,[Os]:Fs,[Hs]:Bs,[Gs]:zs,[ks]:Di};function om(i,e){function t(){let U=!1;const Se=new Mt;let de=null;const we=new Mt(0,0,0,0);return{setMask:function(le){de!==le&&!U&&(i.colorMask(le,le,le,le),de=le)},setLocked:function(le){U=le},setClear:function(le,oe,b,H,Y){Y===!0&&(le*=H,oe*=H,b*=H),Se.set(le,oe,b,H),we.equals(Se)===!1&&(i.clearColor(le,oe,b,H),we.copy(Se))},reset:function(){U=!1,de=null,we.set(-1,0,0,0)}}}function n(){let U=!1,Se=!1,de=null,we=null,le=null;return{setReversed:function(oe){if(Se!==oe){const b=e.get("EXT_clip_control");oe?b.clipControlEXT(b.LOWER_LEFT_EXT,b.ZERO_TO_ONE_EXT):b.clipControlEXT(b.LOWER_LEFT_EXT,b.NEGATIVE_ONE_TO_ONE_EXT),Se=oe;const H=le;le=null,this.setClear(H)}},getReversed:function(){return Se},setTest:function(oe){oe?re(i.DEPTH_TEST):ie(i.DEPTH_TEST)},setMask:function(oe){de!==oe&&!U&&(i.depthMask(oe),de=oe)},setFunc:function(oe){if(Se&&(oe=sm[oe]),we!==oe){switch(oe){case Fs:i.depthFunc(i.NEVER);break;case Os:i.depthFunc(i.ALWAYS);break;case Bs:i.depthFunc(i.LESS);break;case Di:i.depthFunc(i.LEQUAL);break;case zs:i.depthFunc(i.EQUAL);break;case ks:i.depthFunc(i.GEQUAL);break;case Hs:i.depthFunc(i.GREATER);break;case Gs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}we=oe}},setLocked:function(oe){U=oe},setClear:function(oe){le!==oe&&(Se&&(oe=1-oe),i.clearDepth(oe),le=oe)},reset:function(){U=!1,de=null,we=null,le=null,Se=!1}}}function r(){let U=!1,Se=null,de=null,we=null,le=null,oe=null,b=null,H=null,Y=null;return{setTest:function(ae){U||(ae?re(i.STENCIL_TEST):ie(i.STENCIL_TEST))},setMask:function(ae){Se!==ae&&!U&&(i.stencilMask(ae),Se=ae)},setFunc:function(ae,he,Ue){(de!==ae||we!==he||le!==Ue)&&(i.stencilFunc(ae,he,Ue),de=ae,we=he,le=Ue)},setOp:function(ae,he,Ue){(oe!==ae||b!==he||H!==Ue)&&(i.stencilOp(ae,he,Ue),oe=ae,b=he,H=Ue)},setLocked:function(ae){U=ae},setClear:function(ae){Y!==ae&&(i.clearStencil(ae),Y=ae)},reset:function(){U=!1,Se=null,de=null,we=null,le=null,oe=null,b=null,H=null,Y=null}}}const s=new t,o=new n,a=new r,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,p=[],x=null,v=!1,m=null,d=null,T=null,w=null,A=null,P=null,R=null,C=new Ze(0,0,0),G=0,M=!1,g=null,E=null,D=null,L=null,O=null;const X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let q=!1,z=0;const te=i.getParameter(i.VERSION);te.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(te)[1]),q=z>=1):te.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(te)[1]),q=z>=2);let Z=null,V={};const Q=i.getParameter(i.SCISSOR_BOX),me=i.getParameter(i.VIEWPORT),Te=new Mt().fromArray(Q),Ne=new Mt().fromArray(me);function He(U,Se,de,we){const le=new Uint8Array(4),oe=i.createTexture();i.bindTexture(U,oe),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let b=0;b<de;b++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(Se,0,i.RGBA,1,1,we,0,i.RGBA,i.UNSIGNED_BYTE,le):i.texImage2D(Se+b,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,le);return oe}const $={};$[i.TEXTURE_2D]=He(i.TEXTURE_2D,i.TEXTURE_2D,1),$[i.TEXTURE_CUBE_MAP]=He(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),$[i.TEXTURE_2D_ARRAY]=He(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),$[i.TEXTURE_3D]=He(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),re(i.DEPTH_TEST),o.setFunc(Di),ce(!1),Be(na),re(i.CULL_FACE),ne(Pn);function re(U){u[U]!==!0&&(i.enable(U),u[U]=!0)}function ie(U){u[U]!==!1&&(i.disable(U),u[U]=!1)}function xe(U,Se){return h[U]!==Se?(i.bindFramebuffer(U,Se),h[U]=Se,U===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=Se),U===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=Se),!0):!1}function fe(U,Se){let de=p,we=!1;if(U){de=f.get(Se),de===void 0&&(de=[],f.set(Se,de));const le=U.textures;if(de.length!==le.length||de[0]!==i.COLOR_ATTACHMENT0){for(let oe=0,b=le.length;oe<b;oe++)de[oe]=i.COLOR_ATTACHMENT0+oe;de.length=le.length,we=!0}}else de[0]!==i.BACK&&(de[0]=i.BACK,we=!0);we&&i.drawBuffers(de)}function We(U){return x!==U?(i.useProgram(U),x=U,!0):!1}const st={[ii]:i.FUNC_ADD,[nc]:i.FUNC_SUBTRACT,[ic]:i.FUNC_REVERSE_SUBTRACT};st[rc]=i.MIN,st[sc]=i.MAX;const qe={[oc]:i.ZERO,[ac]:i.ONE,[lc]:i.SRC_COLOR,[Us]:i.SRC_ALPHA,[pc]:i.SRC_ALPHA_SATURATE,[fc]:i.DST_COLOR,[uc]:i.DST_ALPHA,[cc]:i.ONE_MINUS_SRC_COLOR,[Ns]:i.ONE_MINUS_SRC_ALPHA,[dc]:i.ONE_MINUS_DST_COLOR,[hc]:i.ONE_MINUS_DST_ALPHA,[mc]:i.CONSTANT_COLOR,[gc]:i.ONE_MINUS_CONSTANT_COLOR,[_c]:i.CONSTANT_ALPHA,[xc]:i.ONE_MINUS_CONSTANT_ALPHA};function ne(U,Se,de,we,le,oe,b,H,Y,ae){if(U===Pn){v===!0&&(ie(i.BLEND),v=!1);return}if(v===!1&&(re(i.BLEND),v=!0),U!==tc){if(U!==m||ae!==M){if((d!==ii||A!==ii)&&(i.blendEquation(i.FUNC_ADD),d=ii,A=ii),ae)switch(U){case Ii:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ia:i.blendFunc(i.ONE,i.ONE);break;case ra:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case sa:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:nt("WebGLState: Invalid blending: ",U);break}else switch(U){case Ii:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ia:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case ra:nt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case sa:nt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:nt("WebGLState: Invalid blending: ",U);break}T=null,w=null,P=null,R=null,C.set(0,0,0),G=0,m=U,M=ae}return}le=le||Se,oe=oe||de,b=b||we,(Se!==d||le!==A)&&(i.blendEquationSeparate(st[Se],st[le]),d=Se,A=le),(de!==T||we!==w||oe!==P||b!==R)&&(i.blendFuncSeparate(qe[de],qe[we],qe[oe],qe[b]),T=de,w=we,P=oe,R=b),(H.equals(C)===!1||Y!==G)&&(i.blendColor(H.r,H.g,H.b,Y),C.copy(H),G=Y),m=U,M=!1}function Ee(U,Se){U.side===An?ie(i.CULL_FACE):re(i.CULL_FACE);let de=U.side===Vt;Se&&(de=!de),ce(de),U.blending===Ii&&U.transparent===!1?ne(Pn):ne(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),s.setMask(U.colorWrite);const we=U.stencilWrite;a.setTest(we),we&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),et(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?re(i.SAMPLE_ALPHA_TO_COVERAGE):ie(i.SAMPLE_ALPHA_TO_COVERAGE)}function ce(U){g!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),g=U)}function Be(U){U!==Jl?(re(i.CULL_FACE),U!==E&&(U===na?i.cullFace(i.BACK):U===Ql?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ie(i.CULL_FACE),E=U}function I(U){U!==D&&(q&&i.lineWidth(U),D=U)}function et(U,Se,de){U?(re(i.POLYGON_OFFSET_FILL),(L!==Se||O!==de)&&(i.polygonOffset(Se,de),L=Se,O=de)):ie(i.POLYGON_OFFSET_FILL)}function Xe(U){U?re(i.SCISSOR_TEST):ie(i.SCISSOR_TEST)}function ot(U){U===void 0&&(U=i.TEXTURE0+X-1),Z!==U&&(i.activeTexture(U),Z=U)}function ge(U,Se,de){de===void 0&&(Z===null?de=i.TEXTURE0+X-1:de=Z);let we=V[de];we===void 0&&(we={type:void 0,texture:void 0},V[de]=we),(we.type!==U||we.texture!==Se)&&(Z!==de&&(i.activeTexture(de),Z=de),i.bindTexture(U,Se||$[U]),we.type=U,we.texture=Se)}function y(){const U=V[Z];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function _(){try{i.compressedTexImage2D(...arguments)}catch(U){nt("WebGLState:",U)}}function F(){try{i.compressedTexImage3D(...arguments)}catch(U){nt("WebGLState:",U)}}function ee(){try{i.texSubImage2D(...arguments)}catch(U){nt("WebGLState:",U)}}function se(){try{i.texSubImage3D(...arguments)}catch(U){nt("WebGLState:",U)}}function J(){try{i.compressedTexSubImage2D(...arguments)}catch(U){nt("WebGLState:",U)}}function De(){try{i.compressedTexSubImage3D(...arguments)}catch(U){nt("WebGLState:",U)}}function ve(){try{i.texStorage2D(...arguments)}catch(U){nt("WebGLState:",U)}}function Pe(){try{i.texStorage3D(...arguments)}catch(U){nt("WebGLState:",U)}}function Ge(){try{i.texImage2D(...arguments)}catch(U){nt("WebGLState:",U)}}function ue(){try{i.texImage3D(...arguments)}catch(U){nt("WebGLState:",U)}}function Me(U){Te.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),Te.copy(U))}function Ce(U){Ne.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),Ne.copy(U))}function Le(U,Se){let de=c.get(Se);de===void 0&&(de=new WeakMap,c.set(Se,de));let we=de.get(U);we===void 0&&(we=i.getUniformBlockIndex(Se,U.name),de.set(U,we))}function _e(U,Se){const we=c.get(Se).get(U);l.get(Se)!==we&&(i.uniformBlockBinding(Se,we,U.__bindingPointIndex),l.set(Se,we))}function Ke(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},Z=null,V={},h={},f=new WeakMap,p=[],x=null,v=!1,m=null,d=null,T=null,w=null,A=null,P=null,R=null,C=new Ze(0,0,0),G=0,M=!1,g=null,E=null,D=null,L=null,O=null,Te.set(0,0,i.canvas.width,i.canvas.height),Ne.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:re,disable:ie,bindFramebuffer:xe,drawBuffers:fe,useProgram:We,setBlending:ne,setMaterial:Ee,setFlipSided:ce,setCullFace:Be,setLineWidth:I,setPolygonOffset:et,setScissorTest:Xe,activeTexture:ot,bindTexture:ge,unbindTexture:y,compressedTexImage2D:_,compressedTexImage3D:F,texImage2D:Ge,texImage3D:ue,updateUBOMapping:Le,uniformBlockBinding:_e,texStorage2D:ve,texStorage3D:Pe,texSubImage2D:ee,texSubImage3D:se,compressedTexSubImage2D:J,compressedTexSubImage3D:De,scissor:Me,viewport:Ce,reset:Ke}}function am(i,e,t,n,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new rt,u=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(y,_){return p?new OffscreenCanvas(y,_):Vr("canvas")}function v(y,_,F){let ee=1;const se=ge(y);if((se.width>F||se.height>F)&&(ee=F/Math.max(se.width,se.height)),ee<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const J=Math.floor(ee*se.width),De=Math.floor(ee*se.height);h===void 0&&(h=x(J,De));const ve=_?x(J,De):h;return ve.width=J,ve.height=De,ve.getContext("2d").drawImage(y,0,0,J,De),$e("WebGLRenderer: Texture has been resized from ("+se.width+"x"+se.height+") to ("+J+"x"+De+")."),ve}else return"data"in y&&$e("WebGLRenderer: Image in DataTexture is too big ("+se.width+"x"+se.height+")."),y;return y}function m(y){return y.generateMipmaps}function d(y){i.generateMipmap(y)}function T(y){return y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?i.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function w(y,_,F,ee,se=!1){if(y!==null){if(i[y]!==void 0)return i[y];$e("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let J=_;if(_===i.RED&&(F===i.FLOAT&&(J=i.R32F),F===i.HALF_FLOAT&&(J=i.R16F),F===i.UNSIGNED_BYTE&&(J=i.R8)),_===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(J=i.R8UI),F===i.UNSIGNED_SHORT&&(J=i.R16UI),F===i.UNSIGNED_INT&&(J=i.R32UI),F===i.BYTE&&(J=i.R8I),F===i.SHORT&&(J=i.R16I),F===i.INT&&(J=i.R32I)),_===i.RG&&(F===i.FLOAT&&(J=i.RG32F),F===i.HALF_FLOAT&&(J=i.RG16F),F===i.UNSIGNED_BYTE&&(J=i.RG8)),_===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(J=i.RG8UI),F===i.UNSIGNED_SHORT&&(J=i.RG16UI),F===i.UNSIGNED_INT&&(J=i.RG32UI),F===i.BYTE&&(J=i.RG8I),F===i.SHORT&&(J=i.RG16I),F===i.INT&&(J=i.RG32I)),_===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(J=i.RGB8UI),F===i.UNSIGNED_SHORT&&(J=i.RGB16UI),F===i.UNSIGNED_INT&&(J=i.RGB32UI),F===i.BYTE&&(J=i.RGB8I),F===i.SHORT&&(J=i.RGB16I),F===i.INT&&(J=i.RGB32I)),_===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(J=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(J=i.RGBA16UI),F===i.UNSIGNED_INT&&(J=i.RGBA32UI),F===i.BYTE&&(J=i.RGBA8I),F===i.SHORT&&(J=i.RGBA16I),F===i.INT&&(J=i.RGBA32I)),_===i.RGB&&(F===i.UNSIGNED_INT_5_9_9_9_REV&&(J=i.RGB9_E5),F===i.UNSIGNED_INT_10F_11F_11F_REV&&(J=i.R11F_G11F_B10F)),_===i.RGBA){const De=se?Hr:it.getTransfer(ee);F===i.FLOAT&&(J=i.RGBA32F),F===i.HALF_FLOAT&&(J=i.RGBA16F),F===i.UNSIGNED_BYTE&&(J=De===ut?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(J=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(J=i.RGB5_A1)}return(J===i.R16F||J===i.R32F||J===i.RG16F||J===i.RG32F||J===i.RGBA16F||J===i.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function A(y,_){let F;return y?_===null||_===mn||_===sr?F=i.DEPTH24_STENCIL8:_===un?F=i.DEPTH32F_STENCIL8:_===rr&&(F=i.DEPTH24_STENCIL8,$e("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===mn||_===sr?F=i.DEPTH_COMPONENT24:_===un?F=i.DEPTH_COMPONENT32F:_===rr&&(F=i.DEPTH_COMPONENT16),F}function P(y,_){return m(y)===!0||y.isFramebufferTexture&&y.minFilter!==It&&y.minFilter!==St?Math.log2(Math.max(_.width,_.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?_.mipmaps.length:1}function R(y){const _=y.target;_.removeEventListener("dispose",R),G(_),_.isVideoTexture&&u.delete(_)}function C(y){const _=y.target;_.removeEventListener("dispose",C),g(_)}function G(y){const _=n.get(y);if(_.__webglInit===void 0)return;const F=y.source,ee=f.get(F);if(ee){const se=ee[_.__cacheKey];se.usedTimes--,se.usedTimes===0&&M(y),Object.keys(ee).length===0&&f.delete(F)}n.remove(y)}function M(y){const _=n.get(y);i.deleteTexture(_.__webglTexture);const F=y.source,ee=f.get(F);delete ee[_.__cacheKey],o.memory.textures--}function g(y){const _=n.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),n.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(_.__webglFramebuffer[ee]))for(let se=0;se<_.__webglFramebuffer[ee].length;se++)i.deleteFramebuffer(_.__webglFramebuffer[ee][se]);else i.deleteFramebuffer(_.__webglFramebuffer[ee]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[ee])}else{if(Array.isArray(_.__webglFramebuffer))for(let ee=0;ee<_.__webglFramebuffer.length;ee++)i.deleteFramebuffer(_.__webglFramebuffer[ee]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let ee=0;ee<_.__webglColorRenderbuffer.length;ee++)_.__webglColorRenderbuffer[ee]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[ee]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const F=y.textures;for(let ee=0,se=F.length;ee<se;ee++){const J=n.get(F[ee]);J.__webglTexture&&(i.deleteTexture(J.__webglTexture),o.memory.textures--),n.remove(F[ee])}n.remove(y)}let E=0;function D(){E=0}function L(){const y=E;return y>=r.maxTextures&&$e("WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+r.maxTextures),E+=1,y}function O(y){const _=[];return _.push(y.wrapS),_.push(y.wrapT),_.push(y.wrapR||0),_.push(y.magFilter),_.push(y.minFilter),_.push(y.anisotropy),_.push(y.internalFormat),_.push(y.format),_.push(y.type),_.push(y.generateMipmaps),_.push(y.premultiplyAlpha),_.push(y.flipY),_.push(y.unpackAlignment),_.push(y.colorSpace),_.join()}function X(y,_){const F=n.get(y);if(y.isVideoTexture&&Xe(y),y.isRenderTargetTexture===!1&&y.isExternalTexture!==!0&&y.version>0&&F.__version!==y.version){const ee=y.image;if(ee===null)$e("WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)$e("WebGLRenderer: Texture marked for update but image is incomplete");else{$(F,y,_);return}}else y.isExternalTexture&&(F.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+_)}function q(y,_){const F=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&F.__version!==y.version){$(F,y,_);return}else y.isExternalTexture&&(F.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+_)}function z(y,_){const F=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&F.__version!==y.version){$(F,y,_);return}t.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+_)}function te(y,_){const F=n.get(y);if(y.isCubeDepthTexture!==!0&&y.version>0&&F.__version!==y.version){re(F,y,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+_)}const Z={[ir]:i.REPEAT,[Rn]:i.CLAMP_TO_EDGE,[Xs]:i.MIRRORED_REPEAT},V={[It]:i.NEAREST,[Sc]:i.NEAREST_MIPMAP_NEAREST,[dr]:i.NEAREST_MIPMAP_LINEAR,[St]:i.LINEAR,[ts]:i.LINEAR_MIPMAP_NEAREST,[ai]:i.LINEAR_MIPMAP_LINEAR},Q={[yc]:i.NEVER,[Cc]:i.ALWAYS,[Tc]:i.LESS,[Ho]:i.LEQUAL,[wc]:i.EQUAL,[Go]:i.GEQUAL,[Ac]:i.GREATER,[Rc]:i.NOTEQUAL};function me(y,_){if(_.type===un&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===St||_.magFilter===ts||_.magFilter===dr||_.magFilter===ai||_.minFilter===St||_.minFilter===ts||_.minFilter===dr||_.minFilter===ai)&&$e("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,Z[_.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,Z[_.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,Z[_.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,V[_.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,V[_.minFilter]),_.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,Q[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===It||_.minFilter!==dr&&_.minFilter!==ai||_.type===un&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");i.texParameterf(y,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Te(y,_){let F=!1;y.__webglInit===void 0&&(y.__webglInit=!0,_.addEventListener("dispose",R));const ee=_.source;let se=f.get(ee);se===void 0&&(se={},f.set(ee,se));const J=O(_);if(J!==y.__cacheKey){se[J]===void 0&&(se[J]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,F=!0),se[J].usedTimes++;const De=se[y.__cacheKey];De!==void 0&&(se[y.__cacheKey].usedTimes--,De.usedTimes===0&&M(_)),y.__cacheKey=J,y.__webglTexture=se[J].texture}return F}function Ne(y,_,F){return Math.floor(Math.floor(y/F)/_)}function He(y,_,F,ee){const J=y.updateRanges;if(J.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,F,ee,_.data);else{J.sort((ue,Me)=>ue.start-Me.start);let De=0;for(let ue=1;ue<J.length;ue++){const Me=J[De],Ce=J[ue],Le=Me.start+Me.count,_e=Ne(Ce.start,_.width,4),Ke=Ne(Me.start,_.width,4);Ce.start<=Le+1&&_e===Ke&&Ne(Ce.start+Ce.count-1,_.width,4)===_e?Me.count=Math.max(Me.count,Ce.start+Ce.count-Me.start):(++De,J[De]=Ce)}J.length=De+1;const ve=i.getParameter(i.UNPACK_ROW_LENGTH),Pe=i.getParameter(i.UNPACK_SKIP_PIXELS),Ge=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let ue=0,Me=J.length;ue<Me;ue++){const Ce=J[ue],Le=Math.floor(Ce.start/4),_e=Math.ceil(Ce.count/4),Ke=Le%_.width,U=Math.floor(Le/_.width),Se=_e,de=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ke),i.pixelStorei(i.UNPACK_SKIP_ROWS,U),t.texSubImage2D(i.TEXTURE_2D,0,Ke,U,Se,de,F,ee,_.data)}y.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ve),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Pe),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ge)}}function $(y,_,F){let ee=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(ee=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(ee=i.TEXTURE_3D);const se=Te(y,_),J=_.source;t.bindTexture(ee,y.__webglTexture,i.TEXTURE0+F);const De=n.get(J);if(J.version!==De.__version||se===!0){t.activeTexture(i.TEXTURE0+F);const ve=it.getPrimaries(it.workingColorSpace),Pe=_.colorSpace===Vn?null:it.getPrimaries(_.colorSpace),Ge=_.colorSpace===Vn||ve===Pe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ge);let ue=v(_.image,!1,r.maxTextureSize);ue=ot(_,ue);const Me=s.convert(_.format,_.colorSpace),Ce=s.convert(_.type);let Le=w(_.internalFormat,Me,Ce,_.colorSpace,_.isVideoTexture);me(ee,_);let _e;const Ke=_.mipmaps,U=_.isVideoTexture!==!0,Se=De.__version===void 0||se===!0,de=J.dataReady,we=P(_,ue);if(_.isDepthTexture)Le=A(_.format===li,_.type),Se&&(U?t.texStorage2D(i.TEXTURE_2D,1,Le,ue.width,ue.height):t.texImage2D(i.TEXTURE_2D,0,Le,ue.width,ue.height,0,Me,Ce,null));else if(_.isDataTexture)if(Ke.length>0){U&&Se&&t.texStorage2D(i.TEXTURE_2D,we,Le,Ke[0].width,Ke[0].height);for(let le=0,oe=Ke.length;le<oe;le++)_e=Ke[le],U?de&&t.texSubImage2D(i.TEXTURE_2D,le,0,0,_e.width,_e.height,Me,Ce,_e.data):t.texImage2D(i.TEXTURE_2D,le,Le,_e.width,_e.height,0,Me,Ce,_e.data);_.generateMipmaps=!1}else U?(Se&&t.texStorage2D(i.TEXTURE_2D,we,Le,ue.width,ue.height),de&&He(_,ue,Me,Ce)):t.texImage2D(i.TEXTURE_2D,0,Le,ue.width,ue.height,0,Me,Ce,ue.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){U&&Se&&t.texStorage3D(i.TEXTURE_2D_ARRAY,we,Le,Ke[0].width,Ke[0].height,ue.depth);for(let le=0,oe=Ke.length;le<oe;le++)if(_e=Ke[le],_.format!==on)if(Me!==null)if(U){if(de)if(_.layerUpdates.size>0){const b=Ia(_e.width,_e.height,_.format,_.type);for(const H of _.layerUpdates){const Y=_e.data.subarray(H*b/_e.data.BYTES_PER_ELEMENT,(H+1)*b/_e.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,le,0,0,H,_e.width,_e.height,1,Me,Y)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,le,0,0,0,_e.width,_e.height,ue.depth,Me,_e.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,le,Le,_e.width,_e.height,ue.depth,0,_e.data,0,0);else $e("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?de&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,le,0,0,0,_e.width,_e.height,ue.depth,Me,Ce,_e.data):t.texImage3D(i.TEXTURE_2D_ARRAY,le,Le,_e.width,_e.height,ue.depth,0,Me,Ce,_e.data)}else{U&&Se&&t.texStorage2D(i.TEXTURE_2D,we,Le,Ke[0].width,Ke[0].height);for(let le=0,oe=Ke.length;le<oe;le++)_e=Ke[le],_.format!==on?Me!==null?U?de&&t.compressedTexSubImage2D(i.TEXTURE_2D,le,0,0,_e.width,_e.height,Me,_e.data):t.compressedTexImage2D(i.TEXTURE_2D,le,Le,_e.width,_e.height,0,_e.data):$e("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?de&&t.texSubImage2D(i.TEXTURE_2D,le,0,0,_e.width,_e.height,Me,Ce,_e.data):t.texImage2D(i.TEXTURE_2D,le,Le,_e.width,_e.height,0,Me,Ce,_e.data)}else if(_.isDataArrayTexture)if(U){if(Se&&t.texStorage3D(i.TEXTURE_2D_ARRAY,we,Le,ue.width,ue.height,ue.depth),de)if(_.layerUpdates.size>0){const le=Ia(ue.width,ue.height,_.format,_.type);for(const oe of _.layerUpdates){const b=ue.data.subarray(oe*le/ue.data.BYTES_PER_ELEMENT,(oe+1)*le/ue.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,oe,ue.width,ue.height,1,Me,Ce,b)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ue.width,ue.height,ue.depth,Me,Ce,ue.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Le,ue.width,ue.height,ue.depth,0,Me,Ce,ue.data);else if(_.isData3DTexture)U?(Se&&t.texStorage3D(i.TEXTURE_3D,we,Le,ue.width,ue.height,ue.depth),de&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ue.width,ue.height,ue.depth,Me,Ce,ue.data)):t.texImage3D(i.TEXTURE_3D,0,Le,ue.width,ue.height,ue.depth,0,Me,Ce,ue.data);else if(_.isFramebufferTexture){if(Se)if(U)t.texStorage2D(i.TEXTURE_2D,we,Le,ue.width,ue.height);else{let le=ue.width,oe=ue.height;for(let b=0;b<we;b++)t.texImage2D(i.TEXTURE_2D,b,Le,le,oe,0,Me,Ce,null),le>>=1,oe>>=1}}else if(Ke.length>0){if(U&&Se){const le=ge(Ke[0]);t.texStorage2D(i.TEXTURE_2D,we,Le,le.width,le.height)}for(let le=0,oe=Ke.length;le<oe;le++)_e=Ke[le],U?de&&t.texSubImage2D(i.TEXTURE_2D,le,0,0,Me,Ce,_e):t.texImage2D(i.TEXTURE_2D,le,Le,Me,Ce,_e);_.generateMipmaps=!1}else if(U){if(Se){const le=ge(ue);t.texStorage2D(i.TEXTURE_2D,we,Le,le.width,le.height)}de&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Me,Ce,ue)}else t.texImage2D(i.TEXTURE_2D,0,Le,Me,Ce,ue);m(_)&&d(ee),De.__version=J.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function re(y,_,F){if(_.image.length!==6)return;const ee=Te(y,_),se=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+F);const J=n.get(se);if(se.version!==J.__version||ee===!0){t.activeTexture(i.TEXTURE0+F);const De=it.getPrimaries(it.workingColorSpace),ve=_.colorSpace===Vn?null:it.getPrimaries(_.colorSpace),Pe=_.colorSpace===Vn||De===ve?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Pe);const Ge=_.isCompressedTexture||_.image[0].isCompressedTexture,ue=_.image[0]&&_.image[0].isDataTexture,Me=[];for(let oe=0;oe<6;oe++)!Ge&&!ue?Me[oe]=v(_.image[oe],!0,r.maxCubemapSize):Me[oe]=ue?_.image[oe].image:_.image[oe],Me[oe]=ot(_,Me[oe]);const Ce=Me[0],Le=s.convert(_.format,_.colorSpace),_e=s.convert(_.type),Ke=w(_.internalFormat,Le,_e,_.colorSpace),U=_.isVideoTexture!==!0,Se=J.__version===void 0||ee===!0,de=se.dataReady;let we=P(_,Ce);me(i.TEXTURE_CUBE_MAP,_);let le;if(Ge){U&&Se&&t.texStorage2D(i.TEXTURE_CUBE_MAP,we,Ke,Ce.width,Ce.height);for(let oe=0;oe<6;oe++){le=Me[oe].mipmaps;for(let b=0;b<le.length;b++){const H=le[b];_.format!==on?Le!==null?U?de&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b,0,0,H.width,H.height,Le,H.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b,Ke,H.width,H.height,0,H.data):$e("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?de&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b,0,0,H.width,H.height,Le,_e,H.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b,Ke,H.width,H.height,0,Le,_e,H.data)}}}else{if(le=_.mipmaps,U&&Se){le.length>0&&we++;const oe=ge(Me[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,we,Ke,oe.width,oe.height)}for(let oe=0;oe<6;oe++)if(ue){U?de&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,Me[oe].width,Me[oe].height,Le,_e,Me[oe].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Ke,Me[oe].width,Me[oe].height,0,Le,_e,Me[oe].data);for(let b=0;b<le.length;b++){const Y=le[b].image[oe].image;U?de&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b+1,0,0,Y.width,Y.height,Le,_e,Y.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b+1,Ke,Y.width,Y.height,0,Le,_e,Y.data)}}else{U?de&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,Le,_e,Me[oe]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Ke,Le,_e,Me[oe]);for(let b=0;b<le.length;b++){const H=le[b];U?de&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b+1,0,0,Le,_e,H.image[oe]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b+1,Ke,Le,_e,H.image[oe])}}}m(_)&&d(i.TEXTURE_CUBE_MAP),J.__version=se.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function ie(y,_,F,ee,se,J){const De=s.convert(F.format,F.colorSpace),ve=s.convert(F.type),Pe=w(F.internalFormat,De,ve,F.colorSpace),Ge=n.get(_),ue=n.get(F);if(ue.__renderTarget=_,!Ge.__hasExternalTextures){const Me=Math.max(1,_.width>>J),Ce=Math.max(1,_.height>>J);se===i.TEXTURE_3D||se===i.TEXTURE_2D_ARRAY?t.texImage3D(se,J,Pe,Me,Ce,_.depth,0,De,ve,null):t.texImage2D(se,J,Pe,Me,Ce,0,De,ve,null)}t.bindFramebuffer(i.FRAMEBUFFER,y),et(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ee,se,ue.__webglTexture,0,I(_)):(se===i.TEXTURE_2D||se>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&se<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,ee,se,ue.__webglTexture,J),t.bindFramebuffer(i.FRAMEBUFFER,null)}function xe(y,_,F){if(i.bindRenderbuffer(i.RENDERBUFFER,y),_.depthBuffer){const ee=_.depthTexture,se=ee&&ee.isDepthTexture?ee.type:null,J=A(_.stencilBuffer,se),De=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;et(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,I(_),J,_.width,_.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,I(_),J,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,J,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,De,i.RENDERBUFFER,y)}else{const ee=_.textures;for(let se=0;se<ee.length;se++){const J=ee[se],De=s.convert(J.format,J.colorSpace),ve=s.convert(J.type),Pe=w(J.internalFormat,De,ve,J.colorSpace);et(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,I(_),Pe,_.width,_.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,I(_),Pe,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Pe,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function fe(y,_,F){const ee=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,y),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const se=n.get(_.depthTexture);if(se.__renderTarget=_,(!se.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),ee){if(se.__webglInit===void 0&&(se.__webglInit=!0,_.depthTexture.addEventListener("dispose",R)),se.__webglTexture===void 0){se.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,se.__webglTexture),me(i.TEXTURE_CUBE_MAP,_.depthTexture);const Ge=s.convert(_.depthTexture.format),ue=s.convert(_.depthTexture.type);let Me;_.depthTexture.format===Nn?Me=i.DEPTH_COMPONENT24:_.depthTexture.format===li&&(Me=i.DEPTH24_STENCIL8);for(let Ce=0;Ce<6;Ce++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,0,Me,_.width,_.height,0,Ge,ue,null)}}else X(_.depthTexture,0);const J=se.__webglTexture,De=I(_),ve=ee?i.TEXTURE_CUBE_MAP_POSITIVE_X+F:i.TEXTURE_2D,Pe=_.depthTexture.format===li?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===Nn)et(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Pe,ve,J,0,De):i.framebufferTexture2D(i.FRAMEBUFFER,Pe,ve,J,0);else if(_.depthTexture.format===li)et(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Pe,ve,J,0,De):i.framebufferTexture2D(i.FRAMEBUFFER,Pe,ve,J,0);else throw new Error("Unknown depthTexture format")}function We(y){const _=n.get(y),F=y.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==y.depthTexture){const ee=y.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),ee){const se=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,ee.removeEventListener("dispose",se)};ee.addEventListener("dispose",se),_.__depthDisposeCallback=se}_.__boundDepthTexture=ee}if(y.depthTexture&&!_.__autoAllocateDepthBuffer)if(F)for(let ee=0;ee<6;ee++)fe(_.__webglFramebuffer[ee],y,ee);else{const ee=y.texture.mipmaps;ee&&ee.length>0?fe(_.__webglFramebuffer[0],y,0):fe(_.__webglFramebuffer,y,0)}else if(F){_.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[ee]),_.__webglDepthbuffer[ee]===void 0)_.__webglDepthbuffer[ee]=i.createRenderbuffer(),xe(_.__webglDepthbuffer[ee],y,!1);else{const se=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=_.__webglDepthbuffer[ee];i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,se,i.RENDERBUFFER,J)}}else{const ee=y.texture.mipmaps;if(ee&&ee.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),xe(_.__webglDepthbuffer,y,!1);else{const se=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,se,i.RENDERBUFFER,J)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function st(y,_,F){const ee=n.get(y);_!==void 0&&ie(ee.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&We(y)}function qe(y){const _=y.texture,F=n.get(y),ee=n.get(_);y.addEventListener("dispose",C);const se=y.textures,J=y.isWebGLCubeRenderTarget===!0,De=se.length>1;if(De||(ee.__webglTexture===void 0&&(ee.__webglTexture=i.createTexture()),ee.__version=_.version,o.memory.textures++),J){F.__webglFramebuffer=[];for(let ve=0;ve<6;ve++)if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer[ve]=[];for(let Pe=0;Pe<_.mipmaps.length;Pe++)F.__webglFramebuffer[ve][Pe]=i.createFramebuffer()}else F.__webglFramebuffer[ve]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer=[];for(let ve=0;ve<_.mipmaps.length;ve++)F.__webglFramebuffer[ve]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(De)for(let ve=0,Pe=se.length;ve<Pe;ve++){const Ge=n.get(se[ve]);Ge.__webglTexture===void 0&&(Ge.__webglTexture=i.createTexture(),o.memory.textures++)}if(y.samples>0&&et(y)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let ve=0;ve<se.length;ve++){const Pe=se[ve];F.__webglColorRenderbuffer[ve]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[ve]);const Ge=s.convert(Pe.format,Pe.colorSpace),ue=s.convert(Pe.type),Me=w(Pe.internalFormat,Ge,ue,Pe.colorSpace,y.isXRRenderTarget===!0),Ce=I(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ce,Me,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ve,i.RENDERBUFFER,F.__webglColorRenderbuffer[ve])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),xe(F.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(J){t.bindTexture(i.TEXTURE_CUBE_MAP,ee.__webglTexture),me(i.TEXTURE_CUBE_MAP,_);for(let ve=0;ve<6;ve++)if(_.mipmaps&&_.mipmaps.length>0)for(let Pe=0;Pe<_.mipmaps.length;Pe++)ie(F.__webglFramebuffer[ve][Pe],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ve,Pe);else ie(F.__webglFramebuffer[ve],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ve,0);m(_)&&d(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(De){for(let ve=0,Pe=se.length;ve<Pe;ve++){const Ge=se[ve],ue=n.get(Ge);let Me=i.TEXTURE_2D;(y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(Me=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Me,ue.__webglTexture),me(Me,Ge),ie(F.__webglFramebuffer,y,Ge,i.COLOR_ATTACHMENT0+ve,Me,0),m(Ge)&&d(Me)}t.unbindTexture()}else{let ve=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(ve=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ve,ee.__webglTexture),me(ve,_),_.mipmaps&&_.mipmaps.length>0)for(let Pe=0;Pe<_.mipmaps.length;Pe++)ie(F.__webglFramebuffer[Pe],y,_,i.COLOR_ATTACHMENT0,ve,Pe);else ie(F.__webglFramebuffer,y,_,i.COLOR_ATTACHMENT0,ve,0);m(_)&&d(ve),t.unbindTexture()}y.depthBuffer&&We(y)}function ne(y){const _=y.textures;for(let F=0,ee=_.length;F<ee;F++){const se=_[F];if(m(se)){const J=T(y),De=n.get(se).__webglTexture;t.bindTexture(J,De),d(J),t.unbindTexture()}}}const Ee=[],ce=[];function Be(y){if(y.samples>0){if(et(y)===!1){const _=y.textures,F=y.width,ee=y.height;let se=i.COLOR_BUFFER_BIT;const J=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,De=n.get(y),ve=_.length>1;if(ve)for(let Ge=0;Ge<_.length;Ge++)t.bindFramebuffer(i.FRAMEBUFFER,De.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,De.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,De.__webglMultisampledFramebuffer);const Pe=y.texture.mipmaps;Pe&&Pe.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,De.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,De.__webglFramebuffer);for(let Ge=0;Ge<_.length;Ge++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(se|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(se|=i.STENCIL_BUFFER_BIT)),ve){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,De.__webglColorRenderbuffer[Ge]);const ue=n.get(_[Ge]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ue,0)}i.blitFramebuffer(0,0,F,ee,0,0,F,ee,se,i.NEAREST),l===!0&&(Ee.length=0,ce.length=0,Ee.push(i.COLOR_ATTACHMENT0+Ge),y.depthBuffer&&y.resolveDepthBuffer===!1&&(Ee.push(J),ce.push(J),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,ce)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ee))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ve)for(let Ge=0;Ge<_.length;Ge++){t.bindFramebuffer(i.FRAMEBUFFER,De.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.RENDERBUFFER,De.__webglColorRenderbuffer[Ge]);const ue=n.get(_[Ge]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,De.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.TEXTURE_2D,ue,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,De.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&l){const _=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function I(y){return Math.min(r.maxSamples,y.samples)}function et(y){const _=n.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Xe(y){const _=o.render.frame;u.get(y)!==_&&(u.set(y,_),y.update())}function ot(y,_){const F=y.colorSpace,ee=y.format,se=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||F!==Fi&&F!==Vn&&(it.getTransfer(F)===ut?(ee!==on||se!==qt)&&$e("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):nt("WebGLTextures: Unsupported texture color space:",F)),_}function ge(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(c.width=y.naturalWidth||y.width,c.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(c.width=y.displayWidth,c.height=y.displayHeight):(c.width=y.width,c.height=y.height),c}this.allocateTextureUnit=L,this.resetTextureUnits=D,this.setTexture2D=X,this.setTexture2DArray=q,this.setTexture3D=z,this.setTextureCube=te,this.rebindTextures=st,this.setupRenderTarget=qe,this.updateRenderTargetMipmap=ne,this.updateMultisampleRenderTarget=Be,this.setupDepthRenderbuffer=We,this.setupFrameBufferTexture=ie,this.useMultisampledRTT=et,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function lm(i,e){function t(n,r=Vn){let s;const o=it.getTransfer(r);if(n===qt)return i.UNSIGNED_BYTE;if(n===No)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Fo)return i.UNSIGNED_SHORT_5_5_5_1;if(n===El)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===yl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Sl)return i.BYTE;if(n===bl)return i.SHORT;if(n===rr)return i.UNSIGNED_SHORT;if(n===Uo)return i.INT;if(n===mn)return i.UNSIGNED_INT;if(n===un)return i.FLOAT;if(n===Un)return i.HALF_FLOAT;if(n===Tl)return i.ALPHA;if(n===wl)return i.RGB;if(n===on)return i.RGBA;if(n===Nn)return i.DEPTH_COMPONENT;if(n===li)return i.DEPTH_STENCIL;if(n===Al)return i.RED;if(n===Oo)return i.RED_INTEGER;if(n===Ni)return i.RG;if(n===Bo)return i.RG_INTEGER;if(n===zo)return i.RGBA_INTEGER;if(n===Nr||n===Fr||n===Or||n===Br)if(o===ut)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Nr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Fr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Or)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Br)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Nr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Fr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Or)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Br)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ys||n===$s||n===qs||n===Zs)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ys)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===$s)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===qs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Zs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ks||n===js||n===Js||n===Qs||n===eo||n===to||n===no)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Ks||n===js)return o===ut?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Js)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===Qs)return s.COMPRESSED_R11_EAC;if(n===eo)return s.COMPRESSED_SIGNED_R11_EAC;if(n===to)return s.COMPRESSED_RG11_EAC;if(n===no)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===io||n===ro||n===so||n===oo||n===ao||n===lo||n===co||n===uo||n===ho||n===fo||n===po||n===mo||n===go||n===_o)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===io)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ro)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===so)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===oo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ao)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===lo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===co)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===uo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ho)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===fo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===po)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===mo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===go)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===_o)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===xo||n===vo||n===Mo)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===xo)return o===ut?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===vo)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Mo)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===So||n===bo||n===Eo||n===yo)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===So)return s.COMPRESSED_RED_RGTC1_EXT;if(n===bo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Eo)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===yo)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===sr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const cm=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
               ...
               <h3>Your own deck</h3>
               <p>Export slides as PNG/JPG (1920×1080), copy them into <code>slides/</code>, and list them in <code>slides/manifest.json</code> — video clips (.mp4) can be listed too.</p>`:"<p>The hospital street: a racetrack loop of two parallel streets joined by glazed cloisters across the courtyard — take whichever way round is shorter. Wing entrances open off the outside of each street; the courtyard holds the lawn and the Postgraduate Medical Centre.</p>";else{H+=`<p>${ge(b.description??"Definition pending.")}</p>`;const Y=[];b.plural&&Y.push(`<strong>Plural:</strong> ${ge(b.plural)}`),b.alsoKnownAs.length&&Y.push(`<strong>Also known as:</strong> ${ge(b.alsoKnownAs.join("; "))}`),b.deprecated.length&&Y.push(`<strong>Deprecated terms:</strong> ${ge(b.deprecated.join("; "))}`),b.termClause&&Y.push(`<strong>Clause:</strong> ${ge(b.termClause)}`),b.source&&Y.push(`<span class="small"><strong>Source:</strong> ${ge(b.source)}</span>`),Y.length&&(H+=`<p>${Y.join("<br>")}</p>`),b.notes.length&&(H+=`<h3>Notes</h3><ol>${b.notes.map(he=>`<li>${ge(he.text)}</li>`).join("")}</ol>`),b.examples.length&&(H+=`<h3>Examples</h3><ol>${b.examples.map(he=>`<li>${ge(he.text)}</li>`).join("")}</ol>`);const ae=he=>ge(e.get(he)?.label??"?");(b.out.length||b.self.length)&&(H+=`<h3>Outbound associations (doors on the right wall)</h3><ul>${[...b.out.map(he=>`<li>${ge(Yr(b.label,he.label,e.get(he.targetId)?.label??"?",he))}</li>`),...b.self.map(he=>`<li>${ge(he.label)} → ${ge(b.label)} (end wall)</li>`)].join("")}</ul>`),b.in.length&&(H+=`<h3>Inbound associations (doors on the left wall)</h3><ul>${b.in.map(he=>`<li>${ge(Yr(e.get(he.sourceId)?.label??"?",he.label,b.label,he))}</li>`).join("")}</ul>`),b.supers.length&&(H+=`<h3>Generalisations (stairs up)</h3><ul>${b.supers.map(he=>`<li>${ae(he)}</li>`).join("")}</ul>`),b.subs.length&&(H+=`<h3>Specialisations (stairs down)</h3><ul>${b.subs.map(he=>`<li>${ae(he)}</li>`).join("")}</ul>`)}et.innerHTML=H,ot=g.controls.isLocked,ot&&g.controls.unlock(),ce.style.display="flex",Xe=!0}ce.addEventListener("click",b=>{b.target===ce&&y()});let F=null;function ee(){Tn()||Xe||F?.kind==="lift"&&ne(F)}function se(b){const H=new Set;for(const Y of O.interactables){if(Math.abs(Y.triggerPos.y-b.y)>2)continue;const ae=Math.abs(b.x-Y.triggerPos.x),he=Math.abs(b.z-Y.triggerPos.z);Y.halfX!==void 0?ae<=Y.halfX&&he<=(Y.halfZ??Y.halfX)&&H.add(Y):ae*ae+he*he<=Y.radius*Y.radius&&H.add(Y)}return H}let J=new Set;function De(){if(q){F=null,Ri.style.opacity="0";return}const b=performance.now(),H=se(g.floorPosition);let Y=null;for(const ae of H){if(!ae.auto){Y=ae;continue}if(!J.has(ae)&&!(b-He<n0)){ae.kind==="stair-up"||ae.kind==="stair-down"?xe(ae.targetIds[0],`${ae.label} (portal)`):st(ae);return}}J=H,F=Y,Ri.textContent=Y?Y.prompt??`E — ${Y.label}`:"",Ri.style.opacity=Y?"1":"0"}const ve=new Mu,Pe=new rt;function Ge(b,H){const Y=O.boards;if(!Y?.length)return null;g.camera.updateMatrixWorld(),Pe.set(b,H),ve.setFromCamera(Pe,g.camera);for(const ae of Y){ae.mesh.updateWorldMatrix(!0,!1);const he=ve.intersectObject(ae.mesh,!1)[0];if(!(!he?.uv||he.distance>(ae.kind==="screen"?16:4.2)))for(const Ue of ae.cells){const[Ye,_t,yt,an]=Ue.rect;if(he.uv.x>=Ye&&he.uv.x<=yt&&he.uv.y>=_t&&he.uv.y<=an)return{...Ue,kind:ae.kind}}}return null}function ue(b,H){if(q||Tn()||Xe||performance.now()-He<400)return!1;const Y=Ge(b,H);if(!Y)return!1;if(Y.kind==="screen")Y.id==="next"?A.next():A.prev(),Ot(A.label);else if(Y.kind==="lift"){const ae=O;ae.liftPos&&g.floorPosition.distanceTo(ae.liftPos)<1.2?fe(ae,Y.id):We(Y.id)}else xe(Y.id,`→ ${v.get(Y.id)?.label??Y.label}`);return!0}p.domElement.addEventListener("click",()=>{g.controls.isLocked&&ue(0,0)});let Me=0,Ce=0,Le=0;p.domElement.addEventListener("pointerdown",b=>{Me=b.clientX,Ce=b.clientY,Le=performance.now()}),p.domElement.addEventListener("pointerup",b=>{g.controls.isLocked||Math.hypot(b.clientX-Me,b.clientY-Ce)>8||performance.now()-Le>600||ue(b.clientX/innerWidth*2-1,-(b.clientY/innerHeight)*2+1)}),addEventListener("keydown",b=>{if(Xe){(b.code==="Escape"||b.code==="KeyR")&&y();return}Tn()||(b.code==="KeyE"&&ee(),b.code==="KeyR"&&_(),b.code==="KeyM"&&Ee(),b.code==="KeyB"&&ie(),b.code==="KeyF"&&g.dash(12)>.3&&Ci(),b.code==="KeyH"&&(document.body.classList.toggle("filming")||Ot("Interface restored")),O.id===oi&&((b.code==="ArrowRight"||b.code==="PageDown")&&(b.preventDefault(),A.next(),Ot(A.label)),(b.code==="ArrowLeft"||b.code==="PageUp")&&(b.preventDefault(),A.prev(),Ot(A.label)),b.code==="KeyL"&&(_e=!_e,w.setHouseLights(_e),Ot(_e?"House lights up":"House lights dimmed — L restores"))))});let _e=!0;if(Ri.addEventListener("click",ee),g.enableDragLook(p.domElement),Te){const b=document.getElementById("joy"),H=document.getElementById("joy-knob");let Y=null;const ae=()=>{Y=null,H.style.transform="",g.setTouchMove(0,0)},he=Ue=>{const Ye=b.getBoundingClientRect();let _t=Ue.clientX-(Ye.left+Ye.width/2),yt=Ue.clientY-(Ye.top+Ye.height/2);if(!Number.isFinite(_t)||!Number.isFinite(yt))return;const an=Math.hypot(_t,yt),Oe=44;an>Oe&&(_t*=Oe/an,yt*=Oe/an),H.style.transform=`translate(${_t}px, ${yt}px)`,g.setTouchMove(-yt/Oe,_t/Oe)};b.addEventListener("pointerdown",Ue=>{Ue.preventDefault(),Y=Ue.pointerId,he(Ue);try{b.setPointerCapture(Ue.pointerId)}catch{}}),b.addEventListener("pointermove",Ue=>{Ue.pointerId===Y&&(Ue.preventDefault(),he(Ue))}),b.addEventListener("pointerup",ae),b.addEventListener("pointercancel",ae),document.getElementById("btn-read").addEventListener("click",()=>Xe?y():_()),document.getElementById("btn-porter").addEventListener("click",()=>{!Tn()&&!Xe&&Ee()}),document.getElementById("btn-dash").addEventListener("click",()=>{!Tn()&&!Xe&&g.dash(12)>.3&&Ci()}),document.getElementById("btn-back").addEventListener("click",ie)}const Ke=new vu;let U=0;const Se={logic:0,render:0},de=performance.now();let we=12,le=0;p.setAnimationLoop(()=>{const b=performance.now(),H=Math.min(Ke.getDelta(),.05);Tn()||g.update(H),z(H);for(const he of E){const Ue=he.owner.group.visible;he.w.group.visible=Ue,Ue&&he.w.update(H)}const Y=me(g.floorPosition);if(Y&&Y!==O&&X(Y),De(),g.controls.isLocked&&!q&&!Tn()){const he=Ge(0,0);he&&(Ri.textContent=he.kind==="screen"?`Click — ${he.label}`:`Click — ${he.kind==="lift"?"lift to":"go to"} ${he.label}`,Ri.style.opacity="1")}if(U+=H,U>.4&&(U=0,x.update(g.position,a?40:55,a?100:120,a?5:8),L(),performance.now()-de>12e3&&E.length)){if(le===0&&we>26){le=1;for(let he=E.length-1;he>=0;he-=2)h.remove(E[he].w.group),E.splice(he,1);Ot("Trimmed ward activity to keep things smooth")}else if(le===1&&we>30){le=2;for(const he of E)h.remove(he.w.group);E.length=0,Ot("Paused ward activity for performance")}}const ae=performance.now();p.render(h,g.camera),Se.logic=ae-b,Se.render=performance.now()-ae,we=we*.96+(Se.logic+Se.render)*.04}),addEventListener("resize",()=>{g.camera.aspect=innerWidth/innerHeight,g.camera.updateProjectionMatrix(),p.setSize(innerWidth,innerHeight)});function oe(){const b={areas:i.classes.length+3,doorOut:i.classes.reduce((Oe,at)=>Oe+at.out.length,0),doorIn:i.classes.reduce((Oe,at)=>Oe+at.in.length,0),doorSelf:i.classes.reduce((Oe,at)=>Oe+at.self.length,0),notices:i.classes.reduce((Oe,at)=>Oe+at.notes.length+at.examples.length,0),stairUpPortals:i.classes.reduce((Oe,at)=>Oe+Math.max(0,at.supers.length-1),0),stairDownPortals:i.classes.reduce((Oe,at)=>Oe+(at.subs.length-(r.homeChildren[at.id]?.length??0)),0),lifts:i.classes.filter(Oe=>Oe.supers.length||Oe.subs.length).length,realStairwells:Object.keys(r.landings).length},H=Oe=>C.filter(at=>at.kind===Oe).length,Y={areas:v.size,doorOut:H("door-out"),doorIn:H("door-in"),doorSelf:H("door-self"),notices:[...v.values()].reduce((Oe,at)=>Oe+(at.notices??0),0),stairUpPortals:H("stair-up"),stairDownPortals:H("stair-down"),lifts:H("lift"),realStairwells:Object.keys(r.landings).length},ae=C.filter(Oe=>(Oe.kind==="door-out"||Oe.kind==="door-in")&&!M(Oe)),he=new Map,Ue=(Oe,at)=>{he.has(Oe)||he.set(Oe,new Set),he.get(Oe).add(at)};Ue(rn,kr),Ue(rn,oi),Ue(oi,rn);for(const Oe of r.wings)for(const at of Oe.rootIds)Ue(kr,at),Ue(at,kr);for(const[Oe,at]of Object.entries(r.homeChildren))for(const zt of at)Ue(Oe,zt),Ue(zt,Oe);for(const Oe of C){for(const at of Oe.targetIds)Ue(Oe.areaId,at);if(Oe.kind==="lift"){const at=e.get(Oe.areaId);for(const zt of Lo(at,e))Ue(Oe.areaId,zt.id);for(const zt of at.subs)Ue(Oe.areaId,zt);Ue(Oe.areaId,rn)}}const Ye=new Set([rn]),_t=[rn];for(;_t.length;)for(const Oe of he.get(_t.pop())??[])Ye.has(Oe)||(Ye.add(Oe),_t.push(Oe));const yt=[...v.keys()].filter(Oe=>!Ye.has(Oe)).map(Oe=>v.get(Oe).label);return{pass:Y.areas===b.areas&&Y.doorOut===b.doorOut&&Y.doorIn===b.doorIn&&Y.doorSelf===b.doorSelf&&Y.notices===b.notices&&Y.stairUpPortals===b.stairUpPortals&&Y.stairDownPortals===b.stairDownPortals&&Y.lifts===b.lifts&&ae.length===0&&yt.length===0,expect:b,built:Y,unpaired:ae.length,unreachable:yt,signs:x.count}}window.__hospital={world:i,layout:r,player:g,areas:v,interactables:C,audit:oe,openSearch:Ee,perf:()=>({...Se,avg:+we.toFixed(1),drawCalls:p.info.render.calls,triangles:p.info.render.triangles}),people:()=>({tier:c,walkers:E.length,demoteStage:le}),tickPeople(b=.1,H=1){for(let Y=0;Y<H;Y++)for(const ae of E)ae.w.update(b)},tickDoors(b=.1,H=1){for(let Y=0;Y<H;Y++)z(b);return O.lift?+O.lift.doors.openness.toFixed(2):null},bench(b=30){const H=performance.now();for(let Y=0;Y<b;Y++)p.render(h,g.camera);return{msPerFrame:+((performance.now()-H)/b).toFixed(2),drawCalls:p.info.render.calls,triangles:p.info.render.triangles}},currentArea:()=>O.label,pick:(b,H)=>Ge(b,H),tapPick:(b,H)=>ue(b,H),slides:()=>({label:A.label,total:A.count}),nextSlide:()=>(A.next(),A.label),prevSlide:()=>(A.prev(),A.label),houseLights:b=>w.setHouseLights(b),goto(b){const H=b==="Reception"?d:b==="Hospital Street"?T:b==="Postgraduate Medical Centre"?w:t.get(b)&&v.get(t.get(b).id)||null;return H?(xe(H.id),H.label):`unknown area: ${b}`},walk(b){const H=Math.ceil(Math.abs(b)/.1);for(let ae=0;ae<H;ae++){const he=g.camera.rotation.y,Ue=g.camera.position;Ue.x+=-Math.sin(he)*.1*Math.sign(b),Ue.z+=-Math.cos(he)*.1*Math.sign(b),g.snapGround();const Ye=me(g.floorPosition);Ye&&Ye!==O&&X(Ye),De()}const Y=g.camera.position;return{x:+Y.x.toFixed(2),y:+(Y.y-1.7).toFixed(2),z:+Y.z.toFixed(2),area:O.label}}},console.info(`[hospital] built ${v.size} areas, ${C.length} interactables, ${x.count} signs, loop ${Math.round(r.street.x1)}m × 2 + ${r.loop.C}m courtyard`)}a0().catch(i=>{console.error(i);const e=document.createElement("p");e.style.cssText="color:#fff;padding:24px;font-family:Arial",e.textContent=String(i),ni.replaceChildren(e)});
