...
`].filter(Qi).join(`
`)),o=Ro(o),o=$a(o,t),o=qa(o,t),a=Ro(a),a=$a(a,t),a=qa(a,t),o=Za(o),a=Za(a),t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+d);const T=w+m+o,A=w+d+a,C=Wa(r,r.VERTEX_SHADER,T),R=Wa(r,r.FRAGMENT_SHADER,A);r.attachShader(v,C),r.attachShader(v,R),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function P(E){if(i.debug.checkShaderErrors){const D=r.getProgramInfoLog(v)||"",L=r.getShaderInfoLog(C)||"",O=r.getShaderInfoLog(R)||"",Y=D.trim(),$=L.trim(),G=O.trim();let k=!0,Q=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(k=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,C,R);else{const q=Ya(r,C,"vertex"),ie=Ya(r,R,"fragment");nt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
}`,nm=[new B(1,0,0),new B(-1,0,0),new B(0,1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1)],im=[new B(0,-1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1),new B(0,-1,0),new B(0,-1,0)],el=new gt,Ki=new B,Ls=new B;function rm(i,e,t){let n=new Yo;const r=new rt,s=new rt,o=new Mt,a=new hu,l=new fu,c={},u=t.maxTextureSize,h={[Yn]:Vt,[Vt]:Yn,[An]:An},f=new _n({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new rt},radius:{value:4}},vertexShader:em,fragmentShader:tm}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const x=new xn;x.setAttribute("position",new Jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Pt(x,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ur;let d=this.type;this.render=function(R,P,V){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;R.type===ec&&($e("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),R.type=Ur);const M=i.getRenderTarget(),g=i.getActiveCubeFace(),E=i.getActiveMipmapLevel(),D=i.state;D.setBlending(Pn),D.buffers.depth.getReversed()===!0?D.buffers.color.setClear(0,0,0,0):D.buffers.color.setClear(1,1,1,1),D.buffers.depth.setTest(!0),D.setScissorTest(!1);const L=d!==this.type;L&&P.traverse(function(O){O.material&&(Array.isArray(O.material)?O.material.forEach(Y=>Y.needsUpdate=!0):O.material.needsUpdate=!0)});for(let O=0,Y=R.length;O<Y;O++){const $=R[O],G=$.shadow;if(G===void 0){$e("WebGLShadowMap:",$,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;r.copy(G.mapSize);const k=G.getFrameExtents();if(r.multiply(k),s.copy(G.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/k.x),r.x=s.x*k.x,G.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/k.y),r.y=s.y*k.y,G.mapSize.y=s.y)),G.map===null||L===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===Ji){if($.isPointLight){$e("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new pn(r.x,r.y,{format:Ni,type:Un,minFilter:St,magFilter:St,generateMipmaps:!1}),G.map.texture.name=$.name+".shadowMap",G.map.depthTexture=new ar(r.x,r.y,un),G.map.depthTexture.name=$.name+".shadowMapDepth",G.map.depthTexture.format=Nn,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=It,G.map.depthTexture.magFilter=It}else{$.isPointLight?(G.map=new Ol(r.x),G.map.depthTexture=new lu(r.x,mn)):(G.map=new pn(r.x,r.y),G.map.depthTexture=new ar(r.x,r.y,mn)),G.map.depthTexture.name=$.name+".shadowMap",G.map.depthTexture.format=Nn;const q=i.state.buffers.depth.getReversed();this.type===Ur?(G.map.depthTexture.compareFunction=q?Go:Ho,G.map.depthTexture.minFilter=St,G.map.depthTexture.magFilter=St):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=It,G.map.depthTexture.magFilter=It)}G.camera.updateProjectionMatrix()}const Q=G.map.isWebGLCubeRenderTarget?6:1;for(let q=0;q<Q;q++){if(G.map.isWebGLCubeRenderTarget)i.setRenderTarget(G.map,q),i.clear();else{q===0&&(i.setRenderTarget(G.map),i.clear());const ie=G.getViewport(q);o.set(s.x*ie.x,s.y*ie.y,s.x*ie.z,s.y*ie.w),D.viewport(o)}if($.isPointLight){const ie=G.camera,Ae=G.matrix,_e=$.distance||ie.far;_e!==ie.far&&(ie.far=_e,ie.updateProjectionMatrix()),Ki.setFromMatrixPosition($.matrixWorld),ie.position.copy(Ki),Ls.copy(ie.position),Ls.add(nm[q]),ie.up.copy(im[q]),ie.lookAt(Ls),ie.updateMatrixWorld(),Ae.makeTranslation(-Ki.x,-Ki.y,-Ki.z),el.multiplyMatrices(ie.projectionMatrix,ie.matrixWorldInverse),G._frustum.setFromProjectionMatrix(el,ie.coordinateSystem,ie.reversedDepth)}else G.updateMatrices($);n=G.getFrustum(),A(P,V,G.camera,$,this.type)}G.isPointLightShadow!==!0&&this.type===Ji&&w(G,V),G.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(M,g,E)};function w(R,P){const V=e.update(v);f.defines.VSM_SAMPLES!==R.blurSamples&&(f.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new pn(r.x,r.y,{format:Ni,type:Un})),f.uniforms.shadow_pass.value=R.map.depthTexture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(P,null,V,f,v,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(P,null,V,p,v,null)}function T(R,P,V,M){let g=null;const E=V.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(E!==void 0)g=E;else if(g=V.isPointLight===!0?l:a,i.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const D=g.uuid,L=P.uuid;let O=c[D];O===void 0&&(O={},c[D]=O);let Y=O[L];Y===void 0&&(Y=g.clone(),O[L]=Y,P.addEventListener("dispose",C)),g=Y}if(g.visible=P.visible,g.wireframe=P.wireframe,M===Ji?g.side=P.shadowSide!==null?P.shadowSide:P.side:g.side=P.shadowSide!==null?P.shadowSide:h[P.side],g.alphaMap=P.alphaMap,g.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,g.map=P.map,g.clipShadows=P.clipShadows,g.clippingPlanes=P.clippingPlanes,g.clipIntersection=P.clipIntersection,g.displacementMap=P.displacementMap,g.displacementScale=P.displacementScale,g.displacementBias=P.displacementBias,g.wireframeLinewidth=P.wireframeLinewidth,g.linewidth=P.linewidth,V.isPointLight===!0&&g.isMeshDistanceMaterial===!0){const D=i.properties.get(g);D.light=V}return g}function A(R,P,V,M,g){if(R.visible===!1)return;if(R.layers.test(P.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&g===Ji)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,R.matrixWorld);const L=e.update(R),O=R.material;if(Array.isArray(O)){const Y=L.groups;for(let $=0,G=Y.length;$<G;$++){const k=Y[$],Q=O[k.materialIndex];if(Q&&Q.visible){const q=T(R,Q,M,g);R.onBeforeShadow(i,R,P,V,L,q,k),i.renderBufferDirect(V,null,L,q,R,k),R.onAfterShadow(i,R,P,V,L,q,k)}}}else if(O.visible){const Y=T(R,O,M,g);R.onBeforeShadow(i,R,P,V,L,Y,null),i.renderBufferDirect(V,null,L,Y,R,null),R.onAfterShadow(i,R,P,V,L,Y,null)}}const D=R.children;for(let L=0,O=D.length;L<O;L++)A(D[L],P,V,M,g)}function C(R){R.target.removeEventListener("dispose",C);for(const V in c){const M=c[V],g=R.target.uuid;g in M&&(M[g].dispose(),delete M[g])}}}const sm={[Fs]:Os,[Bs]:Hs,[zs]:Gs,[Di]:ks,[Os]:Fs,[Hs]:Bs,[Gs]:zs,[ks]:Di};function om(i,e){function t(){let U=!1;const Se=new Mt;let fe=null;const Te=new Mt(0,0,0,0);return{setMask:function(le){fe!==le&&!U&&(i.colorMask(le,le,le,le),fe=le)},setLocked:function(le){U=le},setClear:function(le,se,b,H,X){X===!0&&(le*=H,se*=H,b*=H),Se.set(le,se,b,H),Te.equals(Se)===!1&&(i.clearColor(le,se,b,H),Te.copy(Se))},reset:function(){U=!1,fe=null,Te.set(-1,0,0,0)}}}function n(){let U=!1,Se=!1,fe=null,Te=null,le=null;return{setReversed:function(se){if(Se!==se){const b=e.get("EXT_clip_control");se?b.clipControlEXT(b.LOWER_LEFT_EXT,b.ZERO_TO_ONE_EXT):b.clipControlEXT(b.LOWER_LEFT_EXT,b.NEGATIVE_ONE_TO_ONE_EXT),Se=se;const H=le;le=null,this.setClear(H)}},getReversed:function(){return Se},setTest:function(se){se?te(i.DEPTH_TEST):oe(i.DEPTH_TEST)},setMask:function(se){fe!==se&&!U&&(i.depthMask(se),fe=se)},setFunc:function(se){if(Se&&(se=sm[se]),Te!==se){switch(se){case Fs:i.depthFunc(i.NEVER);break;case Os:i.depthFunc(i.ALWAYS);break;case Bs:i.depthFunc(i.LESS);break;case Di:i.depthFunc(i.LEQUAL);break;case zs:i.depthFunc(i.EQUAL);break;case ks:i.depthFunc(i.GEQUAL);break;case Hs:i.depthFunc(i.GREATER);break;case Gs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Te=se}},setLocked:function(se){U=se},setClear:function(se){le!==se&&(Se&&(se=1-se),i.clearDepth(se),le=se)},reset:function(){U=!1,fe=null,Te=null,le=null,Se=!1}}}function r(){let U=!1,Se=null,fe=null,Te=null,le=null,se=null,b=null,H=null,X=null;return{setTest:function(ae){U||(ae?te(i.STENCIL_TEST):oe(i.STENCIL_TEST))},setMask:function(ae){Se!==ae&&!U&&(i.stencilMask(ae),Se=ae)},setFunc:function(ae,he,Ue){(fe!==ae||Te!==he||le!==Ue)&&(i.stencilFunc(ae,he,Ue),fe=ae,Te=he,le=Ue)},setOp:function(ae,he,Ue){(se!==ae||b!==he||H!==Ue)&&(i.stencilOp(ae,he,Ue),se=ae,b=he,H=Ue)},setLocked:function(ae){U=ae},setClear:function(ae){X!==ae&&(i.clearStencil(ae),X=ae)},reset:function(){U=!1,Se=null,fe=null,Te=null,le=null,se=null,b=null,H=null,X=null}}}const s=new t,o=new n,a=new r,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,p=[],x=null,v=!1,m=null,d=null,w=null,T=null,A=null,C=null,R=null,P=new Ze(0,0,0),V=0,M=!1,g=null,E=null,D=null,L=null,O=null;const Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let $=!1,G=0;const k=i.getParameter(i.VERSION);k.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(k)[1]),$=G>=1):k.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(k)[1]),$=G>=2);let Q=null,q={};const ie=i.getParameter(i.SCISSOR_BOX),Ae=i.getParameter(i.VIEWPORT),_e=new Mt().fromArray(ie),He=new Mt().fromArray(Ae);function Be(U,Se,fe,Te){const le=new Uint8Array(4),se=i.createTexture();i.bindTexture(U,se),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let b=0;b<fe;b++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(Se,0,i.RGBA,1,1,Te,0,i.RGBA,i.UNSIGNED_BYTE,le):i.texImage2D(Se+b,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,le);return se}const K={};K[i.TEXTURE_2D]=Be(i.TEXTURE_2D,i.TEXTURE_2D,1),K[i.TEXTURE_CUBE_MAP]=Be(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[i.TEXTURE_2D_ARRAY]=Be(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),K[i.TEXTURE_3D]=Be(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),te(i.DEPTH_TEST),o.setFunc(Di),ce(!1),Oe(na),te(i.CULL_FACE),ne(Pn);function te(U){u[U]!==!0&&(i.enable(U),u[U]=!0)}function oe(U){u[U]!==!1&&(i.disable(U),u[U]=!1)}function ve(U,Se){return h[U]!==Se?(i.bindFramebuffer(U,Se),h[U]=Se,U===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=Se),U===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=Se),!0):!1}function pe(U,Se){let fe=p,Te=!1;if(U){fe=f.get(Se),fe===void 0&&(fe=[],f.set(Se,fe));const le=U.textures;if(fe.length!==le.length||fe[0]!==i.COLOR_ATTACHMENT0){for(let se=0,b=le.length;se<b;se++)fe[se]=i.COLOR_ATTACHMENT0+se;fe.length=le.length,Te=!0}}else fe[0]!==i.BACK&&(fe[0]=i.BACK,Te=!0);Te&&i.drawBuffers(fe)}function We(U){return x!==U?(i.useProgram(U),x=U,!0):!1}const st={[ii]:i.FUNC_ADD,[nc]:i.FUNC_SUBTRACT,[ic]:i.FUNC_REVERSE_SUBTRACT};st[rc]=i.MIN,st[sc]=i.MAX;const qe={[oc]:i.ZERO,[ac]:i.ONE,[lc]:i.SRC_COLOR,[Us]:i.SRC_ALPHA,[pc]:i.SRC_ALPHA_SATURATE,[fc]:i.DST_COLOR,[uc]:i.DST_ALPHA,[cc]:i.ONE_MINUS_SRC_COLOR,[Ns]:i.ONE_MINUS_SRC_ALPHA,[dc]:i.ONE_MINUS_DST_COLOR,[hc]:i.ONE_MINUS_DST_ALPHA,[mc]:i.CONSTANT_COLOR,[gc]:i.ONE_MINUS_CONSTANT_COLOR,[_c]:i.CONSTANT_ALPHA,[xc]:i.ONE_MINUS_CONSTANT_ALPHA};function ne(U,Se,fe,Te,le,se,b,H,X,ae){if(U===Pn){v===!0&&(oe(i.BLEND),v=!1);return}if(v===!1&&(te(i.BLEND),v=!0),U!==tc){if(U!==m||ae!==M){if((d!==ii||A!==ii)&&(i.blendEquation(i.FUNC_ADD),d=ii,A=ii),ae)switch(U){case Ii:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ia:i.blendFunc(i.ONE,i.ONE);break;case ra:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case sa:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:nt("WebGLState: Invalid blending: ",U);break}else switch(U){case Ii:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ia:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case ra:nt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case sa:nt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:nt("WebGLState: Invalid blending: ",U);break}w=null,T=null,C=null,R=null,P.set(0,0,0),V=0,m=U,M=ae}return}le=le||Se,se=se||fe,b=b||Te,(Se!==d||le!==A)&&(i.blendEquationSeparate(st[Se],st[le]),d=Se,A=le),(fe!==w||Te!==T||se!==C||b!==R)&&(i.blendFuncSeparate(qe[fe],qe[Te],qe[se],qe[b]),w=fe,T=Te,C=se,R=b),(H.equals(P)===!1||X!==V)&&(i.blendColor(H.r,H.g,H.b,X),P.copy(H),V=X),m=U,M=!1}function Ee(U,Se){U.side===An?oe(i.CULL_FACE):te(i.CULL_FACE);let fe=U.side===Vt;Se&&(fe=!fe),ce(fe),U.blending===Ii&&U.transparent===!1?ne(Pn):ne(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),s.setMask(U.colorWrite);const Te=U.stencilWrite;a.setTest(Te),Te&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),et(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?te(i.SAMPLE_ALPHA_TO_COVERAGE):oe(i.SAMPLE_ALPHA_TO_COVERAGE)}function ce(U){g!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),g=U)}function Oe(U){U!==Jl?(te(i.CULL_FACE),U!==E&&(U===na?i.cullFace(i.BACK):U===Ql?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):oe(i.CULL_FACE),E=U}function I(U){U!==D&&($&&i.lineWidth(U),D=U)}function et(U,Se,fe){U?(te(i.POLYGON_OFFSET_FILL),(L!==Se||O!==fe)&&(i.polygonOffset(Se,fe),L=Se,O=fe)):oe(i.POLYGON_OFFSET_FILL)}function Xe(U){U?te(i.SCISSOR_TEST):oe(i.SCISSOR_TEST)}function ot(U){U===void 0&&(U=i.TEXTURE0+Y-1),Q!==U&&(i.activeTexture(U),Q=U)}function me(U,Se,fe){fe===void 0&&(Q===null?fe=i.TEXTURE0+Y-1:fe=Q);let Te=q[fe];Te===void 0&&(Te={type:void 0,texture:void 0},q[fe]=Te),(Te.type!==U||Te.texture!==Se)&&(Q!==fe&&(i.activeTexture(fe),Q=fe),i.bindTexture(U,Se||K[U]),Te.type=U,Te.texture=Se)}function y(){const U=q[Q];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function _(){try{i.compressedTexImage2D(...arguments)}catch(U){nt("WebGLState:",U)}}function N(){try{i.compressedTexImage3D(...arguments)}catch(U){nt("WebGLState:",U)}}function ee(){try{i.texSubImage2D(...arguments)}catch(U){nt("WebGLState:",U)}}function re(){try{i.texSubImage3D(...arguments)}catch(U){nt("WebGLState:",U)}}function J(){try{i.compressedTexSubImage2D(...arguments)}catch(U){nt("WebGLState:",U)}}function De(){try{i.compressedTexSubImage3D(...arguments)}catch(U){nt("WebGLState:",U)}}function xe(){try{i.texStorage2D(...arguments)}catch(U){nt("WebGLState:",U)}}function Pe(){try{i.texStorage3D(...arguments)}catch(U){nt("WebGLState:",U)}}function Ge(){try{i.texImage2D(...arguments)}catch(U){nt("WebGLState:",U)}}function ue(){try{i.texImage3D(...arguments)}catch(U){nt("WebGLState:",U)}}function Me(U){_e.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),_e.copy(U))}function Ce(U){He.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),He.copy(U))}function Le(U,Se){let fe=c.get(Se);fe===void 0&&(fe=new WeakMap,c.set(Se,fe));let Te=fe.get(U);Te===void 0&&(Te=i.getUniformBlockIndex(Se,U.name),fe.set(U,Te))}function ge(U,Se){const Te=c.get(Se).get(U);l.get(Se)!==Te&&(i.uniformBlockBinding(Se,Te,U.__bindingPointIndex),l.set(Se,Te))}function Ke(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},Q=null,q={},h={},f=new WeakMap,p=[],x=null,v=!1,m=null,d=null,w=null,T=null,A=null,C=null,R=null,P=new Ze(0,0,0),V=0,M=!1,g=null,E=null,D=null,L=null,O=null,_e.set(0,0,i.canvas.width,i.canvas.height),He.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:te,disable:oe,bindFramebuffer:ve,drawBuffers:pe,useProgram:We,setBlending:ne,setMaterial:Ee,setFlipSided:ce,setCullFace:Oe,setLineWidth:I,setPolygonOffset:et,setScissorTest:Xe,activeTexture:ot,bindTexture:me,unbindTexture:y,compressedTexImage2D:_,compressedTexImage3D:N,texImage2D:Ge,texImage3D:ue,updateUBOMapping:Le,uniformBlockBinding:ge,texStorage2D:xe,texStorage3D:Pe,texSubImage2D:ee,texSubImage3D:re,compressedTexSubImage2D:J,compressedTexSubImage3D:De,scissor:Me,viewport:Ce,reset:Ke}}function am(i,e,t,n,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new rt,u=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(y,_){return p?new OffscreenCanvas(y,_):Vr("canvas")}function v(y,_,N){let ee=1;const re=me(y);if((re.width>N||re.height>N)&&(ee=N/Math.max(re.width,re.height)),ee<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const J=Math.floor(ee*re.width),De=Math.floor(ee*re.height);h===void 0&&(h=x(J,De));const xe=_?x(J,De):h;return xe.width=J,xe.height=De,xe.getContext("2d").drawImage(y,0,0,J,De),$e("WebGLRenderer: Texture has been resized from ("+re.width+"x"+re.height+") to ("+J+"x"+De+")."),xe}else return"data"in y&&$e("WebGLRenderer: Image in DataTexture is too big ("+re.width+"x"+re.height+")."),y;return y}function m(y){return y.generateMipmaps}function d(y){i.generateMipmap(y)}function w(y){return y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?i.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(y,_,N,ee,re=!1){if(y!==null){if(i[y]!==void 0)return i[y];$e("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let J=_;if(_===i.RED&&(N===i.FLOAT&&(J=i.R32F),N===i.HALF_FLOAT&&(J=i.R16F),N===i.UNSIGNED_BYTE&&(J=i.R8)),_===i.RED_INTEGER&&(N===i.UNSIGNED_BYTE&&(J=i.R8UI),N===i.UNSIGNED_SHORT&&(J=i.R16UI),N===i.UNSIGNED_INT&&(J=i.R32UI),N===i.BYTE&&(J=i.R8I),N===i.SHORT&&(J=i.R16I),N===i.INT&&(J=i.R32I)),_===i.RG&&(N===i.FLOAT&&(J=i.RG32F),N===i.HALF_FLOAT&&(J=i.RG16F),N===i.UNSIGNED_BYTE&&(J=i.RG8)),_===i.RG_INTEGER&&(N===i.UNSIGNED_BYTE&&(J=i.RG8UI),N===i.UNSIGNED_SHORT&&(J=i.RG16UI),N===i.UNSIGNED_INT&&(J=i.RG32UI),N===i.BYTE&&(J=i.RG8I),N===i.SHORT&&(J=i.RG16I),N===i.INT&&(J=i.RG32I)),_===i.RGB_INTEGER&&(N===i.UNSIGNED_BYTE&&(J=i.RGB8UI),N===i.UNSIGNED_SHORT&&(J=i.RGB16UI),N===i.UNSIGNED_INT&&(J=i.RGB32UI),N===i.BYTE&&(J=i.RGB8I),N===i.SHORT&&(J=i.RGB16I),N===i.INT&&(J=i.RGB32I)),_===i.RGBA_INTEGER&&(N===i.UNSIGNED_BYTE&&(J=i.RGBA8UI),N===i.UNSIGNED_SHORT&&(J=i.RGBA16UI),N===i.UNSIGNED_INT&&(J=i.RGBA32UI),N===i.BYTE&&(J=i.RGBA8I),N===i.SHORT&&(J=i.RGBA16I),N===i.INT&&(J=i.RGBA32I)),_===i.RGB&&(N===i.UNSIGNED_INT_5_9_9_9_REV&&(J=i.RGB9_E5),N===i.UNSIGNED_INT_10F_11F_11F_REV&&(J=i.R11F_G11F_B10F)),_===i.RGBA){const De=re?Hr:it.getTransfer(ee);N===i.FLOAT&&(J=i.RGBA32F),N===i.HALF_FLOAT&&(J=i.RGBA16F),N===i.UNSIGNED_BYTE&&(J=De===ut?i.SRGB8_ALPHA8:i.RGBA8),N===i.UNSIGNED_SHORT_4_4_4_4&&(J=i.RGBA4),N===i.UNSIGNED_SHORT_5_5_5_1&&(J=i.RGB5_A1)}return(J===i.R16F||J===i.R32F||J===i.RG16F||J===i.RG32F||J===i.RGBA16F||J===i.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function A(y,_){let N;return y?_===null||_===mn||_===sr?N=i.DEPTH24_STENCIL8:_===un?N=i.DEPTH32F_STENCIL8:_===rr&&(N=i.DEPTH24_STENCIL8,$e("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===mn||_===sr?N=i.DEPTH_COMPONENT24:_===un?N=i.DEPTH_COMPONENT32F:_===rr&&(N=i.DEPTH_COMPONENT16),N}function C(y,_){return m(y)===!0||y.isFramebufferTexture&&y.minFilter!==It&&y.minFilter!==St?Math.log2(Math.max(_.width,_.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?_.mipmaps.length:1}function R(y){const _=y.target;_.removeEventListener("dispose",R),V(_),_.isVideoTexture&&u.delete(_)}function P(y){const _=y.target;_.removeEventListener("dispose",P),g(_)}function V(y){const _=n.get(y);if(_.__webglInit===void 0)return;const N=y.source,ee=f.get(N);if(ee){const re=ee[_.__cacheKey];re.usedTimes--,re.usedTimes===0&&M(y),Object.keys(ee).length===0&&f.delete(N)}n.remove(y)}function M(y){const _=n.get(y);i.deleteTexture(_.__webglTexture);const N=y.source,ee=f.get(N);delete ee[_.__cacheKey],o.memory.textures--}function g(y){const _=n.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),n.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(_.__webglFramebuffer[ee]))for(let re=0;re<_.__webglFramebuffer[ee].length;re++)i.deleteFramebuffer(_.__webglFramebuffer[ee][re]);else i.deleteFramebuffer(_.__webglFramebuffer[ee]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[ee])}else{if(Array.isArray(_.__webglFramebuffer))for(let ee=0;ee<_.__webglFramebuffer.length;ee++)i.deleteFramebuffer(_.__webglFramebuffer[ee]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let ee=0;ee<_.__webglColorRenderbuffer.length;ee++)_.__webglColorRenderbuffer[ee]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[ee]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const N=y.textures;for(let ee=0,re=N.length;ee<re;ee++){const J=n.get(N[ee]);J.__webglTexture&&(i.deleteTexture(J.__webglTexture),o.memory.textures--),n.remove(N[ee])}n.remove(y)}let E=0;function D(){E=0}function L(){const y=E;return y>=r.maxTextures&&$e("WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+r.maxTextures),E+=1,y}function O(y){const _=[];return _.push(y.wrapS),_.push(y.wrapT),_.push(y.wrapR||0),_.push(y.magFilter),_.push(y.minFilter),_.push(y.anisotropy),_.push(y.internalFormat),_.push(y.format),_.push(y.type),_.push(y.generateMipmaps),_.push(y.premultiplyAlpha),_.push(y.flipY),_.push(y.unpackAlignment),_.push(y.colorSpace),_.join()}function Y(y,_){const N=n.get(y);if(y.isVideoTexture&&Xe(y),y.isRenderTargetTexture===!1&&y.isExternalTexture!==!0&&y.version>0&&N.__version!==y.version){const ee=y.image;if(ee===null)$e("WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)$e("WebGLRenderer: Texture marked for update but image is incomplete");else{K(N,y,_);return}}else y.isExternalTexture&&(N.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,N.__webglTexture,i.TEXTURE0+_)}function $(y,_){const N=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&N.__version!==y.version){K(N,y,_);return}else y.isExternalTexture&&(N.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,N.__webglTexture,i.TEXTURE0+_)}function G(y,_){const N=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&N.__version!==y.version){K(N,y,_);return}t.bindTexture(i.TEXTURE_3D,N.__webglTexture,i.TEXTURE0+_)}function k(y,_){const N=n.get(y);if(y.isCubeDepthTexture!==!0&&y.version>0&&N.__version!==y.version){te(N,y,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+_)}const Q={[ir]:i.REPEAT,[Rn]:i.CLAMP_TO_EDGE,[Xs]:i.MIRRORED_REPEAT},q={[It]:i.NEAREST,[Sc]:i.NEAREST_MIPMAP_NEAREST,[dr]:i.NEAREST_MIPMAP_LINEAR,[St]:i.LINEAR,[ts]:i.LINEAR_MIPMAP_NEAREST,[ai]:i.LINEAR_MIPMAP_LINEAR},ie={[yc]:i.NEVER,[Cc]:i.ALWAYS,[Tc]:i.LESS,[Ho]:i.LEQUAL,[wc]:i.EQUAL,[Go]:i.GEQUAL,[Ac]:i.GREATER,[Rc]:i.NOTEQUAL};function Ae(y,_){if(_.type===un&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===St||_.magFilter===ts||_.magFilter===dr||_.magFilter===ai||_.minFilter===St||_.minFilter===ts||_.minFilter===dr||_.minFilter===ai)&&$e("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,Q[_.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,Q[_.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,Q[_.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,q[_.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,q[_.minFilter]),_.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,ie[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===It||_.minFilter!==dr&&_.minFilter!==ai||_.type===un&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const N=e.get("EXT_texture_filter_anisotropic");i.texParameterf(y,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function _e(y,_){let N=!1;y.__webglInit===void 0&&(y.__webglInit=!0,_.addEventListener("dispose",R));const ee=_.source;let re=f.get(ee);re===void 0&&(re={},f.set(ee,re));const J=O(_);if(J!==y.__cacheKey){re[J]===void 0&&(re[J]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,N=!0),re[J].usedTimes++;const De=re[y.__cacheKey];De!==void 0&&(re[y.__cacheKey].usedTimes--,De.usedTimes===0&&M(_)),y.__cacheKey=J,y.__webglTexture=re[J].texture}return N}function He(y,_,N){return Math.floor(Math.floor(y/N)/_)}function Be(y,_,N,ee){const J=y.updateRanges;if(J.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,N,ee,_.data);else{J.sort((ue,Me)=>ue.start-Me.start);let De=0;for(let ue=1;ue<J.length;ue++){const Me=J[De],Ce=J[ue],Le=Me.start+Me.count,ge=He(Ce.start,_.width,4),Ke=He(Me.start,_.width,4);Ce.start<=Le+1&&ge===Ke&&He(Ce.start+Ce.count-1,_.width,4)===ge?Me.count=Math.max(Me.count,Ce.start+Ce.count-Me.start):(++De,J[De]=Ce)}J.length=De+1;const xe=i.getParameter(i.UNPACK_ROW_LENGTH),Pe=i.getParameter(i.UNPACK_SKIP_PIXELS),Ge=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let ue=0,Me=J.length;ue<Me;ue++){const Ce=J[ue],Le=Math.floor(Ce.start/4),ge=Math.ceil(Ce.count/4),Ke=Le%_.width,U=Math.floor(Le/_.width),Se=ge,fe=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ke),i.pixelStorei(i.UNPACK_SKIP_ROWS,U),t.texSubImage2D(i.TEXTURE_2D,0,Ke,U,Se,fe,N,ee,_.data)}y.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,xe),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Pe),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ge)}}function K(y,_,N){let ee=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(ee=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(ee=i.TEXTURE_3D);const re=_e(y,_),J=_.source;t.bindTexture(ee,y.__webglTexture,i.TEXTURE0+N);const De=n.get(J);if(J.version!==De.__version||re===!0){t.activeTexture(i.TEXTURE0+N);const xe=it.getPrimaries(it.workingColorSpace),Pe=_.colorSpace===Vn?null:it.getPrimaries(_.colorSpace),Ge=_.colorSpace===Vn||xe===Pe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ge);let ue=v(_.image,!1,r.maxTextureSize);ue=ot(_,ue);const Me=s.convert(_.format,_.colorSpace),Ce=s.convert(_.type);let Le=T(_.internalFormat,Me,Ce,_.colorSpace,_.isVideoTexture);Ae(ee,_);let ge;const Ke=_.mipmaps,U=_.isVideoTexture!==!0,Se=De.__version===void 0||re===!0,fe=J.dataReady,Te=C(_,ue);if(_.isDepthTexture)Le=A(_.format===li,_.type),Se&&(U?t.texStorage2D(i.TEXTURE_2D,1,Le,ue.width,ue.height):t.texImage2D(i.TEXTURE_2D,0,Le,ue.width,ue.height,0,Me,Ce,null));else if(_.isDataTexture)if(Ke.length>0){U&&Se&&t.texStorage2D(i.TEXTURE_2D,Te,Le,Ke[0].width,Ke[0].height);for(let le=0,se=Ke.length;le<se;le++)ge=Ke[le],U?fe&&t.texSubImage2D(i.TEXTURE_2D,le,0,0,ge.width,ge.height,Me,Ce,ge.data):t.texImage2D(i.TEXTURE_2D,le,Le,ge.width,ge.height,0,Me,Ce,ge.data);_.generateMipmaps=!1}else U?(Se&&t.texStorage2D(i.TEXTURE_2D,Te,Le,ue.width,ue.height),fe&&Be(_,ue,Me,Ce)):t.texImage2D(i.TEXTURE_2D,0,Le,ue.width,ue.height,0,Me,Ce,ue.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){U&&Se&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Te,Le,Ke[0].width,Ke[0].height,ue.depth);for(let le=0,se=Ke.length;le<se;le++)if(ge=Ke[le],_.format!==on)if(Me!==null)if(U){if(fe)if(_.layerUpdates.size>0){const b=Ia(ge.width,ge.height,_.format,_.type);for(const H of _.layerUpdates){const X=ge.data.subarray(H*b/ge.data.BYTES_PER_ELEMENT,(H+1)*b/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,le,0,0,H,ge.width,ge.height,1,Me,X)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,le,0,0,0,ge.width,ge.height,ue.depth,Me,ge.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,le,Le,ge.width,ge.height,ue.depth,0,ge.data,0,0);else $e("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?fe&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,le,0,0,0,ge.width,ge.height,ue.depth,Me,Ce,ge.data):t.texImage3D(i.TEXTURE_2D_ARRAY,le,Le,ge.width,ge.height,ue.depth,0,Me,Ce,ge.data)}else{U&&Se&&t.texStorage2D(i.TEXTURE_2D,Te,Le,Ke[0].width,Ke[0].height);for(let le=0,se=Ke.length;le<se;le++)ge=Ke[le],_.format!==on?Me!==null?U?fe&&t.compressedTexSubImage2D(i.TEXTURE_2D,le,0,0,ge.width,ge.height,Me,ge.data):t.compressedTexImage2D(i.TEXTURE_2D,le,Le,ge.width,ge.height,0,ge.data):$e("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?fe&&t.texSubImage2D(i.TEXTURE_2D,le,0,0,ge.width,ge.height,Me,Ce,ge.data):t.texImage2D(i.TEXTURE_2D,le,Le,ge.width,ge.height,0,Me,Ce,ge.data)}else if(_.isDataArrayTexture)if(U){if(Se&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Te,Le,ue.width,ue.height,ue.depth),fe)if(_.layerUpdates.size>0){const le=Ia(ue.width,ue.height,_.format,_.type);for(const se of _.layerUpdates){const b=ue.data.subarray(se*le/ue.data.BYTES_PER_ELEMENT,(se+1)*le/ue.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,se,ue.width,ue.height,1,Me,Ce,b)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ue.width,ue.height,ue.depth,Me,Ce,ue.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Le,ue.width,ue.height,ue.depth,0,Me,Ce,ue.data);else if(_.isData3DTexture)U?(Se&&t.texStorage3D(i.TEXTURE_3D,Te,Le,ue.width,ue.height,ue.depth),fe&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ue.width,ue.height,ue.depth,Me,Ce,ue.data)):t.texImage3D(i.TEXTURE_3D,0,Le,ue.width,ue.height,ue.depth,0,Me,Ce,ue.data);else if(_.isFramebufferTexture){if(Se)if(U)t.texStorage2D(i.TEXTURE_2D,Te,Le,ue.width,ue.height);else{let le=ue.width,se=ue.height;for(let b=0;b<Te;b++)t.texImage2D(i.TEXTURE_2D,b,Le,le,se,0,Me,Ce,null),le>>=1,se>>=1}}else if(Ke.length>0){if(U&&Se){const le=me(Ke[0]);t.texStorage2D(i.TEXTURE_2D,Te,Le,le.width,le.height)}for(let le=0,se=Ke.length;le<se;le++)ge=Ke[le],U?fe&&t.texSubImage2D(i.TEXTURE_2D,le,0,0,Me,Ce,ge):t.texImage2D(i.TEXTURE_2D,le,Le,Me,Ce,ge);_.generateMipmaps=!1}else if(U){if(Se){const le=me(ue);t.texStorage2D(i.TEXTURE_2D,Te,Le,le.width,le.height)}fe&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Me,Ce,ue)}else t.texImage2D(i.TEXTURE_2D,0,Le,Me,Ce,ue);m(_)&&d(ee),De.__version=J.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function te(y,_,N){if(_.image.length!==6)return;const ee=_e(y,_),re=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+N);const J=n.get(re);if(re.version!==J.__version||ee===!0){t.activeTexture(i.TEXTURE0+N);const De=it.getPrimaries(it.workingColorSpace),xe=_.colorSpace===Vn?null:it.getPrimaries(_.colorSpace),Pe=_.colorSpace===Vn||De===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Pe);const Ge=_.isCompressedTexture||_.image[0].isCompressedTexture,ue=_.image[0]&&_.image[0].isDataTexture,Me=[];for(let se=0;se<6;se++)!Ge&&!ue?Me[se]=v(_.image[se],!0,r.maxCubemapSize):Me[se]=ue?_.image[se].image:_.image[se],Me[se]=ot(_,Me[se]);const Ce=Me[0],Le=s.convert(_.format,_.colorSpace),ge=s.convert(_.type),Ke=T(_.internalFormat,Le,ge,_.colorSpace),U=_.isVideoTexture!==!0,Se=J.__version===void 0||ee===!0,fe=re.dataReady;let Te=C(_,Ce);Ae(i.TEXTURE_CUBE_MAP,_);let le;if(Ge){U&&Se&&t.texStorage2D(i.TEXTURE_CUBE_MAP,Te,Ke,Ce.width,Ce.height);for(let se=0;se<6;se++){le=Me[se].mipmaps;for(let b=0;b<le.length;b++){const H=le[b];_.format!==on?Le!==null?U?fe&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,b,0,0,H.width,H.height,Le,H.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,b,Ke,H.width,H.height,0,H.data):$e("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,b,0,0,H.width,H.height,Le,ge,H.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,b,Ke,H.width,H.height,0,Le,ge,H.data)}}}else{if(le=_.mipmaps,U&&Se){le.length>0&&Te++;const se=me(Me[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,Te,Ke,se.width,se.height)}for(let se=0;se<6;se++)if(ue){U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,Me[se].width,Me[se].height,Le,ge,Me[se].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Ke,Me[se].width,Me[se].height,0,Le,ge,Me[se].data);for(let b=0;b<le.length;b++){const X=le[b].image[se].image;U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,b+1,0,0,X.width,X.height,Le,ge,X.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,b+1,Ke,X.width,X.height,0,Le,ge,X.data)}}else{U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,Le,ge,Me[se]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Ke,Le,ge,Me[se]);for(let b=0;b<le.length;b++){const H=le[b];U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,b+1,0,0,Le,ge,H.image[se]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,b+1,Ke,Le,ge,H.image[se])}}}m(_)&&d(i.TEXTURE_CUBE_MAP),J.__version=re.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function oe(y,_,N,ee,re,J){const De=s.convert(N.format,N.colorSpace),xe=s.convert(N.type),Pe=T(N.internalFormat,De,xe,N.colorSpace),Ge=n.get(_),ue=n.get(N);if(ue.__renderTarget=_,!Ge.__hasExternalTextures){const Me=Math.max(1,_.width>>J),Ce=Math.max(1,_.height>>J);re===i.TEXTURE_3D||re===i.TEXTURE_2D_ARRAY?t.texImage3D(re,J,Pe,Me,Ce,_.depth,0,De,xe,null):t.texImage2D(re,J,Pe,Me,Ce,0,De,xe,null)}t.bindFramebuffer(i.FRAMEBUFFER,y),et(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ee,re,ue.__webglTexture,0,I(_)):(re===i.TEXTURE_2D||re>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&re<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,ee,re,ue.__webglTexture,J),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ve(y,_,N){if(i.bindRenderbuffer(i.RENDERBUFFER,y),_.depthBuffer){const ee=_.depthTexture,re=ee&&ee.isDepthTexture?ee.type:null,J=A(_.stencilBuffer,re),De=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;et(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,I(_),J,_.width,_.height):N?i.renderbufferStorageMultisample(i.RENDERBUFFER,I(_),J,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,J,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,De,i.RENDERBUFFER,y)}else{const ee=_.textures;for(let re=0;re<ee.length;re++){const J=ee[re],De=s.convert(J.format,J.colorSpace),xe=s.convert(J.type),Pe=T(J.internalFormat,De,xe,J.colorSpace);et(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,I(_),Pe,_.width,_.height):N?i.renderbufferStorageMultisample(i.RENDERBUFFER,I(_),Pe,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Pe,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function pe(y,_,N){const ee=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,y),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const re=n.get(_.depthTexture);if(re.__renderTarget=_,(!re.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),ee){if(re.__webglInit===void 0&&(re.__webglInit=!0,_.depthTexture.addEventListener("dispose",R)),re.__webglTexture===void 0){re.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,re.__webglTexture),Ae(i.TEXTURE_CUBE_MAP,_.depthTexture);const Ge=s.convert(_.depthTexture.format),ue=s.convert(_.depthTexture.type);let Me;_.depthTexture.format===Nn?Me=i.DEPTH_COMPONENT24:_.depthTexture.format===li&&(Me=i.DEPTH24_STENCIL8);for(let Ce=0;Ce<6;Ce++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,0,Me,_.width,_.height,0,Ge,ue,null)}}else Y(_.depthTexture,0);const J=re.__webglTexture,De=I(_),xe=ee?i.TEXTURE_CUBE_MAP_POSITIVE_X+N:i.TEXTURE_2D,Pe=_.depthTexture.format===li?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===Nn)et(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Pe,xe,J,0,De):i.framebufferTexture2D(i.FRAMEBUFFER,Pe,xe,J,0);else if(_.depthTexture.format===li)et(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Pe,xe,J,0,De):i.framebufferTexture2D(i.FRAMEBUFFER,Pe,xe,J,0);else throw new Error("Unknown depthTexture format")}function We(y){const _=n.get(y),N=y.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==y.depthTexture){const ee=y.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),ee){const re=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,ee.removeEventListener("dispose",re)};ee.addEventListener("dispose",re),_.__depthDisposeCallback=re}_.__boundDepthTexture=ee}if(y.depthTexture&&!_.__autoAllocateDepthBuffer)if(N)for(let ee=0;ee<6;ee++)pe(_.__webglFramebuffer[ee],y,ee);else{const ee=y.texture.mipmaps;ee&&ee.length>0?pe(_.__webglFramebuffer[0],y,0):pe(_.__webglFramebuffer,y,0)}else if(N){_.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[ee]),_.__webglDepthbuffer[ee]===void 0)_.__webglDepthbuffer[ee]=i.createRenderbuffer(),ve(_.__webglDepthbuffer[ee],y,!1);else{const re=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=_.__webglDepthbuffer[ee];i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,re,i.RENDERBUFFER,J)}}else{const ee=y.texture.mipmaps;if(ee&&ee.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),ve(_.__webglDepthbuffer,y,!1);else{const re=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,re,i.RENDERBUFFER,J)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function st(y,_,N){const ee=n.get(y);_!==void 0&&oe(ee.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),N!==void 0&&We(y)}function qe(y){const _=y.texture,N=n.get(y),ee=n.get(_);y.addEventListener("dispose",P);const re=y.textures,J=y.isWebGLCubeRenderTarget===!0,De=re.length>1;if(De||(ee.__webglTexture===void 0&&(ee.__webglTexture=i.createTexture()),ee.__version=_.version,o.memory.textures++),J){N.__webglFramebuffer=[];for(let xe=0;xe<6;xe++)if(_.mipmaps&&_.mipmaps.length>0){N.__webglFramebuffer[xe]=[];for(let Pe=0;Pe<_.mipmaps.length;Pe++)N.__webglFramebuffer[xe][Pe]=i.createFramebuffer()}else N.__webglFramebuffer[xe]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){N.__webglFramebuffer=[];for(let xe=0;xe<_.mipmaps.length;xe++)N.__webglFramebuffer[xe]=i.createFramebuffer()}else N.__webglFramebuffer=i.createFramebuffer();if(De)for(let xe=0,Pe=re.length;xe<Pe;xe++){const Ge=n.get(re[xe]);Ge.__webglTexture===void 0&&(Ge.__webglTexture=i.createTexture(),o.memory.textures++)}if(y.samples>0&&et(y)===!1){N.__webglMultisampledFramebuffer=i.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let xe=0;xe<re.length;xe++){const Pe=re[xe];N.__webglColorRenderbuffer[xe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,N.__webglColorRenderbuffer[xe]);const Ge=s.convert(Pe.format,Pe.colorSpace),ue=s.convert(Pe.type),Me=T(Pe.internalFormat,Ge,ue,Pe.colorSpace,y.isXRRenderTarget===!0),Ce=I(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ce,Me,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.RENDERBUFFER,N.__webglColorRenderbuffer[xe])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(N.__webglDepthRenderbuffer=i.createRenderbuffer(),ve(N.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(J){t.bindTexture(i.TEXTURE_CUBE_MAP,ee.__webglTexture),Ae(i.TEXTURE_CUBE_MAP,_);for(let xe=0;xe<6;xe++)if(_.mipmaps&&_.mipmaps.length>0)for(let Pe=0;Pe<_.mipmaps.length;Pe++)oe(N.__webglFramebuffer[xe][Pe],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Pe);else oe(N.__webglFramebuffer[xe],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0);m(_)&&d(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(De){for(let xe=0,Pe=re.length;xe<Pe;xe++){const Ge=re[xe],ue=n.get(Ge);let Me=i.TEXTURE_2D;(y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(Me=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Me,ue.__webglTexture),Ae(Me,Ge),oe(N.__webglFramebuffer,y,Ge,i.COLOR_ATTACHMENT0+xe,Me,0),m(Ge)&&d(Me)}t.unbindTexture()}else{let xe=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(xe=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(xe,ee.__webglTexture),Ae(xe,_),_.mipmaps&&_.mipmaps.length>0)for(let Pe=0;Pe<_.mipmaps.length;Pe++)oe(N.__webglFramebuffer[Pe],y,_,i.COLOR_ATTACHMENT0,xe,Pe);else oe(N.__webglFramebuffer,y,_,i.COLOR_ATTACHMENT0,xe,0);m(_)&&d(xe),t.unbindTexture()}y.depthBuffer&&We(y)}function ne(y){const _=y.textures;for(let N=0,ee=_.length;N<ee;N++){const re=_[N];if(m(re)){const J=w(y),De=n.get(re).__webglTexture;t.bindTexture(J,De),d(J),t.unbindTexture()}}}const Ee=[],ce=[];function Oe(y){if(y.samples>0){if(et(y)===!1){const _=y.textures,N=y.width,ee=y.height;let re=i.COLOR_BUFFER_BIT;const J=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,De=n.get(y),xe=_.length>1;if(xe)for(let Ge=0;Ge<_.length;Ge++)t.bindFramebuffer(i.FRAMEBUFFER,De.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,De.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,De.__webglMultisampledFramebuffer);const Pe=y.texture.mipmaps;Pe&&Pe.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,De.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,De.__webglFramebuffer);for(let Ge=0;Ge<_.length;Ge++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(re|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(re|=i.STENCIL_BUFFER_BIT)),xe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,De.__webglColorRenderbuffer[Ge]);const ue=n.get(_[Ge]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ue,0)}i.blitFramebuffer(0,0,N,ee,0,0,N,ee,re,i.NEAREST),l===!0&&(Ee.length=0,ce.length=0,Ee.push(i.COLOR_ATTACHMENT0+Ge),y.depthBuffer&&y.resolveDepthBuffer===!1&&(Ee.push(J),ce.push(J),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,ce)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ee))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),xe)for(let Ge=0;Ge<_.length;Ge++){t.bindFramebuffer(i.FRAMEBUFFER,De.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.RENDERBUFFER,De.__webglColorRenderbuffer[Ge]);const ue=n.get(_[Ge]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,De.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.TEXTURE_2D,ue,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,De.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&l){const _=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function I(y){return Math.min(r.maxSamples,y.samples)}function et(y){const _=n.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Xe(y){const _=o.render.frame;u.get(y)!==_&&(u.set(y,_),y.update())}function ot(y,_){const N=y.colorSpace,ee=y.format,re=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||N!==Fi&&N!==Vn&&(it.getTransfer(N)===ut?(ee!==on||re!==qt)&&$e("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):nt("WebGLTextures: Unsupported texture color space:",N)),_}function me(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(c.width=y.naturalWidth||y.width,c.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(c.width=y.displayWidth,c.height=y.displayHeight):(c.width=y.width,c.height=y.height),c}this.allocateTextureUnit=L,this.resetTextureUnits=D,this.setTexture2D=Y,this.setTexture2DArray=$,this.setTexture3D=G,this.setTextureCube=k,this.rebindTextures=st,this.setupRenderTarget=qe,this.updateRenderTargetMipmap=ne,this.updateMultisampleRenderTarget=Oe,this.setupDepthRenderbuffer=We,this.setupFrameBufferTexture=oe,this.useMultisampledRTT=et,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function lm(i,e){function t(n,r=Vn){let s;const o=it.getTransfer(r);if(n===qt)return i.UNSIGNED_BYTE;if(n===No)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Fo)return i.UNSIGNED_SHORT_5_5_5_1;if(n===El)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===yl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Sl)return i.BYTE;if(n===bl)return i.SHORT;if(n===rr)return i.UNSIGNED_SHORT;if(n===Uo)return i.INT;if(n===mn)return i.UNSIGNED_INT;if(n===un)return i.FLOAT;if(n===Un)return i.HALF_FLOAT;if(n===Tl)return i.ALPHA;if(n===wl)return i.RGB;if(n===on)return i.RGBA;if(n===Nn)return i.DEPTH_COMPONENT;if(n===li)return i.DEPTH_STENCIL;if(n===Al)return i.RED;if(n===Oo)return i.RED_INTEGER;if(n===Ni)return i.RG;if(n===Bo)return i.RG_INTEGER;if(n===zo)return i.RGBA_INTEGER;if(n===Nr||n===Fr||n===Or||n===Br)if(o===ut)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Nr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Fr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Or)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Br)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Nr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Fr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Or)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Br)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ys||n===$s||n===qs||n===Zs)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ys)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===$s)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===qs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Zs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ks||n===js||n===Js||n===Qs||n===eo||n===to||n===no)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Ks||n===js)return o===ut?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Js)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===Qs)return s.COMPRESSED_R11_EAC;if(n===eo)return s.COMPRESSED_SIGNED_R11_EAC;if(n===to)return s.COMPRESSED_RG11_EAC;if(n===no)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===io||n===ro||n===so||n===oo||n===ao||n===lo||n===co||n===uo||n===ho||n===fo||n===po||n===mo||n===go||n===_o)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===io)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ro)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===so)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===oo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ao)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===lo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===co)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===uo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ho)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===fo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===po)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===mo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===go)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===_o)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===xo||n===vo||n===Mo)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===xo)return o===ut?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===vo)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Mo)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===So||n===bo||n===Eo||n===yo)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===So)return s.COMPRESSED_RED_RGTC1_EXT;if(n===bo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Eo)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===yo)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===sr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const cm=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
...
}`;class hm{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Bl(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new _n({vertexShader:cm,fragmentShader:um,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Pt(new ki(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class fm extends ui{constructor(e,t){super();const n=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,h=null,f=null,p=null,x=null;const v=typeof XRWebGLBinding<"u",m=new hm,d={},w=t.getContextAttributes();let T=null,A=null;const C=[],R=[],P=new rt;let V=null;const M=new jt;M.viewport=new Mt;const g=new jt;g.viewport=new Mt;const E=[M,g],D=new xu;let L=null,O=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let te=C[K];return te===void 0&&(te=new ys,C[K]=te),te.getTargetRaySpace()},this.getControllerGrip=function(K){let te=C[K];return te===void 0&&(te=new ys,C[K]=te),te.getGripSpace()},this.getHand=function(K){let te=C[K];return te===void 0&&(te=new ys,C[K]=te),te.getHandSpace()};function Y(K){const te=R.indexOf(K.inputSource);if(te===-1)return;const oe=C[te];oe!==void 0&&(oe.update(K.inputSource,K.frame,c||o),oe.dispatchEvent({type:K.type,data:K.inputSource}))}function $(){r.removeEventListener("select",Y),r.removeEventListener("selectstart",Y),r.removeEventListener("selectend",Y),r.removeEventListener("squeeze",Y),r.removeEventListener("squeezestart",Y),r.removeEventListener("squeezeend",Y),r.removeEventListener("end",$),r.removeEventListener("inputsourceschange",G);for(let K=0;K<C.length;K++){const te=R[K];te!==null&&(R[K]=null,C[K].disconnect(te))}L=null,O=null,m.reset();for(const K in d)delete d[K];e.setRenderTarget(T),p=null,f=null,h=null,r=null,A=null,Be.stop(),n.isPresenting=!1,e.setPixelRatio(V),e.setSize(P.width,P.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,n.isPresenting===!0&&$e("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){a=K,n.isPresenting===!0&&$e("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h===null&&v&&(h=new XRWebGLBinding(r,t)),h},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(K){if(r=K,r!==null){if(T=e.getRenderTarget(),r.addEventListener("select",Y),r.addEventListener("selectstart",Y),r.addEventListener("selectend",Y),r.addEventListener("squeeze",Y),r.addEventListener("squeezestart",Y),r.addEventListener("squeezeend",Y),r.addEventListener("end",$),r.addEventListener("inputsourceschange",G),w.xrCompatible!==!0&&await t.makeXRCompatible(),V=e.getPixelRatio(),e.getSize(P),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let oe=null,ve=null,pe=null;w.depth&&(pe=w.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,oe=w.stencil?li:Nn,ve=w.stencil?sr:mn);const We={colorFormat:t.RGBA8,depthFormat:pe,scaleFactor:s};h=this.getBinding(),f=h.createProjectionLayer(We),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),A=new pn(f.textureWidth,f.textureHeight,{format:on,type:qt,depthTexture:new ar(f.textureWidth,f.textureHeight,ve,void 0,void 0,void 0,void 0,void 0,void 0,oe),stencilBuffer:w.stencil,colorSpace:e.outputColorSpace,samples:w.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const oe={antialias:w.antialias,alpha:!0,depth:w.depth,stencil:w.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,oe),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),A=new pn(p.framebufferWidth,p.framebufferHeight,{format:on,type:qt,colorSpace:e.outputColorSpace,stencilBuffer:w.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}A.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),Be.setContext(r),Be.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function G(K){for(let te=0;te<K.removed.length;te++){const oe=K.removed[te],ve=R.indexOf(oe);ve>=0&&(R[ve]=null,C[ve].disconnect(oe))}for(let te=0;te<K.added.length;te++){const oe=K.added[te];let ve=R.indexOf(oe);if(ve===-1){for(let We=0;We<C.length;We++)if(We>=R.length){R.push(oe),ve=We;break}else if(R[We]===null){R[We]=oe,ve=We;break}if(ve===-1)break}const pe=C[ve];pe&&pe.connect(oe)}}const k=new B,Q=new B;function q(K,te,oe){k.setFromMatrixPosition(te.matrixWorld),Q.setFromMatrixPosition(oe.matrixWorld);const ve=k.distanceTo(Q),pe=te.projectionMatrix.elements,We=oe.projectionMatrix.elements,st=pe[14]/(pe[10]-1),qe=pe[14]/(pe[10]+1),ne=(pe[9]+1)/pe[5],Ee=(pe[9]-1)/pe[5],ce=(pe[8]-1)/pe[0],Oe=(We[8]+1)/We[0],I=st*ce,et=st*Oe,Xe=ve/(-ce+Oe),ot=Xe*-ce;if(te.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(ot),K.translateZ(Xe),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),pe[10]===-1)K.projectionMatrix.copy(te.projectionMatrix),K.projectionMatrixInverse.copy(te.projectionMatrixInverse);else{const me=st+Xe,y=qe+Xe,_=I-ot,N=et+(ve-ot),ee=ne*qe/y*me,re=Ee*qe/y*me;K.projectionMatrix.makePerspective(_,N,ee,re,me,y),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function ie(K,te){te===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(te.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(r===null)return;let te=K.near,oe=K.far;m.texture!==null&&(m.depthNear>0&&(te=m.depthNear),m.depthFar>0&&(oe=m.depthFar)),D.near=g.near=M.near=te,D.far=g.far=M.far=oe,(L!==D.near||O!==D.far)&&(r.updateRenderState({depthNear:D.near,depthFar:D.far}),L=D.near,O=D.far),D.layers.mask=K.layers.mask|6,M.layers.mask=D.layers.mask&3,g.layers.mask=D.layers.mask&5;const ve=K.parent,pe=D.cameras;ie(D,ve);for(let We=0;We<pe.length;We++)ie(pe[We],ve);pe.length===2?q(D,M,g):D.projectionMatrix.copy(M.projectionMatrix),Ae(K,D,ve)};function Ae(K,te,oe){oe===null?K.matrix.copy(te.matrixWorld):(K.matrix.copy(oe.matrixWorld),K.matrix.invert(),K.matrix.multiply(te.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(te.projectionMatrix),K.projectionMatrixInverse.copy(te.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=To*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return D},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(K){l=K,f!==null&&(f.fixedFoveation=K),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=K)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(D)},this.getCameraTexture=function(K){return d[K]};let _e=null;function He(K,te){if(u=te.getViewerPose(c||o),x=te,u!==null){const oe=u.views;p!==null&&(e.setRenderTargetFramebuffer(A,p.framebuffer),e.setRenderTarget(A));let ve=!1;oe.length!==D.cameras.length&&(D.cameras.length=0,ve=!0);for(let qe=0;qe<oe.length;qe++){const ne=oe[qe];let Ee=null;if(p!==null)Ee=p.getViewport(ne);else{const Oe=h.getViewSubImage(f,ne);Ee=Oe.viewport,qe===0&&(e.setRenderTargetTextures(A,Oe.colorTexture,Oe.depthStencilTexture),e.setRenderTarget(A))}let ce=E[qe];ce===void 0&&(ce=new jt,ce.layers.enable(qe),ce.viewport=new Mt,E[qe]=ce),ce.matrix.fromArray(ne.transform.matrix),ce.matrix.decompose(ce.position,ce.quaternion,ce.scale),ce.projectionMatrix.fromArray(ne.projectionMatrix),ce.projectionMatrixInverse.copy(ce.projectionMatrix).invert(),ce.viewport.set(Ee.x,Ee.y,Ee.width,Ee.height),qe===0&&(D.matrix.copy(ce.matrix),D.matrix.decompose(D.position,D.quaternion,D.scale)),ve===!0&&D.cameras.push(ce)}const pe=r.enabledFeatures;if(pe&&pe.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&v){h=n.getBinding();const qe=h.getDepthInformation(oe[0]);qe&&qe.isValid&&qe.texture&&m.init(qe,r.renderState)}if(pe&&pe.includes("camera-access")&&v){e.state.unbindTexture(),h=n.getBinding();for(let qe=0;qe<oe.length;qe++){const ne=oe[qe].camera;if(ne){let Ee=d[ne];Ee||(Ee=new Bl,d[ne]=Ee);const ce=h.getCameraImage(ne);Ee.sourceTexture=ce}}}}for(let oe=0;oe<C.length;oe++){const ve=R[oe],pe=C[oe];ve!==null&&pe!==void 0&&pe.update(ve,te,c||o)}_e&&_e(K,te),te.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:te}),x=null}const Be=new zl;Be.setAnimationLoop(He),this.setAnimationLoop=function(K){_e=K},this.dispose=function(){}}}const Qn=new Qt,dm=new gt;function pm(i,e){function t(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,Ul(i)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,w,T,A){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(m,d):d.isMeshToonMaterial?(s(m,d),h(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d)):d.isMeshStandardMaterial?(s(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,A)):d.isMeshMatcapMaterial?(s(m,d),x(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),v(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(o(m,d),d.isLineDashedMaterial&&a(m,d)):d.isPointsMaterial?l(m,d,w,T):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,t(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===Vt&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,t(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===Vt&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,t(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,t(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const w=e.get(d),T=w.envMap,A=w.envMapRotation;T&&(m.envMap.value=T,Qn.copy(A),Qn.x*=-1,Qn.y*=-1,Qn.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(Qn.y*=-1,Qn.z*=-1),m.envMapRotation.value.setFromMatrix4(dm.makeRotationFromEuler(Qn)),m.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,m.aoMapTransform))}function o(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform))}function a(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,w,T){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*w,m.scale.value=T*.5,d.map&&(m.map.value=d.map,t(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function h(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,w){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Vt&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,d){d.matcap&&(m.matcap.value=d.matcap)}function v(m,d){const w=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function mm(i,e,t,n){let r={},s={},o=[];const a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(w,T){const A=T.program;n.uniformBlockBinding(w,A)}function c(w,T){let A=r[w.id];A===void 0&&(x(w),A=u(w),r[w.id]=A,w.addEventListener("dispose",m));const C=T.program;n.updateUBOMapping(w,C);const R=e.render.frame;s[w.id]!==R&&(f(w),s[w.id]=R)}function u(w){const T=h();w.__bindingPointIndex=T;const A=i.createBuffer(),C=w.__size,R=w.usage;return i.bindBuffer(i.UNIFORM_BUFFER,A),i.bufferData(i.UNIFORM_BUFFER,C,R),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,A),A}function h(){for(let w=0;w<a;w++)if(o.indexOf(w)===-1)return o.push(w),w;return nt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(w){const T=r[w.id],A=w.uniforms,C=w.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let R=0,P=A.length;R<P;R++){const V=Array.isArray(A[R])?A[R]:[A[R]];for(let M=0,g=V.length;M<g;M++){const E=V[M];if(p(E,R,M,C)===!0){const D=E.__offset,L=Array.isArray(E.value)?E.value:[E.value];let O=0;for(let Y=0;Y<L.length;Y++){const $=L[Y],G=v($);typeof $=="number"||typeof $=="boolean"?(E.__data[0]=$,i.bufferSubData(i.UNIFORM_BUFFER,D+O,E.__data)):$.isMatrix3?(E.__data[0]=$.elements[0],E.__data[1]=$.elements[1],E.__data[2]=$.elements[2],E.__data[3]=0,E.__data[4]=$.elements[3],E.__data[5]=$.elements[4],E.__data[6]=$.elements[5],E.__data[7]=0,E.__data[8]=$.elements[6],E.__data[9]=$.elements[7],E.__data[10]=$.elements[8],E.__data[11]=0):($.toArray(E.__data,O),O+=G.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,D,E.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(w,T,A,C){const R=w.value,P=T+"_"+A;if(C[P]===void 0)return typeof R=="number"||typeof R=="boolean"?C[P]=R:C[P]=R.clone(),!0;{const V=C[P];if(typeof R=="number"||typeof R=="boolean"){if(V!==R)return C[P]=R,!0}else if(V.equals(R)===!1)return V.copy(R),!0}return!1}function x(w){const T=w.uniforms;let A=0;const C=16;for(let P=0,V=T.length;P<V;P++){const M=Array.isArray(T[P])?T[P]:[T[P]];for(let g=0,E=M.length;g<E;g++){const D=M[g],L=Array.isArray(D.value)?D.value:[D.value];for(let O=0,Y=L.length;O<Y;O++){const $=L[O],G=v($),k=A%C,Q=k%G.boundary,q=k+Q;A+=Q,q!==0&&C-q<G.storage&&(A+=C-q),D.__data=new Float32Array(G.storage/Float32Array.BYTES_PER_ELEMENT),D.__offset=A,A+=G.storage}}}const R=A%C;return R>0&&(A+=C-R),w.__size=A,w.__cache={},this}function v(w){const T={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(T.boundary=4,T.storage=4):w.isVector2?(T.boundary=8,T.storage=8):w.isVector3||w.isColor?(T.boundary=16,T.storage=12):w.isVector4?(T.boundary=16,T.storage=16):w.isMatrix3?(T.boundary=48,T.storage=48):w.isMatrix4?(T.boundary=64,T.storage=64):w.isTexture?$e("WebGLRenderer: Texture samplers can not be part of an uniforms group."):$e("WebGLRenderer: Unsupported uniform value type.",w),T}function m(w){const T=w.target;T.removeEventListener("dispose",m);const A=o.indexOf(T.__bindingPointIndex);o.splice(A,1),i.deleteBuffer(r[T.id]),delete r[T.id],delete s[T.id]}function d(){for(const w in r)i.deleteBuffer(r[w]);o=[],r={},s={}}return{bind:l,update:c,dispose:d}}const gm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ln=null;function _m(){return ln===null&&(ln=new iu(gm,16,16,Ni,Un),ln.name="DFG_LUT",ln.minFilter=St,ln.magFilter=St,ln.wrapS=Rn,ln.wrapT=Rn,ln.generateMipmaps=!1,ln.needsUpdate=!0),ln}class xm{constructor(e={}){const{canvas:t=Pc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:f=!1,outputBufferType:p=qt}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=n.getContextAttributes().alpha}else x=o;const v=p,m=new Set([zo,Bo,Oo]),d=new Set([qt,mn,rr,sr,No,Fo]),w=new Uint32Array(4),T=new Int32Array(4);let A=null,C=null;const R=[],P=[];let V=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=dn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const M=this;let g=!1;this._outputColorSpace=mt;let E=0,D=0,L=null,O=-1,Y=null;const $=new Mt,G=new Mt;let k=null;const Q=new Ze(0);let q=0,ie=t.width,Ae=t.height,_e=1,He=null,Be=null;const K=new Mt(0,0,ie,Ae),te=new Mt(0,0,ie,Ae);let oe=!1;const ve=new Yo;let pe=!1,We=!1;const st=new gt,qe=new B,ne=new Mt,Ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ce=!1;function Oe(){return L===null?_e:1}let I=n;function et(S,z){return t.getContext(S,z)}try{const S={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Do}`),t.addEventListener("webglcontextlost",H,!1),t.addEventListener("webglcontextrestored",X,!1),t.addEventListener("webglcontextcreationerror",ae,!1),I===null){const z="webgl2";if(I=et(z,S),I===null)throw et(z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(S){throw nt("WebGLRenderer: "+S.message),S}let Xe,ot,me,y,_,N,ee,re,J,De,xe,Pe,Ge,ue,Me,Ce,Le,ge,Ke,U,Se,fe,Te,le;function se(){Xe=new _d(I),Xe.init(),fe=new lm(I,Xe),ot=new ld(I,Xe,e,fe),me=new om(I,Xe),ot.reversedDepthBuffer&&f&&me.buffers.depth.setReversed(!0),y=new Md(I),_=new Xp,N=new am(I,Xe,me,_,ot,fe,y),ee=new ud(M),re=new gd(M),J=new Eu(I),Te=new od(I,J),De=new xd(I,J,y,Te),xe=new bd(I,De,J,y),Ke=new Sd(I,ot,N),Ce=new cd(_),Pe=new Wp(M,ee,re,Xe,ot,Te,Ce),Ge=new pm(M,_),ue=new $p,Me=new Qp(Xe),ge=new sd(M,ee,re,me,xe,x,l),Le=new rm(M,xe,ot),le=new mm(I,y,ot,me),U=new ad(I,Xe,y),Se=new vd(I,Xe,y),y.programs=Pe.programs,M.capabilities=ot,M.extensions=Xe,M.properties=_,M.renderLists=ue,M.shadowMap=Le,M.state=me,M.info=y}se(),v!==qt&&(V=new yd(v,t.width,t.height,r,s));const b=new fm(M,I);this.xr=b,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const S=Xe.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=Xe.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return _e},this.setPixelRatio=function(S){S!==void 0&&(_e=S,this.setSize(ie,Ae,!1))},this.getSize=function(S){return S.set(ie,Ae)},this.setSize=function(S,z,j=!0){if(b.isPresenting){$e("WebGLRenderer: Can't change size while VR device is presenting.");return}ie=S,Ae=z,t.width=Math.floor(S*_e),t.height=Math.floor(z*_e),j===!0&&(t.style.width=S+"px",t.style.height=z+"px"),V!==null&&V.setSize(t.width,t.height),this.setViewport(0,0,S,z)},this.getDrawingBufferSize=function(S){return S.set(ie*_e,Ae*_e).floor()},this.setDrawingBufferSize=function(S,z,j){ie=S,Ae=z,_e=j,t.width=Math.floor(S*j),t.height=Math.floor(z*j),this.setViewport(0,0,S,z)},this.setEffects=function(S){if(v===qt){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let z=0;z<S.length;z++)if(S[z].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}V.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy($)},this.getViewport=function(S){return S.copy(K)},this.setViewport=function(S,z,j,Z){S.isVector4?K.set(S.x,S.y,S.z,S.w):K.set(S,z,j,Z),me.viewport($.copy(K).multiplyScalar(_e).round())},this.getScissor=function(S){return S.copy(te)},this.setScissor=function(S,z,j,Z){S.isVector4?te.set(S.x,S.y,S.z,S.w):te.set(S,z,j,Z),me.scissor(G.copy(te).multiplyScalar(_e).round())},this.getScissorTest=function(){return oe},this.setScissorTest=function(S){me.setScissorTest(oe=S)},this.setOpaqueSort=function(S){He=S},this.setTransparentSort=function(S){Be=S},this.getClearColor=function(S){return S.copy(ge.getClearColor())},this.setClearColor=function(){ge.setClearColor(...arguments)},this.getClearAlpha=function(){return ge.getClearAlpha()},this.setClearAlpha=function(){ge.setClearAlpha(...arguments)},this.clear=function(S=!0,z=!0,j=!0){let Z=0;if(S){let W=!1;if(L!==null){const be=L.texture.format;W=m.has(be)}if(W){const be=L.texture.type,Re=d.has(be),we=ge.getClearColor(),Ie=ge.getClearAlpha(),Ne=we.r,Ve=we.g,ze=we.b;Re?(w[0]=Ne,w[1]=Ve,w[2]=ze,w[3]=Ie,I.clearBufferuiv(I.COLOR,0,w)):(T[0]=Ne,T[1]=Ve,T[2]=ze,T[3]=Ie,I.clearBufferiv(I.COLOR,0,T))}else Z|=I.COLOR_BUFFER_BIT}z&&(Z|=I.DEPTH_BUFFER_BIT),j&&(Z|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),I.clear(Z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",H,!1),t.removeEventListener("webglcontextrestored",X,!1),t.removeEventListener("webglcontextcreationerror",ae,!1),ge.dispose(),ue.dispose(),Me.dispose(),_.dispose(),ee.dispose(),re.dispose(),xe.dispose(),Te.dispose(),le.dispose(),Pe.dispose(),b.dispose(),b.removeEventListener("sessionstart",Fe),b.removeEventListener("sessionend",at),zt.stop()};function H(S){S.preventDefault(),ua("WebGLRenderer: Context Lost."),g=!0}function X(){ua("WebGLRenderer: Context Restored."),g=!1;const S=y.autoReset,z=Le.enabled,j=Le.autoUpdate,Z=Le.needsUpdate,W=Le.type;se(),y.autoReset=S,Le.enabled=z,Le.autoUpdate=j,Le.needsUpdate=Z,Le.type=W}function ae(S){nt("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function he(S){const z=S.target;z.removeEventListener("dispose",he),Ue(z)}function Ue(S){Ye(S),_.remove(S)}function Ye(S){const z=_.get(S).programs;z!==void 0&&(z.forEach(function(j){Pe.releaseProgram(j)}),S.isShaderMaterial&&Pe.releaseShaderCache(S))}this.renderBufferDirect=function(S,z,j,Z,W,be){z===null&&(z=Ee);const Re=W.isMesh&&W.matrixWorld.determinant()<0,we=Yl(S,z,j,Z,W);me.setMaterial(Z,Re);let Ie=j.index,Ne=1;if(Z.wireframe===!0){if(Ie=De.getWireframeAttribute(j),Ie===void 0)return;Ne=2}const Ve=j.drawRange,ze=j.attributes.position;let Qe=Ve.start*Ne,ht=(Ve.start+Ve.count)*Ne;be!==null&&(Qe=Math.max(Qe,be.start*Ne),ht=Math.min(ht,(be.start+be.count)*Ne)),Ie!==null?(Qe=Math.max(Qe,0),ht=Math.min(ht,Ie.count)):ze!=null&&(Qe=Math.max(Qe,0),ht=Math.min(ht,ze.count));const xt=ht-Qe;if(xt<0||xt===1/0)return;Te.setup(W,Z,we,j,Ie);let vt,ft=U;if(Ie!==null&&(vt=J.get(Ie),ft=Se,ft.setIndex(vt)),W.isMesh)Z.wireframe===!0?(me.setLineWidth(Z.wireframeLinewidth*Oe()),ft.setMode(I.LINES)):ft.setMode(I.TRIANGLES);else if(W.isLine){let ke=Z.linewidth;ke===void 0&&(ke=1),me.setLineWidth(ke*Oe()),W.isLineSegments?ft.setMode(I.LINES):W.isLineLoop?ft.setMode(I.LINE_LOOP):ft.setMode(I.LINE_STRIP)}else W.isPoints?ft.setMode(I.POINTS):W.isSprite&&ft.setMode(I.TRIANGLES);if(W.isBatchedMesh)if(W._multiDrawInstances!==null)or("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ft.renderMultiDrawInstances(W._multiDrawStarts,W._multiDrawCounts,W._multiDrawCount,W._multiDrawInstances);else if(Xe.get("WEBGL_multi_draw"))ft.renderMultiDraw(W._multiDrawStarts,W._multiDrawCounts,W._multiDrawCount);else{const ke=W._multiDrawStarts,ct=W._multiDrawCounts,lt=W._multiDrawCount,Wt=Ie?J.get(Ie).bytesPerElement:1,hi=_.get(Z).currentProgram.getUniforms();for(let Xt=0;Xt<lt;Xt++)hi.setValue(I,"_gl_DrawID",Xt),ft.render(ke[Xt]/Wt,ct[Xt])}else if(W.isInstancedMesh)ft.renderInstances(Qe,xt,W.count);else if(j.isInstancedBufferGeometry){const ke=j._maxInstanceCount!==void 0?j._maxInstanceCount:1/0,ct=Math.min(j.instanceCount,ke);ft.renderInstances(Qe,xt,ct)}else ft.render(Qe,xt)};function _t(S,z,j){S.transparent===!0&&S.side===An&&S.forceSinglePass===!1?(S.side=Vt,S.needsUpdate=!0,fr(S,z,j),S.side=Yn,S.needsUpdate=!0,fr(S,z,j),S.side=An):fr(S,z,j)}this.compile=function(S,z,j=null){j===null&&(j=S),C=Me.get(j),C.init(z),P.push(C),j.traverseVisible(function(W){W.isLight&&W.layers.test(z.layers)&&(C.pushLight(W),W.castShadow&&C.pushShadow(W))}),S!==j&&S.traverseVisible(function(W){W.isLight&&W.layers.test(z.layers)&&(C.pushLight(W),W.castShadow&&C.pushShadow(W))}),C.setupLights();const Z=new Set;return S.traverse(function(W){if(!(W.isMesh||W.isPoints||W.isLine||W.isSprite))return;const be=W.material;if(be)if(Array.isArray(be))for(let Re=0;Re<be.length;Re++){const we=be[Re];_t(we,j,W),Z.add(we)}else _t(be,j,W),Z.add(be)}),C=P.pop(),Z},this.compileAsync=function(S,z,j=null){const Z=this.compile(S,z,j);return new Promise(W=>{function be(){if(Z.forEach(function(Re){_.get(Re).currentProgram.isReady()&&Z.delete(Re)}),Z.size===0){W(S);return}setTimeout(be,10)}Xe.get("KHR_parallel_shader_compile")!==null?be():setTimeout(be,10)})};let yt=null;function an(S){yt&&yt(S)}function Fe(){zt.stop()}function at(){zt.start()}const zt=new zl;zt.setAnimationLoop(an),typeof self<"u"&&zt.setContext(self),this.setAnimationLoop=function(S){yt=S,b.setAnimationLoop(S),S===null?zt.stop():zt.start()},b.addEventListener("sessionstart",Fe),b.addEventListener("sessionend",at),this.render=function(S,z){if(z!==void 0&&z.isCamera!==!0){nt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(g===!0)return;const j=b.enabled===!0&&b.isPresenting===!0,Z=V!==null&&(L===null||j)&&V.begin(M,L);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),z.parent===null&&z.matrixWorldAutoUpdate===!0&&z.updateMatrixWorld(),b.enabled===!0&&b.isPresenting===!0&&(V===null||V.isCompositing()===!1)&&(b.cameraAutoUpdate===!0&&b.updateCamera(z),z=b.getCamera()),S.isScene===!0&&S.onBeforeRender(M,S,z,L),C=Me.get(S,P.length),C.init(z),P.push(C),st.multiplyMatrices(z.projectionMatrix,z.matrixWorldInverse),ve.setFromProjectionMatrix(st,hn,z.reversedDepth),We=this.localClippingEnabled,pe=Ce.init(this.clippingPlanes,We),A=ue.get(S,R.length),A.init(),R.push(A),b.enabled===!0&&b.isPresenting===!0){const Re=M.xr.getDepthSensingMesh();Re!==null&&Qr(Re,z,-1/0,M.sortObjects)}Qr(S,z,0,M.sortObjects),A.finish(),M.sortObjects===!0&&A.sort(He,Be),ce=b.enabled===!1||b.isPresenting===!1||b.hasDepthSensing()===!1,ce&&ge.addToRenderList(A,S),this.info.render.frame++,pe===!0&&Ce.beginShadows();const W=C.state.shadowsArray;if(Le.render(W,S,z),pe===!0&&Ce.endShadows(),this.info.autoReset===!0&&this.info.reset(),(Z&&V.hasRenderPass())===!1){const Re=A.opaque,we=A.transmissive;if(C.setupLights(),z.isArrayCamera){const Ie=z.cameras;if(we.length>0)for(let Ne=0,Ve=Ie.length;Ne<Ve;Ne++){const ze=Ie[Ne];Jo(Re,we,S,ze)}ce&&ge.render(S);for(let Ne=0,Ve=Ie.length;Ne<Ve;Ne++){const ze=Ie[Ne];jo(A,S,ze,ze.viewport)}}else we.length>0&&Jo(Re,we,S,z),ce&&ge.render(S),jo(A,S,z)}L!==null&&D===0&&(N.updateMultisampleRenderTarget(L),N.updateRenderTargetMipmap(L)),Z&&V.end(M),S.isScene===!0&&S.onAfterRender(M,S,z),Te.resetDefaultState(),O=-1,Y=null,P.pop(),P.length>0?(C=P[P.length-1],pe===!0&&Ce.setGlobalState(M.clippingPlanes,C.state.camera)):C=null,R.pop(),R.length>0?A=R[R.length-1]:A=null};function Qr(S,z,j,Z){if(S.visible===!1)return;if(S.layers.test(z.layers)){if(S.isGroup)j=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(z);else if(S.isLight)C.pushLight(S),S.castShadow&&C.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||ve.intersectsSprite(S)){Z&&ne.setFromMatrixPosition(S.matrixWorld).applyMatrix4(st);const Re=xe.update(S),we=S.material;we.visible&&A.push(S,Re,we,j,ne.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||ve.intersectsObject(S))){const Re=xe.update(S),we=S.material;if(Z&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),ne.copy(S.boundingSphere.center)):(Re.boundingSphere===null&&Re.computeBoundingSphere(),ne.copy(Re.boundingSphere.center)),ne.applyMatrix4(S.matrixWorld).applyMatrix4(st)),Array.isArray(we)){const Ie=Re.groups;for(let Ne=0,Ve=Ie.length;Ne<Ve;Ne++){const ze=Ie[Ne],Qe=we[ze.materialIndex];Qe&&Qe.visible&&A.push(S,Re,Qe,j,ne.z,ze)}}else we.visible&&A.push(S,Re,we,j,ne.z,null)}}const be=S.children;for(let Re=0,we=be.length;Re<we;Re++)Qr(be[Re],z,j,Z)}function jo(S,z,j,Z){const{opaque:W,transmissive:be,transparent:Re}=S;C.setupLightsView(j),pe===!0&&Ce.setGlobalState(M.clippingPlanes,j),Z&&me.viewport($.copy(Z)),W.length>0&&hr(W,z,j),be.length>0&&hr(be,z,j),Re.length>0&&hr(Re,z,j),me.buffers.depth.setTest(!0),me.buffers.depth.setMask(!0),me.buffers.color.setMask(!0),me.setPolygonOffset(!1)}function Jo(S,z,j,Z){if((j.isScene===!0?j.overrideMaterial:null)!==null)return;if(C.state.transmissionRenderTarget[Z.id]===void 0){const Qe=Xe.has("EXT_color_buffer_half_float")||Xe.has("EXT_color_buffer_float");C.state.transmissionRenderTarget[Z.id]=new pn(1,1,{generateMipmaps:!0,type:Qe?Un:qt,minFilter:ai,samples:ot.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:it.workingColorSpace})}const be=C.state.transmissionRenderTarget[Z.id],Re=Z.viewport||$;be.setSize(Re.z*M.transmissionResolutionScale,Re.w*M.transmissionResolutionScale);const we=M.getRenderTarget(),Ie=M.getActiveCubeFace(),Ne=M.getActiveMipmapLevel();M.setRenderTarget(be),M.getClearColor(Q),q=M.getClearAlpha(),q<1&&M.setClearColor(16777215,.5),M.clear(),ce&&ge.render(j);const Ve=M.toneMapping;M.toneMapping=dn;const ze=Z.viewport;if(Z.viewport!==void 0&&(Z.viewport=void 0),C.setupLightsView(Z),pe===!0&&Ce.setGlobalState(M.clippingPlanes,Z),hr(S,j,Z),N.updateMultisampleRenderTarget(be),N.updateRenderTargetMipmap(be),Xe.has("WEBGL_multisampled_render_to_texture")===!1){let Qe=!1;for(let ht=0,xt=z.length;ht<xt;ht++){const vt=z[ht],{object:ft,geometry:ke,material:ct,group:lt}=vt;if(ct.side===An&&ft.layers.test(Z.layers)){const Wt=ct.side;ct.side=Vt,ct.needsUpdate=!0,Qo(ft,j,Z,ke,ct,lt),ct.side=Wt,ct.needsUpdate=!0,Qe=!0}}Qe===!0&&(N.updateMultisampleRenderTarget(be),N.updateRenderTargetMipmap(be))}M.setRenderTarget(we,Ie,Ne),M.setClearColor(Q,q),ze!==void 0&&(Z.viewport=ze),M.toneMapping=Ve}function hr(S,z,j){const Z=z.isScene===!0?z.overrideMaterial:null;for(let W=0,be=S.length;W<be;W++){const Re=S[W],{object:we,geometry:Ie,group:Ne}=Re;let Ve=Re.material;Ve.allowOverride===!0&&Z!==null&&(Ve=Z),we.layers.test(j.layers)&&Qo(we,z,j,Ie,Ve,Ne)}}function Qo(S,z,j,Z,W,be){S.onBeforeRender(M,z,j,Z,W,be),S.modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),W.onBeforeRender(M,z,j,Z,S,be),W.transparent===!0&&W.side===An&&W.forceSinglePass===!1?(W.side=Vt,W.needsUpdate=!0,M.renderBufferDirect(j,z,Z,W,S,be),W.side=Yn,W.needsUpdate=!0,M.renderBufferDirect(j,z,Z,W,S,be),W.side=An):M.renderBufferDirect(j,z,Z,W,S,be),S.onAfterRender(M,z,j,Z,W,be)}function fr(S,z,j){z.isScene!==!0&&(z=Ee);const Z=_.get(S),W=C.state.lights,be=C.state.shadowsArray,Re=W.state.version,we=Pe.getParameters(S,W.state,be,z,j),Ie=Pe.getProgramCacheKey(we);let Ne=Z.programs;Z.environment=S.isMeshStandardMaterial?z.environment:null,Z.fog=z.fog,Z.envMap=(S.isMeshStandardMaterial?re:ee).get(S.envMap||Z.environment),Z.envMapRotation=Z.environment!==null&&S.envMap===null?z.environmentRotation:S.envMapRotation,Ne===void 0&&(S.addEventListener("dispose",he),Ne=new Map,Z.programs=Ne);let Ve=Ne.get(Ie);if(Ve!==void 0){if(Z.currentProgram===Ve&&Z.lightsStateVersion===Re)return ta(S,we),Ve}else we.uniforms=Pe.getUniforms(S),S.onBeforeCompile(we,M),Ve=Pe.acquireProgram(we,Ie),Ne.set(Ie,Ve),Z.uniforms=we.uniforms;const ze=Z.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(ze.clippingPlanes=Ce.uniform),ta(S,we),Z.needsLights=ql(S),Z.lightsStateVersion=Re,Z.needsLights&&(ze.ambientLightColor.value=W.state.ambient,ze.lightProbe.value=W.state.probe,ze.directionalLights.value=W.state.directional,ze.directionalLightShadows.value=W.state.directionalShadow,ze.spotLights.value=W.state.spot,ze.spotLightShadows.value=W.state.spotShadow,ze.rectAreaLights.value=W.state.rectArea,ze.ltc_1.value=W.state.rectAreaLTC1,ze.ltc_2.value=W.state.rectAreaLTC2,ze.pointLights.value=W.state.point,ze.pointLightShadows.value=W.state.pointShadow,ze.hemisphereLights.value=W.state.hemi,ze.directionalShadowMap.value=W.state.directionalShadowMap,ze.directionalShadowMatrix.value=W.state.directionalShadowMatrix,ze.spotShadowMap.value=W.state.spotShadowMap,ze.spotLightMatrix.value=W.state.spotLightMatrix,ze.spotLightMap.value=W.state.spotLightMap,ze.pointShadowMap.value=W.state.pointShadowMap,ze.pointShadowMatrix.value=W.state.pointShadowMatrix),Z.currentProgram=Ve,Z.uniformsList=null,Ve}function ea(S){if(S.uniformsList===null){const z=S.currentProgram.getUniforms();S.uniformsList=zr.seqWithValue(z.seq,S.uniforms)}return S.uniformsList}function ta(S,z){const j=_.get(S);j.outputColorSpace=z.outputColorSpace,j.batching=z.batching,j.batchingColor=z.batchingColor,j.instancing=z.instancing,j.instancingColor=z.instancingColor,j.instancingMorph=z.instancingMorph,j.skinning=z.skinning,j.morphTargets=z.morphTargets,j.morphNormals=z.morphNormals,j.morphColors=z.morphColors,j.morphTargetsCount=z.morphTargetsCount,j.numClippingPlanes=z.numClippingPlanes,j.numIntersection=z.numClipIntersection,j.vertexAlphas=z.vertexAlphas,j.vertexTangents=z.vertexTangents,j.toneMapping=z.toneMapping}function Yl(S,z,j,Z,W){z.isScene!==!0&&(z=Ee),N.resetTextureUnits();const be=z.fog,Re=Z.isMeshStandardMaterial?z.environment:null,we=L===null?M.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:Fi,Ie=(Z.isMeshStandardMaterial?re:ee).get(Z.envMap||Re),Ne=Z.vertexColors===!0&&!!j.attributes.color&&j.attributes.color.itemSize===4,Ve=!!j.attributes.tangent&&(!!Z.normalMap||Z.anisotropy>0),ze=!!j.morphAttributes.position,Qe=!!j.morphAttributes.normal,ht=!!j.morphAttributes.color;let xt=dn;Z.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(xt=M.toneMapping);const vt=j.morphAttributes.position||j.morphAttributes.normal||j.morphAttributes.color,ft=vt!==void 0?vt.length:0,ke=_.get(Z),ct=C.state.lights;if(pe===!0&&(We===!0||S!==Y)){const Ft=S===Y&&Z.id===O;Ce.setState(Z,S,Ft)}let lt=!1;Z.version===ke.__version?(ke.needsLights&&ke.lightsStateVersion!==ct.state.version||ke.outputColorSpace!==we||W.isBatchedMesh&&ke.batching===!1||!W.isBatchedMesh&&ke.batching===!0||W.isBatchedMesh&&ke.batchingColor===!0&&W.colorTexture===null||W.isBatchedMesh&&ke.batchingColor===!1&&W.colorTexture!==null||W.isInstancedMesh&&ke.instancing===!1||!W.isInstancedMesh&&ke.instancing===!0||W.isSkinnedMesh&&ke.skinning===!1||!W.isSkinnedMesh&&ke.skinning===!0||W.isInstancedMesh&&ke.instancingColor===!0&&W.instanceColor===null||W.isInstancedMesh&&ke.instancingColor===!1&&W.instanceColor!==null||W.isInstancedMesh&&ke.instancingMorph===!0&&W.morphTexture===null||W.isInstancedMesh&&ke.instancingMorph===!1&&W.morphTexture!==null||ke.envMap!==Ie||Z.fog===!0&&ke.fog!==be||ke.numClippingPlanes!==void 0&&(ke.numClippingPlanes!==Ce.numPlanes||ke.numIntersection!==Ce.numIntersection)||ke.vertexAlphas!==Ne||ke.vertexTangents!==Ve||ke.morphTargets!==ze||ke.morphNormals!==Qe||ke.morphColors!==ht||ke.toneMapping!==xt||ke.morphTargetsCount!==ft)&&(lt=!0):(lt=!0,ke.__version=Z.version);let Wt=ke.currentProgram;lt===!0&&(Wt=fr(Z,z,W));let hi=!1,Xt=!1,Vi=!1;const dt=Wt.getUniforms(),kt=ke.uniforms;if(me.useProgram(Wt.program)&&(hi=!0,Xt=!0,Vi=!0),Z.id!==O&&(O=Z.id,Xt=!0),hi||Y!==S){me.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),dt.setValue(I,"projectionMatrix",S.projectionMatrix),dt.setValue(I,"viewMatrix",S.matrixWorldInverse);const Ht=dt.map.cameraPosition;Ht!==void 0&&Ht.setValue(I,qe.setFromMatrixPosition(S.matrixWorld)),ot.logarithmicDepthBuffer&&dt.setValue(I,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(Z.isMeshPhongMaterial||Z.isMeshToonMaterial||Z.isMeshLambertMaterial||Z.isMeshBasicMaterial||Z.isMeshStandardMaterial||Z.isShaderMaterial)&&dt.setValue(I,"isOrthographic",S.isOrthographicCamera===!0),Y!==S&&(Y=S,Xt=!0,Vi=!0)}if(ke.needsLights&&(ct.state.directionalShadowMap.length>0&&dt.setValue(I,"directionalShadowMap",ct.state.directionalShadowMap,N),ct.state.spotShadowMap.length>0&&dt.setValue(I,"spotShadowMap",ct.state.spotShadowMap,N),ct.state.pointShadowMap.length>0&&dt.setValue(I,"pointShadowMap",ct.state.pointShadowMap,N)),W.isSkinnedMesh){dt.setOptional(I,W,"bindMatrix"),dt.setOptional(I,W,"bindMatrixInverse");const Ft=W.skeleton;Ft&&(Ft.boneTexture===null&&Ft.computeBoneTexture(),dt.setValue(I,"boneTexture",Ft.boneTexture,N))}W.isBatchedMesh&&(dt.setOptional(I,W,"batchingTexture"),dt.setValue(I,"batchingTexture",W._matricesTexture,N),dt.setOptional(I,W,"batchingIdTexture"),dt.setValue(I,"batchingIdTexture",W._indirectTexture,N),dt.setOptional(I,W,"batchingColorTexture"),W._colorsTexture!==null&&dt.setValue(I,"batchingColorTexture",W._colorsTexture,N));const Zt=j.morphAttributes;if((Zt.position!==void 0||Zt.normal!==void 0||Zt.color!==void 0)&&Ke.update(W,j,Wt),(Xt||ke.receiveShadow!==W.receiveShadow)&&(ke.receiveShadow=W.receiveShadow,dt.setValue(I,"receiveShadow",W.receiveShadow)),Z.isMeshGouraudMaterial&&Z.envMap!==null&&(kt.envMap.value=Ie,kt.flipEnvMap.value=Ie.isCubeTexture&&Ie.isRenderTargetTexture===!1?-1:1),Z.isMeshStandardMaterial&&Z.envMap===null&&z.environment!==null&&(kt.envMapIntensity.value=z.environmentIntensity),kt.dfgLUT!==void 0&&(kt.dfgLUT.value=_m()),Xt&&(dt.setValue(I,"toneMappingExposure",M.toneMappingExposure),ke.needsLights&&$l(kt,Vi),be&&Z.fog===!0&&Ge.refreshFogUniforms(kt,be),Ge.refreshMaterialUniforms(kt,Z,_e,Ae,C.state.transmissionRenderTarget[S.id]),zr.upload(I,ea(ke),kt,N)),Z.isShaderMaterial&&Z.uniformsNeedUpdate===!0&&(zr.upload(I,ea(ke),kt,N),Z.uniformsNeedUpdate=!1),Z.isSpriteMaterial&&dt.setValue(I,"center",W.center),dt.setValue(I,"modelViewMatrix",W.modelViewMatrix),dt.setValue(I,"normalMatrix",W.normalMatrix),dt.setValue(I,"modelMatrix",W.matrixWorld),Z.isShaderMaterial||Z.isRawShaderMaterial){const Ft=Z.uniformsGroups;for(let Ht=0,es=Ft.length;Ht<es;Ht++){const $n=Ft[Ht];le.update($n,Wt),le.bind($n,Wt)}}return Wt}function $l(S,z){S.ambientLightColor.needsUpdate=z,S.lightProbe.needsUpdate=z,S.directionalLights.needsUpdate=z,S.directionalLightShadows.needsUpdate=z,S.pointLights.needsUpdate=z,S.pointLightShadows.needsUpdate=z,S.spotLights.needsUpdate=z,S.spotLightShadows.needsUpdate=z,S.rectAreaLights.needsUpdate=z,S.hemisphereLights.needsUpdate=z}function ql(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return E},this.getActiveMipmapLevel=function(){return D},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(S,z,j){const Z=_.get(S);Z.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,Z.__autoAllocateDepthBuffer===!1&&(Z.__useRenderToTexture=!1),_.get(S.texture).__webglTexture=z,_.get(S.depthTexture).__webglTexture=Z.__autoAllocateDepthBuffer?void 0:j,Z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,z){const j=_.get(S);j.__webglFramebuffer=z,j.__useDefaultFramebuffer=z===void 0};const Zl=I.createFramebuffer();this.setRenderTarget=function(S,z=0,j=0){L=S,E=z,D=j;let Z=null,W=!1,be=!1;if(S){const we=_.get(S);if(we.__useDefaultFramebuffer!==void 0){me.bindFramebuffer(I.FRAMEBUFFER,we.__webglFramebuffer),$.copy(S.viewport),G.copy(S.scissor),k=S.scissorTest,me.viewport($),me.scissor(G),me.setScissorTest(k),O=-1;return}else if(we.__webglFramebuffer===void 0)N.setupRenderTarget(S);else if(we.__hasExternalTextures)N.rebindTextures(S,_.get(S.texture).__webglTexture,_.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const Ve=S.depthTexture;if(we.__boundDepthTexture!==Ve){if(Ve!==null&&_.has(Ve)&&(S.width!==Ve.image.width||S.height!==Ve.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");N.setupDepthRenderbuffer(S)}}const Ie=S.texture;(Ie.isData3DTexture||Ie.isDataArrayTexture||Ie.isCompressedArrayTexture)&&(be=!0);const Ne=_.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Ne[z])?Z=Ne[z][j]:Z=Ne[z],W=!0):S.samples>0&&N.useMultisampledRTT(S)===!1?Z=_.get(S).__webglMultisampledFramebuffer:Array.isArray(Ne)?Z=Ne[j]:Z=Ne,$.copy(S.viewport),G.copy(S.scissor),k=S.scissorTest}else $.copy(K).multiplyScalar(_e).floor(),G.copy(te).multiplyScalar(_e).floor(),k=oe;if(j!==0&&(Z=Zl),me.bindFramebuffer(I.FRAMEBUFFER,Z)&&me.drawBuffers(S,Z),me.viewport($),me.scissor(G),me.setScissorTest(k),W){const we=_.get(S.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+z,we.__webglTexture,j)}else if(be){const we=z;for(let Ie=0;Ie<S.textures.length;Ie++){const Ne=_.get(S.textures[Ie]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+Ie,Ne.__webglTexture,j,we)}}else if(S!==null&&j!==0){const we=_.get(S.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,we.__webglTexture,j)}O=-1},this.readRenderTargetPixels=function(S,z,j,Z,W,be,Re,we=0){if(!(S&&S.isWebGLRenderTarget)){nt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ie=_.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Re!==void 0&&(Ie=Ie[Re]),Ie){me.bindFramebuffer(I.FRAMEBUFFER,Ie);try{const Ne=S.textures[we],Ve=Ne.format,ze=Ne.type;if(!ot.textureFormatReadable(Ve)){nt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ot.textureTypeReadable(ze)){nt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}z>=0&&z<=S.width-Z&&j>=0&&j<=S.height-W&&(S.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+we),I.readPixels(z,j,Z,W,fe.convert(Ve),fe.convert(ze),be))}finally{const Ne=L!==null?_.get(L).__webglFramebuffer:null;me.bindFramebuffer(I.FRAMEBUFFER,Ne)}}},this.readRenderTargetPixelsAsync=async function(S,z,j,Z,W,be,Re,we=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ie=_.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Re!==void 0&&(Ie=Ie[Re]),Ie)if(z>=0&&z<=S.width-Z&&j>=0&&j<=S.height-W){me.bindFramebuffer(I.FRAMEBUFFER,Ie);const Ne=S.textures[we],Ve=Ne.format,ze=Ne.type;if(!ot.textureFormatReadable(Ve))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ot.textureTypeReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Qe=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,Qe),I.bufferData(I.PIXEL_PACK_BUFFER,be.byteLength,I.STREAM_READ),S.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+we),I.readPixels(z,j,Z,W,fe.convert(Ve),fe.convert(ze),0);const ht=L!==null?_.get(L).__webglFramebuffer:null;me.bindFramebuffer(I.FRAMEBUFFER,ht);const xt=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await Ic(I,xt,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,Qe),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,be),I.deleteBuffer(Qe),I.deleteSync(xt),be}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,z=null,j=0){const Z=Math.pow(2,-j),W=Math.floor(S.image.width*Z),be=Math.floor(S.image.height*Z),Re=z!==null?z.x:0,we=z!==null?z.y:0;N.setTexture2D(S,0),I.copyTexSubImage2D(I.TEXTURE_2D,j,0,0,Re,we,W,be),me.unbindTexture()};const Kl=I.createFramebuffer(),jl=I.createFramebuffer();this.copyTextureToTexture=function(S,z,j=null,Z=null,W=0,be=null){be===null&&(W!==0?(or("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),be=W,W=0):be=0);let Re,we,Ie,Ne,Ve,ze,Qe,ht,xt;const vt=S.isCompressedTexture?S.mipmaps[be]:S.image;if(j!==null)Re=j.max.x-j.min.x,we=j.max.y-j.min.y,Ie=j.isBox3?j.max.z-j.min.z:1,Ne=j.min.x,Ve=j.min.y,ze=j.isBox3?j.min.z:0;else{const Zt=Math.pow(2,-W);Re=Math.floor(vt.width*Zt),we=Math.floor(vt.height*Zt),S.isDataArrayTexture?Ie=vt.depth:S.isData3DTexture?Ie=Math.floor(vt.depth*Zt):Ie=1,Ne=0,Ve=0,ze=0}Z!==null?(Qe=Z.x,ht=Z.y,xt=Z.z):(Qe=0,ht=0,xt=0);const ft=fe.convert(z.format),ke=fe.convert(z.type);let ct;z.isData3DTexture?(N.setTexture3D(z,0),ct=I.TEXTURE_3D):z.isDataArrayTexture||z.isCompressedArrayTexture?(N.setTexture2DArray(z,0),ct=I.TEXTURE_2D_ARRAY):(N.setTexture2D(z,0),ct=I.TEXTURE_2D),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,z.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,z.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,z.unpackAlignment);const lt=I.getParameter(I.UNPACK_ROW_LENGTH),Wt=I.getParameter(I.UNPACK_IMAGE_HEIGHT),hi=I.getParameter(I.UNPACK_SKIP_PIXELS),Xt=I.getParameter(I.UNPACK_SKIP_ROWS),Vi=I.getParameter(I.UNPACK_SKIP_IMAGES);I.pixelStorei(I.UNPACK_ROW_LENGTH,vt.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,vt.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Ne),I.pixelStorei(I.UNPACK_SKIP_ROWS,Ve),I.pixelStorei(I.UNPACK_SKIP_IMAGES,ze);const dt=S.isDataArrayTexture||S.isData3DTexture,kt=z.isDataArrayTexture||z.isData3DTexture;if(S.isDepthTexture){const Zt=_.get(S),Ft=_.get(z),Ht=_.get(Zt.__renderTarget),es=_.get(Ft.__renderTarget);me.bindFramebuffer(I.READ_FRAMEBUFFER,Ht.__webglFramebuffer),me.bindFramebuffer(I.DRAW_FRAMEBUFFER,es.__webglFramebuffer);for(let $n=0;$n<Ie;$n++)dt&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,_.get(S).__webglTexture,W,ze+$n),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,_.get(z).__webglTexture,be,xt+$n)),I.blitFramebuffer(Ne,Ve,Re,we,Qe,ht,Re,we,I.DEPTH_BUFFER_BIT,I.NEAREST);me.bindFramebuffer(I.READ_FRAMEBUFFER,null),me.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(W!==0||S.isRenderTargetTexture||_.has(S)){const Zt=_.get(S),Ft=_.get(z);me.bindFramebuffer(I.READ_FRAMEBUFFER,Kl),me.bindFramebuffer(I.DRAW_FRAMEBUFFER,jl);for(let Ht=0;Ht<Ie;Ht++)dt?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Zt.__webglTexture,W,ze+Ht):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Zt.__webglTexture,W),kt?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Ft.__webglTexture,be,xt+Ht):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Ft.__webglTexture,be),W!==0?I.blitFramebuffer(Ne,Ve,Re,we,Qe,ht,Re,we,I.COLOR_BUFFER_BIT,I.NEAREST):kt?I.copyTexSubImage3D(ct,be,Qe,ht,xt+Ht,Ne,Ve,Re,we):I.copyTexSubImage2D(ct,be,Qe,ht,Ne,Ve,Re,we);me.bindFramebuffer(I.READ_FRAMEBUFFER,null),me.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else kt?S.isDataTexture||S.isData3DTexture?I.texSubImage3D(ct,be,Qe,ht,xt,Re,we,Ie,ft,ke,vt.data):z.isCompressedArrayTexture?I.compressedTexSubImage3D(ct,be,Qe,ht,xt,Re,we,Ie,ft,vt.data):I.texSubImage3D(ct,be,Qe,ht,xt,Re,we,Ie,ft,ke,vt):S.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,be,Qe,ht,Re,we,ft,ke,vt.data):S.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,be,Qe,ht,vt.width,vt.height,ft,vt.data):I.texSubImage2D(I.TEXTURE_2D,be,Qe,ht,Re,we,ft,ke,vt);I.pixelStorei(I.UNPACK_ROW_LENGTH,lt),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,Wt),I.pixelStorei(I.UNPACK_SKIP_PIXELS,hi),I.pixelStorei(I.UNPACK_SKIP_ROWS,Xt),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Vi),be===0&&z.generateMipmaps&&I.generateMipmap(ct),me.unbindTexture()},this.initRenderTarget=function(S){_.get(S).__webglFramebuffer===void 0&&N.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?N.setTextureCube(S,0):S.isData3DTexture?N.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?N.setTexture2DArray(S,0):N.setTexture2D(S,0),me.unbindTexture()},this.resetState=function(){E=0,D=0,L=null,me.reset(),Te.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return hn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=it._getDrawingBufferColorSpace(e),t.unpackColorSpace=it._getUnpackColorSpace()}}const Gi="#005eb8";function si(i,e,t){const n=e.split(/\s+/),r=[];let s="";for(const o of n){const a=s?`${s} ${o}`:o;i.measureText(a).width>t&&s?(r.push(s),s=o):s=a}return s&&r.push(s),r}function er(i,e,t){if(i.measureText(e).width<=t)return e;let n=e;for(;n.length>1&&i.measureText(`${n}…`).width>t;)n=n.slice(0,-1);return`${n}…`}function pt(i){const e=document.createElement("canvas");e.width=i.widthPx,e.height=i.heightPx;const t=e.getContext("2d"),n=Math.round(i.widthPx*.05),r=i.align??"left",s=r==="center"?i.widthPx/2:n;t.fillStyle=i.background??Gi,t.fillRect(0,0,e.width,e.height),t.fillStyle=i.color??"#ffffff",t.textAlign=r,t.textBaseline="top";let o=n;const a=i.titleSize??Math.round(i.heightPx*.28);t.font=`bold ${a}px Arial`;for(const c of si(t,i.title,i.widthPx-n*2))t.fillText(c,s,o),o+=a*1.15;if(i.subtitle){const c=i.subtitleSize??Math.round(a*.55);t.font=`${c}px Arial`,t.globalAlpha=.85;for(const u of si(t,i.subtitle,i.widthPx-n*2))t.fillText(u,s,o),o+=c*1.2;t.globalAlpha=1}if(i.body){o+=n*.5;let c=i.bodySize??Math.round(a*.45);if(i.fitBody){const u=i.footer?Math.round(a*.32)*2.6+n:n,h=i.heightPx-o-u;for(;c>16&&(t.font=`${c}px Arial`,!(si(t,i.body,i.widthPx-n*2).length*c*1.3<=h));)c-=2}t.font=`${c}px Arial`;for(const u of si(t,i.body,i.widthPx-n*2))t.fillText(u,s,o),o+=c*1.3}if(i.footer){const c=Math.round((i.titleSize??i.heightPx*.28)*.32);t.font=`${c}px Arial`,t.globalAlpha=.72;let u=i.heightPx-n;const h=si(t,i.footer,i.widthPx-n*2).reverse();for(const f of h)u-=c*1.25,t.fillText(f,s,u);t.globalAlpha=1}const l=new vn(e);return l.anisotropy=4,l.colorSpace=mt,l}const tl="#009639";function vm(i,e,t){const n=document.createElement("canvas");n.width=620,n.height=810;const r=n.getContext("2d");r.fillStyle="#fbfbf8",r.fillRect(0,0,620,810),r.fillStyle=e,r.fillRect(0,0,620,92),r.fillStyle="#ffffff",r.font="bold 46px Arial",r.textBaseline="middle",r.fillText(i,30,48),r.textBaseline="top",r.fillStyle="#20262b",r.font="34px Arial";let s=130;for(const a of si(r,t,560))if(r.fillText(a,30,s),s+=46,s>770)break;const o=new vn(n);return o.anisotropy=4,o.colorSpace=mt,o}function Mm(i){const e=document.createElement("canvas");e.width=620,e.height=290;const t=e.getContext("2d");t.fillStyle="#e9e3d0",t.fillRect(0,0,620,290),t.strokeStyle="#8b8672",t.lineWidth=6,t.strokeRect(8,8,604,274),t.fillStyle="#6c6753",t.font="26px Arial",t.fillText("formerly signposted as",28,34),t.fillStyle="#3a382f";let n=88;for(const s of i.slice(0,3)){t.font="bold 44px Arial",t.fillText(s,28,n);const o=t.measureText(s).width;t.strokeStyle="#7d2a2a",t.lineWidth=5,t.beginPath(),t.moveTo(24,n+2),t.lineTo(32+o,n-6),t.stroke(),n+=64}const r=new vn(e);return r.colorSpace=mt,r}function Wl(i){const e=document.createElement("canvas"),t=640,n=460;e.width=t,e.height=n;const r=e.getContext("2d");let s=i%2147483646+1;const o=()=>(s=s*16807%2147483647)/2147483647,a=[["#e8e3d4","#41668c","#c4a35a","#7a4b3a","#5d7a76"],["#ece7dc","#6c8c5f","#c96f4a","#3d4a52","#c4b57a"],["#e6e2d8","#8a5a74","#5a7d8a","#c9a35a","#4a5747"]],l=a[i%a.length];r.fillStyle=l[0],r.fillRect(0,0,t,n);const c=5+Math.floor(o()*5);for(let h=0;h<c;h++)if(r.fillStyle=l[1+Math.floor(o()*(l.length-1))],r.globalAlpha=.75+o()*.25,o()<.45)r.beginPath(),r.arc(o()*t,o()*n,40+o()*100,0,Math.PI*(.7+o()*1.3)),r.lineWidth=14+o()*30,r.strokeStyle=r.fillStyle,r.stroke();else{const f=40+o()*150;r.fillRect(o()*(t-f),o()*(n-100),f,50+o()*160)}r.globalAlpha=1;const u=new vn(e);return u.colorSpace=mt,u}function Xr(i,e){const t=document.createElement("canvas");t.width=512,t.height=150;const n=t.getContext("2d");n.fillStyle="#f5f4ef",n.fillRect(0,0,512,150),n.fillStyle="#20262b",n.font="bold 34px Arial",n.fillText(er(n,i,470),22,26),n.font="24px Arial",n.globalAlpha=.75;let r=78;for(const o of si(n,e,470).slice(0,2))n.fillText(o,22,r),r+=32;n.globalAlpha=1;const s=new vn(t);return s.colorSpace=mt,s}function Xl(i){const e=Math.round(i.widthPx*.035),t=Math.round(i.heightPx*.075);let n=e+t*1.25;i.subtitle&&(n+=t*.8),n+=e*.4;const r=n;n+=e*.6;const s=i.columns??1,o=(i.widthPx-e*2-e*(s-1))/s,a=i.rowSize??Math.round(t*.62),l=a*1.55,c=Math.max(1,Math.floor((i.heightPx-n-e)/l));return{pad:e,titleSize:t,top:n,ruleY:r,columns:s,colWidth:o,rowSize:a,rowH:l,rowsPerCol:c}}function Co(i,e){const t=Xl(i),n=[];for(let r=0;r<e;r++){const s=Math.floor(r/t.rowsPerCol);if(s>=t.columns){n.push(null);continue}const o=t.pad+s*(t.colWidth+t.pad),a=t.top+r%t.rowsPerCol*t.rowH;n.push([o/i.widthPx,1-(a+t.rowH)/i.heightPx,(o+t.colWidth)/i.widthPx,1-a/i.heightPx])}return n}function nr(i){const e=document.createElement("canvas");e.width=i.widthPx,e.height=i.heightPx;const t=e.getContext("2d"),n=Xl(i),r=n.pad;t.fillStyle=i.background??Gi,t.fillRect(0,0,e.width,e.height),t.textBaseline="top",t.textAlign="left";const s=n.titleSize;t.fillStyle="#ffffff",t.font=`bold ${s}px Arial`,t.fillText(er(t,i.title,i.widthPx-r*2),r,r),i.subtitle&&(t.font=`${Math.round(s*.55)}px Arial`,t.globalAlpha=.85,t.fillText(er(t,i.subtitle,i.widthPx-r*2),r,r+s*1.25),t.globalAlpha=1),t.strokeStyle="rgba(255,255,255,0.5)",t.lineWidth=Math.max(2,i.heightPx*.004),t.beginPath(),t.moveTo(r,n.ruleY),t.lineTo(i.widthPx-r,n.ruleY),t.stroke();const o=n.top,a=n.columns,l=n.colWidth,c=n.rowSize,u=n.rowH,h=n.rowsPerCol;i.rows.forEach((p,x)=>{const v=Math.floor(x/h);if(v>=a)return;const m=r+v*(l+r),d=o+x%h*u;let w=m;p.chip&&(t.fillStyle=p.chip,t.fillRect(m,d+c*.1,c*.8,c*.8),w+=c*1.2),t.fillStyle="#ffffff",t.font=`${p.strong?"bold ":""}${c}px Arial`;const T=er(t,p.text,l-(w-m));if(t.fillText(T,w,d),p.sub){const A=t.measureText(T).width;t.font=`${Math.round(c*.78)}px Arial`,t.globalAlpha=.75,t.fillText(er(t,`  ${p.sub}`,l-(w-m)-A),w+A,d+c*.15),t.globalAlpha=1}});const f=new vn(e);return f.anisotropy=4,f.colorSpace=mt,f}function Po(i,e=1.36){const t=document.createElement("canvas");t.width=1088,t.height=Math.round(1088/e);const n=t.getContext("2d");n.fillStyle="#3b4046",n.fillRect(0,0,t.width,t.height);const r=new vn(t);r.colorSpace=mt,r.anisotropy=4,r.generateMipmaps=!1,r.minFilter=St;const s=new Image;return s.onload=()=>{const o=Math.max(t.width/s.naturalWidth,t.height/s.naturalHeight),a=s.naturalWidth*o,l=s.naturalHeight*o;n.drawImage(s,(t.width-a)/2,(t.height-l)/2,a,l),r.needsUpdate=!0},s.src=i,r}class Sm{entries=[];placeholder=new gn({color:new Ze(Gi)});register(e,t,n){e.material=this.placeholder,this.entries.push({pos:t.clone(),mesh:e,make:n,ready:!1})}update(e,t=55,n=120,r=8){const s=[];for(const o of this.entries){const a=o.pos.distanceTo(e);if(o.mesh.visible=a<n,!o.ready&&a<t)s.push({e:o,d:a});else if(o.ready&&a>n){const l=o.mesh.material;l.map?.dispose(),l.dispose(),o.mesh.material=this.placeholder,o.ready=!1}}s.sort((o,a)=>o.d-a.d);for(const{e:o}of s.slice(0,r))o.mesh.material=new gn({map:o.make()}),o.ready=!0}get count(){return this.entries.length}get readyCount(){return this.entries.filter(e=>e.ready).length}}function bm(i,e,t,n,r,s="sign"){const o=new Pt(new ki(e,t),new gn);return o.name=s,i.register(o,n,r),o}const Em={event:"#41b6e6","mental-object":"#78be20",stative:"#ed8b00","time-interval":"#8a1538",role:"#00a499","physical-object":"#ffb81c",resources:"#7c2855"},Xn=i=>Em[i]??"#425563";function Bi(i,e=!1){const t=i[0].index!==null,n=new Set(Object.keys(i[0].attributes)),r=new Set(Object.keys(i[0].morphAttributes)),s={},o={},a=i[0].morphTargetsRelative,l=new xn;let c=0;for(let u=0;u<i.length;++u){const h=i[u];let f=0;if(t!==(h.index!==null))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them."),null;for(const p in h.attributes){if(!n.has(p))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+'. All geometries must have compatible attributes; make sure "'+p+'" attribute exists among all geometries, or in none of them.'),null;s[p]===void 0&&(s[p]=[]),s[p].push(h.attributes[p]),f++}if(f!==n.size)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". Make sure all geometries have the same number of attributes."),null;if(a!==h.morphTargetsRelative)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". .morphTargetsRelative must be consistent throughout all geometries."),null;for(const p in h.morphAttributes){if(!r.has(p))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+".  .morphAttributes must be consistent throughout all geometries."),null;o[p]===void 0&&(o[p]=[]),o[p].push(h.morphAttributes[p])}if(e){let p;if(t)p=h.index.count;else if(h.attributes.position!==void 0)p=h.attributes.position.count;else return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". The geometry must have either an index or a position attribute"),null;l.addGroup(c,p,u),c+=p}}if(t){let u=0;const h=[];for(let f=0;f<i.length;++f){const p=i[f].index;for(let x=0;x<p.count;++x)h.push(p.getX(x)+u);u+=i[f].attributes.position.count}l.setIndex(h)}for(const u in s){const h=nl(s[u]);if(!h)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+u+" attribute."),null;l.setAttribute(u,h)}for(const u in o){const h=o[u][0].length;if(h===0)break;l.morphAttributes=l.morphAttributes||{},l.morphAttributes[u]=[];for(let f=0;f<h;++f){const p=[];for(let v=0;v<o[u].length;++v)p.push(o[u][v][f]);const x=nl(p);if(!x)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+u+" morphAttribute."),null;l.morphAttributes[u].push(x)}}return l}function nl(i){let e,t,n,r=-1,s=0;for(let c=0;c<i.length;++c){const u=i[c];if(e===void 0&&(e=u.array.constructor),e!==u.array.constructor)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes."),null;if(t===void 0&&(t=u.itemSize),t!==u.itemSize)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes."),null;if(n===void 0&&(n=u.normalized),n!==u.normalized)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes."),null;if(r===-1&&(r=u.gpuType),r!==u.gpuType)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes."),null;s+=u.count*t}const o=new e(s),a=new Jt(o,t,n);let l=0;for(let c=0;c<i.length;++c){const u=i[c];if(u.isInterleavedBufferAttribute){const h=l/t;for(let f=0,p=u.count;f<p;f++)for(let x=0;x<t;x++){const v=u.getComponent(f,x);a.setComponent(f+h,x,v)}}else o.set(u.array,l);l+=u.count*t}return r!==void 0&&(a.gpuType=r),a}function ym(){const i=document.createElement("canvas");i.width=i.height=256;const e=i.getContext("2d");e.fillStyle="#89928b",e.fillRect(0,0,256,256);let t=42;const n=()=>(t=t*16807%2147483647)/2147483647,r=["#9aa39b","#78817a","#a7ada3","#6e766f","#93856f"];for(let o=0;o<1400;o++){e.fillStyle=r[Math.floor(n()*r.length)],e.globalAlpha=.35+n()*.4;const a=1+n()*2.6;e.fillRect(n()*256,n()*256,a,a)}e.globalAlpha=1;const s=new vn(i);return s.wrapS=s.wrapT=ir,s.colorSpace=mt,s.anisotropy=4,s}function Tm(){const i=document.createElement("canvas");i.width=i.height=256;const e=i.getContext("2d");e.fillStyle="#f5f6f3",e.fillRect(0,0,256,256);let t=7;const n=()=>(t=t*16807%2147483647)/2147483647;e.fillStyle="#e8eae4";for(let s=0;s<600;s++)e.globalAlpha=.35+n()*.3,e.fillRect(n()*256,n()*256,1.6,1.6);e.globalAlpha=1,e.strokeStyle="#cfd3cb",e.lineWidth=3;for(const s of[0,128,256])e.beginPath(),e.moveTo(s,0),e.lineTo(s,256),e.moveTo(0,s),e.lineTo(256,s),e.stroke();const r=new vn(i);return r.wrapS=r.wrapT=ir,r.repeat.set(1/1.2,1/1.2),r.colorSpace=mt,r.anisotropy=4,r}const de={floor:new uu({map:ym(),shininess:60,specular:new Ze(3026478)}),wall:new Tt({color:14541782}),endWall:new Tt({color:12175549}),ceiling:new Tt({map:Tm()}),door:new Tt({color:9083520}),liftDoor:new Tt({color:12042182}),stair:new Tt({color:12174013}),stairDark:new Tt({color:3817799}),rail:new Tt({color:8358806}),oak:new Tt({color:9071173}),glass:new Tt({color:3095104}),steel:new Tt({color:12831182}),led:new gn({color:16251391}),chair:new Tt({color:5140074}),daylight:new gn({color:14214894})};function wm(i,e,t,n){const r=i.attributes.uv,s=[[n,t],[n,t],[e,n],[e,n],[e,t],[e,t]];for(let o=0;o<6;o++){const[a,l]=s[o];for(let c=0;c<4;c++){const u=o*4+c;r.setXY(u,r.getX(u)*a,r.getY(u)*l)}}r.needsUpdate=!0}function ji(i,e){if(!i.length)return null;const t=i.map(s=>{const o=new Fn(s.w,s.h,s.d);return s.rx&&o.rotateX(s.rx),o.translate(s.x,s.y,s.z),o}),n=Bi(t);t.forEach(s=>s.dispose());const r=new Pt(n,e);return r.matrixAutoUpdate=!1,r}const tr={skirtH:.152,railH:.152,railCentre:.95},Io=new Tt({vertexColors:!0}),il=["#c98d64","#8d5a3c","#e3b498","#6b4a30","#d9a37e"],rl=["#2e2620","#5b4632","#8c8c8c","#d9d3c5","#141414"];function Zo(i){const e=i();if(e<.25)return{top:"#f2f3ef",legs:"#f2f3ef",cap:"#ffffff"};if(e<.31)return{top:"#20375c",legs:"#20375c",cap:"#ffffff"};if(e<.43)return{top:"#eeefe9",legs:"#565b62"};if(e<.55)return{top:"#68727d",legs:"#4c5257"};const t=["#7a8f6a","#c0a052","#7c5866","#5f7484","#96694f"],n=["#55504a","#3f464d","#6a5d4f","#44403a"];return{top:t[Math.floor(i()*t.length)],legs:n[Math.floor(i()*n.length)]}}function ur(i){let e=i%2147483646+1;for(let t=0;t<3;t++)e=e*16807%2147483647;return()=>(e=e*16807%2147483647)/2147483647}function Ct(i,e,t,n,r,s,o){const a=new Fn(i,e,t);a.translate(n,r,s);const l=new Ze(o),c=a.attributes.position.count,u=new Float32Array(c*3);for(let h=0;h<c;h++)u[h*3]=l.r,u[h*3+1]=l.g,u[h*3+2]=l.b;return a.setAttribute("color",new Jt(u,3)),a}function Ko(i,e,t,n){const r=il[Math.floor(i()*il.length)],s=e.cap??rl[Math.floor(i()*rl.length)],o=[Ct(.2,.22,.2,0,t,n,r),Ct(.21,.08,.21,0,t+.15,n-.01,s)];return e.cap&&o.push(Ct(.24,.03,.24,0,t+.2,n-.01,e.cap)),o}function Am(i){const e=ur(i),t=Zo(e),n=[Ct(.09,.44,.11,-.09,.22,.17,t.legs),Ct(.09,.44,.11,.09,.22,.17,t.legs),Ct(.1,.13,.4,-.09,.5,.03,t.legs),Ct(.1,.13,.4,.09,.5,.03,t.legs),Ct(.32,.52,.2,0,.82,-.08,t.top),Ct(.08,.4,.1,-.21,.86,-.05,t.top),Ct(.08,.4,.1,.21,.86,-.05,t.top),...Ko(e,t,1.2,-.06)],r=Bi(n);return n.forEach(s=>s.dispose()),r}function Rm(i){const e=ur(i),t=Zo(e),n=[Ct(.1,.78,.12,-.09,.39,0,t.legs),Ct(.1,.78,.12,.09,.39,0,t.legs),Ct(.32,.52,.2,0,1.04,0,t.top),Ct(.08,.52,.1,-.21,1,0,t.top),Ct(.08,.52,.1,.21,1,0,t.top),...Ko(e,t,1.42,0)],r=Bi(n);return n.forEach(s=>s.dispose()),r}class Cm{constructor(e,t,n){this.a=e,this.b=t;const r=ur(n),s=Zo(r);this.len=e.distanceTo(t),this.speed=1+r()*.5,this.s=r()*this.len,this.dir=r()<.5?1:-1;const o=(h,f,p)=>{const x=new Pt(h,Io);return x.position.set(f,p,0),this.group.add(x),x},a=()=>Ct(.1,.78,.12,0,-.39,0,s.legs),l=()=>Ct(.08,.52,.1,0,-.26,0,s.top);this.legL=o(a(),-.09,.78),this.legR=o(a(),.09,.78),this.armL=o(l(),-.21,1.28),this.armR=o(l(),.21,1.28);const c=[Ct(.32,.52,.2,0,1.04,0,s.top),...Ko(r,s,1.42,0)],u=Bi(c);c.forEach(h=>h.dispose()),this.group.add(new Pt(u,Io)),this.place()}a;b;group=new Cn;legL;legR;armL;armR;s;dir=1;pause=0;phase=0;len;speed;place(){const e=this.s/this.len;this.group.position.lerpVectors(this.a,this.b,e);const t=(this.b.x-this.a.x)*this.dir,n=(this.b.z-this.a.z)*this.dir;this.group.rotation.y=Math.atan2(t,n)}update(e){if(this.pause>0){this.pause-=e;for(const n of[this.legL,this.legR,this.armL,this.armR])n.rotation.x*=Math.max(0,1-e*6);return}this.s+=this.speed*e*this.dir,(this.s<=0||this.s>=this.len)&&(this.s=Math.max(0,Math.min(this.len,this.s)),this.dir*=-1,this.pause=1.2+this.phase%1.3),this.phase+=this.speed*e*3.4;const t=Math.sin(this.phase)*.5;this.legL.rotation.x=t,this.legR.rotation.x=-t,this.armL.rotation.x=-t*.6,this.armR.rotation.x=t*.6,this.place(),this.group.position.y+=Math.abs(Math.sin(this.phase))*.025}}class Pm{constructor(e,t,n){this.zc=n;const r=new Fn(.05,2.06,.5),s=de.liftDoor;this.leafA=new Pt(r,s),this.leafB=new Pt(r.clone(),s),this.leafA.position.set(t,1.03,n-.25),this.leafB.position.set(t,1.03,n+.25),e.add(this.leafA,this.leafB)}zc;leafA;leafB;openT=0;target=0;update(e){this.openT+=(this.target-this.openT)*Math.min(1,e*5);const t=this.openT*.48;this.leafA.position.z=this.zc-.25-t,this.leafB.position.z=this.zc+.25+t}get openness(){return this.openT}}const sl=i=>i.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,""),F={CORRIDOR_W:3,ROOM_H:3,STOREY:4,DOOR_W:1.2,DOOR_H:2.1,DOOR_SPACING:2,ENTRY:2.2,END_ZONE:2.6,NOTICE_SPACING:1.25,LOBBY_W:7,LOBBY_D:7,LANDING_Z0:7,LANDING_Z1:10,STREET_Z0:7,STREET_Z1:11,STREET_H:4,STRIP:8.2,STAIR_SLOT:3.6,WING_GAP:12,PIT_X0:-3.5,PIT_X1:-.7,PIT_Z0:1.2,PIT_Z1:5.5},Im=(i,e,t=0,n=0)=>{const r=Math.max(t,n)*F.NOTICE_SPACING;return F.ENTRY+Math.max(i,e,1)*F.DOOR_SPACING+(r?r+.4:0)+F.END_ZONE};function Lm(i){const e=new Map(i.classes.map(g=>[g.id,g])),t={};for(const g of i.classes)t[g.id]=[];for(const g of i.classes)g.supers.length&&t[g.supers[0]]?.push(g.id);for(const g of i.classes){const E=new Set(t[g.id]);t[g.id]=g.subs.filter(D=>E.has(D))}const n=new Map;function r(g){if(n.has(g))return n.get(g);const E=t[g],D=E.filter(G=>t[G].length),L=[];let O=D.reduce((G,k)=>G+o(k),0),Y=0;for(const G of E)t[G].length||(Y<O?(L.push(G),Y+=o(G)):(D.push(G),O+=o(G)));const $={south:D,north:L,southSum:O,northSum:Y};return n.set(g,$),$}const s=new Map;function o(g){if(s.has(g))return s.get(g);const E=t[g];let D=F.STRIP;if(E.length){const{southSum:L,northSum:O}=r(g);D=Math.max(F.STRIP,F.STAIR_SLOT+Math.max(L,O))}return s.set(g,D),D}const a={},l={};function c(g,E,D,L=!1){const O=e.get(g),Y=t[g],$=Y.length?E+.2-F.PIT_X0:E+F.STRIP/2;if(a[g]={x:$,level:D,y:-4*D,flip:L,corridorLen:Im(O.out.length,O.in.length,O.notes.length,O.examples.length)},Y.length){const{south:G,north:k,southSum:Q,northSum:q}=r(g);let ie=E+F.STAIR_SLOT;for(const He of G)c(He,ie,D+1,!1),ie+=o(He);let Ae=E+F.STAIR_SLOT;for(const He of k)c(He,Ae,D+1,!0),Ae+=o(He);const _e=new Set(Y);l[g]={parentId:g,level:D+1,y:-4*(D+1),x0:E+.2,x1:E+F.STAIR_SLOT+Math.max(Q,q,5),stairX:$+(F.PIT_X0+F.PIT_X1)/2,homeChildIds:Y,southIds:G,northIds:k,portalChildIds:O.subs.filter(He=>!_e.has(He))}}}const u=g=>g.rootIds.reduce((E,D)=>E+o(D),0),h=i.wings.reduce((g,E)=>g+u(E),0);let f=0;const p=new Map;for(const g of i.wings){const E=f<h/2;p.set(g.key,E?"south":"north"),E&&(f+=u(g))}const x=[],v={south:6,north:6};for(const g of i.wings){const E=p.get(g.key),D=v[E];for(const L of g.rootIds)c(L,v[E],0),v[E]+=o(L);x.push({key:g.key,x0:D,x1:v[E],rootIds:g.rootIds,street:E}),v[E]+=F.WING_GAP}const m=Math.max(v.south,v.north)-F.WING_GAP+6;for(const g of x){if(g.street!=="north")continue;const E=g.x0+g.x1;for(const L of i.classes){if(L.wing!==g.key)continue;const O=a[L.id];O.x=E-O.x,O.flip=!O.flip,O.mirror=!0}const D=new Set(i.classes.filter(L=>L.wing===g.key).map(L=>L.id));for(const L of Object.values(l))D.has(L.parentId)&&([L.x0,L.x1]=[E-L.x1,E-L.x0],L.stairX=E-L.stairX,L.mirror=!0)}const d=[],w=[];for(const g of i.classes){const E=a[g.id];!E.mirror&&E.flip&&d.push(E),E.mirror&&!E.flip&&w.push(E)}let T=28;const A=2,C=F.CORRIDOR_W/2+.3,R=F.LOBBY_W/2+.15,P=(g,E,D,L)=>Math.abs(g.x-E.x)<D+L;for(const g of d)for(const E of w)g.level===E.level&&(P(g,E,C,C)&&(T=Math.max(T,12+g.corridorLen+E.corridorLen+A)),P(g,E,C,R)&&(T=Math.max(T,12+g.corridorLen+A)),P(g,E,R,C)&&(T=Math.max(T,12+E.corridorLen+A)));T=Math.ceil(T);const V=F.STREET_Z1+T+F.STREET_Z0+4;for(const g of i.classes){const E=a[g.id];E.mirror=!!E.mirror,E.oz=E.mirror?E.flip?V:V-17:E.flip?17:0}const M=[];for(const g of i.classes)for(const E of g.supers.slice(1))M.push({childId:g.id,parentId:E});return{areas:a,landings:l,homeChildren:t,nonPrimaryUp:M,wings:x,street:{x0:0,x1:m},loop:{C:T,K:V,xEnd:m,south:{z0:F.STREET_Z0,z1:F.STREET_Z1},north:{z0:F.STREET_Z1+T,z1:F.STREET_Z1+T+4},connectors:{west:[.2,3.8],east:[m-3.8,m-.2]}}}}const rn="__atrium",Dm=(i,e)=>i===null&&e===null?"":`${i??0}..${e===-1?"*":e??"*"}`,ol=(i,e)=>{if(i===null&&e===null)return"";const t=e===null||String(e)==="-1"?"*":String(e);return`${i??0}..${t}`},Yr=(i,e,t,n)=>`${[ol(n.oppMin,n.oppMax),i].filter(Boolean).join(" ")} — ${e} → ${[ol(n.min,n.max),t].filter(Boolean).join(" ")}`;class Jr{constructor(e,t,n,r=!1){this.group=e,this.origin=t,this.signs=n,this.f=r?-1:1,e.rotation.y=r?Math.PI:0}group;origin;signs;colliders=[];walkables=[];trims=[];plates=[];glass=[];leds=[];seats=[];f;local(e,t,n){return new B(this.origin.x+this.f*e,this.origin.y+t,this.origin.z+this.f*n)}batches=new Map;box(e,t,n,r,s,o,a,l={solid:!0}){const c={w:e,h:t,d:n,x:s,y:o,z:a,worldUV:l.vinyl||l.worldUV},u=this.batches.get(r);u?u.push(c):this.batches.set(r,[c]);const h=this.origin.x+this.f*s,f=this.origin.z+this.f*a,p=new Et(new B(h-e/2,this.origin.y+o-t/2,f-n/2),new B(h+e/2,this.origin.y+o+t/2,f+n/2));if(l.solid&&this.colliders.push(p),l.walkable&&this.walkables.push(p),l.trim)for(const x of l.trim)this.trimFace(x,e,t,n,s,o,a)}trimFace(e,t,n,r,s,o,a){const l=o-n/2,c=.05,u=e.startsWith("x")?{w:c,d:Math.max(.3,r-.1)}:{w:Math.max(.3,t-.1),d:c},h=c/2+.005,f=e==="x+"?s+t/2+h:e==="x-"?s-t/2-h:s,p=e==="z+"?a+r/2+h:e==="z-"?a-r/2-h:a;this.trims.push({...u,h:tr.skirtH,x:f,y:l+tr.skirtH/2,z:p},{...u,h:tr.railH,x:f,y:l+tr.railCentre,z:p})}led(e,t,n,r=.6,s=.6){this.leds.push({w:r,h:.035,d:s,x:e,y:n,z:t})}oakSpec(e){this.trims.push(e)}steelSpec(e){this.plates.push(e)}chairSpots=[];peopleGeos=[];sit(e,t,n,r,s){const o=Am(s);r===-1&&o.rotateY(Math.PI),o.translate(e,t,n),this.peopleGeos.push(o)}stand(e,t,n,r,s){const o=Rm(s);o.rotateY(r),o.translate(e,t,n),this.peopleGeos.push(o)}chair(e,t,n,r=1){this.chairSpots.push({x:e,y:t,z:n,face:r});const s=t+.45;this.seats.push({w:.44,h:.06,d:.4,x:e,y:s,z:n}),this.seats.push({w:.44,h:.48,d:.05,x:e,y:s+.36,z:n-r*.19});for(const[o,a]of[[-.18,-.16],[.18,-.16],[-.18,.16],[.18,.16]])this.plates.push({w:.035,h:.44,d:.035,x:e+o,y:t+.22,z:n+a});this.colliders.push(new Et().setFromPoints([this.local(e-.26,t,n-.26),this.local(e+.26,t+.95,n+.26)]))}doorFurniture(e,t,n,r){const o=e.startsWith("x"),a=o?{w:.02,d:.28}:{w:.28,d:.02},l=o?{w:.02,d:F.DOOR_W-.25}:{w:F.DOOR_W-.25,d:.02},c=o?{w:.02,d:.1}:{w:.1,d:.02},u=.06,h=e==="x+"?t+u:e==="x-"?t-u:t,f=e==="z+"?r+u:e==="z-"?r-u:r,p=.42;this.glass.push({...a,h:.42,x:h,y:n+1.5,z:f}),this.plates.push({...l,h:.25,x:h,y:n+.13,z:f}),this.plates.push({...c,h:.3,x:o?h:t+p,y:n+1.05,z:o?r+p:f})}populate(e,t){if(e!=="off"){const n=e==="full"?.4:.2,r=ur(t);for(const s of this.chairSpots)r()<n&&this.sit(s.x,s.y+.03,s.z,s.face,Math.floor(r()*99991))}if(this.peopleGeos.length){const n=Bi(this.peopleGeos);this.peopleGeos.forEach(s=>s.dispose());const r=new Pt(n,Io);r.matrixAutoUpdate=!1,this.group.add(r),this.peopleGeos=[]}}finalize(){for(const[e,t]of this.batches){const n=t.map(o=>{const a=new Fn(o.w,o.h,o.d);return o.worldUV&&wm(a,o.w,o.h,o.d),a.translate(o.x,o.y,o.z),a}),r=Bi(n);n.forEach(o=>o.dispose());const s=new Pt(r,e);s.matrixAutoUpdate=!1,this.group.add(s)}this.batches.clear();for(const e of[ji(this.trims,de.oak),ji(this.plates,de.steel),ji(this.glass,de.glass),ji(this.leds,de.led),ji(this.seats,de.chair)])e&&this.group.add(e)}sign(e,t,n,r,s,o,a,l){const c=bm(this.signs,e,t,this.local(n,r,s),a,l);return c.position.set(n,r,s),c.rotation.y=o,c.matrixAutoUpdate=!1,c.updateMatrix(),this.group.add(c),c}}function Um(i,e,t){const{byId:n,layout:r}=e,s=new Cn;s.name=`area:${i.label}`,s.position.copy(t);const o=r.areas[i.id].flip,a=o?Math.PI:0,l=new Jr(s,t,e.signs,o),c=[],u=Xn(i.wing),h=r.areas[i.id].corridorLen,f=F.CORRIDOR_W,p=F.ROOM_H,x=F.LOBBY_W,v=F.LOBBY_D,m=r.landings[i.id],d=i.supers.length===0,w=-h/2;l.box(f,.1,h,de.floor,0,-.05,w,{walkable:!0,vinyl:!0}),l.box(f,.1,h,de.ceiling,0,p+.05,w,{worldUV:!0}),l.box(.15,p,h,de.wall,f/2+.075,p/2,w,{solid:!0,trim:["x-"]}),l.box(.15,p,h,de.wall,-f/2-.075,p/2,w,{solid:!0,trim:["x+"]}),l.box(f+.3,p,.15,de.endWall,0,p/2,-h-.075,{solid:!0,trim:["z+"]});for(let ne=0;ne<Math.floor(h/3);ne++)l.led(0,-(ne+.6)*3,p-.02,.35,1.3);m?(l.box(x/2-F.PIT_X1,.1,v,de.floor,(F.PIT_X1+x/2)/2,-.05,v/2,{walkable:!0,vinyl:!0}),l.box(F.PIT_X1-F.PIT_X0,.1,F.PIT_Z0,de.floor,(F.PIT_X0+F.PIT_X1)/2,-.05,F.PIT_Z0/2,{walkable:!0,vinyl:!0}),l.box(F.PIT_X1-F.PIT_X0,.1,v-F.PIT_Z1,de.floor,(F.PIT_X0+F.PIT_X1)/2,-.05,(F.PIT_Z1+v)/2,{walkable:!0,vinyl:!0})):l.box(x,.1,v,de.floor,0,-.05,v/2,{walkable:!0,vinyl:!0}),l.box(x,.1,v,de.ceiling,0,p+.05,v/2,{worldUV:!0}),l.box(.15,p,v,de.wall,x/2+.075,p/2,v/2,{solid:!0,trim:["x-"]}),l.box(.15,p,v,de.wall,-x/2-.075,p/2,v/2,{solid:!0,trim:["x+"]});const T=(x-f)/2;l.box(T,p,.15,de.wall,f/2+T/2,p/2,-.075,{solid:!0,trim:["z+","z-"]}),l.box(T,p,.15,de.wall,-2.5,p/2,-.075,{solid:!0,trim:["z+","z-"]}),l.box(2,p,.15,de.wall,-2.5,p/2,v+.075,{solid:!0,trim:["z-","z+"]}),l.box(2,p,.15,de.wall,2.5,p/2,v+.075,{solid:!0,trim:["z-","z+"]}),l.box(3,p-F.DOOR_H-.3,.15,de.wall,0,(p+F.DOOR_H+.3)/2,v+.075,{});for(const ne of[-1.8,1.8])for(const Ee of[2,5])l.led(ne,Ee,p-.02);const A=d?F.STREET_H:F.ROOM_H,C=d?2.7:2.4;for(const ne of[1,-1])l.sign(1.6,.44,ne*.015,C,v+1.35,ne*Math.PI/2,()=>pt({widthPx:800,heightPx:220,title:i.label,subtitle:i.roomNumber?`Room ${i.roomNumber}`:`${i.wing} wing`,titleSize:62}),`hang:${i.label}:${ne}`);for(const ne of[-.6,.6])l.steelSpec({w:.03,h:A-C-.22,d:.03,x:ne,y:(A+C+.22)/2,z:v+1.35});const R=new gn({color:new Ze(u)});l.box(.18,.012,v+h,R,0,.012,(v-h)/2,{}),l.sign(2.6,.7,0,p-.5,.08,0,()=>pt({widthPx:1024,heightPx:276,title:i.label,subtitle:[i.roomNumber?`Room ${i.roomNumber}`:null,`${i.wing} wing · ${i.floor?`level −${i.floor}`:"ground"}`].filter(Boolean).join(" · "),titleSize:96}),`name:${i.label}`);const P=i.supers.map(ne=>n.get(ne)?.label??"?");l.sign(2.9,.62,0,F.DOOR_H+.55,v-.09,Math.PI,()=>pt({widthPx:1152,heightPx:246,title:d?"⌂ Hospital Street":`Stairs ↑ ${P[0]}`,subtitle:d?"reception · all wings":`landing · stairs at the west end${P.length>1?` · also: ${P.slice(1).join(", ")}`:""}`,titleSize:74}),`back:${i.label}`),l.sign(1.9,1.5,2.5,1.62,.01,0,()=>pt({widthPx:1024,heightPx:810,title:i.label,subtitle:[i.plural?`plural: ${i.plural}`:null,i.alsoKnownAs.length?`also: ${i.alsoKnownAs.join("; ")}`:null,i.roomNumber?`Room ${i.roomNumber}`:null].filter(Boolean).join(" · "),body:i.description??"Definition pending.",footer:i.source?`Source: ${i.source}`:void 0,fitBody:!0,titleSize:88,align:"left"}),`poster:${i.label}`),e.illustrations?.has(sl(i.label))&&(l.oakSpec({w:1.3,h:1.38,d:.05,x:-2.5,y:1.62,z:-.02}),l.sign(1.2,1.28,-2.5,1.62,.01,0,()=>Po(`art/illustrations/${sl(i.label)}.jpg`,1.2/1.28),`illu:${i.label}`));const V=i.self.length;i.deprecated.length&&l.sign(.9,.42,-1.44,1.9,-1.4,Math.PI/2,()=>Mm(i.deprecated),`old:${i.label}`);const M=Math.max(i.out.length,i.in.length,1)*F.DOOR_SPACING,g=-(F.ENTRY+M+.2),E=(ne,Ee)=>{const ce=ne.match(/(\d+)/);return ce?`${Ee} ${ce[1]}`:Ee};let D=0;const L=(ne,Ee,ce,Oe,I)=>{const et=ne==="right"?1:-1,Xe=g-(Ee+.5)*F.NOTICE_SPACING;l.oakSpec({w:.05,h:1.34,d:1.06,x:et*(f/2-.035),y:1.55,z:Xe}),l.sign(.94,1.22,et*(f/2-.075),1.55,Xe,et>0?-Math.PI/2:Math.PI/2,()=>vm(ce,Oe,I),`notice:${i.label}:${ce}`),D++};i.notes.forEach((ne,Ee)=>L("left",Ee,E(ne.key,"Note"),Gi,ne.text)),i.examples.forEach((ne,Ee)=>L("right",Ee,E(ne.key,"Example"),tl,ne.text));const O=i.notes.length-i.examples.length,Y=Math.min(Math.abs(O),2);for(let ne=0;ne<Y;ne++){const Ee=O>0?1:-1,ce=(O>0?i.examples.length:i.notes.length)+ne,Oe=g-(ce+.5)*F.NOTICE_SPACING,I=(i.id.charCodeAt(0)+i.id.charCodeAt(3)*31+ne*7>>>0)%997,et=e.art.length?e.art[I%e.art.length]:null;l.oakSpec({w:.05,h:1.02,d:1.36,x:Ee*(f/2-.035),y:1.68,z:Oe}),l.sign(1.28,.94,Ee*(f/2-.075),1.68,Oe,Ee>0?-Math.PI/2:Math.PI/2,()=>et?Po(`art/${et.file}`):Wl(I),`print:${i.label}:${ne}`),l.sign(.44,.13,Ee*(f/2-.075),1.05,Oe,Ee>0?-Math.PI/2:Math.PI/2,()=>et?Xr(et.title,`${et.artist} · ${et.licence} · Wikimedia Commons`):Xr("Untitled study","Procedural print — placeholder"),`placard:${i.label}:${ne}`)}l.chair(2.35,0,.42,1),l.chair(2.95,0,.42,1),l.chair(-2.35,0,.42,1),l.chair(-2.95,0,.42,1);const $=ne=>-(F.ENTRY+(ne+.5)*F.DOOR_SPACING),G=(ne,Ee,ce,Oe,I,et,Xe,ot)=>{const me=ne==="right"?1:-1,y=me*(f/2),_=$(Ee);l.box(.08,F.DOOR_H,F.DOOR_W,de.door,y-me*.05,F.DOOR_H/2,_,{}),l.doorFurniture(me>0?"x-":"x+",y-me*.05,0,_);const N=me*.75;for(const ee of[1,-1])l.sign(1.3,.56,N,2.42,_+ee*.015,ee>0?0:Math.PI,()=>pt({widthPx:760,heightPx:328,title:Xe,subtitle:ot,titleSize:50}),`doorsign:${I}:${ee}`);for(const ee of[N-.45,N+.45])l.steelSpec({w:.03,h:p-2.69,d:.03,x:ee,y:(p+2.69)/2,z:_});c.push({kind:ce,areaId:i.id,elementId:Oe,label:I,targetIds:[et],triggerPos:l.local(y-me*.45,0,_),radius:.75,halfX:.4,halfZ:.55,auto:!0,exitPos:l.local(y-me*1.35,0,_),exitYaw:(me>0?Math.PI/2:-Math.PI/2)+a})};i.out.forEach((ne,Ee)=>{const ce=n.get(ne.targetId)?.label??"?";G("right",Ee,"door-out",ne.elementId,ne.label,ne.targetId,ce,Yr(i.label,ne.label,ce,ne))}),i.in.forEach((ne,Ee)=>{const ce=n.get(ne.sourceId)?.label??"?";G("left",Ee,"door-in",ne.elementId,ne.label,ne.sourceId,ce,Yr(ce,ne.label,i.label,ne))});const k=ne=>e.art.length?e.art[ne%e.art.length]:null,Q=ne=>(i.id.charCodeAt(1)*17+i.id.charCodeAt(5)*5+ne*31>>>0)%997,q=Math.max(i.out.length,i.in.length,1),ie=(ne,Ee)=>{const ce=ne==="right"?1:-1;for(let Oe=Ee;Oe<q;Oe+=2){const I=Q(Oe*2+(ce>0?1:0));Dn(l,k(I),I,ce*(f/2-.075),1.68,$(Oe),ce>0?-Math.PI/2:Math.PI/2,`${i.label}:${ne}:${Oe}`)}};i.out.length<q&&ie("right",i.out.length),i.in.length<q&&ie("left",i.in.length);{const ne=Q(99);Dn(l,k(ne),ne,f/2-.075,1.68,-1.15,-Math.PI/2,`${i.label}:entry`)}if(i.self.forEach((ne,Ee)=>{const ce=f/2-.8-Ee*(F.DOOR_W+.2);l.box(F.DOOR_W,F.DOOR_H,.08,de.door,ce,F.DOOR_H/2,-h+.06,{}),l.doorFurniture("z+",ce,0,-h+.06),l.sign(1.3,.4,ce,F.DOOR_H+.4,-h+.07,0,()=>pt({widthPx:768,heightPx:236,title:`${ne.label} ${Dm(ne.min,ne.max)}`,subtitle:`→ ${i.label}`,titleSize:56}),`selfsign:${ne.label}`),c.push({kind:"door-self",areaId:i.id,elementId:ne.elementId,label:ne.label,targetIds:[i.id],triggerPos:l.local(ce,0,-h+.5),radius:.7,halfX:.55,halfZ:.45,auto:!0})}),!V){for(const ne of[-1,1]){const Ee=ne*.44;l.box(.85,F.DOOR_H,.08,de.door,Ee,F.DOOR_H/2,-h+.06,{}),l.steelSpec({w:.7,h:.05,d:.05,x:Ee,y:1.05,z:-h+.13}),l.steelSpec({w:.7,h:.22,d:.02,x:Ee,y:.13,z:-h+.11})}l.steelSpec({w:.04,h:F.DOOR_H,d:.03,x:0,y:F.DOOR_H/2,z:-h+.11}),l.sign(1.1,.34,0,F.DOOR_H+.35,-h+.07,0,()=>pt({widthPx:640,heightPx:198,title:"FIRE EXIT",subtitle:"emergency use only",background:tl,titleSize:78,align:"center"}),`fire:${i.label}`)}const Ae=i.supers.length>0||i.subs.length>0;let _e,He,Be;const K=[],te=[];{const ne=Lo(i,n),Ee=ne.length?Math.max(...ne.map(ce=>ce.level)):0;for(let ce=Ee;ce>=1;ce--)for(const Oe of ne.filter(I=>I.level===ce)){const I=n.get(Oe.id);K.push({text:`▲${ce} ${I?.label??"?"}`,chip:Xn(I?.wing??"")}),te.push(Oe.id)}K.push({text:`● ${i.label}`,strong:!0,chip:u}),te.push(null);for(const ce of i.subs){const Oe=n.get(ce);K.push({text:`▼1 ${Oe?.label??"?"}`,chip:Xn(Oe?.wing??"")}),te.push(ce)}K.push({text:"⌂ Reception"}),te.push(rn)}const oe={widthPx:850,heightPx:750,title:Ae?"Lift":"Exit",subtitle:i.label,rows:K,rowSize:K.length>10?30:38,columns:K.length>10?2:1},ve=(()=>{const ne=Co(oe,K.length);return K.flatMap((Ee,ce)=>ne[ce]&&te[ce]?[{rect:ne[ce],id:te[ce],label:Ee.text.replace(/^[▲▼●⌂]\S* ?/u,"")}]:[])})();let pe;Ae&&(l.box(.08,2.4,5.15-4.85,de.liftDoor,2+.04,2.4/2,(4.85+5.15)/2),l.box(.08,2.4,6.45-6.15,de.liftDoor,2+.04,2.4/2,(6.15+6.45)/2),l.box(.08,2.4-F.DOOR_H,1,de.liftDoor,2+.04,(2.4+F.DOOR_H)/2,5.65,{}),l.box(3.42-2,2.4,.08,de.liftDoor,2.71,2.4/2,4.85+.04),l.box(3.42-2,2.4,.08,de.liftDoor,2.71,2.4/2,6.45-.04),l.box(3.42-2,.06,6.45-4.85,de.liftDoor,2.71,2.4+.03,5.65,{}),l.led(2.71,5.65,2.4-.02,.5,.5),Be={doors:new Pm(s,2+.1,5.65),doorwayPos:l.local(2+.05,0,5.65)},l.steelSpec({w:.06,h:2.12,d:.09,x:2-.01,y:1.06,z:5.12}),l.steelSpec({w:.06,h:2.12,d:.09,x:2-.01,y:1.06,z:6.18}),l.steelSpec({w:.06,h:.09,d:1.15,x:2-.01,y:2.14,z:5.65}),l.steelSpec({w:.16,h:.02,d:1.05,x:2+.02,y:.012,z:5.65}),l.steelSpec({w:.03,h:.26,d:.16,x:2-.015,y:1.12,z:4.99}),l.sign(.1,.2,2-.035,1.12,4.99,-Math.PI/2,()=>pt({widthPx:64,heightPx:128,title:"▲",subtitle:"▼",titleSize:40,align:"center"}),`liftcall:${i.label}`),l.sign(.72,.24,2-.015,2.27,5.65,-Math.PI/2,()=>pt({widthPx:384,heightPx:128,title:"LIFT",subtitle:i.floor?`level −${i.floor}`:"ground",titleSize:56,align:"center"}),`liftind:${i.label}`),l.steelSpec({w:1.24,h:.05,d:.04,x:2.71+.04,y:.92,z:4.85+.13}),l.steelSpec({w:1.24,h:.05,d:.04,x:2.71+.04,y:.92,z:6.45-.13}),l.steelSpec({w:.04,h:.05,d:1.44,x:3.42-.13,y:.92,z:5.65}),l.sign(.42,.15,2.71+.35,2.02,4.85+.09,0,()=>pt({widthPx:336,heightPx:120,title:"MAX 8 PERSONS · 610 kg",titleSize:30,align:"center",background:"#e8e9e4",color:"#3a4046"}),`liftload:${i.label}`),l.sign(.4,.14,2.71-.2,1.78,6.45-.09,Math.PI,()=>pt({widthPx:320,heightPx:112,title:"NO SMOKING",titleSize:40,align:"center",background:"#f4f4f1",color:"#b3261e"}),`liftsmoke:${i.label}`),pe=l.sign(.95,1.05,2.71-.08,1.3,4.85+.09,0,()=>nr(oe),`liftcab:${i.label}`),_e=l.local(2.71,0,5.65),He=Math.PI/2+a,c.push({kind:"lift",areaId:i.id,label:"Lift",targetIds:[],triggerPos:_e.clone(),radius:.75,auto:!1,prompt:"E — Lift: select destination"}));const We=l.sign(1.7,1.5,x/2-.09,1.7,3.1,-Math.PI/2,()=>nr(oe),`liftboard:${i.label}`);let st;if(Ae&&(st=[{kind:"lift",mesh:We,cells:ve}],pe&&st.push({kind:"lift",mesh:pe,cells:ve})),i.supers.slice(1).forEach((ne,Ee)=>{const ce=n.get(ne),Oe=6.35-Ee*1.15;l.box(.1,F.DOOR_H,1,de.door,-3.5+.06,F.DOOR_H/2,Oe,{}),l.doorFurniture("x+",-3.5+.06,0,Oe),l.sign(1.35,.42,-3.5+.1,F.DOOR_H+.4,Oe,Math.PI/2,()=>pt({widthPx:768,heightPx:240,title:`Stairs ↑ ${ce?.label??"?"}`,subtitle:`${ce?.wing??"?"} wing`,titleSize:56}),`upportal:${ce?.label}`),c.push({kind:"stair-up",areaId:i.id,label:`Stairs ↑ ${ce?.label??"?"}`,targetIds:[ne],triggerPos:l.local(-3.5+.5,0,Oe),radius:.7,halfX:.45,halfZ:.55,auto:!0})}),m?Nm(i,l,c,e):i.subs.length&&i.subs.forEach((ne,Ee)=>{const ce=n.get(ne),Oe=4.6-Ee*1.15;l.box(.1,F.DOOR_H,1,de.door,-3.5+.06,F.DOOR_H/2,Oe,{}),l.doorFurniture("x+",-3.5+.06,0,Oe),l.sign(1.35,.42,-3.5+.1,F.DOOR_H+.4,Oe,Math.PI/2,()=>pt({widthPx:768,heightPx:240,title:`↓ ${ce?.label??"?"}`,subtitle:`homed in ${ce?.wing??"?"} wing`,titleSize:56}),`downportal:${ce?.label}`),c.push({kind:"stair-down",areaId:i.id,label:`Stairs ↓ ${ce?.label??"?"}`,targetIds:[ne],triggerPos:l.local(-3.5+.5,0,Oe),radius:.7,halfX:.45,halfZ:.55,auto:!0})}),i.subs.length){const ne=i.subs.map(Ee=>n.get(Ee)?.label??"?");l.sign(1.9,.85,-3.5+.09,2.45,3.3,Math.PI/2,()=>nr({widthPx:900,heightPx:400,title:"Stairs ↓",rows:ne.map(Ee=>({text:Ee})),rowSize:ne.length>6?34:44,columns:ne.length>8?2:1}),`stairsdown:${i.label}`)}const qe=[new Et().setFromPoints([l.local(-x/2-.3,-.5,-.2),l.local(x/2+.3,2.5,v+.2)]),new Et().setFromPoints([l.local(-f/2-.4,-.5,-h-.5),l.local(f/2+.4,2.5,0)])];if(m){const ne=o?-1:1;qe.push(new Et().setFromPoints([l.local(F.PIT_X0-.2,-4-.5,F.PIT_Z0-.2),l.local(F.PIT_X1+.2,2.5,v+.2)]),new Et().setFromPoints([new B(m.x0-.3,t.y-F.STOREY-.5,t.z+ne*5.4),new B(m.x1+.3,t.y-F.STOREY+2.5,t.z+ne*(F.LANDING_Z1+.3))]))}return l.populate(e.people,i.id.charCodeAt(0)*131+i.id.charCodeAt(4)*17+i.id.charCodeAt(8)>>>0),l.finalize(),{id:i.id,wc:i,label:i.label,group:s,colliders:l.colliders,walkables:l.walkables,interactables:c,spawnPos:l.local(0,0,4.6),spawnYaw:a,liftPos:_e,liftYaw:He,lift:Be,boards:st,notices:D,boxes:qe}}function Nm(i,e,t,n){const{byId:r,layout:s}=n,o=s.landings[i.id],a=e.origin,l=F.STOREY,c=F.PIT_X1-F.PIT_X0,u=c/2-.1,h=F.PIT_X0+u/2,f=F.PIT_X1-u/2,p=.8,x=F.PIT_Z1-F.PIT_Z0-p,v=12,m=x/v;for(let k=0;k<v;k++){const Q=-((k+1)*(l/2))/v;e.box(u,.09,m+.02,de.stair,h,Q-.045,F.PIT_Z1-(k+.5)*m,{walkable:!0})}e.box(c,.1,p,de.stair,(F.PIT_X0+F.PIT_X1)/2,-l/2-.05,F.PIT_Z0+p/2,{walkable:!0});for(let k=0;k<v;k++){const Q=-l/2-(k+1)*(l/2)/v;e.box(u,.09,m+.02,de.stair,f,Q-.045,F.PIT_Z0+p+(k+.5)*m,{walkable:!0})}e.box(c,.1,F.LOBBY_D-F.PIT_Z1+.1,de.floor,(F.PIT_X0+F.PIT_X1)/2,-l-.05,(F.PIT_Z1+F.LOBBY_D)/2,{walkable:!0,vinyl:!0});const d=l+F.ROOM_H;e.box(.1,d,F.LOBBY_D-F.PIT_Z0,de.wall,F.PIT_X0-.05,-l+d/2-F.ROOM_H,(F.PIT_Z0+F.LOBBY_D)/2),e.box(.1,l,F.PIT_Z1-F.PIT_Z0,de.wall,F.PIT_X1+.05,-l/2,(F.PIT_Z0+F.PIT_Z1)/2),e.box(.1,l,F.LOBBY_D-F.PIT_Z1,de.wall,F.PIT_X1+.05,-l/2,(F.PIT_Z1+F.LOBBY_D)/2),e.box(c+.2,l,.1,de.wall,(F.PIT_X0+F.PIT_X1)/2,-l/2,F.PIT_Z0-.05);const w=tr.railCentre,T=(k,Q,q,ie,Ae)=>{const _e=Math.abs(q-k)>Math.abs(ie-Q),He=_e?q-k:ie-Q;e.oakSpec({w:_e?He:.06,h:.06,d:_e?.06:He,x:(k+q)/2,y:Ae+w,z:(Q+ie)/2});for(let Be=.15;Be<He;Be+=.3)e.oakSpec({w:.035,h:w-.03,d:.035,x:_e?k+Be:k,y:Ae+(w-.03)/2,z:_e?Q:Q+Be});e.colliders.push(new Et().setFromPoints([e.local(Math.min(k,q)-.05,Ae,Math.min(Q,ie)-.05),e.local(Math.max(k,q)+.05,Ae+w+.05,Math.max(Q,ie)+.05)]))};T(F.PIT_X1+.04,F.PIT_Z0,F.PIT_X1+.04,F.PIT_Z1,0),T(F.PIT_X0,F.PIT_Z0-.04,F.PIT_X1,F.PIT_Z0-.04,0),T(F.PIT_X1-u-.2,F.PIT_Z1+.04,F.PIT_X1,F.PIT_Z1+.04,0);{const k=(F.PIT_X0+F.PIT_X1)/2,Q=Math.atan2(l/2,x),q=Math.hypot(x,l/2)+.15,ie=F.PIT_Z1,Ae=F.PIT_Z0+p,_e=(ie+Ae)/2,He=te=>w-l/2*((ie-te)/x),Be=(te,oe,ve)=>e.oakSpec({w:.07,h:.07,d:q,x:te,y:oe,z:_e,rx:ve});Be(k,w-l/4,-Q),Be(k,w-3*l/4,Q),Be(F.PIT_X0+.08,w-l/4,-Q),Be(F.PIT_X1-.08,w-3*l/4,Q);const K=te=>w-l+l/2*((ie-te)/x);for(let te=Ae+.15;te<ie;te+=.3)for(const oe of[He(te),K(te)])e.oakSpec({w:.035,h:w-.06,d:.035,x:k,y:oe-.03-(w-.06)/2,z:te});e.colliders.push(new Et().setFromPoints([e.local(k-.06,-l,F.PIT_Z0+.8),e.local(k+.06,1,F.PIT_Z1)]))}const A=s.areas[i.id].flip?-1:1,C=k=>A*(k-a.x),R=-l,[P,V]=[C(o.x0),C(o.x1)].sort((k,Q)=>k-Q),M=V-P,g=(P+V)/2,E=(F.LANDING_Z0+F.LANDING_Z1)/2;e.box(M,.1,3,de.floor,g,R-.05,E,{walkable:!0,vinyl:!0}),e.box(M,.1,3,de.ceiling,g,R+F.ROOM_H+.05,E,{worldUV:!0}),e.box(.15,F.ROOM_H,3.3,de.wall,P-.075,R+F.ROOM_H/2,E,{solid:!0,trim:["x+"]}),e.box(.15,F.ROOM_H,3.3,de.wall,V+.075,R+F.ROOM_H/2,E,{solid:!0,trim:["x-"]});for(let k=0;k<Math.floor(M/3.5);k++)e.led(P+(k+.5)*3.5,E,R+F.ROOM_H-.02,.35,1.3);const D=k=>{const Q=C(s.areas[k].x);return[Q-F.LOBBY_W/2,Q+F.LOBBY_W/2]},L=(k,Q,q)=>{const ie=[],Ae=[...q].sort((He,Be)=>He[0]-Be[0]);let _e=P;for(const[He,Be]of Ae)He>_e&&(e.box(He-_e,F.ROOM_H,.15,de.wall,(_e+He)/2,R+F.ROOM_H/2,k,{solid:!0,trim:[Q]}),ie.push([_e,He])),_e=Math.max(_e,Be);return V>_e&&(e.box(V-_e,F.ROOM_H,.15,de.wall,(_e+V)/2,R+F.ROOM_H/2,k,{solid:!0,trim:[Q]}),ie.push([_e,V])),ie},O=o.northIds.map(D),Y=L(F.LANDING_Z0-.075,"z+",[[F.PIT_X0,F.PIT_X1],...o.southIds.map(D)]);L(F.LANDING_Z1+.075,"z-",O);for(const[k,Q]of Y)if(!(Q-k<4.5))for(let q=k+2.3;q<=Q-2.3;q+=6.5){const ie=(Math.round(q*13)+i.id.charCodeAt(2)>>>0)%997;Dn(e,n.art.length?n.art[ie%n.art.length]:null,ie,q,R+1.7,F.LANDING_Z0+.01,0,`${i.label}:land:${Math.round(q)}`)}e.sign(2.4,.6,(F.PIT_X0+F.PIT_X1)/2,R+F.DOOR_H+.5,F.LANDING_Z1-.09,Math.PI,()=>pt({widthPx:1024,heightPx:256,title:`Stairs ↑ ${i.label}`,subtitle:`${i.wing} wing · ${i.floor?`level −${i.floor}`:"ground"}`,titleSize:72}),`landingup:${i.label}`);let $=F.PIT_X1+1.6;const G=k=>{for(const[Q,q]of O)if(k>Q-.85&&k<q+.85)return q+.95;return k};o.portalChildIds.forEach(k=>{const Q=r.get(k);let q=G($);for(;q!==$;)$=q,q=G($);$=Math.min($,V-1),q=$,$+=2,e.box(.08,F.DOOR_H,F.DOOR_W,de.door,q,R+F.DOOR_H/2,F.LANDING_Z1-.05,{}),e.doorFurniture("z-",q,R,F.LANDING_Z1-.05),e.sign(1.5,.45,q,R+F.DOOR_H+.45,F.LANDING_Z1-.09,Math.PI,()=>pt({widthPx:768,heightPx:230,title:`↓ ${Q?.label??"?"}`,subtitle:`homed in ${Q?.wing??"?"} wing`,titleSize:58}),`downportal:${Q?.label}`),t.push({kind:"stair-down",areaId:i.id,label:`Stairs ↓ ${Q?.label??"?"}`,targetIds:[k],triggerPos:e.local(q,-l,F.LANDING_Z1-.5),radius:.7,halfX:.55,halfZ:.45,auto:!0})});for(let k=0;k<3;k++){const Q=V-.8-k*.6;if(Q<$+.8)break;O.some(([q,ie])=>Q>q-.45&&Q<ie+.45)||e.chair(Q,R,F.LANDING_Z1-.45,-1)}}function Dn(i,e,t,n,r,s,o,a){const l=Math.sin(o),c=Math.cos(o),u=Math.abs(l)>.5;i.oakSpec({w:u?.05:1.36,h:1.02,d:u?1.36:.05,x:n-l*.045,y:r,z:s-c*.045}),i.sign(1.28,.94,n,r,s,o,()=>e?Po(`art/${e.file}`):Wl(t),`pic:${a}`),i.sign(.44,.13,n,r-.62,s,o,()=>e?Xr(e.title,`${e.artist} · ${e.licence} · Wikimedia Commons`):Xr("Untitled study","Procedural print — placeholder"),`picplacard:${a}`)}function Lo(i,e){const t=new Map;let n=[i.id],r=0;for(;n.length;){r++;const s=[];for(const o of n)for(const a of e.get(o)?.supers??[])t.has(a)||(t.set(a,r),s.push(a));n=s}return[...t].map(([s,o])=>({id:s,level:o}))}const oi="__theatre";function Fm(i,e,t){const n=new Cn;n.name="area:theatre";const r=new Jr(n,new B(0,0,0),i),s=-24,o=-4,a=20,l=33.5,c=(s+o)/2,u=(a+l)/2,h=4.5,f=5,p=1.7,x=.35,v=-f*x,m=v+.4,d=de.wall.clone(),w=de.ceiling.clone(),T=de.floor.clone(),A=de.led.clone(),C=new Tt({color:2830648}),R=new Tt({color:9264970}),P=new Tt({color:6715727}),V=new Tt({color:13623528,transparent:!0,opacity:.3}),M=[d,w,T,C].map(q=>({m:q,base:q.color.clone()})),g=q=>{for(const ie of M)ie.m.color.copy(ie.base).multiplyScalar(q?1:.3);A.color.set(q?16251391:4212047)},E=-15;r.box(3,.1,5,de.floor,E,-.05,17.5,{walkable:!0,vinyl:!0}),r.box(3,.1,5,de.ceiling,E,3.05,17.5,{worldUV:!0});for(const[q,ie]of[[E-1.575,"x+"],[E+1.575,"x-"]]){r.box(.15,1,5,de.wall,q,.5,17.5,{solid:!0,trim:[ie]}),r.box(.08,1.7,5,V,q,1.85,17.5,{solid:!0}),r.box(.15,.3,5,de.wall,q,2.85,17.5,{});for(const Ae of[16.2,17.5,18.8])r.steelSpec({w:.18,h:1.7,d:.07,x:q,y:1.85,z:Ae})}for(const q of[16.4,18.6])r.led(E,q,2.98);r.sign(2.6,.62,E,2.55,a-.09,Math.PI,()=>pt({widthPx:1152,heightPx:260,title:"Postgraduate Medical Centre",subtitle:"lecture theatre · seminars & presentations",titleSize:74}),"theatre-door");const D=h+2.4,L=h-D/2;r.box(.15,D,l-a,d,s-.075,L,u,{solid:!0}),r.box(.15,D,l-a,d,o+.075,L,u,{solid:!0}),r.box(o-s+.3,D,.15,d,c,L,l+.075,{solid:!0}),r.box(-16-s,h+.2,.15,d,(s+-16)/2,h/2-.1,a-.075,{solid:!0}),r.box(o- -14,h+.2,.15,d,(-14+o)/2,h/2-.1,a-.075,{solid:!0}),r.box(2,h-2.3,.15,d,E,(h+2.3)/2,a-.075,{}),r.box(o-s,.1,l-a,w,c,h+.05,u,{worldUV:!0});for(const q of[s+.11,o-.11])r.box(.06,.8,l-a-3,de.daylight,q,3.7,u,{});r.box(o-s,.1,2,T,c,-.05,a+1,{walkable:!0,vinyl:!0});for(let q=0;q<f;q++){const ie=-x*(q+1),Ae=a+2+p*q;r.box(o-s,.1,p,T,c,ie-.05,Ae+p/2,{walkable:!0,vinyl:!0}),r.box(o-s,x,.06,C,c,ie+x/2,Ae+.03,{})}const O=a+2+p*f;r.box(o-s,.1,1,T,c,v-.05,O+.5,{walkable:!0,vinyl:!0}),r.box(17,.5,1.85,de.oak,c,m-.25,O+1+.925,{walkable:!0});for(let q=0;q<f;q++){const ie=-x*(q+1),Ae=a+2+p*q+.9;for(let _e=-22.8;_e<=-16.45;_e+=.62)r.chair(_e,ie,Ae,1);for(let _e=-13.55;_e<=-5.2;_e+=.62)r.chair(_e,ie,Ae,1)}const Y=l-.075;r.box(6.7,4.1,.06,C,c,.85,Y-.035,{});const $=new gn({color:16777215}),G=new Pt(new ki(6,3.375),$);G.position.set(c,.84,Y-.075),G.rotation.y=Math.PI,G.matrixAutoUpdate=!1,G.updateMatrix(),n.add(G),r.sign(5,.7,c,3.35,Y-.08,Math.PI,()=>pt({widthPx:1600,heightPx:224,title:"Postgraduate Medical Centre",subtitle:"slides: ← → · PageUp/PageDown (clickers work) · or tap the screen",titleSize:76}),"proscenium"),r.box(.42,1.05,.42,de.oak,-17.5,m+.525,O+1.7,{solid:!0}),r.oakSpec({w:.62,h:.05,d:.5,x:-17.5,y:m+1.08,z:O+1.7}),r.steelSpec({w:.05,h:.3,d:.05,x:-17.28,y:m+1.25,z:O+1.62}),r.sign(1.7,.5,E,2.65,a+.085,0,()=>pt({widthPx:900,heightPx:240,title:"→ Reception",subtitle:"B returns to your last stop",titleSize:66}),"theatre-exit");const k=q=>e.length?e[q%e.length]:null;Dn(r,k(5),5,-19.5,1.7,a+.085,0,"theatre:r1"),Dn(r,k(11),11,-10.5,1.7,a+.085,0,"theatre:r2");for(const q of[-20,c,-8])for(const ie of[21.5,24.5,27.5,30.5])r.box(.6,.035,1.3,A,q,h-.02,ie,{});r.box(.12,7,l-a+.3,R,s-.21,1,u,{}),r.box(.12,7,l-a+.3,R,o+.21,1,u,{}),r.box(o-s+.7,7,.12,R,c,1,l+.21,{}),r.box(-16.6-(s-.35),7,.12,R,(s-.35+-16.6)/2,1,a-.21,{}),r.box(o+.35- -13.4,7,.12,R,(-13.4+o+.35)/2,1,a-.21,{}),r.box(3.2,1.3,.12,R,E,3.85,a-.21,{}),r.box(o-s+.9,.18,l-a+.9,R,c,h+.24,u,{});const Q=(q,ie,Ae,_e)=>r.box(ie-q,.06,_e-Ae,P,(q+ie)/2,-.09,(Ae+_e)/2,{});return Q(-30,s-.35,15.2,38),Q(o+.35,2,15.2,38),Q(s-.35,-16.7,15.2,a-.3),Q(-13.3,o+.35,15.2,a-.3),Q(s-.35,o+.35,l+.35,38),t!=="off"&&r.stand(-17.5,m,O+2.15,Math.PI,4271),r.populate(t,6101),r.finalize(),g(!0),{id:oi,wc:null,label:"Postgraduate Medical Centre",group:n,colliders:r.colliders,walkables:r.walkables,interactables:[],boards:[{kind:"screen",mesh:G,cells:[{rect:[0,0,.35,1],id:"prev",label:"previous slide"},{rect:[.35,0,1,1],id:"next",label:"next slide"}]}],spawnPos:new B(E,0,a+1.2),spawnYaw:Math.PI,boxes:[new Et(new B(s-.3,-2.5,a-.3),new B(o+.3,h+.3,l+.3)),new Et(new B(E-1.7,-.5,15),new B(E+1.7,3.2,a))],screen:G,setHouseLights:g,lecternPos:new B(-16.6,m,O+1.9),lecternYaw:0}}function Om(i,e,t,n){const r=new Cn;r.name="area:atrium";const s=new Jr(r,new B(0,0,0),e),o=-26,a=0,l=3,c=15,u=F.STREET_H,h=(o+a)/2,f=(l+c)/2;s.box(a-o,.1,c-l,de.floor,h,-.05,f,{walkable:!0,vinyl:!0}),s.box(a-o,.1,c-l,de.ceiling,h,u+.05,f,{worldUV:!0}),s.box(a-o+.3,1,.15,de.wall,h,.5,l-.075,{solid:!0,trim:["z+"]}),s.box(a-o+.3,1.7,.08,de.daylight,h,1.85,l-.075,{solid:!0}),s.box(a-o+.3,u-2.7,.15,de.wall,h,(u+2.7)/2,l-.075,{});for(let R=o+2;R<a-.5;R+=2)s.steelSpec({w:.07,h:1.7,d:.18,x:R,y:1.85,z:l-.075});s.box(-16-o+.3,u,.15,de.wall,(o-.15+-16)/2,u/2,c+.075,{solid:!0,trim:["z-"]}),s.box(a- -14+.3,u,.15,de.wall,(-14+a+.15)/2,u/2,c+.075,{solid:!0,trim:["z-"]}),s.box(2,u-2.3,.15,de.wall,-15,(u+2.3)/2,c+.075,{}),s.box(.15,u,c-l,de.wall,o-.075,u/2,f,{solid:!0,trim:["x+"]}),s.box(.15,u,F.STREET_Z0-l,de.wall,a+.075,u/2,(l+F.STREET_Z0)/2,{solid:!0,trim:["x-"]}),s.box(.15,u,c-F.STREET_Z1,de.wall,a+.075,u/2,(F.STREET_Z1+c)/2,{solid:!0,trim:["x-"]});for(let R=o+3;R<a-1;R+=4.5)for(const P of[5.2,9,12.8])s.led(R,P,u-.02);s.box(1.1,1.1,5.2,de.oak,o+4.5,.55,f),s.box(4.2,.46,.55,de.oak,-10,.23,4.4),s.box(4.2,.5,.09,de.oak,-10,.7,4.4-.24);for(let R=0;R<5;R++)s.chair(-5.8+R*.62,0,14.35,-1);for(let R=0;R<3;R++)s.chair(-17.9+R*.62,0,14.35,-1);const p=R=>t.length?t[R%t.length]:null;Dn(s,p(3),3,o+.09,1.8,4.6,Math.PI/2,"atrium:w1"),Dn(s,p(9),9,o+.09,1.8,13.4,Math.PI/2,"atrium:w2"),Dn(s,p(6),6,-3.4,1.8,c-.09,Math.PI,"atrium:n1"),s.sign(7,1.5,o+.09,2.6,f,Math.PI/2,()=>pt({widthPx:1792,heightPx:384,title:"ContSys Hospital",subtitle:`${i.meta.label} · ${i.classes.length} concepts · welcome — walk the model`,titleSize:150,align:"center"}),"title"),s.sign(3.2,.7,a-.09,F.ROOM_H+.55,(F.STREET_Z0+F.STREET_Z1)/2,-Math.PI/2,()=>pt({widthPx:1280,heightPx:280,title:"Hospital Street →",subtitle:"all wings · concepts A–Z on the directory",titleSize:88}),"to-street"),s.sign(2.6,.6,-15,2.62,c-.09,Math.PI,()=>pt({widthPx:1152,heightPx:252,title:"Postgraduate Medical Centre →",subtitle:"lecture theatre · seminars & presentations",titleSize:70}),"to-theatre");const x=[...i.wings.map(R=>({text:R.annex?R.label:`${R.label} wing`,sub:`${R.classCount} concepts`,chip:Xn(R.key)})),{text:"Postgraduate Medical Centre",sub:"lecture theatre",chip:"#005eb8"}],v={widthPx:1024,heightPx:724,title:"Hospital directory",subtitle:"wings west to east — tap one to visit its entrance",rows:x,rowSize:40},m=s.sign(3.4,2.4,-20,1.9,c-.09,Math.PI,()=>nr(v),"directory-wings"),d=Co(v,x.length),w={widthPx:2048,heightPx:1152,title:"Concepts A–Z",subtitle:"tap a concept to go there · or press M anywhere for the porter",rows:i.classes.map(R=>({text:R.label,sub:R.roomNumber??void 0,chip:Xn(R.wing)})),rowSize:14,columns:5},T=s.sign(6.4,3.6,-9,1.9,c-.09,Math.PI,()=>nr(w),"directory-az"),A=Co(w,i.classes.length),C=[{kind:"directory",mesh:m,cells:[...i.wings.flatMap((R,P)=>d[P]?[{rect:d[P],id:R.rootIds[0],label:R.annex?R.label:`${R.label} wing`}]:[]),...d[i.wings.length]?[{rect:d[i.wings.length],id:oi,label:"Postgraduate Medical Centre"}]:[]]},{kind:"directory",mesh:T,cells:i.classes.flatMap((R,P)=>A[P]?[{rect:A[P],id:R.id,label:R.label}]:[])}];return n!=="off"&&(s.stand(o+3.7,0,f,Math.PI/2,137),s.sit(-9.4,.02,4.55,1,553),s.sit(-10.6,.02,4.55,1,887)),s.populate(n,9001),s.finalize(),{id:rn,wc:null,label:"Reception",group:r,colliders:s.colliders,walkables:s.walkables,interactables:[],boards:C,spawnPos:new B(-14,0,f),spawnYaw:-Math.PI/2,boxes:[new Et(new B(o-.3,-.5,l-.3),new B(a+.1,2.5,c+.3))]}}const kr="__street";function Bm(i,e,t,n,r){const s=new Cn;s.name="area:street";const o=new Jr(s,new B(0,0,0),t),a=e.loop,l=0,c=a.xEnd,u=c-l,h=(l+c)/2,f=F.STREET_H,p=a.south.z1,x=a.north.z0,v=[a.connectors.west,a.connectors.east],m=new Map(i.classes.map(M=>[M.id,M])),d=new Map(i.wings.map(M=>[M.key,M])),w=new Tt({color:13623528,transparent:!0,opacity:.3}),T=new Tt({color:6715727}),A=M=>{const g=M==="south"?a.south:a.north,E=g.z0,D=g.z1,L=(E+D)/2,O=M==="south"?E-.075:D+.075,Y=M==="south"?D+.075:E-.075,$=M==="south"?"z+":"z-",G=M==="south"?"z-":"z+",k=M==="south"?0:Math.PI;o.box(u,.1,D-E,de.floor,h,-.05,L,{walkable:!0,vinyl:!0}),o.box(u,.1,D-E,de.ceiling,h,f+.05,L,{worldUV:!0});for(let oe=l+2;oe<c-1;oe+=4)o.led(oe,E+1.3,f-.02,.35,1.3),o.led(oe,D-1.3,f-.02,.35,1.3);const Q=[];let q=l;for(const[oe,ve]of v)oe>q&&Q.push([q,oe]),q=Math.max(q,ve);c>q&&Q.push([q,c]);for(const[oe,ve]of Q){const pe=(oe+ve)/2,We=ve-oe;o.box(We,1,.15,de.wall,pe,.5,Y,{solid:!0,trim:[G]}),o.box(We,1.7,.08,w,pe,1.85,Y,{solid:!0}),o.box(We,f-2.7,.15,de.wall,pe,(f+2.7)/2,Y,{});for(let st=oe+2;st<ve-.5;st+=2)o.steelSpec({w:.07,h:1.7,d:.18,x:st,y:1.85,z:Y})}for(const[oe,ve]of v){const pe=(oe+ve)/2;o.box(ve-oe,f-3,.15,de.wall,pe,(f+3)/2,Y,{}),o.sign(2.7,.6,pe,2.62,Y+(M==="south"?-.08:.08),M==="south"?Math.PI:0,()=>pt({widthPx:1152,heightPx:252,title:`Cloister → ${M==="south"?"north":"south"} side`,subtitle:"across the courtyard · shorter way round",titleSize:68}),`cloister:${M}:${Math.round(pe)}`)}const ie=[];for(const oe of e.wings)if(oe.street===M)for(const ve of oe.rootIds)ie.push({x:e.areas[ve].x,id:ve,wingKey:oe.key});ie.sort((oe,ve)=>oe.x-ve.x);const Ae=M==="south"?E+.46:D-.46,_e=M==="south"?1:-1,He=M==="south"?E+.075:D-.075,Be=(oe,ve)=>{const pe=ve-oe,We=(oe+ve)/2;if(pe>=12&&(o.chair(We-.35,0,Ae,_e),o.chair(We+.35,0,Ae,_e)),pe>=9)for(const st of[We-3.2,We+3.2]){const qe=(Math.round(st*7)>>>0)%997,ne=n.length?n[qe%n.length]:null;Dn(o,ne,qe,st,1.78,He,k,`street:${M}:${Math.round(st)}`)}};let K=l;for(const oe of ie){const ve=oe.x-F.LOBBY_W/2,pe=oe.x+F.LOBBY_W/2;ve>K&&(o.box(ve-K,f,.15,de.wall,(K+ve)/2,f/2,O,{solid:!0,trim:[$]}),Be(K,ve)),o.box(F.LOBBY_W,f-F.ROOM_H,.15,de.wall,oe.x,(f+F.ROOM_H)/2,O,{}),K=pe}c>K&&(o.box(c-K,f,.15,de.wall,(K+c)/2,f/2,O,{solid:!0,trim:[$]}),Be(K,c));const te=M==="south"?E+.02:D-.02;ie.forEach(oe=>{const ve=m.get(oe.id),pe=d.get(oe.wingKey);o.sign(3.2,.7,oe.x,F.ROOM_H+.45,te,k,()=>pt({widthPx:1280,heightPx:280,title:pe?.annex?ve?.label??"?":`${pe?.label??"?"} wing`,subtitle:pe?.annex?`${pe.label} · ${ve?.roomNumber?`Room ${ve.roomNumber}`:""}`:`${pe?.classCount??"?"} concepts · enter for ${ve?.label??"?"}`,titleSize:86}),`street:${ve?.label}`)}),o.box(.15,f,D-E+.3,de.wall,c+.075,f/2,L,{solid:!0,trim:["x-"]}),M==="north"&&o.box(.15,f,D-E+.3,de.wall,l-.075,f/2,L,{solid:!0,trim:["x+"]}),o.sign(3.4,.8,l+.4,2.7,L,-Math.PI/2,()=>pt({widthPx:1280,heightPx:300,title:"Hospital Street",subtitle:`${M} side · wings this way →`,titleSize:96}),`street-name:${M}`)};A("south"),A("north");const[C]=a.connectors.west,R=e.wings.filter(M=>M.street==="south").length;let P=0,V=0;for(const M of e.wings){const g=new gn({color:new Ze(Xn(M.key))}),E=e.areas[M.rootIds[0]].x;if(M.street==="south"){const D=a.south.z0+.4+P*.24;P++,o.box(E-l,.012,.16,g,(l+E)/2,.012,D,{}),o.box(.16,.012,D-a.south.z0,g,E,.012,(a.south.z0+D)/2,{})}else{const D=C+.55+V*.62,L=a.south.z0+.4+(R+V)*.24,O=a.north.z1-.4-V*.24;V++,o.box(D-l,.012,.16,g,(l+D)/2,.012,L,{}),o.box(.16,.012,O-L,g,D,.012,(L+O)/2,{}),o.box(E-D,.012,.16,g,(D+E)/2,.012,O,{}),o.box(.16,.012,a.north.z1-O,g,E,.012,(O+a.north.z1)/2,{})}}for(const[M,g]of v){const E=(M+g)/2,D=x-p,L=(p+x)/2;o.box(g-M,.1,D,de.floor,E,-.05,L,{walkable:!0,vinyl:!0}),o.box(g-M,.1,D,de.ceiling,E,f+.05,L,{worldUV:!0});for(const O of[M-.075,g+.075]){o.box(.15,1,D,de.wall,O,.5,L,{solid:!0,trim:[O<E?"x+":"x-"]}),o.box(.08,1.7,D,w,O,1.85,L,{solid:!0}),o.box(.15,f-2.7,D,de.wall,O,(f+2.7)/2,L,{});for(let Y=p+2;Y<x-.5;Y+=2)o.steelSpec({w:.18,h:1.7,d:.07,x:O,y:1.85,z:Y})}for(let O=p+2;O<x-1;O+=4)o.led(E,O,f-.02,.35,1.3)}return o.box(c-2,.06,x-p-.4,T,(2+c)/2,-.09,(p+x)/2,{}),x-.2>38&&o.box(32,.06,x-.2-38,T,-14,-.09,(38+x-.2)/2,{}),o.populate(r,4211),o.finalize(),{id:kr,wc:null,label:"Hospital Street",group:s,colliders:o.colliders,walkables:o.walkables,interactables:[],spawnPos:new B(l+3,0,(a.south.z0+a.south.z1)/2),spawnYaw:-Math.PI/2,boxes:[new Et(new B(l-.3,-.5,a.south.z0-.2),new B(c+.3,2.5,a.south.z1+.3)),new Et(new B(l-.3,-.5,a.north.z0-.3),new B(c+.3,2.5,a.north.z1+.2)),...v.map(([M,g])=>new Et(new B(M-.2,-.5,p),new B(g+.2,2.5,x)))]}}const fn=1920,Pi=1080;function zm(i,e,t,n){i.fillStyle=Gi,i.fillRect(0,0,fn,Pi),i.fillStyle="#ffffff",i.textAlign="center",i.font="bold 118px Arial",i.fillText(e,fn/2,470),i.font="54px Arial",i.globalAlpha=.92,i.fillText(t,fn/2,580),i.font="34px Arial",i.globalAlpha=.7,i.fillText(n,fn/2,990),i.globalAlpha=1}function al(i,e,t){i.fillStyle="#f4f6f7",i.fillRect(0,0,fn,Pi),i.fillStyle=Gi,i.fillRect(0,0,fn,190),i.fillStyle="#ffffff",i.textAlign="left",i.font="bold 78px Arial",i.fillText(e,110,128),i.fillStyle="#16212a",i.font="46px Arial",t.forEach((n,r)=>i.fillText(n,110,330+r*105))}function km(){return[{kind:"builtin",draw:i=>zm(i,"Postgraduate Medical Centre","Lecture Theatre · ContSys Hospital","a walkable model of the continuity-of-care concept system")},{kind:"builtin",draw:i=>al(i,"Bring your own slides",["1.  Export your deck as PNG or JPG images (1920 × 1080 works best).","2.  Copy them into the site’s  slides/  folder.","3.  List them in order in  slides/manifest.json :",'         ["01.png", "02.png", "03.png"]',"4.  Video clips (.mp4, .webm) can be listed too — they play here.","5.  Redeploy. This screen then presents your deck."])},{kind:"builtin",draw:i=>al(i,"Presenting & filming",["← →  or  PageUp / PageDown change slides — presenter clickers work.","Tap or click the screen: right side = next, left side = back.","H  hides the whole interface for a clean recording.","L  dims the house lights.","Add  ?start=theatre  to the address to begin at the lectern.","B  returns to your last stop when you’re done."])}]}class Hm{entries=[];index=0;cache=new Map;video=null;videoTex=null;mat;constructor(e){this.mat=e.material}get count(){return this.entries.length}get label(){return`Slide ${this.index+1} / ${this.entries.length}`}async load(){try{const e=await fetch("slides/manifest.json");if(e.ok){const t=await e.json(),n=Array.isArray(t)?t:t?.slides??[];this.entries=n.map(r=>({kind:/\.(mp4|webm|mov)$/i.test(r)?"video":"image",src:`slides/${r}`}))}}catch{}this.entries.length||(this.entries=km()),this.show(0)}next(){this.show(Math.min(this.index+1,this.entries.length-1))}prev(){this.show(Math.max(this.index-1,0))}show(e){if(!this.entries.length)return;this.index=e;const t=this.entries[e];t.kind==="video"?this.mat.map=this.playVideo(t.src):(this.video?.pause(),this.mat.map=this.texture(e),this.entries[e+1]?.kind==="image"&&this.texture(e+1),this.entries[e-1]?.kind==="image"&&this.texture(e-1)),this.mat.needsUpdate=!0}texture(e){const t=this.cache.get(e);if(t)return t;const n=document.createElement("canvas");n.width=fn,n.height=Pi;const r=n.getContext("2d");r.fillStyle="#0d1114",r.fillRect(0,0,fn,Pi);const s=new vn(n);s.colorSpace=mt,s.generateMipmaps=!1,s.minFilter=St;const o=this.entries[e];if(o.kind==="builtin")o.draw(r),s.needsUpdate=!0;else if(o.kind==="image"){const a=new Image;a.onload=()=>{const l=Math.min(fn/a.width,Pi/a.height),c=a.width*l,u=a.height*l;r.drawImage(a,(fn-c)/2,(Pi-u)/2,c,u),s.needsUpdate=!0},a.src=o.src}return this.cache.set(e,s),s}playVideo(e){this.video||(this.video=document.createElement("video"),this.video.playsInline=!0,this.videoTex=new au(this.video),this.videoTex.colorSpace=mt,this.videoTex.generateMipmaps=!1,this.videoTex.minFilter=St);const t=this.video;return t.src.endsWith(e)||(t.src=e),t.currentTime=0,t.muted=!1,t.play().catch(()=>{t.muted=!0,t.play().catch(()=>{})}),this.videoTex}}const wi=new Qt(0,0,0,"YXZ"),Ai=new B,Gm={type:"change"},Vm={type:"lock"},Wm={type:"unlock"},ll=.002,cl=Math.PI/2;class Xm extends Su{constructor(e,t=null){super(e,t),this.isLocked=!1,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.pointerSpeed=1,this._onMouseMove=Ym.bind(this),this._onPointerlockChange=$m.bind(this),this._onPointerlockError=qm.bind(this),this.domElement!==null&&this.connect(this.domElement)}connect(e){super.connect(e),this.domElement.ownerDocument.addEventListener("mousemove",this._onMouseMove),this.domElement.ownerDocument.addEventListener("pointerlockchange",this._onPointerlockChange),this.domElement.ownerDocument.addEventListener("pointerlockerror",this._onPointerlockError)}disconnect(){this.domElement.ownerDocument.removeEventListener("mousemove",this._onMouseMove),this.domElement.ownerDocument.removeEventListener("pointerlockchange",this._onPointerlockChange),this.domElement.ownerDocument.removeEventListener("pointerlockerror",this._onPointerlockError)}dispose(){this.disconnect()}getDirection(e){return e.set(0,0,-1).applyQuaternion(this.object.quaternion)}moveForward(e){if(this.enabled===!1)return;const t=this.object;Ai.setFromMatrixColumn(t.matrix,0),Ai.crossVectors(t.up,Ai),t.position.addScaledVector(Ai,e)}moveRight(e){if(this.enabled===!1)return;const t=this.object;Ai.setFromMatrixColumn(t.matrix,0),t.position.addScaledVector(Ai,e)}lock(e=!1){this.domElement.requestPointerLock({unadjustedMovement:e})}unlock(){this.domElement.ownerDocument.exitPointerLock()}}function Ym(i){if(this.enabled===!1||this.isLocked===!1)return;const e=this.object;wi.setFromQuaternion(e.quaternion),wi.y-=i.movementX*ll*this.pointerSpeed,wi.x-=i.movementY*ll*this.pointerSpeed,wi.x=Math.max(cl-this.maxPolarAngle,Math.min(cl-this.minPolarAngle,wi.x)),e.quaternion.setFromEuler(wi),this.dispatchEvent(Gm)}function $m(){this.domElement.ownerDocument.pointerLockElement===this.domElement?(this.dispatchEvent(Vm),this.isLocked=!0):(this.dispatchEvent(Wm),this.isLocked=!1)}function qm(){console.error("THREE.PointerLockControls: Unable to use Pointer Lock API")}const ei=1.7,Dr=.3,Zm=4.2,Km=8.5,jm=.5,Jm=7;class Qm{camera;controls;keys=new Set;colliders=[];walkables=[];touch={f:0,s:0};constructor(e){this.camera=new jt(70,innerWidth/innerHeight,.05,160),this.camera.position.set(0,ei,0),this.camera.rotation.order="YXZ",this.controls=new Xm(this.camera,e),addEventListener("keydown",t=>this.keys.add(t.code)),addEventListener("keyup",t=>this.keys.delete(t.code)),addEventListener("blur",()=>this.keys.clear())}setTouchMove(e,t){this.touch.f=e,this.touch.s=t}enableDragLook(e){let t=!1,n=0,r=0;e.addEventListener("pointerdown",s=>{this.controls.isLocked||(t=!0,n=s.clientX,r=s.clientY,e.setPointerCapture(s.pointerId))}),e.addEventListener("pointermove",s=>{if(!t||this.controls.isLocked)return;const o=this.camera.rotation;o.y-=(s.clientX-n)*.0042,o.x=Math.max(-1.45,Math.min(1.45,o.x-(s.clientY-r)*.0042)),n=s.clientX,r=s.clientY});for(const s of["pointerup","pointercancel"])e.addEventListener(s,()=>t=!1)}dash(e=12){const t=this.camera.rotation.y,n=-Math.sin(t),r=-Math.cos(t),s=this.camera.position;let o=0;for(let a=0;a<Math.ceil(e/.4);a++){const l=this.feetY,c=s.x+n*.4,u=s.z+r*.4;if(this.collides(c,u,l))break;const h=this.groundAt(c,u,l);if(h===-1/0)break;s.x=c,s.z=u,s.y=h+ei,o+=.4}return o}setColliders(e){this.colliders=e}setWalkables(e){this.walkables=e}get position(){return this.camera.position}get feetY(){return this.camera.position.y-ei}get floorPosition(){return new B(this.camera.position.x,this.feetY,this.camera.position.z)}teleport(e,t){this.camera.position.set(e.x,(e.y??0)+ei,e.z),this.camera.rotation.set(0,t,0)}groundAt(e,t,n){let r=-1/0;for(const s of this.walkables){if(e<s.min.x-.05||e>s.max.x+.05||t<s.min.z-.05||t>s.max.z+.05)continue;const o=s.max.y;o<=n+jm&&o>r&&(r=o)}return r}collides(e,t,n){const r=new Et(new B(e-Dr,n+.25,t-Dr),new B(e+Dr,n+1.75,t+Dr));return this.colliders.some(s=>s.intersectsBox(r))}snapGround(){const e=this.camera.position,t=this.groundAt(e.x,e.z,this.feetY+.01);t>-1/0&&(e.y=t+ei)}update(e){const t=this.camera.position,n=this.feetY,r=Number(this.keys.has("KeyW"))-Number(this.keys.has("KeyS"))+this.touch.f,s=Number(this.keys.has("KeyD"))-Number(this.keys.has("KeyA"))+this.touch.s;if(r||s){const a=Math.min(1,Math.hypot(r,s)),c=(this.keys.has("ShiftLeft")||this.keys.has("ShiftRight")||a>.92?Km:Zm)*a,u=this.camera.rotation.y,h=-Math.sin(u)*r+Math.cos(u)*s,f=-Math.cos(u)*r-Math.sin(u)*s,p=Math.hypot(h,f)||1,x=h/p*c*e,v=f/p*c*e;this.collides(t.x+x,t.z,n)||(t.x+=x),this.collides(t.x,t.z+v,n)||(t.z+=v)}const o=this.groundAt(t.x,t.z,n);o>-1/0&&(o>=n?t.y=o+ei:t.y=Math.max(o,n-Jm*e)+ei)}}let wn=null,$r=!1;const Tn=()=>$r;function e0(){return wn||(wn=document.createElement("div"),wn.id="menu-root",document.body.appendChild(wn),wn)}function t0(){!wn||!$r||($r=!1,wn.replaceChildren(),wn.style.display="none")}function ul(i,e,t,n){const r=e0();r.replaceChildren(),r.style.display="flex",$r=!0;const s=document.createElement("div");s.className="menu-panel";const o=document.createElement("div");o.className="menu-head",o.innerHTML='<div class="menu-title"></div><div class="menu-sub"></div>',o.querySelector(".menu-title").textContent=i,o.querySelector(".menu-sub").textContent=e,s.appendChild(o);let a=null;n.searchable&&(a=document.createElement("input"),a.className="menu-filter",a.placeholder="Type to search…",s.appendChild(a));const l=document.createElement("div");l.className="menu-list",s.appendChild(l);const c=document.createElement("div");c.className="menu-foot",c.textContent="↑↓ choose · Enter go · Esc close",s.appendChild(c),r.appendChild(s);let u=[],h=0;const f=m=>{removeEventListener("keydown",v,!0),t0(),m!==null?n.onPick(m):n.onClose?.()},p=()=>{const m=a?.value.trim().toLowerCase()??"";u=t.filter(d=>!m||`${d.label} ${d.sub??""}`.toLowerCase().includes(m)),h=Math.min(h,Math.max(0,u.length-1)),l.replaceChildren(...u.map((d,w)=>{const T=document.createElement("div");T.className="menu-item"+(d.value===null?" info":"")+(d.strong?" strong":"")+(w===h&&d.value!==null?" active":""),d.chip&&(T.style.borderLeftColor=d.chip);const A=document.createElement("span");if(A.textContent=d.label,T.appendChild(A),d.sub){const C=document.createElement("span");C.className="menu-item-sub",C.textContent=d.sub,T.appendChild(C)}return d.value!==null&&(T.addEventListener("click",()=>f(d.value)),T.addEventListener("mousemove",()=>{h!==w&&(h=w,p())})),T})),l.querySelector(".active")?.scrollIntoView({block:"nearest"})},x=m=>{if(!u.length)return;let d=h;for(let w=0;w<u.length&&(d=(d+m+u.length)%u.length,u[d].value===null);w++);h=d,p()},v=m=>{if(m.code==="Escape")m.preventDefault(),m.stopPropagation(),f(null);else if(m.code==="ArrowDown")m.preventDefault(),x(1);else if(m.code==="ArrowUp")m.preventDefault(),x(-1);else if(m.code==="Enter"){m.preventDefault();const d=u[h];d&&d.value!==null&&f(d.value)}else a&&requestAnimationFrame(p)};addEventListener("keydown",v,!0),a?.addEventListener("input",()=>{h=0,p()}),p(),h=Math.max(0,u.findIndex(m=>m.value!==null)),p(),a?.focus()}const n0=700,i0=document.getElementById("app"),ni=document.getElementById("start"),hl=document.getElementById("fade"),Ds=document.getElementById("toast"),Ri=document.getElementById("prompt"),r0=document.getElementById("area-sign"),s0=document.querySelector("#area-sign .label"),o0=document.querySelector("#area-sign .room");let fl=0;function Ot(i){Ds.textContent=i,Ds.style.opacity="1",clearTimeout(fl),fl=window.setTimeout(()=>Ds.style.opacity="0",2200)}function Ci(){hl.style.opacity="1",setTimeout(()=>hl.style.opacity="0",160)}async function a0(){const i=await fetch("world.json").then(b=>{if(!b.ok)throw new Error(`world.json ${b.status} — run \`npm run world\` first`);return b.json()}),e=new Map(i.classes.map(b=>[b.id,b])),t=new Map(i.classes.map(b=>[b.label,b])),n=new Map(i.wings.map(b=>[b.key,b.annex?b.label:`${b.label} wing`])),r=Lm(i),s=await fetch("art/manifest.json").then(b=>b.ok?b.json():[]).catch(()=>[]),o=await fetch("art/illustrations/manifest.json").then(b=>b.ok?b.json():null).then(b=>b?new Set(b.map(H=>H.slug)):null).catch(()=>null),a=navigator.maxTouchPoints>0&&Math.min(screen.width,screen.height)<=500,l=new URLSearchParams(location.search).get("people"),c=l==="off"||l==="low"||l==="full"?l:a?"low":"full",u=matchMedia("(prefers-reduced-motion: reduce)").matches,h=new nu;h.background=new Ze(6055792),h.fog=a?new Wr(6055792,42,120):new Wr(6055792,55,150),h.add(new du(16777215,12172994,1)),h.add(new _u(16777215,.38));const f=new gu(16777215,.4);f.position.set(3,8,2),h.add(f);let p;try{p=new xm({antialias:!a})}catch{throw new Error("3D graphics (WebGL) could not start in this browser. On iPhone/iPad, Lockdown Mode blocks WebGL — allow this site under Settings → Privacy & Security → Lockdown Mode → Configure Web Browsing, or try another device.")}p.setSize(innerWidth,innerHeight),p.setPixelRatio(Math.min(devicePixelRatio,a?1.5:2)),p.domElement.style.touchAction="none",p.domElement.style.userSelect="none",i0.appendChild(p.domElement);const x=new Sm,v=new Map,m={byId:e,signs:x,layout:r,art:s,illustrations:o,people:c},d=Om(i,x,s,c);v.set(d.id,d);const w=Bm(i,r,x,s,c);v.set(w.id,w);const T=Fm(x,s,c);v.set(T.id,T);const A=new Hm(T.screen);A.load();for(const b of i.classes){const H=r.areas[b.id],X=Um(b,m,new B(H.x,H.y,H.oz));v.set(X.id,X)}for(const b of v.values())h.add(b.group);const C=[...v.values()].flatMap(b=>b.colliders),R=[...v.values()].flatMap(b=>b.walkables),P=[...v.values()].flatMap(b=>b.interactables),V=new Map;for(const b of P)if(b.elementId){const H=V.get(b.elementId)??[];H.push(b),V.set(b.elementId,H)}function M(b){if(b.kind!=="door-self")return V.get(b.elementId)?.find(H=>H!==b)}const g=new Qm(p.domElement);g.setColliders(C),g.setWalkables(R),g.teleport(d.spawnPos,d.spawnYaw),h.add(g.camera),a&&(g.camera.far=130,g.camera.updateProjectionMatrix());const E=[];if(c!=="off"&&!u){const b=ur(20260703),H=(ae,he,Ue)=>{const Ye=new Cm(he,Ue,1+Math.floor(b()*99991));h.add(Ye.group),E.push({w:Ye,owner:ae})},X=c==="full"?7:3;for(let ae=0;ae<X;ae++){const he=4+(r.street.x1-70)*ae/Math.max(1,X-1),Ue=ae%2?r.loop.north.z0+2:9;H(w,new B(he,0,Ue),new B(Math.min(he+55,r.street.x1-4),0,Ue))}if(c==="full"){let ae=0;for(const[Ue,Ye]of Object.entries(r.landings)){if(Ye.x1-Ye.x0<18||ae>=12)continue;const _t=v.get(Ue);if(!_t)continue;const yt=Ye.mirror?r.loop.K-8.5:8.5;H(_t,new B(Ye.x0+1.2,Ye.y,yt),new B(Ye.x1-1.2,Ye.y,yt)),ae++}let he=0;for(const Ue of i.classes){const Ye=r.areas[Ue.id];if(Ye.corridorLen<24||he>=8)continue;const _t=v.get(Ue.id);if(!_t)continue;const yt=Ye.oz+(Ye.flip?.8:-.8),an=Ye.oz+(Ye.flip?Ye.corridorLen-2:-(Ye.corridorLen-2));H(_t,new B(Ye.x,Ye.y,yt),new B(Ye.x,Ye.y,an)),he++}}}const D=a?140:175;function L(){const b=g.position,H=g.floorPosition.y;for(const X of v.values()){let ae=1/0;for(const Ue of X.boxes)ae=Math.min(ae,Ue.distanceToPoint(b));const he=X.wc?r.areas[X.wc.id].y:0;X.group.visible=ae<D&&(Math.abs(he-H)<F.STOREY/2||ae<30)}}L();let O=d;function Y(b){O=b;const H=b.wc;s0.textContent=b.label,o0.textContent=H?[H.roomNumber?`Room ${H.roomNumber}`:null,`${n.get(H.wing)??H.wing} · ${H.floor?`level −${H.floor}`:"ground"}`].filter(Boolean).join(" · "):i.meta.label,r0.style.borderLeft=`8px solid ${H?Xn(H.wing):"#ffffff"}`}Y(d),new URLSearchParams(location.search).get("start")==="theatre"&&(g.teleport(T.lecternPos,T.lecternYaw),Y(T));{const b=new URLSearchParams(location.search).get("concept")?.trim().toLowerCase();if(b){const H=i.classes.find(ae=>ae.label.toLowerCase()===b),X=H&&v.get(H.id);X?(g.teleport(X.spawnPos,X.spawnYaw),Y(X),L()):Ot(`No concept called “${b}” — press M for the porter`)}}let $=!1;function G(b){const H=O.lift;H&&($||(H.doors.target=g.floorPosition.distanceTo(H.doorwayPos)<2.1?1:0),H.doors.update(b))}let k=null;const Q=()=>{if(!k)try{k=new AudioContext}catch{}};addEventListener("pointerdown",Q,{once:!0}),addEventListener("keydown",Q,{once:!0});function q(){if(!k)return;const b=k.currentTime+.05;for(const[H,X]of[[1318.5,0],[1046.5,.14]]){const ae=k.createOscillator(),he=k.createGain();ae.type="sine",ae.frequency.value=H,he.gain.setValueAtTime(1e-4,b+X),he.gain.linearRampToValueAtTime(.045,b+X+.015),he.gain.exponentialRampToValueAtTime(1e-4,b+X+.55),ae.connect(he).connect(k.destination),ae.start(b+X),ae.stop(b+X+.6)}}const ie=b=>(b.max.x-b.min.x)*(b.max.y-b.min.y)*(b.max.z-b.min.z);function Ae(b){let H,X=1/0;for(const ae of v.values())for(const he of ae.boxes)he.containsPoint(b)&&ie(he)<X&&(H=ae,X=ie(he));return H}const _e=navigator.maxTouchPoints>0||"ontouchstart"in window||matchMedia("(pointer: coarse)").matches,He=matchMedia("(pointer: coarse)").matches;if(_e){document.body.classList.add("touch");const b=ni.querySelector(".badge"),H=ni.querySelector("p");b&&(b.textContent=He?"Tap to enter":"Click or tap to enter"),H&&(H.textContent="Left pad or WASD to walk · drag to look · ⏩ jumps ahead · ℹ reads · ⌖ porter · double-click captures the mouse")}ni.addEventListener("pointerup",b=>{_e||b.pointerType==="touch"?ni.style.display="none":g.controls.lock()}),p.domElement.addEventListener("dblclick",()=>g.controls.lock()),g.controls.addEventListener("lock",()=>ni.style.display="none"),g.controls.addEventListener("unlock",()=>{!Tn()&&!Xe&&(ni.style.display="flex")});let Be=0;const K=[];function te(){const b=g.floorPosition;K.push({x:b.x,y:b.y,z:b.z,yaw:g.camera.rotation.y,areaId:O.id}),K.length>60&&K.shift()}function oe(){if(Tn()||Xe||$)return;const b=K.pop();if(!b){Ot("No earlier stop to go back to");return}const H=v.get(b.areaId);g.teleport({x:b.x,y:b.y,z:b.z},b.yaw),H&&Y(H),J=re(g.floorPosition),L(),Ci(),Ot(`Back → ${H?.label??"previous stop"}`),Be=performance.now()}function ve(b,H){const X=v.get(b);X&&(te(),g.teleport(X.spawnPos,X.spawnYaw),Y(X),J=re(g.floorPosition),L(),Ci(),H&&Ot(H),Be=performance.now())}function pe(b,H){b?.lift?($=!0,b.lift.doors.target=0,setTimeout(()=>{$=!1,g.floorPosition.distanceTo(b.lift.doorwayPos)<1.7?We(H):Ot("The lift left without you")},650)):We(H)}function We(b){const H=v.get(b);H&&(H.liftPos?(te(),g.teleport(H.liftPos,H.liftYaw??0),Y(H),J=re(g.floorPosition),L(),Ci(),Ot(`Lift → ${H.label}`),Be=performance.now(),q()):ve(b,`Lift → ${H.label}`))}function st(b){const H=b.targetIds[0],X=v.get(H);if(X){if(te(),b.kind==="door-self")g.teleport(X.spawnPos,X.spawnYaw),Ot(`${b.label} — back where you started (a pig's ear)`);else{const ae=M(b);ae?.exitPos?g.teleport(ae.exitPos,ae.exitYaw??0):g.teleport(X.spawnPos,X.spawnYaw),Ot(`${b.label} → ${X.label}`)}Y(X),J=re(g.floorPosition),L(),Ci(),Be=performance.now()}}const qe=(b,H="")=>{const X=e.get(b);return{label:`${H}${X?.label??b}`,sub:X?[X.roomNumber,`${n.get(X.wing)??X.wing} · ${X.floor?`level −${X.floor}`:"ground"}`].filter(Boolean).join(" · "):void 0,chip:X?Xn(X.wing):void 0,value:b}};function ne(b){const H=e.get(b.areaId),X=g.controls.isLocked;X&&g.controls.unlock();const ae=Ue=>{X&&g.controls.lock(),Ue?.()},he=[];if(H){const Ue=Lo(H,e).sort((Ye,_t)=>_t.level-Ye.level);he.push(...Ue.map(Ye=>qe(Ye.id,`▲${Ye.level}  `))),he.push({label:`●  ${H.label}`,sub:"you are here",strong:!0,value:null}),he.push(...H.subs.map(Ye=>qe(Ye,"▼1  ")))}he.push({label:"⌂  Reception",sub:"ground floor",value:rn}),ul("Lift",H?.label??"",he,{onPick:Ue=>ae(()=>pe(v.get(b.areaId),Ue)),onClose:()=>ae()})}function Ee(){const b=g.controls.isLocked;b&&g.controls.unlock();const H=[...i.classes].sort((X,ae)=>X.label.localeCompare(ae.label)).map(X=>qe(X.id));H.unshift({label:"⌂  Reception",sub:"the atrium",value:rn},{label:"▤  Postgraduate Medical Centre",sub:"lecture theatre",value:oi}),ul("Porter service","where would you like to go?",H,{searchable:!0,onPick:X=>{b&&g.controls.lock(),ve(X,`Porter → ${v.get(X)?.label}`)},onClose:()=>{b&&g.controls.lock()}})}const ce=document.getElementById("reader"),Oe=ce.querySelector("h2"),I=ce.querySelector("header .meta"),et=ce.querySelector(".reader-body");let Xe=!1,ot=!1;const me=b=>b.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");function y(){Xe=!1,ce.style.display="none",ot&&g.controls.lock()}function _(){const b=O.wc;Oe.textContent=O.label,I.textContent=b?[b.roomNumber?`Room ${b.roomNumber}`:null,`${n.get(b.wing)??b.wing}`,b.floor?`level −${b.floor}`:"ground"].filter(Boolean).join(" · "):i.meta.label;let H="";if(!b)H=O.id===rn?`<p>Reception for the ContSys Hospital — a walkable model of ${me(i.meta.label)}. The hospital street runs east; every wing's entrance opens off it. The Postgraduate Medical Centre (lecture theatre) is through the north door. Press M (or ⌖) for the porter.</p>`:O.id===oi?`<p>The Postgraduate Medical Centre: a raked lecture theatre for seminars and video presentations.</p>
               <h3>Presenting</h3>
               ...
               <h3>Your own deck</h3>
               <p>Export slides as PNG/JPG (1920×1080), copy them into <code>slides/</code>, and list them in <code>slides/manifest.json</code> — video clips (.mp4) can be listed too.</p>`:"<p>The hospital street: a racetrack loop of two parallel streets joined by glazed cloisters across the courtyard — take whichever way round is shorter. Wing entrances open off the outside of each street; the courtyard holds the lawn and the Postgraduate Medical Centre.</p>";else{H+=`<p>${me(b.description??"Definition pending.")}</p>`;const X=[];b.plural&&X.push(`<strong>Plural:</strong> ${me(b.plural)}`),b.alsoKnownAs.length&&X.push(`<strong>Also known as:</strong> ${me(b.alsoKnownAs.join("; "))}`),b.deprecated.length&&X.push(`<strong>Deprecated terms:</strong> ${me(b.deprecated.join("; "))}`),b.termClause&&X.push(`<strong>Clause:</strong> ${me(b.termClause)}`),b.source&&X.push(`<span class="small"><strong>Source:</strong> ${me(b.source)}</span>`),X.length&&(H+=`<p>${X.join("<br>")}</p>`),b.notes.length&&(H+=`<h3>Notes</h3><ol>${b.notes.map(he=>`<li>${me(he.text)}</li>`).join("")}</ol>`),b.examples.length&&(H+=`<h3>Examples</h3><ol>${b.examples.map(he=>`<li>${me(he.text)}</li>`).join("")}</ol>`);const ae=he=>me(e.get(he)?.label??"?");(b.out.length||b.self.length)&&(H+=`<h3>Outbound associations (doors on the right wall)</h3><ul>${[...b.out.map(he=>`<li>${me(Yr(b.label,he.label,e.get(he.targetId)?.label??"?",he))}</li>`),...b.self.map(he=>`<li>${me(he.label)} → ${me(b.label)} (end wall)</li>`)].join("")}</ul>`),b.in.length&&(H+=`<h3>Inbound associations (doors on the left wall)</h3><ul>${b.in.map(he=>`<li>${me(Yr(e.get(he.sourceId)?.label??"?",he.label,b.label,he))}</li>`).join("")}</ul>`),b.supers.length&&(H+=`<h3>Generalisations (stairs up)</h3><ul>${b.supers.map(he=>`<li>${ae(he)}</li>`).join("")}</ul>`),b.subs.length&&(H+=`<h3>Specialisations (stairs down)</h3><ul>${b.subs.map(he=>`<li>${ae(he)}</li>`).join("")}</ul>`)}et.innerHTML=H,ot=g.controls.isLocked,ot&&g.controls.unlock(),ce.style.display="flex",Xe=!0}ce.addEventListener("click",b=>{b.target===ce&&y()});let N=null;function ee(){Tn()||Xe||N?.kind==="lift"&&ne(N)}function re(b){const H=new Set;for(const X of O.interactables){if(Math.abs(X.triggerPos.y-b.y)>2)continue;const ae=Math.abs(b.x-X.triggerPos.x),he=Math.abs(b.z-X.triggerPos.z);X.halfX!==void 0?ae<=X.halfX&&he<=(X.halfZ??X.halfX)&&H.add(X):ae*ae+he*he<=X.radius*X.radius&&H.add(X)}return H}let J=new Set;function De(){if($){N=null,Ri.style.opacity="0";return}const b=performance.now(),H=re(g.floorPosition);let X=null;for(const ae of H){if(!ae.auto){X=ae;continue}if(!J.has(ae)&&!(b-Be<n0)){ae.kind==="stair-up"||ae.kind==="stair-down"?ve(ae.targetIds[0],`${ae.label} (portal)`):st(ae);return}}J=H,N=X,Ri.textContent=X?X.prompt??`E — ${X.label}`:"",Ri.style.opacity=X?"1":"0"}const xe=new Mu,Pe=new rt;function Ge(b,H){const X=O.boards;if(!X?.length)return null;g.camera.updateMatrixWorld(),Pe.set(b,H),xe.setFromCamera(Pe,g.camera);for(const ae of X){ae.mesh.updateWorldMatrix(!0,!1);const he=xe.intersectObject(ae.mesh,!1)[0];if(!(!he?.uv||he.distance>(ae.kind==="screen"?16:4.2)))for(const Ue of ae.cells){const[Ye,_t,yt,an]=Ue.rect;if(he.uv.x>=Ye&&he.uv.x<=yt&&he.uv.y>=_t&&he.uv.y<=an)return{...Ue,kind:ae.kind}}}return null}function ue(b,H){if($||Tn()||Xe||performance.now()-Be<400)return!1;const X=Ge(b,H);if(!X)return!1;if(X.kind==="screen")X.id==="next"?A.next():A.prev(),Ot(A.label);else if(X.kind==="lift"){const ae=O;ae.liftPos&&g.floorPosition.distanceTo(ae.liftPos)<1.2?pe(ae,X.id):We(X.id)}else ve(X.id,`→ ${v.get(X.id)?.label??X.label}`);return!0}p.domElement.addEventListener("click",()=>{g.controls.isLocked&&ue(0,0)});let Me=0,Ce=0,Le=0;p.domElement.addEventListener("pointerdown",b=>{Me=b.clientX,Ce=b.clientY,Le=performance.now()}),p.domElement.addEventListener("pointerup",b=>{g.controls.isLocked||Math.hypot(b.clientX-Me,b.clientY-Ce)>8||performance.now()-Le>600||ue(b.clientX/innerWidth*2-1,-(b.clientY/innerHeight)*2+1)}),addEventListener("keydown",b=>{if(Xe){(b.code==="Escape"||b.code==="KeyR")&&y();return}Tn()||(b.code==="KeyE"&&ee(),b.code==="KeyR"&&_(),b.code==="KeyM"&&Ee(),b.code==="KeyB"&&oe(),b.code==="KeyF"&&g.dash(12)>.3&&Ci(),b.code==="KeyH"&&(document.body.classList.toggle("filming")||Ot("Interface restored")),O.id===oi&&((b.code==="ArrowRight"||b.code==="PageDown")&&(b.preventDefault(),A.next(),Ot(A.label)),(b.code==="ArrowLeft"||b.code==="PageUp")&&(b.preventDefault(),A.prev(),Ot(A.label)),b.code==="KeyL"&&(ge=!ge,T.setHouseLights(ge),Ot(ge?"House lights up":"House lights dimmed — L restores"))))});let ge=!0;if(Ri.addEventListener("click",ee),g.enableDragLook(p.domElement),_e){const b=document.getElementById("joy"),H=document.getElementById("joy-knob");let X=null;const ae=()=>{X=null,H.style.transform="",g.setTouchMove(0,0)},he=Ue=>{const Ye=b.getBoundingClientRect();let _t=Ue.clientX-(Ye.left+Ye.width/2),yt=Ue.clientY-(Ye.top+Ye.height/2);if(!Number.isFinite(_t)||!Number.isFinite(yt))return;const an=Math.hypot(_t,yt),Fe=44;an>Fe&&(_t*=Fe/an,yt*=Fe/an),H.style.transform=`translate(${_t}px, ${yt}px)`,g.setTouchMove(-yt/Fe,_t/Fe)};b.addEventListener("pointerdown",Ue=>{Ue.preventDefault(),X=Ue.pointerId,he(Ue);try{b.setPointerCapture(Ue.pointerId)}catch{}}),b.addEventListener("pointermove",Ue=>{Ue.pointerId===X&&(Ue.preventDefault(),he(Ue))}),b.addEventListener("pointerup",ae),b.addEventListener("pointercancel",ae),document.getElementById("btn-read").addEventListener("click",()=>Xe?y():_()),document.getElementById("btn-porter").addEventListener("click",()=>{!Tn()&&!Xe&&Ee()}),document.getElementById("btn-dash").addEventListener("click",()=>{!Tn()&&!Xe&&g.dash(12)>.3&&Ci()}),document.getElementById("btn-back").addEventListener("click",oe)}const Ke=new vu;let U=0;const Se={logic:0,render:0},fe=performance.now();let Te=12,le=0;p.setAnimationLoop(()=>{const b=performance.now(),H=Math.min(Ke.getDelta(),.05);Tn()||g.update(H),G(H);for(const he of E){const Ue=he.owner.group.visible;he.w.group.visible=Ue,Ue&&he.w.update(H)}const X=Ae(g.floorPosition);if(X&&X!==O&&Y(X),De(),g.controls.isLocked&&!$&&!Tn()){const he=Ge(0,0);he&&(Ri.textContent=he.kind==="screen"?`Click — ${he.label}`:`Click — ${he.kind==="lift"?"lift to":"go to"} ${he.label}`,Ri.style.opacity="1")}if(U+=H,U>.4&&(U=0,x.update(g.position,a?40:55,a?100:120,a?5:8),L(),performance.now()-fe>12e3&&E.length)){if(le===0&&Te>26){le=1;for(let he=E.length-1;he>=0;he-=2)h.remove(E[he].w.group),E.splice(he,1);Ot("Trimmed ward activity to keep things smooth")}else if(le===1&&Te>30){le=2;for(const he of E)h.remove(he.w.group);E.length=0,Ot("Paused ward activity for performance")}}const ae=performance.now();p.render(h,g.camera),Se.logic=ae-b,Se.render=performance.now()-ae,Te=Te*.96+(Se.logic+Se.render)*.04}),addEventListener("resize",()=>{g.camera.aspect=innerWidth/innerHeight,g.camera.updateProjectionMatrix(),p.setSize(innerWidth,innerHeight)});function se(){const b={areas:i.classes.length+3,doorOut:i.classes.reduce((Fe,at)=>Fe+at.out.length,0),doorIn:i.classes.reduce((Fe,at)=>Fe+at.in.length,0),doorSelf:i.classes.reduce((Fe,at)=>Fe+at.self.length,0),notices:i.classes.reduce((Fe,at)=>Fe+at.notes.length+at.examples.length,0),stairUpPortals:i.classes.reduce((Fe,at)=>Fe+Math.max(0,at.supers.length-1),0),stairDownPortals:i.classes.reduce((Fe,at)=>Fe+(at.subs.length-(r.homeChildren[at.id]?.length??0)),0),lifts:i.classes.filter(Fe=>Fe.supers.length||Fe.subs.length).length,realStairwells:Object.keys(r.landings).length},H=Fe=>P.filter(at=>at.kind===Fe).length,X={areas:v.size,doorOut:H("door-out"),doorIn:H("door-in"),doorSelf:H("door-self"),notices:[...v.values()].reduce((Fe,at)=>Fe+(at.notices??0),0),stairUpPortals:H("stair-up"),stairDownPortals:H("stair-down"),lifts:H("lift"),realStairwells:Object.keys(r.landings).length},ae=P.filter(Fe=>(Fe.kind==="door-out"||Fe.kind==="door-in")&&!M(Fe)),he=new Map,Ue=(Fe,at)=>{he.has(Fe)||he.set(Fe,new Set),he.get(Fe).add(at)};Ue(rn,kr),Ue(rn,oi),Ue(oi,rn);for(const Fe of r.wings)for(const at of Fe.rootIds)Ue(kr,at),Ue(at,kr);for(const[Fe,at]of Object.entries(r.homeChildren))for(const zt of at)Ue(Fe,zt),Ue(zt,Fe);for(const Fe of P){for(const at of Fe.targetIds)Ue(Fe.areaId,at);if(Fe.kind==="lift"){const at=e.get(Fe.areaId);for(const zt of Lo(at,e))Ue(Fe.areaId,zt.id);for(const zt of at.subs)Ue(Fe.areaId,zt);Ue(Fe.areaId,rn)}}const Ye=new Set([rn]),_t=[rn];for(;_t.length;)for(const Fe of he.get(_t.pop())??[])Ye.has(Fe)||(Ye.add(Fe),_t.push(Fe));const yt=[...v.keys()].filter(Fe=>!Ye.has(Fe)).map(Fe=>v.get(Fe).label);return{pass:X.areas===b.areas&&X.doorOut===b.doorOut&&X.doorIn===b.doorIn&&X.doorSelf===b.doorSelf&&X.notices===b.notices&&X.stairUpPortals===b.stairUpPortals&&X.stairDownPortals===b.stairDownPortals&&X.lifts===b.lifts&&ae.length===0&&yt.length===0,expect:b,built:X,unpaired:ae.length,unreachable:yt,signs:x.count}}window.__hospital={world:i,layout:r,player:g,areas:v,interactables:P,audit:se,openSearch:Ee,perf:()=>({...Se,avg:+Te.toFixed(1),drawCalls:p.info.render.calls,triangles:p.info.render.triangles}),people:()=>({tier:c,walkers:E.length,demoteStage:le}),tickPeople(b=.1,H=1){for(let X=0;X<H;X++)for(const ae of E)ae.w.update(b)},tickDoors(b=.1,H=1){for(let X=0;X<H;X++)G(b);return O.lift?+O.lift.doors.openness.toFixed(2):null},bench(b=30){const H=performance.now();for(let X=0;X<b;X++)p.render(h,g.camera);return{msPerFrame:+((performance.now()-H)/b).toFixed(2),drawCalls:p.info.render.calls,triangles:p.info.render.triangles}},currentArea:()=>O.label,pick:(b,H)=>Ge(b,H),tapPick:(b,H)=>ue(b,H),slides:()=>({label:A.label,total:A.count}),nextSlide:()=>(A.next(),A.label),prevSlide:()=>(A.prev(),A.label),houseLights:b=>T.setHouseLights(b),goto(b){const H=b==="Reception"?d:b==="Hospital Street"?w:b==="Postgraduate Medical Centre"?T:t.get(b)&&v.get(t.get(b).id)||null;return H?(ve(H.id),H.label):`unknown area: ${b}`},walk(b){const H=Math.ceil(Math.abs(b)/.1);for(let ae=0;ae<H;ae++){const he=g.camera.rotation.y,Ue=g.camera.position;Ue.x+=-Math.sin(he)*.1*Math.sign(b),Ue.z+=-Math.cos(he)*.1*Math.sign(b),g.snapGround();const Ye=Ae(g.floorPosition);Ye&&Ye!==O&&Y(Ye),De()}const X=g.camera.position;return{x:+X.x.toFixed(2),y:+(X.y-1.7).toFixed(2),z:+X.z.toFixed(2),area:O.label}}},console.info(`[hospital] built ${v.size} areas, ${P.length} interactables, ${x.count} signs, loop ${Math.round(r.street.x1)}m × 2 + ${r.loop.C}m courtyard`)}a0().catch(i=>{console.error(i);const e=document.createElement("p");e.style.cssText="color:#fff;padding:24px;font-family:Arial",e.textContent=String(i),ni.replaceChildren(e)});
