...
`)}const Mp={[dl]:"Linear",[pl]:"Reinhard",[ml]:"Cineon",[gl]:"ACESFilmic",[xl]:"AgX",[vl]:"Neutral",[_l]:"Custom"};function Sp(i,e){const t=Mp[e];return t===void 0?(Ye("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Lr=new O;function bp(){rt.getLuminanceCoefficients(Lr);const i=Lr.x.toFixed(4),e=Lr.y.toFixed(4),t=Lr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+d);const w=T+m+o,A=T+d+a,C=Wa(r,r.VERTEX_SHADER,w),R=Wa(r,r.FRAGMENT_SHADER,A);r.attachShader(v,C),r.attachShader(v,R),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function P(E){if(i.debug.checkShaderErrors){const D=r.getProgramInfoLog(v)||"",L=r.getShaderInfoLog(C)||"",B=r.getShaderInfoLog(R)||"",X=D.trim(),Z=L.trim(),z=B.trim();let te=!0,$=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(te=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,C,R);else{const V=Ya(r,C,"vertex"),Q=Ya(r,R,"fragment");it("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
}`,nm=[new O(1,0,0),new O(-1,0,0),new O(0,1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1)],im=[new O(0,-1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1),new O(0,-1,0),new O(0,-1,0)],el=new gt,Ki=new O,Ls=new O;function rm(i,e,t){let n=new Yo;const r=new st,s=new st,o=new Mt,a=new hu,l=new fu,c={},u=t.maxTextureSize,h={[Yn]:Vt,[Vt]:Yn,[An]:An},f=new _n({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new st},radius:{value:4}},vertexShader:em,fragmentShader:tm}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const x=new xn;x.setAttribute("position",new Jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Pt(x,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ur;let d=this.type;this.render=function(R,P,G){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;R.type===ec&&(Ye("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),R.type=Ur);const M=i.getRenderTarget(),g=i.getActiveCubeFace(),E=i.getActiveMipmapLevel(),D=i.state;D.setBlending(Pn),D.buffers.depth.getReversed()===!0?D.buffers.color.setClear(0,0,0,0):D.buffers.color.setClear(1,1,1,1),D.buffers.depth.setTest(!0),D.setScissorTest(!1);const L=d!==this.type;L&&P.traverse(function(B){B.material&&(Array.isArray(B.material)?B.material.forEach(X=>X.needsUpdate=!0):B.material.needsUpdate=!0)});for(let B=0,X=R.length;B<X;B++){const Z=R[B],z=Z.shadow;if(z===void 0){Ye("WebGLShadowMap:",Z,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const te=z.getFrameExtents();if(r.multiply(te),s.copy(z.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/te.x),r.x=s.x*te.x,z.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/te.y),r.y=s.y*te.y,z.mapSize.y=s.y)),z.map===null||L===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Ji){if(Z.isPointLight){Ye("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new pn(r.x,r.y,{format:Ni,type:Un,minFilter:St,magFilter:St,generateMipmaps:!1}),z.map.texture.name=Z.name+".shadowMap",z.map.depthTexture=new ar(r.x,r.y,un),z.map.depthTexture.name=Z.name+".shadowMapDepth",z.map.depthTexture.format=Nn,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=It,z.map.depthTexture.magFilter=It}else{Z.isPointLight?(z.map=new Ol(r.x),z.map.depthTexture=new lu(r.x,mn)):(z.map=new pn(r.x,r.y),z.map.depthTexture=new ar(r.x,r.y,mn)),z.map.depthTexture.name=Z.name+".shadowMap",z.map.depthTexture.format=Nn;const V=i.state.buffers.depth.getReversed();this.type===Ur?(z.map.depthTexture.compareFunction=V?Go:Ho,z.map.depthTexture.minFilter=St,z.map.depthTexture.magFilter=St):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=It,z.map.depthTexture.magFilter=It)}z.camera.updateProjectionMatrix()}const $=z.map.isWebGLCubeRenderTarget?6:1;for(let V=0;V<$;V++){if(z.map.isWebGLCubeRenderTarget)i.setRenderTarget(z.map,V),i.clear();else{V===0&&(i.setRenderTarget(z.map),i.clear());const Q=z.getViewport(V);o.set(s.x*Q.x,s.y*Q.y,s.x*Q.z,s.y*Q.w),D.viewport(o)}if(Z.isPointLight){const Q=z.camera,me=z.matrix,ye=Z.distance||Q.far;ye!==Q.far&&(Q.far=ye,Q.updateProjectionMatrix()),Ki.setFromMatrixPosition(Z.matrixWorld),Q.position.copy(Ki),Ls.copy(Q.position),Ls.add(nm[V]),Q.up.copy(im[V]),Q.lookAt(Ls),Q.updateMatrixWorld(),me.makeTranslation(-Ki.x,-Ki.y,-Ki.z),el.multiplyMatrices(Q.projectionMatrix,Q.matrixWorldInverse),z._frustum.setFromProjectionMatrix(el,Q.coordinateSystem,Q.reversedDepth)}else z.updateMatrices(Z);n=z.getFrustum(),A(P,G,z.camera,Z,this.type)}z.isPointLightShadow!==!0&&this.type===Ji&&T(z,G),z.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(M,g,E)};function T(R,P){const G=e.update(v);f.defines.VSM_SAMPLES!==R.blurSamples&&(f.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new pn(r.x,r.y,{format:Ni,type:Un})),f.uniforms.shadow_pass.value=R.map.depthTexture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(P,null,G,f,v,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(P,null,G,p,v,null)}function w(R,P,G,M){let g=null;const E=G.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(E!==void 0)g=E;else if(g=G.isPointLight===!0?l:a,i.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const D=g.uuid,L=P.uuid;let B=c[D];B===void 0&&(B={},c[D]=B);let X=B[L];X===void 0&&(X=g.clone(),B[L]=X,P.addEventListener("dispose",C)),g=X}if(g.visible=P.visible,g.wireframe=P.wireframe,M===Ji?g.side=P.shadowSide!==null?P.shadowSide:P.side:g.side=P.shadowSide!==null?P.shadowSide:h[P.side],g.alphaMap=P.alphaMap,g.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,g.map=P.map,g.clipShadows=P.clipShadows,g.clippingPlanes=P.clippingPlanes,g.clipIntersection=P.clipIntersection,g.displacementMap=P.displacementMap,g.displacementScale=P.displacementScale,g.displacementBias=P.displacementBias,g.wireframeLinewidth=P.wireframeLinewidth,g.linewidth=P.linewidth,G.isPointLight===!0&&g.isMeshDistanceMaterial===!0){const D=i.properties.get(g);D.light=G}return g}function A(R,P,G,M,g){if(R.visible===!1)return;if(R.layers.test(P.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&g===Ji)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,R.matrixWorld);const L=e.update(R),B=R.material;if(Array.isArray(B)){const X=L.groups;for(let Z=0,z=X.length;Z<z;Z++){const te=X[Z],$=B[te.materialIndex];if($&&$.visible){const V=w(R,$,M,g);R.onBeforeShadow(i,R,P,G,L,V,te),i.renderBufferDirect(G,null,L,V,R,te),R.onAfterShadow(i,R,P,G,L,V,te)}}}else if(B.visible){const X=w(R,B,M,g);R.onBeforeShadow(i,R,P,G,L,X,null),i.renderBufferDirect(G,null,L,X,R,null),R.onAfterShadow(i,R,P,G,L,X,null)}}const D=R.children;for(let L=0,B=D.length;L<B;L++)A(D[L],P,G,M,g)}function C(R){R.target.removeEventListener("dispose",C);for(const G in c){const M=c[G],g=R.target.uuid;g in M&&(M[g].dispose(),delete M[g])}}}const sm={[Fs]:Os,[Bs]:Hs,[zs]:Gs,[Di]:ks,[Os]:Fs,[Hs]:Bs,[Gs]:zs,[ks]:Di};function om(i,e){function t(){let U=!1;const Me=new Mt;let fe=null;const Te=new Mt(0,0,0,0);return{setMask:function(le){fe!==le&&!U&&(i.colorMask(le,le,le,le),fe=le)},setLocked:function(le){U=le},setClear:function(le,oe,b,H,Y){Y===!0&&(le*=H,oe*=H,b*=H),Me.set(le,oe,b,H),Te.equals(Me)===!1&&(i.clearColor(le,oe,b,H),Te.copy(Me))},reset:function(){U=!1,fe=null,Te.set(-1,0,0,0)}}}function n(){let U=!1,Me=!1,fe=null,Te=null,le=null;return{setReversed:function(oe){if(Me!==oe){const b=e.get("EXT_clip_control");oe?b.clipControlEXT(b.LOWER_LEFT_EXT,b.ZERO_TO_ONE_EXT):b.clipControlEXT(b.LOWER_LEFT_EXT,b.NEGATIVE_ONE_TO_ONE_EXT),Me=oe;const H=le;le=null,this.setClear(H)}},getReversed:function(){return Me},setTest:function(oe){oe?se(i.DEPTH_TEST):ie(i.DEPTH_TEST)},setMask:function(oe){fe!==oe&&!U&&(i.depthMask(oe),fe=oe)},setFunc:function(oe){if(Me&&(oe=sm[oe]),Te!==oe){switch(oe){case Fs:i.depthFunc(i.NEVER);break;case Os:i.depthFunc(i.ALWAYS);break;case Bs:i.depthFunc(i.LESS);break;case Di:i.depthFunc(i.LEQUAL);break;case zs:i.depthFunc(i.EQUAL);break;case ks:i.depthFunc(i.GEQUAL);break;case Hs:i.depthFunc(i.GREATER);break;case Gs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Te=oe}},setLocked:function(oe){U=oe},setClear:function(oe){le!==oe&&(Me&&(oe=1-oe),i.clearDepth(oe),le=oe)},reset:function(){U=!1,fe=null,Te=null,le=null,Me=!1}}}function r(){let U=!1,Me=null,fe=null,Te=null,le=null,oe=null,b=null,H=null,Y=null;return{setTest:function(ae){U||(ae?se(i.STENCIL_TEST):ie(i.STENCIL_TEST))},setMask:function(ae){Me!==ae&&!U&&(i.stencilMask(ae),Me=ae)},setFunc:function(ae,ue,Ue){(fe!==ae||Te!==ue||le!==Ue)&&(i.stencilFunc(ae,ue,Ue),fe=ae,Te=ue,le=Ue)},setOp:function(ae,ue,Ue){(oe!==ae||b!==ue||H!==Ue)&&(i.stencilOp(ae,ue,Ue),oe=ae,b=ue,H=Ue)},setLocked:function(ae){U=ae},setClear:function(ae){Y!==ae&&(i.clearStencil(ae),Y=ae)},reset:function(){U=!1,Me=null,fe=null,Te=null,le=null,oe=null,b=null,H=null,Y=null}}}const s=new t,o=new n,a=new r,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,p=[],x=null,v=!1,m=null,d=null,T=null,w=null,A=null,C=null,R=null,P=new qe(0,0,0),G=0,M=!1,g=null,E=null,D=null,L=null,B=null;const X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Z=!1,z=0;const te=i.getParameter(i.VERSION);te.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(te)[1]),Z=z>=1):te.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(te)[1]),Z=z>=2);let $=null,V={};const Q=i.getParameter(i.SCISSOR_BOX),me=i.getParameter(i.VIEWPORT),ye=new Mt().fromArray(Q),Ne=new Mt().fromArray(me);function He(U,Me,fe,Te){const le=new Uint8Array(4),oe=i.createTexture();i.bindTexture(U,oe),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let b=0;b<fe;b++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(Me,0,i.RGBA,1,1,Te,0,i.RGBA,i.UNSIGNED_BYTE,le):i.texImage2D(Me+b,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,le);return oe}const q={};q[i.TEXTURE_2D]=He(i.TEXTURE_2D,i.TEXTURE_2D,1),q[i.TEXTURE_CUBE_MAP]=He(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[i.TEXTURE_2D_ARRAY]=He(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),q[i.TEXTURE_3D]=He(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),se(i.DEPTH_TEST),o.setFunc(Di),he(!1),we(na),se(i.CULL_FACE),et(Pn);function se(U){u[U]!==!0&&(i.enable(U),u[U]=!0)}function ie(U){u[U]!==!1&&(i.disable(U),u[U]=!1)}function ge(U,Me){return h[U]!==Me?(i.bindFramebuffer(U,Me),h[U]=Me,U===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=Me),U===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=Me),!0):!1}function pe(U,Me){let fe=p,Te=!1;if(U){fe=f.get(Me),fe===void 0&&(fe=[],f.set(Me,fe));const le=U.textures;if(fe.length!==le.length||fe[0]!==i.COLOR_ATTACHMENT0){for(let oe=0,b=le.length;oe<b;oe++)fe[oe]=i.COLOR_ATTACHMENT0+oe;fe.length=le.length,Te=!0}}else fe[0]!==i.BACK&&(fe[0]=i.BACK,Te=!0);Te&&i.drawBuffers(fe)}function Ve(U){return x!==U?(i.useProgram(U),x=U,!0):!1}const lt={[ii]:i.FUNC_ADD,[nc]:i.FUNC_SUBTRACT,[ic]:i.FUNC_REVERSE_SUBTRACT};lt[rc]=i.MIN,lt[sc]=i.MAX;const $e={[oc]:i.ZERO,[ac]:i.ONE,[lc]:i.SRC_COLOR,[Us]:i.SRC_ALPHA,[pc]:i.SRC_ALPHA_SATURATE,[fc]:i.DST_COLOR,[uc]:i.DST_ALPHA,[cc]:i.ONE_MINUS_SRC_COLOR,[Ns]:i.ONE_MINUS_SRC_ALPHA,[dc]:i.ONE_MINUS_DST_COLOR,[hc]:i.ONE_MINUS_DST_ALPHA,[mc]:i.CONSTANT_COLOR,[gc]:i.ONE_MINUS_CONSTANT_COLOR,[_c]:i.CONSTANT_ALPHA,[xc]:i.ONE_MINUS_CONSTANT_ALPHA};function et(U,Me,fe,Te,le,oe,b,H,Y,ae){if(U===Pn){v===!0&&(ie(i.BLEND),v=!1);return}if(v===!1&&(se(i.BLEND),v=!0),U!==tc){if(U!==m||ae!==M){if((d!==ii||A!==ii)&&(i.blendEquation(i.FUNC_ADD),d=ii,A=ii),ae)switch(U){case Ii:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ia:i.blendFunc(i.ONE,i.ONE);break;case ra:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case sa:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:it("WebGLState: Invalid blending: ",U);break}else switch(U){case Ii:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ia:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case ra:it("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case sa:it("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:it("WebGLState: Invalid blending: ",U);break}T=null,w=null,C=null,R=null,P.set(0,0,0),G=0,m=U,M=ae}return}le=le||Me,oe=oe||fe,b=b||Te,(Me!==d||le!==A)&&(i.blendEquationSeparate(lt[Me],lt[le]),d=Me,A=le),(fe!==T||Te!==w||oe!==C||b!==R)&&(i.blendFuncSeparate($e[fe],$e[Te],$e[oe],$e[b]),T=fe,w=Te,C=oe,R=b),(H.equals(P)===!1||Y!==G)&&(i.blendColor(H.r,H.g,H.b,Y),P.copy(H),G=Y),m=U,M=!1}function ne(U,Me){U.side===An?ie(i.CULL_FACE):se(i.CULL_FACE);let fe=U.side===Vt;Me&&(fe=!fe),he(fe),U.blending===Ii&&U.transparent===!1?et(Pn):et(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),s.setMask(U.colorWrite);const Te=U.stencilWrite;a.setTest(Te),Te&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Je(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?se(i.SAMPLE_ALPHA_TO_COVERAGE):ie(i.SAMPLE_ALPHA_TO_COVERAGE)}function he(U){g!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),g=U)}function we(U){U!==Jl?(se(i.CULL_FACE),U!==E&&(U===na?i.cullFace(i.BACK):U===Ql?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ie(i.CULL_FACE),E=U}function I(U){U!==D&&(Z&&i.lineWidth(U),D=U)}function Je(U,Me,fe){U?(se(i.POLYGON_OFFSET_FILL),(L!==Me||B!==fe)&&(i.polygonOffset(Me,fe),L=Me,B=fe)):ie(i.POLYGON_OFFSET_FILL)}function Be(U){U?se(i.SCISSOR_TEST):ie(i.SCISSOR_TEST)}function tt(U){U===void 0&&(U=i.TEXTURE0+X-1),$!==U&&(i.activeTexture(U),$=U)}function Se(U,Me,fe){fe===void 0&&($===null?fe=i.TEXTURE0+X-1:fe=$);let Te=V[fe];Te===void 0&&(Te={type:void 0,texture:void 0},V[fe]=Te),(Te.type!==U||Te.texture!==Me)&&($!==fe&&(i.activeTexture(fe),$=fe),i.bindTexture(U,Me||q[U]),Te.type=U,Te.texture=Me)}function y(){const U=V[$];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function _(){try{i.compressedTexImage2D(...arguments)}catch(U){it("WebGLState:",U)}}function F(){try{i.compressedTexImage3D(...arguments)}catch(U){it("WebGLState:",U)}}function ee(){try{i.texSubImage2D(...arguments)}catch(U){it("WebGLState:",U)}}function re(){try{i.texSubImage3D(...arguments)}catch(U){it("WebGLState:",U)}}function J(){try{i.compressedTexSubImage2D(...arguments)}catch(U){it("WebGLState:",U)}}function De(){try{i.compressedTexSubImage3D(...arguments)}catch(U){it("WebGLState:",U)}}function xe(){try{i.texStorage2D(...arguments)}catch(U){it("WebGLState:",U)}}function Pe(){try{i.texStorage3D(...arguments)}catch(U){it("WebGLState:",U)}}function Ge(){try{i.texImage2D(...arguments)}catch(U){it("WebGLState:",U)}}function ce(){try{i.texImage3D(...arguments)}catch(U){it("WebGLState:",U)}}function ve(U){ye.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),ye.copy(U))}function Ce(U){Ne.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),Ne.copy(U))}function Le(U,Me){let fe=c.get(Me);fe===void 0&&(fe=new WeakMap,c.set(Me,fe));let Te=fe.get(U);Te===void 0&&(Te=i.getUniformBlockIndex(Me,U.name),fe.set(U,Te))}function _e(U,Me){const Te=c.get(Me).get(U);l.get(Me)!==Te&&(i.uniformBlockBinding(Me,Te,U.__bindingPointIndex),l.set(Me,Te))}function Ze(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},$=null,V={},h={},f=new WeakMap,p=[],x=null,v=!1,m=null,d=null,T=null,w=null,A=null,C=null,R=null,P=new qe(0,0,0),G=0,M=!1,g=null,E=null,D=null,L=null,B=null,ye.set(0,0,i.canvas.width,i.canvas.height),Ne.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:se,disable:ie,bindFramebuffer:ge,drawBuffers:pe,useProgram:Ve,setBlending:et,setMaterial:ne,setFlipSided:he,setCullFace:we,setLineWidth:I,setPolygonOffset:Je,setScissorTest:Be,activeTexture:tt,bindTexture:Se,unbindTexture:y,compressedTexImage2D:_,compressedTexImage3D:F,texImage2D:Ge,texImage3D:ce,updateUBOMapping:Le,uniformBlockBinding:_e,texStorage2D:xe,texStorage3D:Pe,texSubImage2D:ee,texSubImage3D:re,compressedTexSubImage2D:J,compressedTexSubImage3D:De,scissor:ve,viewport:Ce,reset:Ze}}function am(i,e,t,n,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new st,u=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(y,_){return p?new OffscreenCanvas(y,_):Vr("canvas")}function v(y,_,F){let ee=1;const re=Se(y);if((re.width>F||re.height>F)&&(ee=F/Math.max(re.width,re.height)),ee<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const J=Math.floor(ee*re.width),De=Math.floor(ee*re.height);h===void 0&&(h=x(J,De));const xe=_?x(J,De):h;return xe.width=J,xe.height=De,xe.getContext("2d").drawImage(y,0,0,J,De),Ye("WebGLRenderer: Texture has been resized from ("+re.width+"x"+re.height+") to ("+J+"x"+De+")."),xe}else return"data"in y&&Ye("WebGLRenderer: Image in DataTexture is too big ("+re.width+"x"+re.height+")."),y;return y}function m(y){return y.generateMipmaps}function d(y){i.generateMipmap(y)}function T(y){return y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?i.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function w(y,_,F,ee,re=!1){if(y!==null){if(i[y]!==void 0)return i[y];Ye("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let J=_;if(_===i.RED&&(F===i.FLOAT&&(J=i.R32F),F===i.HALF_FLOAT&&(J=i.R16F),F===i.UNSIGNED_BYTE&&(J=i.R8)),_===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(J=i.R8UI),F===i.UNSIGNED_SHORT&&(J=i.R16UI),F===i.UNSIGNED_INT&&(J=i.R32UI),F===i.BYTE&&(J=i.R8I),F===i.SHORT&&(J=i.R16I),F===i.INT&&(J=i.R32I)),_===i.RG&&(F===i.FLOAT&&(J=i.RG32F),F===i.HALF_FLOAT&&(J=i.RG16F),F===i.UNSIGNED_BYTE&&(J=i.RG8)),_===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(J=i.RG8UI),F===i.UNSIGNED_SHORT&&(J=i.RG16UI),F===i.UNSIGNED_INT&&(J=i.RG32UI),F===i.BYTE&&(J=i.RG8I),F===i.SHORT&&(J=i.RG16I),F===i.INT&&(J=i.RG32I)),_===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(J=i.RGB8UI),F===i.UNSIGNED_SHORT&&(J=i.RGB16UI),F===i.UNSIGNED_INT&&(J=i.RGB32UI),F===i.BYTE&&(J=i.RGB8I),F===i.SHORT&&(J=i.RGB16I),F===i.INT&&(J=i.RGB32I)),_===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(J=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(J=i.RGBA16UI),F===i.UNSIGNED_INT&&(J=i.RGBA32UI),F===i.BYTE&&(J=i.RGBA8I),F===i.SHORT&&(J=i.RGBA16I),F===i.INT&&(J=i.RGBA32I)),_===i.RGB&&(F===i.UNSIGNED_INT_5_9_9_9_REV&&(J=i.RGB9_E5),F===i.UNSIGNED_INT_10F_11F_11F_REV&&(J=i.R11F_G11F_B10F)),_===i.RGBA){const De=re?Hr:rt.getTransfer(ee);F===i.FLOAT&&(J=i.RGBA32F),F===i.HALF_FLOAT&&(J=i.RGBA16F),F===i.UNSIGNED_BYTE&&(J=De===ut?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(J=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(J=i.RGB5_A1)}return(J===i.R16F||J===i.R32F||J===i.RG16F||J===i.RG32F||J===i.RGBA16F||J===i.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function A(y,_){let F;return y?_===null||_===mn||_===sr?F=i.DEPTH24_STENCIL8:_===un?F=i.DEPTH32F_STENCIL8:_===rr&&(F=i.DEPTH24_STENCIL8,Ye("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===mn||_===sr?F=i.DEPTH_COMPONENT24:_===un?F=i.DEPTH_COMPONENT32F:_===rr&&(F=i.DEPTH_COMPONENT16),F}function C(y,_){return m(y)===!0||y.isFramebufferTexture&&y.minFilter!==It&&y.minFilter!==St?Math.log2(Math.max(_.width,_.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?_.mipmaps.length:1}function R(y){const _=y.target;_.removeEventListener("dispose",R),G(_),_.isVideoTexture&&u.delete(_)}function P(y){const _=y.target;_.removeEventListener("dispose",P),g(_)}function G(y){const _=n.get(y);if(_.__webglInit===void 0)return;const F=y.source,ee=f.get(F);if(ee){const re=ee[_.__cacheKey];re.usedTimes--,re.usedTimes===0&&M(y),Object.keys(ee).length===0&&f.delete(F)}n.remove(y)}function M(y){const _=n.get(y);i.deleteTexture(_.__webglTexture);const F=y.source,ee=f.get(F);delete ee[_.__cacheKey],o.memory.textures--}function g(y){const _=n.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),n.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(_.__webglFramebuffer[ee]))for(let re=0;re<_.__webglFramebuffer[ee].length;re++)i.deleteFramebuffer(_.__webglFramebuffer[ee][re]);else i.deleteFramebuffer(_.__webglFramebuffer[ee]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[ee])}else{if(Array.isArray(_.__webglFramebuffer))for(let ee=0;ee<_.__webglFramebuffer.length;ee++)i.deleteFramebuffer(_.__webglFramebuffer[ee]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let ee=0;ee<_.__webglColorRenderbuffer.length;ee++)_.__webglColorRenderbuffer[ee]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[ee]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const F=y.textures;for(let ee=0,re=F.length;ee<re;ee++){const J=n.get(F[ee]);J.__webglTexture&&(i.deleteTexture(J.__webglTexture),o.memory.textures--),n.remove(F[ee])}n.remove(y)}let E=0;function D(){E=0}function L(){const y=E;return y>=r.maxTextures&&Ye("WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+r.maxTextures),E+=1,y}function B(y){const _=[];return _.push(y.wrapS),_.push(y.wrapT),_.push(y.wrapR||0),_.push(y.magFilter),_.push(y.minFilter),_.push(y.anisotropy),_.push(y.internalFormat),_.push(y.format),_.push(y.type),_.push(y.generateMipmaps),_.push(y.premultiplyAlpha),_.push(y.flipY),_.push(y.unpackAlignment),_.push(y.colorSpace),_.join()}function X(y,_){const F=n.get(y);if(y.isVideoTexture&&Be(y),y.isRenderTargetTexture===!1&&y.isExternalTexture!==!0&&y.version>0&&F.__version!==y.version){const ee=y.image;if(ee===null)Ye("WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)Ye("WebGLRenderer: Texture marked for update but image is incomplete");else{q(F,y,_);return}}else y.isExternalTexture&&(F.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+_)}function Z(y,_){const F=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&F.__version!==y.version){q(F,y,_);return}else y.isExternalTexture&&(F.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+_)}function z(y,_){const F=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&F.__version!==y.version){q(F,y,_);return}t.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+_)}function te(y,_){const F=n.get(y);if(y.isCubeDepthTexture!==!0&&y.version>0&&F.__version!==y.version){se(F,y,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+_)}const $={[ir]:i.REPEAT,[Rn]:i.CLAMP_TO_EDGE,[Xs]:i.MIRRORED_REPEAT},V={[It]:i.NEAREST,[Sc]:i.NEAREST_MIPMAP_NEAREST,[dr]:i.NEAREST_MIPMAP_LINEAR,[St]:i.LINEAR,[ts]:i.LINEAR_MIPMAP_NEAREST,[ai]:i.LINEAR_MIPMAP_LINEAR},Q={[yc]:i.NEVER,[Cc]:i.ALWAYS,[Tc]:i.LESS,[Ho]:i.LEQUAL,[wc]:i.EQUAL,[Go]:i.GEQUAL,[Ac]:i.GREATER,[Rc]:i.NOTEQUAL};function me(y,_){if(_.type===un&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===St||_.magFilter===ts||_.magFilter===dr||_.magFilter===ai||_.minFilter===St||_.minFilter===ts||_.minFilter===dr||_.minFilter===ai)&&Ye("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,$[_.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,$[_.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,$[_.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,V[_.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,V[_.minFilter]),_.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,Q[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===It||_.minFilter!==dr&&_.minFilter!==ai||_.type===un&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");i.texParameterf(y,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ye(y,_){let F=!1;y.__webglInit===void 0&&(y.__webglInit=!0,_.addEventListener("dispose",R));const ee=_.source;let re=f.get(ee);re===void 0&&(re={},f.set(ee,re));const J=B(_);if(J!==y.__cacheKey){re[J]===void 0&&(re[J]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,F=!0),re[J].usedTimes++;const De=re[y.__cacheKey];De!==void 0&&(re[y.__cacheKey].usedTimes--,De.usedTimes===0&&M(_)),y.__cacheKey=J,y.__webglTexture=re[J].texture}return F}function Ne(y,_,F){return Math.floor(Math.floor(y/F)/_)}function He(y,_,F,ee){const J=y.updateRanges;if(J.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,F,ee,_.data);else{J.sort((ce,ve)=>ce.start-ve.start);let De=0;for(let ce=1;ce<J.length;ce++){const ve=J[De],Ce=J[ce],Le=ve.start+ve.count,_e=Ne(Ce.start,_.width,4),Ze=Ne(ve.start,_.width,4);Ce.start<=Le+1&&_e===Ze&&Ne(Ce.start+Ce.count-1,_.width,4)===_e?ve.count=Math.max(ve.count,Ce.start+Ce.count-ve.start):(++De,J[De]=Ce)}J.length=De+1;const xe=i.getParameter(i.UNPACK_ROW_LENGTH),Pe=i.getParameter(i.UNPACK_SKIP_PIXELS),Ge=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let ce=0,ve=J.length;ce<ve;ce++){const Ce=J[ce],Le=Math.floor(Ce.start/4),_e=Math.ceil(Ce.count/4),Ze=Le%_.width,U=Math.floor(Le/_.width),Me=_e,fe=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ze),i.pixelStorei(i.UNPACK_SKIP_ROWS,U),t.texSubImage2D(i.TEXTURE_2D,0,Ze,U,Me,fe,F,ee,_.data)}y.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,xe),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Pe),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ge)}}function q(y,_,F){let ee=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(ee=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(ee=i.TEXTURE_3D);const re=ye(y,_),J=_.source;t.bindTexture(ee,y.__webglTexture,i.TEXTURE0+F);const De=n.get(J);if(J.version!==De.__version||re===!0){t.activeTexture(i.TEXTURE0+F);const xe=rt.getPrimaries(rt.workingColorSpace),Pe=_.colorSpace===Vn?null:rt.getPrimaries(_.colorSpace),Ge=_.colorSpace===Vn||xe===Pe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ge);let ce=v(_.image,!1,r.maxTextureSize);ce=tt(_,ce);const ve=s.convert(_.format,_.colorSpace),Ce=s.convert(_.type);let Le=w(_.internalFormat,ve,Ce,_.colorSpace,_.isVideoTexture);me(ee,_);let _e;const Ze=_.mipmaps,U=_.isVideoTexture!==!0,Me=De.__version===void 0||re===!0,fe=J.dataReady,Te=C(_,ce);if(_.isDepthTexture)Le=A(_.format===li,_.type),Me&&(U?t.texStorage2D(i.TEXTURE_2D,1,Le,ce.width,ce.height):t.texImage2D(i.TEXTURE_2D,0,Le,ce.width,ce.height,0,ve,Ce,null));else if(_.isDataTexture)if(Ze.length>0){U&&Me&&t.texStorage2D(i.TEXTURE_2D,Te,Le,Ze[0].width,Ze[0].height);for(let le=0,oe=Ze.length;le<oe;le++)_e=Ze[le],U?fe&&t.texSubImage2D(i.TEXTURE_2D,le,0,0,_e.width,_e.height,ve,Ce,_e.data):t.texImage2D(i.TEXTURE_2D,le,Le,_e.width,_e.height,0,ve,Ce,_e.data);_.generateMipmaps=!1}else U?(Me&&t.texStorage2D(i.TEXTURE_2D,Te,Le,ce.width,ce.height),fe&&He(_,ce,ve,Ce)):t.texImage2D(i.TEXTURE_2D,0,Le,ce.width,ce.height,0,ve,Ce,ce.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){U&&Me&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Te,Le,Ze[0].width,Ze[0].height,ce.depth);for(let le=0,oe=Ze.length;le<oe;le++)if(_e=Ze[le],_.format!==on)if(ve!==null)if(U){if(fe)if(_.layerUpdates.size>0){const b=Ia(_e.width,_e.height,_.format,_.type);for(const H of _.layerUpdates){const Y=_e.data.subarray(H*b/_e.data.BYTES_PER_ELEMENT,(H+1)*b/_e.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,le,0,0,H,_e.width,_e.height,1,ve,Y)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,le,0,0,0,_e.width,_e.height,ce.depth,ve,_e.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,le,Le,_e.width,_e.height,ce.depth,0,_e.data,0,0);else Ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?fe&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,le,0,0,0,_e.width,_e.height,ce.depth,ve,Ce,_e.data):t.texImage3D(i.TEXTURE_2D_ARRAY,le,Le,_e.width,_e.height,ce.depth,0,ve,Ce,_e.data)}else{U&&Me&&t.texStorage2D(i.TEXTURE_2D,Te,Le,Ze[0].width,Ze[0].height);for(let le=0,oe=Ze.length;le<oe;le++)_e=Ze[le],_.format!==on?ve!==null?U?fe&&t.compressedTexSubImage2D(i.TEXTURE_2D,le,0,0,_e.width,_e.height,ve,_e.data):t.compressedTexImage2D(i.TEXTURE_2D,le,Le,_e.width,_e.height,0,_e.data):Ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?fe&&t.texSubImage2D(i.TEXTURE_2D,le,0,0,_e.width,_e.height,ve,Ce,_e.data):t.texImage2D(i.TEXTURE_2D,le,Le,_e.width,_e.height,0,ve,Ce,_e.data)}else if(_.isDataArrayTexture)if(U){if(Me&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Te,Le,ce.width,ce.height,ce.depth),fe)if(_.layerUpdates.size>0){const le=Ia(ce.width,ce.height,_.format,_.type);for(const oe of _.layerUpdates){const b=ce.data.subarray(oe*le/ce.data.BYTES_PER_ELEMENT,(oe+1)*le/ce.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,oe,ce.width,ce.height,1,ve,Ce,b)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ce.width,ce.height,ce.depth,ve,Ce,ce.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Le,ce.width,ce.height,ce.depth,0,ve,Ce,ce.data);else if(_.isData3DTexture)U?(Me&&t.texStorage3D(i.TEXTURE_3D,Te,Le,ce.width,ce.height,ce.depth),fe&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ce.width,ce.height,ce.depth,ve,Ce,ce.data)):t.texImage3D(i.TEXTURE_3D,0,Le,ce.width,ce.height,ce.depth,0,ve,Ce,ce.data);else if(_.isFramebufferTexture){if(Me)if(U)t.texStorage2D(i.TEXTURE_2D,Te,Le,ce.width,ce.height);else{let le=ce.width,oe=ce.height;for(let b=0;b<Te;b++)t.texImage2D(i.TEXTURE_2D,b,Le,le,oe,0,ve,Ce,null),le>>=1,oe>>=1}}else if(Ze.length>0){if(U&&Me){const le=Se(Ze[0]);t.texStorage2D(i.TEXTURE_2D,Te,Le,le.width,le.height)}for(let le=0,oe=Ze.length;le<oe;le++)_e=Ze[le],U?fe&&t.texSubImage2D(i.TEXTURE_2D,le,0,0,ve,Ce,_e):t.texImage2D(i.TEXTURE_2D,le,Le,ve,Ce,_e);_.generateMipmaps=!1}else if(U){if(Me){const le=Se(ce);t.texStorage2D(i.TEXTURE_2D,Te,Le,le.width,le.height)}fe&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ve,Ce,ce)}else t.texImage2D(i.TEXTURE_2D,0,Le,ve,Ce,ce);m(_)&&d(ee),De.__version=J.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function se(y,_,F){if(_.image.length!==6)return;const ee=ye(y,_),re=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+F);const J=n.get(re);if(re.version!==J.__version||ee===!0){t.activeTexture(i.TEXTURE0+F);const De=rt.getPrimaries(rt.workingColorSpace),xe=_.colorSpace===Vn?null:rt.getPrimaries(_.colorSpace),Pe=_.colorSpace===Vn||De===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Pe);const Ge=_.isCompressedTexture||_.image[0].isCompressedTexture,ce=_.image[0]&&_.image[0].isDataTexture,ve=[];for(let oe=0;oe<6;oe++)!Ge&&!ce?ve[oe]=v(_.image[oe],!0,r.maxCubemapSize):ve[oe]=ce?_.image[oe].image:_.image[oe],ve[oe]=tt(_,ve[oe]);const Ce=ve[0],Le=s.convert(_.format,_.colorSpace),_e=s.convert(_.type),Ze=w(_.internalFormat,Le,_e,_.colorSpace),U=_.isVideoTexture!==!0,Me=J.__version===void 0||ee===!0,fe=re.dataReady;let Te=C(_,Ce);me(i.TEXTURE_CUBE_MAP,_);let le;if(Ge){U&&Me&&t.texStorage2D(i.TEXTURE_CUBE_MAP,Te,Ze,Ce.width,Ce.height);for(let oe=0;oe<6;oe++){le=ve[oe].mipmaps;for(let b=0;b<le.length;b++){const H=le[b];_.format!==on?Le!==null?U?fe&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b,0,0,H.width,H.height,Le,H.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b,Ze,H.width,H.height,0,H.data):Ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b,0,0,H.width,H.height,Le,_e,H.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b,Ze,H.width,H.height,0,Le,_e,H.data)}}}else{if(le=_.mipmaps,U&&Me){le.length>0&&Te++;const oe=Se(ve[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,Te,Ze,oe.width,oe.height)}for(let oe=0;oe<6;oe++)if(ce){U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,ve[oe].width,ve[oe].height,Le,_e,ve[oe].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Ze,ve[oe].width,ve[oe].height,0,Le,_e,ve[oe].data);for(let b=0;b<le.length;b++){const Y=le[b].image[oe].image;U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b+1,0,0,Y.width,Y.height,Le,_e,Y.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b+1,Ze,Y.width,Y.height,0,Le,_e,Y.data)}}else{U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,Le,_e,ve[oe]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Ze,Le,_e,ve[oe]);for(let b=0;b<le.length;b++){const H=le[b];U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b+1,0,0,Le,_e,H.image[oe]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,b+1,Ze,Le,_e,H.image[oe])}}}m(_)&&d(i.TEXTURE_CUBE_MAP),J.__version=re.version,_.onUpdate&&_.onUpdate(_)}y.__version=_.version}function ie(y,_,F,ee,re,J){const De=s.convert(F.format,F.colorSpace),xe=s.convert(F.type),Pe=w(F.internalFormat,De,xe,F.colorSpace),Ge=n.get(_),ce=n.get(F);if(ce.__renderTarget=_,!Ge.__hasExternalTextures){const ve=Math.max(1,_.width>>J),Ce=Math.max(1,_.height>>J);re===i.TEXTURE_3D||re===i.TEXTURE_2D_ARRAY?t.texImage3D(re,J,Pe,ve,Ce,_.depth,0,De,xe,null):t.texImage2D(re,J,Pe,ve,Ce,0,De,xe,null)}t.bindFramebuffer(i.FRAMEBUFFER,y),Je(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ee,re,ce.__webglTexture,0,I(_)):(re===i.TEXTURE_2D||re>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&re<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,ee,re,ce.__webglTexture,J),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ge(y,_,F){if(i.bindRenderbuffer(i.RENDERBUFFER,y),_.depthBuffer){const ee=_.depthTexture,re=ee&&ee.isDepthTexture?ee.type:null,J=A(_.stencilBuffer,re),De=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Je(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,I(_),J,_.width,_.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,I(_),J,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,J,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,De,i.RENDERBUFFER,y)}else{const ee=_.textures;for(let re=0;re<ee.length;re++){const J=ee[re],De=s.convert(J.format,J.colorSpace),xe=s.convert(J.type),Pe=w(J.internalFormat,De,xe,J.colorSpace);Je(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,I(_),Pe,_.width,_.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,I(_),Pe,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Pe,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function pe(y,_,F){const ee=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,y),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const re=n.get(_.depthTexture);if(re.__renderTarget=_,(!re.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),ee){if(re.__webglInit===void 0&&(re.__webglInit=!0,_.depthTexture.addEventListener("dispose",R)),re.__webglTexture===void 0){re.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,re.__webglTexture),me(i.TEXTURE_CUBE_MAP,_.depthTexture);const Ge=s.convert(_.depthTexture.format),ce=s.convert(_.depthTexture.type);let ve;_.depthTexture.format===Nn?ve=i.DEPTH_COMPONENT24:_.depthTexture.format===li&&(ve=i.DEPTH24_STENCIL8);for(let Ce=0;Ce<6;Ce++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,0,ve,_.width,_.height,0,Ge,ce,null)}}else X(_.depthTexture,0);const J=re.__webglTexture,De=I(_),xe=ee?i.TEXTURE_CUBE_MAP_POSITIVE_X+F:i.TEXTURE_2D,Pe=_.depthTexture.format===li?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===Nn)Je(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Pe,xe,J,0,De):i.framebufferTexture2D(i.FRAMEBUFFER,Pe,xe,J,0);else if(_.depthTexture.format===li)Je(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Pe,xe,J,0,De):i.framebufferTexture2D(i.FRAMEBUFFER,Pe,xe,J,0);else throw new Error("Unknown depthTexture format")}function Ve(y){const _=n.get(y),F=y.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==y.depthTexture){const ee=y.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),ee){const re=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,ee.removeEventListener("dispose",re)};ee.addEventListener("dispose",re),_.__depthDisposeCallback=re}_.__boundDepthTexture=ee}if(y.depthTexture&&!_.__autoAllocateDepthBuffer)if(F)for(let ee=0;ee<6;ee++)pe(_.__webglFramebuffer[ee],y,ee);else{const ee=y.texture.mipmaps;ee&&ee.length>0?pe(_.__webglFramebuffer[0],y,0):pe(_.__webglFramebuffer,y,0)}else if(F){_.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[ee]),_.__webglDepthbuffer[ee]===void 0)_.__webglDepthbuffer[ee]=i.createRenderbuffer(),ge(_.__webglDepthbuffer[ee],y,!1);else{const re=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=_.__webglDepthbuffer[ee];i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,re,i.RENDERBUFFER,J)}}else{const ee=y.texture.mipmaps;if(ee&&ee.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),ge(_.__webglDepthbuffer,y,!1);else{const re=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,re,i.RENDERBUFFER,J)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function lt(y,_,F){const ee=n.get(y);_!==void 0&&ie(ee.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&Ve(y)}function $e(y){const _=y.texture,F=n.get(y),ee=n.get(_);y.addEventListener("dispose",P);const re=y.textures,J=y.isWebGLCubeRenderTarget===!0,De=re.length>1;if(De||(ee.__webglTexture===void 0&&(ee.__webglTexture=i.createTexture()),ee.__version=_.version,o.memory.textures++),J){F.__webglFramebuffer=[];for(let xe=0;xe<6;xe++)if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer[xe]=[];for(let Pe=0;Pe<_.mipmaps.length;Pe++)F.__webglFramebuffer[xe][Pe]=i.createFramebuffer()}else F.__webglFramebuffer[xe]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer=[];for(let xe=0;xe<_.mipmaps.length;xe++)F.__webglFramebuffer[xe]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(De)for(let xe=0,Pe=re.length;xe<Pe;xe++){const Ge=n.get(re[xe]);Ge.__webglTexture===void 0&&(Ge.__webglTexture=i.createTexture(),o.memory.textures++)}if(y.samples>0&&Je(y)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let xe=0;xe<re.length;xe++){const Pe=re[xe];F.__webglColorRenderbuffer[xe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[xe]);const Ge=s.convert(Pe.format,Pe.colorSpace),ce=s.convert(Pe.type),ve=w(Pe.internalFormat,Ge,ce,Pe.colorSpace,y.isXRRenderTarget===!0),Ce=I(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ce,ve,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.RENDERBUFFER,F.__webglColorRenderbuffer[xe])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),ge(F.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(J){t.bindTexture(i.TEXTURE_CUBE_MAP,ee.__webglTexture),me(i.TEXTURE_CUBE_MAP,_);for(let xe=0;xe<6;xe++)if(_.mipmaps&&_.mipmaps.length>0)for(let Pe=0;Pe<_.mipmaps.length;Pe++)ie(F.__webglFramebuffer[xe][Pe],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Pe);else ie(F.__webglFramebuffer[xe],y,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0);m(_)&&d(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(De){for(let xe=0,Pe=re.length;xe<Pe;xe++){const Ge=re[xe],ce=n.get(Ge);let ve=i.TEXTURE_2D;(y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(ve=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ve,ce.__webglTexture),me(ve,Ge),ie(F.__webglFramebuffer,y,Ge,i.COLOR_ATTACHMENT0+xe,ve,0),m(Ge)&&d(ve)}t.unbindTexture()}else{let xe=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(xe=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(xe,ee.__webglTexture),me(xe,_),_.mipmaps&&_.mipmaps.length>0)for(let Pe=0;Pe<_.mipmaps.length;Pe++)ie(F.__webglFramebuffer[Pe],y,_,i.COLOR_ATTACHMENT0,xe,Pe);else ie(F.__webglFramebuffer,y,_,i.COLOR_ATTACHMENT0,xe,0);m(_)&&d(xe),t.unbindTexture()}y.depthBuffer&&Ve(y)}function et(y){const _=y.textures;for(let F=0,ee=_.length;F<ee;F++){const re=_[F];if(m(re)){const J=T(y),De=n.get(re).__webglTexture;t.bindTexture(J,De),d(J),t.unbindTexture()}}}const ne=[],he=[];function we(y){if(y.samples>0){if(Je(y)===!1){const _=y.textures,F=y.width,ee=y.height;let re=i.COLOR_BUFFER_BIT;const J=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,De=n.get(y),xe=_.length>1;if(xe)for(let Ge=0;Ge<_.length;Ge++)t.bindFramebuffer(i.FRAMEBUFFER,De.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,De.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,De.__webglMultisampledFramebuffer);const Pe=y.texture.mipmaps;Pe&&Pe.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,De.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,De.__webglFramebuffer);for(let Ge=0;Ge<_.length;Ge++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(re|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(re|=i.STENCIL_BUFFER_BIT)),xe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,De.__webglColorRenderbuffer[Ge]);const ce=n.get(_[Ge]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ce,0)}i.blitFramebuffer(0,0,F,ee,0,0,F,ee,re,i.NEAREST),l===!0&&(ne.length=0,he.length=0,ne.push(i.COLOR_ATTACHMENT0+Ge),y.depthBuffer&&y.resolveDepthBuffer===!1&&(ne.push(J),he.push(J),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,he)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ne))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),xe)for(let Ge=0;Ge<_.length;Ge++){t.bindFramebuffer(i.FRAMEBUFFER,De.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.RENDERBUFFER,De.__webglColorRenderbuffer[Ge]);const ce=n.get(_[Ge]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,De.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ge,i.TEXTURE_2D,ce,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,De.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&l){const _=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function I(y){return Math.min(r.maxSamples,y.samples)}function Je(y){const _=n.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Be(y){const _=o.render.frame;u.get(y)!==_&&(u.set(y,_),y.update())}function tt(y,_){const F=y.colorSpace,ee=y.format,re=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||F!==Fi&&F!==Vn&&(rt.getTransfer(F)===ut?(ee!==on||re!==qt)&&Ye("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):it("WebGLTextures: Unsupported texture color space:",F)),_}function Se(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(c.width=y.naturalWidth||y.width,c.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(c.width=y.displayWidth,c.height=y.displayHeight):(c.width=y.width,c.height=y.height),c}this.allocateTextureUnit=L,this.resetTextureUnits=D,this.setTexture2D=X,this.setTexture2DArray=Z,this.setTexture3D=z,this.setTextureCube=te,this.rebindTextures=lt,this.setupRenderTarget=$e,this.updateRenderTargetMipmap=et,this.updateMultisampleRenderTarget=we,this.setupDepthRenderbuffer=Ve,this.setupFrameBufferTexture=ie,this.useMultisampledRTT=Je,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function lm(i,e){function t(n,r=Vn){let s;const o=rt.getTransfer(r);if(n===qt)return i.UNSIGNED_BYTE;if(n===No)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Fo)return i.UNSIGNED_SHORT_5_5_5_1;if(n===El)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===yl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Sl)return i.BYTE;if(n===bl)return i.SHORT;if(n===rr)return i.UNSIGNED_SHORT;if(n===Uo)return i.INT;if(n===mn)return i.UNSIGNED_INT;if(n===un)return i.FLOAT;if(n===Un)return i.HALF_FLOAT;if(n===Tl)return i.ALPHA;if(n===wl)return i.RGB;if(n===on)return i.RGBA;if(n===Nn)return i.DEPTH_COMPONENT;if(n===li)return i.DEPTH_STENCIL;if(n===Al)return i.RED;if(n===Oo)return i.RED_INTEGER;if(n===Ni)return i.RG;if(n===Bo)return i.RG_INTEGER;if(n===zo)return i.RGBA_INTEGER;if(n===Nr||n===Fr||n===Or||n===Br)if(o===ut)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Nr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Fr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Or)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Br)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Nr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Fr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Or)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Br)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ys||n===$s||n===qs||n===Zs)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ys)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===$s)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===qs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Zs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ks||n===js||n===Js||n===Qs||n===eo||n===to||n===no)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Ks||n===js)return o===ut?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Js)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===Qs)return s.COMPRESSED_R11_EAC;if(n===eo)return s.COMPRESSED_SIGNED_R11_EAC;if(n===to)return s.COMPRESSED_RG11_EAC;if(n===no)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===io||n===ro||n===so||n===oo||n===ao||n===lo||n===co||n===uo||n===ho||n===fo||n===po||n===mo||n===go||n===_o)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===io)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ro)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===so)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===oo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ao)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===lo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===co)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===uo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ho)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===fo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===po)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===mo)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===go)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===_o)return o===ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===xo||n===vo||n===Mo)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===xo)return o===ut?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===vo)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Mo)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===So||n===bo||n===Eo||n===yo)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===So)return s.COMPRESSED_RED_RGTC1_EXT;if(n===bo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Eo)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===yo)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===sr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const cm=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
...
}`;class hm{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Bl(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new _n({vertexShader:cm,fragmentShader:um,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Pt(new ki(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class fm extends ui{constructor(e,t){super();const n=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,h=null,f=null,p=null,x=null;const v=typeof XRWebGLBinding<"u",m=new hm,d={},T=t.getContextAttributes();let w=null,A=null;const C=[],R=[],P=new st;let G=null;const M=new jt;M.viewport=new Mt;const g=new jt;g.viewport=new Mt;const E=[M,g],D=new xu;let L=null,B=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let se=C[q];return se===void 0&&(se=new ys,C[q]=se),se.getTargetRaySpace()},this.getControllerGrip=function(q){let se=C[q];return se===void 0&&(se=new ys,C[q]=se),se.getGripSpace()},this.getHand=function(q){let se=C[q];return se===void 0&&(se=new ys,C[q]=se),se.getHandSpace()};function X(q){const se=R.indexOf(q.inputSource);if(se===-1)return;const ie=C[se];ie!==void 0&&(ie.update(q.inputSource,q.frame,c||o),ie.dispatchEvent({type:q.type,data:q.inputSource}))}function Z(){r.removeEventListener("select",X),r.removeEventListener("selectstart",X),r.removeEventListener("selectend",X),r.removeEventListener("squeeze",X),r.removeEventListener("squeezestart",X),r.removeEventListener("squeezeend",X),r.removeEventListener("end",Z),r.removeEventListener("inputsourceschange",z);for(let q=0;q<C.length;q++){const se=R[q];se!==null&&(R[q]=null,C[q].disconnect(se))}L=null,B=null,m.reset();for(const q in d)delete d[q];e.setRenderTarget(w),p=null,f=null,h=null,r=null,A=null,He.stop(),n.isPresenting=!1,e.setPixelRatio(G),e.setSize(P.width,P.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){s=q,n.isPresenting===!0&&Ye("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){a=q,n.isPresenting===!0&&Ye("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(q){c=q},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h===null&&v&&(h=new XRWebGLBinding(r,t)),h},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(q){if(r=q,r!==null){if(w=e.getRenderTarget(),r.addEventListener("select",X),r.addEventListener("selectstart",X),r.addEventListener("selectend",X),r.addEventListener("squeeze",X),r.addEventListener("squeezestart",X),r.addEventListener("squeezeend",X),r.addEventListener("end",Z),r.addEventListener("inputsourceschange",z),T.xrCompatible!==!0&&await t.makeXRCompatible(),G=e.getPixelRatio(),e.getSize(P),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let ie=null,ge=null,pe=null;T.depth&&(pe=T.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ie=T.stencil?li:Nn,ge=T.stencil?sr:mn);const Ve={colorFormat:t.RGBA8,depthFormat:pe,scaleFactor:s};h=this.getBinding(),f=h.createProjectionLayer(Ve),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),A=new pn(f.textureWidth,f.textureHeight,{format:on,type:qt,depthTexture:new ar(f.textureWidth,f.textureHeight,ge,void 0,void 0,void 0,void 0,void 0,void 0,ie),stencilBuffer:T.stencil,colorSpace:e.outputColorSpace,samples:T.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const ie={antialias:T.antialias,alpha:!0,depth:T.depth,stencil:T.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,ie),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),A=new pn(p.framebufferWidth,p.framebufferHeight,{format:on,type:qt,colorSpace:e.outputColorSpace,stencilBuffer:T.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}A.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),He.setContext(r),He.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function z(q){for(let se=0;se<q.removed.length;se++){const ie=q.removed[se],ge=R.indexOf(ie);ge>=0&&(R[ge]=null,C[ge].disconnect(ie))}for(let se=0;se<q.added.length;se++){const ie=q.added[se];let ge=R.indexOf(ie);if(ge===-1){for(let Ve=0;Ve<C.length;Ve++)if(Ve>=R.length){R.push(ie),ge=Ve;break}else if(R[Ve]===null){R[Ve]=ie,ge=Ve;break}if(ge===-1)break}const pe=C[ge];pe&&pe.connect(ie)}}const te=new O,$=new O;function V(q,se,ie){te.setFromMatrixPosition(se.matrixWorld),$.setFromMatrixPosition(ie.matrixWorld);const ge=te.distanceTo($),pe=se.projectionMatrix.elements,Ve=ie.projectionMatrix.elements,lt=pe[14]/(pe[10]-1),$e=pe[14]/(pe[10]+1),et=(pe[9]+1)/pe[5],ne=(pe[9]-1)/pe[5],he=(pe[8]-1)/pe[0],we=(Ve[8]+1)/Ve[0],I=lt*he,Je=lt*we,Be=ge/(-he+we),tt=Be*-he;if(se.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(tt),q.translateZ(Be),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),pe[10]===-1)q.projectionMatrix.copy(se.projectionMatrix),q.projectionMatrixInverse.copy(se.projectionMatrixInverse);else{const Se=lt+Be,y=$e+Be,_=I-tt,F=Je+(ge-tt),ee=et*$e/y*Se,re=ne*$e/y*Se;q.projectionMatrix.makePerspective(_,F,ee,re,Se,y),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function Q(q,se){se===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(se.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(r===null)return;let se=q.near,ie=q.far;m.texture!==null&&(m.depthNear>0&&(se=m.depthNear),m.depthFar>0&&(ie=m.depthFar)),D.near=g.near=M.near=se,D.far=g.far=M.far=ie,(L!==D.near||B!==D.far)&&(r.updateRenderState({depthNear:D.near,depthFar:D.far}),L=D.near,B=D.far),D.layers.mask=q.layers.mask|6,M.layers.mask=D.layers.mask&3,g.layers.mask=D.layers.mask&5;const ge=q.parent,pe=D.cameras;Q(D,ge);for(let Ve=0;Ve<pe.length;Ve++)Q(pe[Ve],ge);pe.length===2?V(D,M,g):D.projectionMatrix.copy(M.projectionMatrix),me(q,D,ge)};function me(q,se,ie){ie===null?q.matrix.copy(se.matrixWorld):(q.matrix.copy(ie.matrixWorld),q.matrix.invert(),q.matrix.multiply(se.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(se.projectionMatrix),q.projectionMatrixInverse.copy(se.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=To*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return D},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(q){l=q,f!==null&&(f.fixedFoveation=q),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=q)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(D)},this.getCameraTexture=function(q){return d[q]};let ye=null;function Ne(q,se){if(u=se.getViewerPose(c||o),x=se,u!==null){const ie=u.views;p!==null&&(e.setRenderTargetFramebuffer(A,p.framebuffer),e.setRenderTarget(A));let ge=!1;ie.length!==D.cameras.length&&(D.cameras.length=0,ge=!0);for(let $e=0;$e<ie.length;$e++){const et=ie[$e];let ne=null;if(p!==null)ne=p.getViewport(et);else{const we=h.getViewSubImage(f,et);ne=we.viewport,$e===0&&(e.setRenderTargetTextures(A,we.colorTexture,we.depthStencilTexture),e.setRenderTarget(A))}let he=E[$e];he===void 0&&(he=new jt,he.layers.enable($e),he.viewport=new Mt,E[$e]=he),he.matrix.fromArray(et.transform.matrix),he.matrix.decompose(he.position,he.quaternion,he.scale),he.projectionMatrix.fromArray(et.projectionMatrix),he.projectionMatrixInverse.copy(he.projectionMatrix).invert(),he.viewport.set(ne.x,ne.y,ne.width,ne.height),$e===0&&(D.matrix.copy(he.matrix),D.matrix.decompose(D.position,D.quaternion,D.scale)),ge===!0&&D.cameras.push(he)}const pe=r.enabledFeatures;if(pe&&pe.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&v){h=n.getBinding();const $e=h.getDepthInformation(ie[0]);$e&&$e.isValid&&$e.texture&&m.init($e,r.renderState)}if(pe&&pe.includes("camera-access")&&v){e.state.unbindTexture(),h=n.getBinding();for(let $e=0;$e<ie.length;$e++){const et=ie[$e].camera;if(et){let ne=d[et];ne||(ne=new Bl,d[et]=ne);const he=h.getCameraImage(et);ne.sourceTexture=he}}}}for(let ie=0;ie<C.length;ie++){const ge=R[ie],pe=C[ie];ge!==null&&pe!==void 0&&pe.update(ge,se,c||o)}ye&&ye(q,se),se.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:se}),x=null}const He=new zl;He.setAnimationLoop(Ne),this.setAnimationLoop=function(q){ye=q},this.dispose=function(){}}}const Qn=new Qt,dm=new gt;function pm(i,e){function t(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,Ul(i)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,T,w,A){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(m,d):d.isMeshToonMaterial?(s(m,d),h(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d)):d.isMeshStandardMaterial?(s(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,A)):d.isMeshMatcapMaterial?(s(m,d),x(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),v(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(o(m,d),d.isLineDashedMaterial&&a(m,d)):d.isPointsMaterial?l(m,d,T,w):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,t(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===Vt&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,t(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===Vt&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,t(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,t(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const T=e.get(d),w=T.envMap,A=T.envMapRotation;w&&(m.envMap.value=w,Qn.copy(A),Qn.x*=-1,Qn.y*=-1,Qn.z*=-1,w.isCubeTexture&&w.isRenderTargetTexture===!1&&(Qn.y*=-1,Qn.z*=-1),m.envMapRotation.value.setFromMatrix4(dm.makeRotationFromEuler(Qn)),m.flipEnvMap.value=w.isCubeTexture&&w.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,m.aoMapTransform))}function o(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform))}function a(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,T,w){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*T,m.scale.value=w*.5,d.map&&(m.map.value=d.map,t(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function h(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,T){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Vt&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,d){d.matcap&&(m.matcap.value=d.matcap)}function v(m,d){const T=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function mm(i,e,t,n){let r={},s={},o=[];const a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(T,w){const A=w.program;n.uniformBlockBinding(T,A)}function c(T,w){let A=r[T.id];A===void 0&&(x(T),A=u(T),r[T.id]=A,T.addEventListener("dispose",m));const C=w.program;n.updateUBOMapping(T,C);const R=e.render.frame;s[T.id]!==R&&(f(T),s[T.id]=R)}function u(T){const w=h();T.__bindingPointIndex=w;const A=i.createBuffer(),C=T.__size,R=T.usage;return i.bindBuffer(i.UNIFORM_BUFFER,A),i.bufferData(i.UNIFORM_BUFFER,C,R),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,w,A),A}function h(){for(let T=0;T<a;T++)if(o.indexOf(T)===-1)return o.push(T),T;return it("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(T){const w=r[T.id],A=T.uniforms,C=T.__cache;i.bindBuffer(i.UNIFORM_BUFFER,w);for(let R=0,P=A.length;R<P;R++){const G=Array.isArray(A[R])?A[R]:[A[R]];for(let M=0,g=G.length;M<g;M++){const E=G[M];if(p(E,R,M,C)===!0){const D=E.__offset,L=Array.isArray(E.value)?E.value:[E.value];let B=0;for(let X=0;X<L.length;X++){const Z=L[X],z=v(Z);typeof Z=="number"||typeof Z=="boolean"?(E.__data[0]=Z,i.bufferSubData(i.UNIFORM_BUFFER,D+B,E.__data)):Z.isMatrix3?(E.__data[0]=Z.elements[0],E.__data[1]=Z.elements[1],E.__data[2]=Z.elements[2],E.__data[3]=0,E.__data[4]=Z.elements[3],E.__data[5]=Z.elements[4],E.__data[6]=Z.elements[5],E.__data[7]=0,E.__data[8]=Z.elements[6],E.__data[9]=Z.elements[7],E.__data[10]=Z.elements[8],E.__data[11]=0):(Z.toArray(E.__data,B),B+=z.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,D,E.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(T,w,A,C){const R=T.value,P=w+"_"+A;if(C[P]===void 0)return typeof R=="number"||typeof R=="boolean"?C[P]=R:C[P]=R.clone(),!0;{const G=C[P];if(typeof R=="number"||typeof R=="boolean"){if(G!==R)return C[P]=R,!0}else if(G.equals(R)===!1)return G.copy(R),!0}return!1}function x(T){const w=T.uniforms;let A=0;const C=16;for(let P=0,G=w.length;P<G;P++){const M=Array.isArray(w[P])?w[P]:[w[P]];for(let g=0,E=M.length;g<E;g++){const D=M[g],L=Array.isArray(D.value)?D.value:[D.value];for(let B=0,X=L.length;B<X;B++){const Z=L[B],z=v(Z),te=A%C,$=te%z.boundary,V=te+$;A+=$,V!==0&&C-V<z.storage&&(A+=C-V),D.__data=new Float32Array(z.storage/Float32Array.BYTES_PER_ELEMENT),D.__offset=A,A+=z.storage}}}const R=A%C;return R>0&&(A+=C-R),T.__size=A,T.__cache={},this}function v(T){const w={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(w.boundary=4,w.storage=4):T.isVector2?(w.boundary=8,w.storage=8):T.isVector3||T.isColor?(w.boundary=16,w.storage=12):T.isVector4?(w.boundary=16,w.storage=16):T.isMatrix3?(w.boundary=48,w.storage=48):T.isMatrix4?(w.boundary=64,w.storage=64):T.isTexture?Ye("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Ye("WebGLRenderer: Unsupported uniform value type.",T),w}function m(T){const w=T.target;w.removeEventListener("dispose",m);const A=o.indexOf(w.__bindingPointIndex);o.splice(A,1),i.deleteBuffer(r[w.id]),delete r[w.id],delete s[w.id]}function d(){for(const T in r)i.deleteBuffer(r[T]);o=[],r={},s={}}return{bind:l,update:c,dispose:d}}const gm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ln=null;function _m(){return ln===null&&(ln=new iu(gm,16,16,Ni,Un),ln.name="DFG_LUT",ln.minFilter=St,ln.magFilter=St,ln.wrapS=Rn,ln.wrapT=Rn,ln.generateMipmaps=!1,ln.needsUpdate=!0),ln}class xm{constructor(e={}){const{canvas:t=Pc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:f=!1,outputBufferType:p=qt}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=n.getContextAttributes().alpha}else x=o;const v=p,m=new Set([zo,Bo,Oo]),d=new Set([qt,mn,rr,sr,No,Fo]),T=new Uint32Array(4),w=new Int32Array(4);let A=null,C=null;const R=[],P=[];let G=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=dn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const M=this;let g=!1;this._outputColorSpace=mt;let E=0,D=0,L=null,B=-1,X=null;const Z=new Mt,z=new Mt;let te=null;const $=new qe(0);let V=0,Q=t.width,me=t.height,ye=1,Ne=null,He=null;const q=new Mt(0,0,Q,me),se=new Mt(0,0,Q,me);let ie=!1;const ge=new Yo;let pe=!1,Ve=!1;const lt=new gt,$e=new O,et=new Mt,ne={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let he=!1;function we(){return L===null?ye:1}let I=n;function Je(S,k){return t.getContext(S,k)}try{const S={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Do}`),t.addEventListener("webglcontextlost",H,!1),t.addEventListener("webglcontextrestored",Y,!1),t.addEventListener("webglcontextcreationerror",ae,!1),I===null){const k="webgl2";if(I=Je(k,S),I===null)throw Je(k)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(S){throw it("WebGLRenderer: "+S.message),S}let Be,tt,Se,y,_,F,ee,re,J,De,xe,Pe,Ge,ce,ve,Ce,Le,_e,Ze,U,Me,fe,Te,le;function oe(){Be=new _d(I),Be.init(),fe=new lm(I,Be),tt=new ld(I,Be,e,fe),Se=new om(I,Be),tt.reversedDepthBuffer&&f&&Se.buffers.depth.setReversed(!0),y=new Md(I),_=new Xp,F=new am(I,Be,Se,_,tt,fe,y),ee=new ud(M),re=new gd(M),J=new Eu(I),Te=new od(I,J),De=new xd(I,J,y,Te),xe=new bd(I,De,J,y),Ze=new Sd(I,tt,F),Ce=new cd(_),Pe=new Wp(M,ee,re,Be,tt,Te,Ce),Ge=new pm(M,_),ce=new $p,ve=new Qp(Be),_e=new sd(M,ee,re,Se,xe,x,l),Le=new rm(M,xe,tt),le=new mm(I,y,tt,Se),U=new ad(I,Be,y),Me=new vd(I,Be,y),y.programs=Pe.programs,M.capabilities=tt,M.extensions=Be,M.properties=_,M.renderLists=ce,M.shadowMap=Le,M.state=Se,M.info=y}oe(),v!==qt&&(G=new yd(v,t.width,t.height,r,s));const b=new fm(M,I);this.xr=b,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const S=Be.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=Be.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return ye},this.setPixelRatio=function(S){S!==void 0&&(ye=S,this.setSize(Q,me,!1))},this.getSize=function(S){return S.set(Q,me)},this.setSize=function(S,k,j=!0){if(b.isPresenting){Ye("WebGLRenderer: Can't change size while VR device is presenting.");return}Q=S,me=k,t.width=Math.floor(S*ye),t.height=Math.floor(k*ye),j===!0&&(t.style.width=S+"px",t.style.height=k+"px"),G!==null&&G.setSize(t.width,t.height),this.setViewport(0,0,S,k)},this.getDrawingBufferSize=function(S){return S.set(Q*ye,me*ye).floor()},this.setDrawingBufferSize=function(S,k,j){Q=S,me=k,ye=j,t.width=Math.floor(S*j),t.height=Math.floor(k*j),this.setViewport(0,0,S,k)},this.setEffects=function(S){if(v===qt){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let k=0;k<S.length;k++)if(S[k].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}G.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy(Z)},this.getViewport=function(S){return S.copy(q)},this.setViewport=function(S,k,j,K){S.isVector4?q.set(S.x,S.y,S.z,S.w):q.set(S,k,j,K),Se.viewport(Z.copy(q).multiplyScalar(ye).round())},this.getScissor=function(S){return S.copy(se)},this.setScissor=function(S,k,j,K){S.isVector4?se.set(S.x,S.y,S.z,S.w):se.set(S,k,j,K),Se.scissor(z.copy(se).multiplyScalar(ye).round())},this.getScissorTest=function(){return ie},this.setScissorTest=function(S){Se.setScissorTest(ie=S)},this.setOpaqueSort=function(S){Ne=S},this.setTransparentSort=function(S){He=S},this.getClearColor=function(S){return S.copy(_e.getClearColor())},this.setClearColor=function(){_e.setClearColor(...arguments)},this.getClearAlpha=function(){return _e.getClearAlpha()},this.setClearAlpha=function(){_e.setClearAlpha(...arguments)},this.clear=function(S=!0,k=!0,j=!0){let K=0;if(S){let W=!1;if(L!==null){const be=L.texture.format;W=m.has(be)}if(W){const be=L.texture.type,Re=d.has(be),Ae=_e.getClearColor(),Ie=_e.getClearAlpha(),Fe=Ae.r,We=Ae.g,ze=Ae.b;Re?(T[0]=Fe,T[1]=We,T[2]=ze,T[3]=Ie,I.clearBufferuiv(I.COLOR,0,T)):(w[0]=Fe,w[1]=We,w[2]=ze,w[3]=Ie,I.clearBufferiv(I.COLOR,0,w))}else K|=I.COLOR_BUFFER_BIT}k&&(K|=I.DEPTH_BUFFER_BIT),j&&(K|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),I.clear(K)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",H,!1),t.removeEventListener("webglcontextrestored",Y,!1),t.removeEventListener("webglcontextcreationerror",ae,!1),_e.dispose(),ce.dispose(),ve.dispose(),_.dispose(),ee.dispose(),re.dispose(),xe.dispose(),Te.dispose(),le.dispose(),Pe.dispose(),b.dispose(),b.removeEventListener("sessionstart",Oe),b.removeEventListener("sessionend",ot),zt.stop()};function H(S){S.preventDefault(),ua("WebGLRenderer: Context Lost."),g=!0}function Y(){ua("WebGLRenderer: Context Restored."),g=!1;const S=y.autoReset,k=Le.enabled,j=Le.autoUpdate,K=Le.needsUpdate,W=Le.type;oe(),y.autoReset=S,Le.enabled=k,Le.autoUpdate=j,Le.needsUpdate=K,Le.type=W}function ae(S){it("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function ue(S){const k=S.target;k.removeEventListener("dispose",ue),Ue(k)}function Ue(S){Xe(S),_.remove(S)}function Xe(S){const k=_.get(S).programs;k!==void 0&&(k.forEach(function(j){Pe.releaseProgram(j)}),S.isShaderMaterial&&Pe.releaseShaderCache(S))}this.renderBufferDirect=function(S,k,j,K,W,be){k===null&&(k=ne);const Re=W.isMesh&&W.matrixWorld.determinant()<0,Ae=Yl(S,k,j,K,W);Se.setMaterial(K,Re);let Ie=j.index,Fe=1;if(K.wireframe===!0){if(Ie=De.getWireframeAttribute(j),Ie===void 0)return;Fe=2}const We=j.drawRange,ze=j.attributes.position;let Qe=We.start*Fe,ht=(We.start+We.count)*Fe;be!==null&&(Qe=Math.max(Qe,be.start*Fe),ht=Math.min(ht,(be.start+be.count)*Fe)),Ie!==null?(Qe=Math.max(Qe,0),ht=Math.min(ht,Ie.count)):ze!=null&&(Qe=Math.max(Qe,0),ht=Math.min(ht,ze.count));const xt=ht-Qe;if(xt<0||xt===1/0)return;Te.setup(W,K,Ae,j,Ie);let vt,ft=U;if(Ie!==null&&(vt=J.get(Ie),ft=Me,ft.setIndex(vt)),W.isMesh)K.wireframe===!0?(Se.setLineWidth(K.wireframeLinewidth*we()),ft.setMode(I.LINES)):ft.setMode(I.TRIANGLES);else if(W.isLine){let ke=K.linewidth;ke===void 0&&(ke=1),Se.setLineWidth(ke*we()),W.isLineSegments?ft.setMode(I.LINES):W.isLineLoop?ft.setMode(I.LINE_LOOP):ft.setMode(I.LINE_STRIP)}else W.isPoints?ft.setMode(I.POINTS):W.isSprite&&ft.setMode(I.TRIANGLES);if(W.isBatchedMesh)if(W._multiDrawInstances!==null)or("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ft.renderMultiDrawInstances(W._multiDrawStarts,W._multiDrawCounts,W._multiDrawCount,W._multiDrawInstances);else if(Be.get("WEBGL_multi_draw"))ft.renderMultiDraw(W._multiDrawStarts,W._multiDrawCounts,W._multiDrawCount);else{const ke=W._multiDrawStarts,ct=W._multiDrawCounts,at=W._multiDrawCount,Wt=Ie?J.get(Ie).bytesPerElement:1,hi=_.get(K).currentProgram.getUniforms();for(let Xt=0;Xt<at;Xt++)hi.setValue(I,"_gl_DrawID",Xt),ft.render(ke[Xt]/Wt,ct[Xt])}else if(W.isInstancedMesh)ft.renderInstances(Qe,xt,W.count);else if(j.isInstancedBufferGeometry){const ke=j._maxInstanceCount!==void 0?j._maxInstanceCount:1/0,ct=Math.min(j.instanceCount,ke);ft.renderInstances(Qe,xt,ct)}else ft.render(Qe,xt)};function _t(S,k,j){S.transparent===!0&&S.side===An&&S.forceSinglePass===!1?(S.side=Vt,S.needsUpdate=!0,fr(S,k,j),S.side=Yn,S.needsUpdate=!0,fr(S,k,j),S.side=An):fr(S,k,j)}this.compile=function(S,k,j=null){j===null&&(j=S),C=ve.get(j),C.init(k),P.push(C),j.traverseVisible(function(W){W.isLight&&W.layers.test(k.layers)&&(C.pushLight(W),W.castShadow&&C.pushShadow(W))}),S!==j&&S.traverseVisible(function(W){W.isLight&&W.layers.test(k.layers)&&(C.pushLight(W),W.castShadow&&C.pushShadow(W))}),C.setupLights();const K=new Set;return S.traverse(function(W){if(!(W.isMesh||W.isPoints||W.isLine||W.isSprite))return;const be=W.material;if(be)if(Array.isArray(be))for(let Re=0;Re<be.length;Re++){const Ae=be[Re];_t(Ae,j,W),K.add(Ae)}else _t(be,j,W),K.add(be)}),C=P.pop(),K},this.compileAsync=function(S,k,j=null){const K=this.compile(S,k,j);return new Promise(W=>{function be(){if(K.forEach(function(Re){_.get(Re).currentProgram.isReady()&&K.delete(Re)}),K.size===0){W(S);return}setTimeout(be,10)}Be.get("KHR_parallel_shader_compile")!==null?be():setTimeout(be,10)})};let yt=null;function an(S){yt&&yt(S)}function Oe(){zt.stop()}function ot(){zt.start()}const zt=new zl;zt.setAnimationLoop(an),typeof self<"u"&&zt.setContext(self),this.setAnimationLoop=function(S){yt=S,b.setAnimationLoop(S),S===null?zt.stop():zt.start()},b.addEventListener("sessionstart",Oe),b.addEventListener("sessionend",ot),this.render=function(S,k){if(k!==void 0&&k.isCamera!==!0){it("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(g===!0)return;const j=b.enabled===!0&&b.isPresenting===!0,K=G!==null&&(L===null||j)&&G.begin(M,L);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),b.enabled===!0&&b.isPresenting===!0&&(G===null||G.isCompositing()===!1)&&(b.cameraAutoUpdate===!0&&b.updateCamera(k),k=b.getCamera()),S.isScene===!0&&S.onBeforeRender(M,S,k,L),C=ve.get(S,P.length),C.init(k),P.push(C),lt.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),ge.setFromProjectionMatrix(lt,hn,k.reversedDepth),Ve=this.localClippingEnabled,pe=Ce.init(this.clippingPlanes,Ve),A=ce.get(S,R.length),A.init(),R.push(A),b.enabled===!0&&b.isPresenting===!0){const Re=M.xr.getDepthSensingMesh();Re!==null&&Qr(Re,k,-1/0,M.sortObjects)}Qr(S,k,0,M.sortObjects),A.finish(),M.sortObjects===!0&&A.sort(Ne,He),he=b.enabled===!1||b.isPresenting===!1||b.hasDepthSensing()===!1,he&&_e.addToRenderList(A,S),this.info.render.frame++,pe===!0&&Ce.beginShadows();const W=C.state.shadowsArray;if(Le.render(W,S,k),pe===!0&&Ce.endShadows(),this.info.autoReset===!0&&this.info.reset(),(K&&G.hasRenderPass())===!1){const Re=A.opaque,Ae=A.transmissive;if(C.setupLights(),k.isArrayCamera){const Ie=k.cameras;if(Ae.length>0)for(let Fe=0,We=Ie.length;Fe<We;Fe++){const ze=Ie[Fe];Jo(Re,Ae,S,ze)}he&&_e.render(S);for(let Fe=0,We=Ie.length;Fe<We;Fe++){const ze=Ie[Fe];jo(A,S,ze,ze.viewport)}}else Ae.length>0&&Jo(Re,Ae,S,k),he&&_e.render(S),jo(A,S,k)}L!==null&&D===0&&(F.updateMultisampleRenderTarget(L),F.updateRenderTargetMipmap(L)),K&&G.end(M),S.isScene===!0&&S.onAfterRender(M,S,k),Te.resetDefaultState(),B=-1,X=null,P.pop(),P.length>0?(C=P[P.length-1],pe===!0&&Ce.setGlobalState(M.clippingPlanes,C.state.camera)):C=null,R.pop(),R.length>0?A=R[R.length-1]:A=null};function Qr(S,k,j,K){if(S.visible===!1)return;if(S.layers.test(k.layers)){if(S.isGroup)j=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(k);else if(S.isLight)C.pushLight(S),S.castShadow&&C.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||ge.intersectsSprite(S)){K&&et.setFromMatrixPosition(S.matrixWorld).applyMatrix4(lt);const Re=xe.update(S),Ae=S.material;Ae.visible&&A.push(S,Re,Ae,j,et.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||ge.intersectsObject(S))){const Re=xe.update(S),Ae=S.material;if(K&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),et.copy(S.boundingSphere.center)):(Re.boundingSphere===null&&Re.computeBoundingSphere(),et.copy(Re.boundingSphere.center)),et.applyMatrix4(S.matrixWorld).applyMatrix4(lt)),Array.isArray(Ae)){const Ie=Re.groups;for(let Fe=0,We=Ie.length;Fe<We;Fe++){const ze=Ie[Fe],Qe=Ae[ze.materialIndex];Qe&&Qe.visible&&A.push(S,Re,Qe,j,et.z,ze)}}else Ae.visible&&A.push(S,Re,Ae,j,et.z,null)}}const be=S.children;for(let Re=0,Ae=be.length;Re<Ae;Re++)Qr(be[Re],k,j,K)}function jo(S,k,j,K){const{opaque:W,transmissive:be,transparent:Re}=S;C.setupLightsView(j),pe===!0&&Ce.setGlobalState(M.clippingPlanes,j),K&&Se.viewport(Z.copy(K)),W.length>0&&hr(W,k,j),be.length>0&&hr(be,k,j),Re.length>0&&hr(Re,k,j),Se.buffers.depth.setTest(!0),Se.buffers.depth.setMask(!0),Se.buffers.color.setMask(!0),Se.setPolygonOffset(!1)}function Jo(S,k,j,K){if((j.isScene===!0?j.overrideMaterial:null)!==null)return;if(C.state.transmissionRenderTarget[K.id]===void 0){const Qe=Be.has("EXT_color_buffer_half_float")||Be.has("EXT_color_buffer_float");C.state.transmissionRenderTarget[K.id]=new pn(1,1,{generateMipmaps:!0,type:Qe?Un:qt,minFilter:ai,samples:tt.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:rt.workingColorSpace})}const be=C.state.transmissionRenderTarget[K.id],Re=K.viewport||Z;be.setSize(Re.z*M.transmissionResolutionScale,Re.w*M.transmissionResolutionScale);const Ae=M.getRenderTarget(),Ie=M.getActiveCubeFace(),Fe=M.getActiveMipmapLevel();M.setRenderTarget(be),M.getClearColor($),V=M.getClearAlpha(),V<1&&M.setClearColor(16777215,.5),M.clear(),he&&_e.render(j);const We=M.toneMapping;M.toneMapping=dn;const ze=K.viewport;if(K.viewport!==void 0&&(K.viewport=void 0),C.setupLightsView(K),pe===!0&&Ce.setGlobalState(M.clippingPlanes,K),hr(S,j,K),F.updateMultisampleRenderTarget(be),F.updateRenderTargetMipmap(be),Be.has("WEBGL_multisampled_render_to_texture")===!1){let Qe=!1;for(let ht=0,xt=k.length;ht<xt;ht++){const vt=k[ht],{object:ft,geometry:ke,material:ct,group:at}=vt;if(ct.side===An&&ft.layers.test(K.layers)){const Wt=ct.side;ct.side=Vt,ct.needsUpdate=!0,Qo(ft,j,K,ke,ct,at),ct.side=Wt,ct.needsUpdate=!0,Qe=!0}}Qe===!0&&(F.updateMultisampleRenderTarget(be),F.updateRenderTargetMipmap(be))}M.setRenderTarget(Ae,Ie,Fe),M.setClearColor($,V),ze!==void 0&&(K.viewport=ze),M.toneMapping=We}function hr(S,k,j){const K=k.isScene===!0?k.overrideMaterial:null;for(let W=0,be=S.length;W<be;W++){const Re=S[W],{object:Ae,geometry:Ie,group:Fe}=Re;let We=Re.material;We.allowOverride===!0&&K!==null&&(We=K),Ae.layers.test(j.layers)&&Qo(Ae,k,j,Ie,We,Fe)}}function Qo(S,k,j,K,W,be){S.onBeforeRender(M,k,j,K,W,be),S.modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),W.onBeforeRender(M,k,j,K,S,be),W.transparent===!0&&W.side===An&&W.forceSinglePass===!1?(W.side=Vt,W.needsUpdate=!0,M.renderBufferDirect(j,k,K,W,S,be),W.side=Yn,W.needsUpdate=!0,M.renderBufferDirect(j,k,K,W,S,be),W.side=An):M.renderBufferDirect(j,k,K,W,S,be),S.onAfterRender(M,k,j,K,W,be)}function fr(S,k,j){k.isScene!==!0&&(k=ne);const K=_.get(S),W=C.state.lights,be=C.state.shadowsArray,Re=W.state.version,Ae=Pe.getParameters(S,W.state,be,k,j),Ie=Pe.getProgramCacheKey(Ae);let Fe=K.programs;K.environment=S.isMeshStandardMaterial?k.environment:null,K.fog=k.fog,K.envMap=(S.isMeshStandardMaterial?re:ee).get(S.envMap||K.environment),K.envMapRotation=K.environment!==null&&S.envMap===null?k.environmentRotation:S.envMapRotation,Fe===void 0&&(S.addEventListener("dispose",ue),Fe=new Map,K.programs=Fe);let We=Fe.get(Ie);if(We!==void 0){if(K.currentProgram===We&&K.lightsStateVersion===Re)return ta(S,Ae),We}else Ae.uniforms=Pe.getUniforms(S),S.onBeforeCompile(Ae,M),We=Pe.acquireProgram(Ae,Ie),Fe.set(Ie,We),K.uniforms=Ae.uniforms;const ze=K.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(ze.clippingPlanes=Ce.uniform),ta(S,Ae),K.needsLights=ql(S),K.lightsStateVersion=Re,K.needsLights&&(ze.ambientLightColor.value=W.state.ambient,ze.lightProbe.value=W.state.probe,ze.directionalLights.value=W.state.directional,ze.directionalLightShadows.value=W.state.directionalShadow,ze.spotLights.value=W.state.spot,ze.spotLightShadows.value=W.state.spotShadow,ze.rectAreaLights.value=W.state.rectArea,ze.ltc_1.value=W.state.rectAreaLTC1,ze.ltc_2.value=W.state.rectAreaLTC2,ze.pointLights.value=W.state.point,ze.pointLightShadows.value=W.state.pointShadow,ze.hemisphereLights.value=W.state.hemi,ze.directionalShadowMap.value=W.state.directionalShadowMap,ze.directionalShadowMatrix.value=W.state.directionalShadowMatrix,ze.spotShadowMap.value=W.state.spotShadowMap,ze.spotLightMatrix.value=W.state.spotLightMatrix,ze.spotLightMap.value=W.state.spotLightMap,ze.pointShadowMap.value=W.state.pointShadowMap,ze.pointShadowMatrix.value=W.state.pointShadowMatrix),K.currentProgram=We,K.uniformsList=null,We}function ea(S){if(S.uniformsList===null){const k=S.currentProgram.getUniforms();S.uniformsList=zr.seqWithValue(k.seq,S.uniforms)}return S.uniformsList}function ta(S,k){const j=_.get(S);j.outputColorSpace=k.outputColorSpace,j.batching=k.batching,j.batchingColor=k.batchingColor,j.instancing=k.instancing,j.instancingColor=k.instancingColor,j.instancingMorph=k.instancingMorph,j.skinning=k.skinning,j.morphTargets=k.morphTargets,j.morphNormals=k.morphNormals,j.morphColors=k.morphColors,j.morphTargetsCount=k.morphTargetsCount,j.numClippingPlanes=k.numClippingPlanes,j.numIntersection=k.numClipIntersection,j.vertexAlphas=k.vertexAlphas,j.vertexTangents=k.vertexTangents,j.toneMapping=k.toneMapping}function Yl(S,k,j,K,W){k.isScene!==!0&&(k=ne),F.resetTextureUnits();const be=k.fog,Re=K.isMeshStandardMaterial?k.environment:null,Ae=L===null?M.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:Fi,Ie=(K.isMeshStandardMaterial?re:ee).get(K.envMap||Re),Fe=K.vertexColors===!0&&!!j.attributes.color&&j.attributes.color.itemSize===4,We=!!j.attributes.tangent&&(!!K.normalMap||K.anisotropy>0),ze=!!j.morphAttributes.position,Qe=!!j.morphAttributes.normal,ht=!!j.morphAttributes.color;let xt=dn;K.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(xt=M.toneMapping);const vt=j.morphAttributes.position||j.morphAttributes.normal||j.morphAttributes.color,ft=vt!==void 0?vt.length:0,ke=_.get(K),ct=C.state.lights;if(pe===!0&&(Ve===!0||S!==X)){const Ft=S===X&&K.id===B;Ce.setState(K,S,Ft)}let at=!1;K.version===ke.__version?(ke.needsLights&&ke.lightsStateVersion!==ct.state.version||ke.outputColorSpace!==Ae||W.isBatchedMesh&&ke.batching===!1||!W.isBatchedMesh&&ke.batching===!0||W.isBatchedMesh&&ke.batchingColor===!0&&W.colorTexture===null||W.isBatchedMesh&&ke.batchingColor===!1&&W.colorTexture!==null||W.isInstancedMesh&&ke.instancing===!1||!W.isInstancedMesh&&ke.instancing===!0||W.isSkinnedMesh&&ke.skinning===!1||!W.isSkinnedMesh&&ke.skinning===!0||W.isInstancedMesh&&ke.instancingColor===!0&&W.instanceColor===null||W.isInstancedMesh&&ke.instancingColor===!1&&W.instanceColor!==null||W.isInstancedMesh&&ke.instancingMorph===!0&&W.morphTexture===null||W.isInstancedMesh&&ke.instancingMorph===!1&&W.morphTexture!==null||ke.envMap!==Ie||K.fog===!0&&ke.fog!==be||ke.numClippingPlanes!==void 0&&(ke.numClippingPlanes!==Ce.numPlanes||ke.numIntersection!==Ce.numIntersection)||ke.vertexAlphas!==Fe||ke.vertexTangents!==We||ke.morphTargets!==ze||ke.morphNormals!==Qe||ke.morphColors!==ht||ke.toneMapping!==xt||ke.morphTargetsCount!==ft)&&(at=!0):(at=!0,ke.__version=K.version);let Wt=ke.currentProgram;at===!0&&(Wt=fr(K,k,W));let hi=!1,Xt=!1,Vi=!1;const dt=Wt.getUniforms(),kt=ke.uniforms;if(Se.useProgram(Wt.program)&&(hi=!0,Xt=!0,Vi=!0),K.id!==B&&(B=K.id,Xt=!0),hi||X!==S){Se.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),dt.setValue(I,"projectionMatrix",S.projectionMatrix),dt.setValue(I,"viewMatrix",S.matrixWorldInverse);const Ht=dt.map.cameraPosition;Ht!==void 0&&Ht.setValue(I,$e.setFromMatrixPosition(S.matrixWorld)),tt.logarithmicDepthBuffer&&dt.setValue(I,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(K.isMeshPhongMaterial||K.isMeshToonMaterial||K.isMeshLambertMaterial||K.isMeshBasicMaterial||K.isMeshStandardMaterial||K.isShaderMaterial)&&dt.setValue(I,"isOrthographic",S.isOrthographicCamera===!0),X!==S&&(X=S,Xt=!0,Vi=!0)}if(ke.needsLights&&(ct.state.directionalShadowMap.length>0&&dt.setValue(I,"directionalShadowMap",ct.state.directionalShadowMap,F),ct.state.spotShadowMap.length>0&&dt.setValue(I,"spotShadowMap",ct.state.spotShadowMap,F),ct.state.pointShadowMap.length>0&&dt.setValue(I,"pointShadowMap",ct.state.pointShadowMap,F)),W.isSkinnedMesh){dt.setOptional(I,W,"bindMatrix"),dt.setOptional(I,W,"bindMatrixInverse");const Ft=W.skeleton;Ft&&(Ft.boneTexture===null&&Ft.computeBoneTexture(),dt.setValue(I,"boneTexture",Ft.boneTexture,F))}W.isBatchedMesh&&(dt.setOptional(I,W,"batchingTexture"),dt.setValue(I,"batchingTexture",W._matricesTexture,F),dt.setOptional(I,W,"batchingIdTexture"),dt.setValue(I,"batchingIdTexture",W._indirectTexture,F),dt.setOptional(I,W,"batchingColorTexture"),W._colorsTexture!==null&&dt.setValue(I,"batchingColorTexture",W._colorsTexture,F));const Zt=j.morphAttributes;if((Zt.position!==void 0||Zt.normal!==void 0||Zt.color!==void 0)&&Ze.update(W,j,Wt),(Xt||ke.receiveShadow!==W.receiveShadow)&&(ke.receiveShadow=W.receiveShadow,dt.setValue(I,"receiveShadow",W.receiveShadow)),K.isMeshGouraudMaterial&&K.envMap!==null&&(kt.envMap.value=Ie,kt.flipEnvMap.value=Ie.isCubeTexture&&Ie.isRenderTargetTexture===!1?-1:1),K.isMeshStandardMaterial&&K.envMap===null&&k.environment!==null&&(kt.envMapIntensity.value=k.environmentIntensity),kt.dfgLUT!==void 0&&(kt.dfgLUT.value=_m()),Xt&&(dt.setValue(I,"toneMappingExposure",M.toneMappingExposure),ke.needsLights&&$l(kt,Vi),be&&K.fog===!0&&Ge.refreshFogUniforms(kt,be),Ge.refreshMaterialUniforms(kt,K,ye,me,C.state.transmissionRenderTarget[S.id]),zr.upload(I,ea(ke),kt,F)),K.isShaderMaterial&&K.uniformsNeedUpdate===!0&&(zr.upload(I,ea(ke),kt,F),K.uniformsNeedUpdate=!1),K.isSpriteMaterial&&dt.setValue(I,"center",W.center),dt.setValue(I,"modelViewMatrix",W.modelViewMatrix),dt.setValue(I,"normalMatrix",W.normalMatrix),dt.setValue(I,"modelMatrix",W.matrixWorld),K.isShaderMaterial||K.isRawShaderMaterial){const Ft=K.uniformsGroups;for(let Ht=0,es=Ft.length;Ht<es;Ht++){const $n=Ft[Ht];le.update($n,Wt),le.bind($n,Wt)}}return Wt}function $l(S,k){S.ambientLightColor.needsUpdate=k,S.lightProbe.needsUpdate=k,S.directionalLights.needsUpdate=k,S.directionalLightShadows.needsUpdate=k,S.pointLights.needsUpdate=k,S.pointLightShadows.needsUpdate=k,S.spotLights.needsUpdate=k,S.spotLightShadows.needsUpdate=k,S.rectAreaLights.needsUpdate=k,S.hemisphereLights.needsUpdate=k}function ql(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return E},this.getActiveMipmapLevel=function(){return D},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(S,k,j){const K=_.get(S);K.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,K.__autoAllocateDepthBuffer===!1&&(K.__useRenderToTexture=!1),_.get(S.texture).__webglTexture=k,_.get(S.depthTexture).__webglTexture=K.__autoAllocateDepthBuffer?void 0:j,K.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,k){const j=_.get(S);j.__webglFramebuffer=k,j.__useDefaultFramebuffer=k===void 0};const Zl=I.createFramebuffer();this.setRenderTarget=function(S,k=0,j=0){L=S,E=k,D=j;let K=null,W=!1,be=!1;if(S){const Ae=_.get(S);if(Ae.__useDefaultFramebuffer!==void 0){Se.bindFramebuffer(I.FRAMEBUFFER,Ae.__webglFramebuffer),Z.copy(S.viewport),z.copy(S.scissor),te=S.scissorTest,Se.viewport(Z),Se.scissor(z),Se.setScissorTest(te),B=-1;return}else if(Ae.__webglFramebuffer===void 0)F.setupRenderTarget(S);else if(Ae.__hasExternalTextures)F.rebindTextures(S,_.get(S.texture).__webglTexture,_.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const We=S.depthTexture;if(Ae.__boundDepthTexture!==We){if(We!==null&&_.has(We)&&(S.width!==We.image.width||S.height!==We.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");F.setupDepthRenderbuffer(S)}}const Ie=S.texture;(Ie.isData3DTexture||Ie.isDataArrayTexture||Ie.isCompressedArrayTexture)&&(be=!0);const Fe=_.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Fe[k])?K=Fe[k][j]:K=Fe[k],W=!0):S.samples>0&&F.useMultisampledRTT(S)===!1?K=_.get(S).__webglMultisampledFramebuffer:Array.isArray(Fe)?K=Fe[j]:K=Fe,Z.copy(S.viewport),z.copy(S.scissor),te=S.scissorTest}else Z.copy(q).multiplyScalar(ye).floor(),z.copy(se).multiplyScalar(ye).floor(),te=ie;if(j!==0&&(K=Zl),Se.bindFramebuffer(I.FRAMEBUFFER,K)&&Se.drawBuffers(S,K),Se.viewport(Z),Se.scissor(z),Se.setScissorTest(te),W){const Ae=_.get(S.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+k,Ae.__webglTexture,j)}else if(be){const Ae=k;for(let Ie=0;Ie<S.textures.length;Ie++){const Fe=_.get(S.textures[Ie]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+Ie,Fe.__webglTexture,j,Ae)}}else if(S!==null&&j!==0){const Ae=_.get(S.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Ae.__webglTexture,j)}B=-1},this.readRenderTargetPixels=function(S,k,j,K,W,be,Re,Ae=0){if(!(S&&S.isWebGLRenderTarget)){it("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ie=_.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Re!==void 0&&(Ie=Ie[Re]),Ie){Se.bindFramebuffer(I.FRAMEBUFFER,Ie);try{const Fe=S.textures[Ae],We=Fe.format,ze=Fe.type;if(!tt.textureFormatReadable(We)){it("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!tt.textureTypeReadable(ze)){it("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=S.width-K&&j>=0&&j<=S.height-W&&(S.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+Ae),I.readPixels(k,j,K,W,fe.convert(We),fe.convert(ze),be))}finally{const Fe=L!==null?_.get(L).__webglFramebuffer:null;Se.bindFramebuffer(I.FRAMEBUFFER,Fe)}}},this.readRenderTargetPixelsAsync=async function(S,k,j,K,W,be,Re,Ae=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ie=_.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Re!==void 0&&(Ie=Ie[Re]),Ie)if(k>=0&&k<=S.width-K&&j>=0&&j<=S.height-W){Se.bindFramebuffer(I.FRAMEBUFFER,Ie);const Fe=S.textures[Ae],We=Fe.format,ze=Fe.type;if(!tt.textureFormatReadable(We))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!tt.textureTypeReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Qe=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,Qe),I.bufferData(I.PIXEL_PACK_BUFFER,be.byteLength,I.STREAM_READ),S.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+Ae),I.readPixels(k,j,K,W,fe.convert(We),fe.convert(ze),0);const ht=L!==null?_.get(L).__webglFramebuffer:null;Se.bindFramebuffer(I.FRAMEBUFFER,ht);const xt=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await Ic(I,xt,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,Qe),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,be),I.deleteBuffer(Qe),I.deleteSync(xt),be}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,k=null,j=0){const K=Math.pow(2,-j),W=Math.floor(S.image.width*K),be=Math.floor(S.image.height*K),Re=k!==null?k.x:0,Ae=k!==null?k.y:0;F.setTexture2D(S,0),I.copyTexSubImage2D(I.TEXTURE_2D,j,0,0,Re,Ae,W,be),Se.unbindTexture()};const Kl=I.createFramebuffer(),jl=I.createFramebuffer();this.copyTextureToTexture=function(S,k,j=null,K=null,W=0,be=null){be===null&&(W!==0?(or("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),be=W,W=0):be=0);let Re,Ae,Ie,Fe,We,ze,Qe,ht,xt;const vt=S.isCompressedTexture?S.mipmaps[be]:S.image;if(j!==null)Re=j.max.x-j.min.x,Ae=j.max.y-j.min.y,Ie=j.isBox3?j.max.z-j.min.z:1,Fe=j.min.x,We=j.min.y,ze=j.isBox3?j.min.z:0;else{const Zt=Math.pow(2,-W);Re=Math.floor(vt.width*Zt),Ae=Math.floor(vt.height*Zt),S.isDataArrayTexture?Ie=vt.depth:S.isData3DTexture?Ie=Math.floor(vt.depth*Zt):Ie=1,Fe=0,We=0,ze=0}K!==null?(Qe=K.x,ht=K.y,xt=K.z):(Qe=0,ht=0,xt=0);const ft=fe.convert(k.format),ke=fe.convert(k.type);let ct;k.isData3DTexture?(F.setTexture3D(k,0),ct=I.TEXTURE_3D):k.isDataArrayTexture||k.isCompressedArrayTexture?(F.setTexture2DArray(k,0),ct=I.TEXTURE_2D_ARRAY):(F.setTexture2D(k,0),ct=I.TEXTURE_2D),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,k.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,k.unpackAlignment);const at=I.getParameter(I.UNPACK_ROW_LENGTH),Wt=I.getParameter(I.UNPACK_IMAGE_HEIGHT),hi=I.getParameter(I.UNPACK_SKIP_PIXELS),Xt=I.getParameter(I.UNPACK_SKIP_ROWS),Vi=I.getParameter(I.UNPACK_SKIP_IMAGES);I.pixelStorei(I.UNPACK_ROW_LENGTH,vt.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,vt.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Fe),I.pixelStorei(I.UNPACK_SKIP_ROWS,We),I.pixelStorei(I.UNPACK_SKIP_IMAGES,ze);const dt=S.isDataArrayTexture||S.isData3DTexture,kt=k.isDataArrayTexture||k.isData3DTexture;if(S.isDepthTexture){const Zt=_.get(S),Ft=_.get(k),Ht=_.get(Zt.__renderTarget),es=_.get(Ft.__renderTarget);Se.bindFramebuffer(I.READ_FRAMEBUFFER,Ht.__webglFramebuffer),Se.bindFramebuffer(I.DRAW_FRAMEBUFFER,es.__webglFramebuffer);for(let $n=0;$n<Ie;$n++)dt&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,_.get(S).__webglTexture,W,ze+$n),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,_.get(k).__webglTexture,be,xt+$n)),I.blitFramebuffer(Fe,We,Re,Ae,Qe,ht,Re,Ae,I.DEPTH_BUFFER_BIT,I.NEAREST);Se.bindFramebuffer(I.READ_FRAMEBUFFER,null),Se.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(W!==0||S.isRenderTargetTexture||_.has(S)){const Zt=_.get(S),Ft=_.get(k);Se.bindFramebuffer(I.READ_FRAMEBUFFER,Kl),Se.bindFramebuffer(I.DRAW_FRAMEBUFFER,jl);for(let Ht=0;Ht<Ie;Ht++)dt?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Zt.__webglTexture,W,ze+Ht):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Zt.__webglTexture,W),kt?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Ft.__webglTexture,be,xt+Ht):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Ft.__webglTexture,be),W!==0?I.blitFramebuffer(Fe,We,Re,Ae,Qe,ht,Re,Ae,I.COLOR_BUFFER_BIT,I.NEAREST):kt?I.copyTexSubImage3D(ct,be,Qe,ht,xt+Ht,Fe,We,Re,Ae):I.copyTexSubImage2D(ct,be,Qe,ht,Fe,We,Re,Ae);Se.bindFramebuffer(I.READ_FRAMEBUFFER,null),Se.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else kt?S.isDataTexture||S.isData3DTexture?I.texSubImage3D(ct,be,Qe,ht,xt,Re,Ae,Ie,ft,ke,vt.data):k.isCompressedArrayTexture?I.compressedTexSubImage3D(ct,be,Qe,ht,xt,Re,Ae,Ie,ft,vt.data):I.texSubImage3D(ct,be,Qe,ht,xt,Re,Ae,Ie,ft,ke,vt):S.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,be,Qe,ht,Re,Ae,ft,ke,vt.data):S.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,be,Qe,ht,vt.width,vt.height,ft,vt.data):I.texSubImage2D(I.TEXTURE_2D,be,Qe,ht,Re,Ae,ft,ke,vt);I.pixelStorei(I.UNPACK_ROW_LENGTH,at),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,Wt),I.pixelStorei(I.UNPACK_SKIP_PIXELS,hi),I.pixelStorei(I.UNPACK_SKIP_ROWS,Xt),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Vi),be===0&&k.generateMipmaps&&I.generateMipmap(ct),Se.unbindTexture()},this.initRenderTarget=function(S){_.get(S).__webglFramebuffer===void 0&&F.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?F.setTextureCube(S,0):S.isData3DTexture?F.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?F.setTexture2DArray(S,0):F.setTexture2D(S,0),Se.unbindTexture()},this.resetState=function(){E=0,D=0,L=null,Se.reset(),Te.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return hn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=rt._getDrawingBufferColorSpace(e),t.unpackColorSpace=rt._getUnpackColorSpace()}}const Gi="#005eb8";function si(i,e,t){const n=e.split(/\s+/),r=[];let s="";for(const o of n){const a=s?`${s} ${o}`:o;i.measureText(a).width>t&&s?(r.push(s),s=o):s=a}return s&&r.push(s),r}function er(i,e,t){if(i.measureText(e).width<=t)return e;let n=e;for(;n.length>1&&i.measureText(`${n}…`).width>t;)n=n.slice(0,-1);return`${n}…`}function pt(i){const e=document.createElement("canvas");e.width=i.widthPx,e.height=i.heightPx;const t=e.getContext("2d"),n=Math.round(i.widthPx*.05),r=i.align??"left",s=r==="center"?i.widthPx/2:n;t.fillStyle=i.background??Gi,t.fillRect(0,0,e.width,e.height),t.fillStyle=i.color??"#ffffff",t.textAlign=r,t.textBaseline="top";let o=n;const a=i.titleSize??Math.round(i.heightPx*.28);t.font=`bold ${a}px Arial`;for(const c of si(t,i.title,i.widthPx-n*2))t.fillText(c,s,o),o+=a*1.15;if(i.subtitle){const c=i.subtitleSize??Math.round(a*.55);t.font=`${c}px Arial`,t.globalAlpha=.85;for(const u of si(t,i.subtitle,i.widthPx-n*2))t.fillText(u,s,o),o+=c*1.2;t.globalAlpha=1}if(i.body){o+=n*.5;let c=i.bodySize??Math.round(a*.45);if(i.fitBody){const u=i.footer?Math.round(a*.32)*2.6+n:n,h=i.heightPx-o-u;for(;c>16&&(t.font=`${c}px Arial`,!(si(t,i.body,i.widthPx-n*2).length*c*1.3<=h));)c-=2}t.font=`${c}px Arial`;for(const u of si(t,i.body,i.widthPx-n*2))t.fillText(u,s,o),o+=c*1.3}if(i.footer){const c=Math.round((i.titleSize??i.heightPx*.28)*.32);t.font=`${c}px Arial`,t.globalAlpha=.72;let u=i.heightPx-n;const h=si(t,i.footer,i.widthPx-n*2).reverse();for(const f of h)u-=c*1.25,t.fillText(f,s,u);t.globalAlpha=1}const l=new vn(e);return l.anisotropy=4,l.colorSpace=mt,l}const tl="#009639";function vm(i,e,t){const n=document.createElement("canvas");n.width=620,n.height=810;const r=n.getContext("2d");r.fillStyle="#fbfbf8",r.fillRect(0,0,620,810),r.fillStyle=e,r.fillRect(0,0,620,92),r.fillStyle="#ffffff",r.font="bold 46px Arial",r.textBaseline="middle",r.fillText(i,30,48),r.textBaseline="top",r.fillStyle="#20262b",r.font="34px Arial";let s=130;for(const a of si(r,t,560))if(r.fillText(a,30,s),s+=46,s>770)break;const o=new vn(n);return o.anisotropy=4,o.colorSpace=mt,o}function Mm(i){const e=document.createElement("canvas");e.width=620,e.height=290;const t=e.getContext("2d");t.fillStyle="#e9e3d0",t.fillRect(0,0,620,290),t.strokeStyle="#8b8672",t.lineWidth=6,t.strokeRect(8,8,604,274),t.fillStyle="#6c6753",t.font="26px Arial",t.fillText("formerly signposted as",28,34),t.fillStyle="#3a382f";let n=88;for(const s of i.slice(0,3)){t.font="bold 44px Arial",t.fillText(s,28,n);const o=t.measureText(s).width;t.strokeStyle="#7d2a2a",t.lineWidth=5,t.beginPath(),t.moveTo(24,n+2),t.lineTo(32+o,n-6),t.stroke(),n+=64}const r=new vn(e);return r.colorSpace=mt,r}function Wl(i){const e=document.createElement("canvas"),t=640,n=460;e.width=t,e.height=n;const r=e.getContext("2d");let s=i%2147483646+1;const o=()=>(s=s*16807%2147483647)/2147483647,a=[["#e8e3d4","#41668c","#c4a35a","#7a4b3a","#5d7a76"],["#ece7dc","#6c8c5f","#c96f4a","#3d4a52","#c4b57a"],["#e6e2d8","#8a5a74","#5a7d8a","#c9a35a","#4a5747"]],l=a[i%a.length];r.fillStyle=l[0],r.fillRect(0,0,t,n);const c=5+Math.floor(o()*5);for(let h=0;h<c;h++)if(r.fillStyle=l[1+Math.floor(o()*(l.length-1))],r.globalAlpha=.75+o()*.25,o()<.45)r.beginPath(),r.arc(o()*t,o()*n,40+o()*100,0,Math.PI*(.7+o()*1.3)),r.lineWidth=14+o()*30,r.strokeStyle=r.fillStyle,r.stroke();else{const f=40+o()*150;r.fillRect(o()*(t-f),o()*(n-100),f,50+o()*160)}r.globalAlpha=1;const u=new vn(e);return u.colorSpace=mt,u}function Xr(i,e){const t=document.createElement("canvas");t.width=512,t.height=150;const n=t.getContext("2d");n.fillStyle="#f5f4ef",n.fillRect(0,0,512,150),n.fillStyle="#20262b",n.font="bold 34px Arial",n.fillText(er(n,i,470),22,26),n.font="24px Arial",n.globalAlpha=.75;let r=78;for(const o of si(n,e,470).slice(0,2))n.fillText(o,22,r),r+=32;n.globalAlpha=1;const s=new vn(t);return s.colorSpace=mt,s}function Xl(i){const e=Math.round(i.widthPx*.035),t=Math.round(i.heightPx*.075);let n=e+t*1.25;i.subtitle&&(n+=t*.8),n+=e*.4;const r=n;n+=e*.6;const s=i.columns??1,o=(i.widthPx-e*2-e*(s-1))/s,a=i.rowSize??Math.round(t*.62),l=a*1.55,c=Math.max(1,Math.floor((i.heightPx-n-e)/l));return{pad:e,titleSize:t,top:n,ruleY:r,columns:s,colWidth:o,rowSize:a,rowH:l,rowsPerCol:c}}function Co(i,e){const t=Xl(i),n=[];for(let r=0;r<e;r++){const s=Math.floor(r/t.rowsPerCol);if(s>=t.columns){n.push(null);continue}const o=t.pad+s*(t.colWidth+t.pad),a=t.top+r%t.rowsPerCol*t.rowH;n.push([o/i.widthPx,1-(a+t.rowH)/i.heightPx,(o+t.colWidth)/i.widthPx,1-a/i.heightPx])}return n}function nr(i){const e=document.createElement("canvas");e.width=i.widthPx,e.height=i.heightPx;const t=e.getContext("2d"),n=Xl(i),r=n.pad;t.fillStyle=i.background??Gi,t.fillRect(0,0,e.width,e.height),t.textBaseline="top",t.textAlign="left";const s=n.titleSize;t.fillStyle="#ffffff",t.font=`bold ${s}px Arial`,t.fillText(er(t,i.title,i.widthPx-r*2),r,r),i.subtitle&&(t.font=`${Math.round(s*.55)}px Arial`,t.globalAlpha=.85,t.fillText(er(t,i.subtitle,i.widthPx-r*2),r,r+s*1.25),t.globalAlpha=1),t.strokeStyle="rgba(255,255,255,0.5)",t.lineWidth=Math.max(2,i.heightPx*.004),t.beginPath(),t.moveTo(r,n.ruleY),t.lineTo(i.widthPx-r,n.ruleY),t.stroke();const o=n.top,a=n.columns,l=n.colWidth,c=n.rowSize,u=n.rowH,h=n.rowsPerCol;i.rows.forEach((p,x)=>{const v=Math.floor(x/h);if(v>=a)return;const m=r+v*(l+r),d=o+x%h*u;let T=m;p.chip&&(t.fillStyle=p.chip,t.fillRect(m,d+c*.1,c*.8,c*.8),T+=c*1.2),t.fillStyle="#ffffff",t.font=`${p.strong?"bold ":""}${c}px Arial`;const w=er(t,p.text,l-(T-m));if(t.fillText(w,T,d),p.sub){const A=t.measureText(w).width;t.font=`${Math.round(c*.78)}px Arial`,t.globalAlpha=.75,t.fillText(er(t,`  ${p.sub}`,l-(T-m)-A),T+A,d+c*.15),t.globalAlpha=1}});const f=new vn(e);return f.anisotropy=4,f.colorSpace=mt,f}function Po(i,e=1.36){const t=document.createElement("canvas");t.width=1088,t.height=Math.round(1088/e);const n=t.getContext("2d");n.fillStyle="#3b4046",n.fillRect(0,0,t.width,t.height);const r=new vn(t);r.colorSpace=mt,r.anisotropy=4,r.generateMipmaps=!1,r.minFilter=St;const s=new Image;return s.onload=()=>{const o=Math.max(t.width/s.naturalWidth,t.height/s.naturalHeight),a=s.naturalWidth*o,l=s.naturalHeight*o;n.drawImage(s,(t.width-a)/2,(t.height-l)/2,a,l),r.needsUpdate=!0},s.src=i,r}class Sm{entries=[];placeholder=new gn({color:new qe(Gi)});register(e,t,n){e.material=this.placeholder,this.entries.push({pos:t.clone(),mesh:e,make:n,ready:!1})}update(e,t=55,n=120,r=8){const s=[];for(const o of this.entries){const a=o.pos.distanceTo(e);if(o.mesh.visible=a<n,!o.ready&&a<t)s.push({e:o,d:a});else if(o.ready&&a>n){const l=o.mesh.material;l.map?.dispose(),l.dispose(),o.mesh.material=this.placeholder,o.ready=!1}}s.sort((o,a)=>o.d-a.d);for(const{e:o}of s.slice(0,r))o.mesh.material=new gn({map:o.make()}),o.ready=!0}get count(){return this.entries.length}get readyCount(){return this.entries.filter(e=>e.ready).length}}function bm(i,e,t,n,r,s="sign"){const o=new Pt(new ki(e,t),new gn);return o.name=s,i.register(o,n,r),o}const Em={event:"#41b6e6","mental-object":"#78be20",stative:"#ed8b00","time-interval":"#8a1538",role:"#00a499","physical-object":"#ffb81c",resources:"#7c2855"},Xn=i=>Em[i]??"#425563";function Bi(i,e=!1){const t=i[0].index!==null,n=new Set(Object.keys(i[0].attributes)),r=new Set(Object.keys(i[0].morphAttributes)),s={},o={},a=i[0].morphTargetsRelative,l=new xn;let c=0;for(let u=0;u<i.length;++u){const h=i[u];let f=0;if(t!==(h.index!==null))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them."),null;for(const p in h.attributes){if(!n.has(p))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+'. All geometries must have compatible attributes; make sure "'+p+'" attribute exists among all geometries, or in none of them.'),null;s[p]===void 0&&(s[p]=[]),s[p].push(h.attributes[p]),f++}if(f!==n.size)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". Make sure all geometries have the same number of attributes."),null;if(a!==h.morphTargetsRelative)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". .morphTargetsRelative must be consistent throughout all geometries."),null;for(const p in h.morphAttributes){if(!r.has(p))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+".  .morphAttributes must be consistent throughout all geometries."),null;o[p]===void 0&&(o[p]=[]),o[p].push(h.morphAttributes[p])}if(e){let p;if(t)p=h.index.count;else if(h.attributes.position!==void 0)p=h.attributes.position.count;else return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". The geometry must have either an index or a position attribute"),null;l.addGroup(c,p,u),c+=p}}if(t){let u=0;const h=[];for(let f=0;f<i.length;++f){const p=i[f].index;for(let x=0;x<p.count;++x)h.push(p.getX(x)+u);u+=i[f].attributes.position.count}l.setIndex(h)}for(const u in s){const h=nl(s[u]);if(!h)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+u+" attribute."),null;l.setAttribute(u,h)}for(const u in o){const h=o[u][0].length;if(h===0)break;l.morphAttributes=l.morphAttributes||{},l.morphAttributes[u]=[];for(let f=0;f<h;++f){const p=[];for(let v=0;v<o[u].length;++v)p.push(o[u][v][f]);const x=nl(p);if(!x)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+u+" morphAttribute."),null;l.morphAttributes[u].push(x)}}return l}function nl(i){let e,t,n,r=-1,s=0;for(let c=0;c<i.length;++c){const u=i[c];if(e===void 0&&(e=u.array.constructor),e!==u.array.constructor)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes."),null;if(t===void 0&&(t=u.itemSize),t!==u.itemSize)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes."),null;if(n===void 0&&(n=u.normalized),n!==u.normalized)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes."),null;if(r===-1&&(r=u.gpuType),r!==u.gpuType)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes."),null;s+=u.count*t}const o=new e(s),a=new Jt(o,t,n);let l=0;for(let c=0;c<i.length;++c){const u=i[c];if(u.isInterleavedBufferAttribute){const h=l/t;for(let f=0,p=u.count;f<p;f++)for(let x=0;x<t;x++){const v=u.getComponent(f,x);a.setComponent(f+h,x,v)}}else o.set(u.array,l);l+=u.count*t}return r!==void 0&&(a.gpuType=r),a}function ym(){const i=document.createElement("canvas");i.width=i.height=256;const e=i.getContext("2d");e.fillStyle="#89928b",e.fillRect(0,0,256,256);let t=42;const n=()=>(t=t*16807%2147483647)/2147483647,r=["#9aa39b","#78817a","#a7ada3","#6e766f","#93856f"];for(let o=0;o<1400;o++){e.fillStyle=r[Math.floor(n()*r.length)],e.globalAlpha=.35+n()*.4;const a=1+n()*2.6;e.fillRect(n()*256,n()*256,a,a)}e.globalAlpha=1;const s=new vn(i);return s.wrapS=s.wrapT=ir,s.colorSpace=mt,s.anisotropy=4,s}function Tm(){const i=document.createElement("canvas");i.width=i.height=256;const e=i.getContext("2d");e.fillStyle="#f5f6f3",e.fillRect(0,0,256,256);let t=7;const n=()=>(t=t*16807%2147483647)/2147483647;e.fillStyle="#e8eae4";for(let s=0;s<600;s++)e.globalAlpha=.35+n()*.3,e.fillRect(n()*256,n()*256,1.6,1.6);e.globalAlpha=1,e.strokeStyle="#cfd3cb",e.lineWidth=3;for(const s of[0,128,256])e.beginPath(),e.moveTo(s,0),e.lineTo(s,256),e.moveTo(0,s),e.lineTo(256,s),e.stroke();const r=new vn(i);return r.wrapS=r.wrapT=ir,r.repeat.set(1/1.2,1/1.2),r.colorSpace=mt,r.anisotropy=4,r}const de={floor:new uu({map:ym(),shininess:60,specular:new qe(3026478)}),wall:new Tt({color:14541782}),endWall:new Tt({color:12175549}),ceiling:new Tt({map:Tm()}),door:new Tt({color:9083520}),liftDoor:new Tt({color:12042182}),stair:new Tt({color:12174013}),stairDark:new Tt({color:3817799}),rail:new Tt({color:8358806}),oak:new Tt({color:9071173}),glass:new Tt({color:3095104}),steel:new Tt({color:12831182}),led:new gn({color:16251391}),chair:new Tt({color:5140074}),daylight:new gn({color:14214894})};function wm(i,e,t,n){const r=i.attributes.uv,s=[[n,t],[n,t],[e,n],[e,n],[e,t],[e,t]];for(let o=0;o<6;o++){const[a,l]=s[o];for(let c=0;c<4;c++){const u=o*4+c;r.setXY(u,r.getX(u)*a,r.getY(u)*l)}}r.needsUpdate=!0}function ji(i,e){if(!i.length)return null;const t=i.map(s=>{const o=new Fn(s.w,s.h,s.d);return s.rx&&o.rotateX(s.rx),o.translate(s.x,s.y,s.z),o}),n=Bi(t);t.forEach(s=>s.dispose());const r=new Pt(n,e);return r.matrixAutoUpdate=!1,r}const tr={skirtH:.152,railH:.152,railCentre:.95},Io=new Tt({vertexColors:!0}),il=["#c98d64","#8d5a3c","#e3b498","#6b4a30","#d9a37e"],rl=["#2e2620","#5b4632","#8c8c8c","#d9d3c5","#141414"];function Zo(i){const e=i();if(e<.25)return{top:"#f2f3ef",legs:"#f2f3ef",cap:"#ffffff"};if(e<.31)return{top:"#20375c",legs:"#20375c",cap:"#ffffff"};if(e<.43)return{top:"#eeefe9",legs:"#565b62"};if(e<.55)return{top:"#68727d",legs:"#4c5257"};const t=["#7a8f6a","#c0a052","#7c5866","#5f7484","#96694f"],n=["#55504a","#3f464d","#6a5d4f","#44403a"];return{top:t[Math.floor(i()*t.length)],legs:n[Math.floor(i()*n.length)]}}function ur(i){let e=i%2147483646+1;for(let t=0;t<3;t++)e=e*16807%2147483647;return()=>(e=e*16807%2147483647)/2147483647}function Ct(i,e,t,n,r,s,o){const a=new Fn(i,e,t);a.translate(n,r,s);const l=new qe(o),c=a.attributes.position.count,u=new Float32Array(c*3);for(let h=0;h<c;h++)u[h*3]=l.r,u[h*3+1]=l.g,u[h*3+2]=l.b;return a.setAttribute("color",new Jt(u,3)),a}function Ko(i,e,t,n){const r=il[Math.floor(i()*il.length)],s=e.cap??rl[Math.floor(i()*rl.length)],o=[Ct(.2,.22,.2,0,t,n,r),Ct(.21,.08,.21,0,t+.15,n-.01,s)];return e.cap&&o.push(Ct(.24,.03,.24,0,t+.2,n-.01,e.cap)),o}function Am(i){const e=ur(i),t=Zo(e),n=[Ct(.09,.44,.11,-.09,.22,.17,t.legs),Ct(.09,.44,.11,.09,.22,.17,t.legs),Ct(.1,.13,.4,-.09,.5,.03,t.legs),Ct(.1,.13,.4,.09,.5,.03,t.legs),Ct(.32,.52,.2,0,.82,-.08,t.top),Ct(.08,.4,.1,-.21,.86,-.05,t.top),Ct(.08,.4,.1,.21,.86,-.05,t.top),...Ko(e,t,1.2,-.06)],r=Bi(n);return n.forEach(s=>s.dispose()),r}function Rm(i){const e=ur(i),t=Zo(e),n=[Ct(.1,.78,.12,-.09,.39,0,t.legs),Ct(.1,.78,.12,.09,.39,0,t.legs),Ct(.32,.52,.2,0,1.04,0,t.top),Ct(.08,.52,.1,-.21,1,0,t.top),Ct(.08,.52,.1,.21,1,0,t.top),...Ko(e,t,1.42,0)],r=Bi(n);return n.forEach(s=>s.dispose()),r}class Cm{constructor(e,t,n){this.a=e,this.b=t;const r=ur(n),s=Zo(r);this.len=e.distanceTo(t),this.speed=1+r()*.5,this.s=r()*this.len,this.dir=r()<.5?1:-1;const o=(h,f,p)=>{const x=new Pt(h,Io);return x.position.set(f,p,0),this.group.add(x),x},a=()=>Ct(.1,.78,.12,0,-.39,0,s.legs),l=()=>Ct(.08,.52,.1,0,-.26,0,s.top);this.legL=o(a(),-.09,.78),this.legR=o(a(),.09,.78),this.armL=o(l(),-.21,1.28),this.armR=o(l(),.21,1.28);const c=[Ct(.32,.52,.2,0,1.04,0,s.top),...Ko(r,s,1.42,0)],u=Bi(c);c.forEach(h=>h.dispose()),this.group.add(new Pt(u,Io)),this.place()}a;b;group=new Cn;legL;legR;armL;armR;s;dir=1;pause=0;phase=0;len;speed;place(){const e=this.s/this.len;this.group.position.lerpVectors(this.a,this.b,e);const t=(this.b.x-this.a.x)*this.dir,n=(this.b.z-this.a.z)*this.dir;this.group.rotation.y=Math.atan2(t,n)}update(e){if(this.pause>0){this.pause-=e;for(const n of[this.legL,this.legR,this.armL,this.armR])n.rotation.x*=Math.max(0,1-e*6);return}this.s+=this.speed*e*this.dir,(this.s<=0||this.s>=this.len)&&(this.s=Math.max(0,Math.min(this.len,this.s)),this.dir*=-1,this.pause=1.2+this.phase%1.3),this.phase+=this.speed*e*3.4;const t=Math.sin(this.phase)*.5;this.legL.rotation.x=t,this.legR.rotation.x=-t,this.armL.rotation.x=-t*.6,this.armR.rotation.x=t*.6,this.place(),this.group.position.y+=Math.abs(Math.sin(this.phase))*.025}}class Pm{constructor(e,t,n){this.zc=n;const r=new Fn(.05,2.06,.5),s=de.liftDoor;this.leafA=new Pt(r,s),this.leafB=new Pt(r.clone(),s),this.leafA.position.set(t,1.03,n-.25),this.leafB.position.set(t,1.03,n+.25),e.add(this.leafA,this.leafB)}zc;leafA;leafB;openT=0;target=0;update(e){this.openT+=(this.target-this.openT)*Math.min(1,e*5);const t=this.openT*.48;this.leafA.position.z=this.zc-.25-t,this.leafB.position.z=this.zc+.25+t}get openness(){return this.openT}}const sl=i=>i.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,""),N={CORRIDOR_W:3,ROOM_H:3,STOREY:4,DOOR_W:1.2,DOOR_H:2.1,DOOR_SPACING:2,ENTRY:2.2,END_ZONE:2.6,NOTICE_SPACING:1.25,LOBBY_W:7,LOBBY_D:7,LANDING_Z0:7,LANDING_Z1:10,STREET_Z0:7,STREET_Z1:11,STREET_H:4,STRIP:8.2,STAIR_SLOT:3.6,WING_GAP:12,PIT_X0:-3.5,PIT_X1:-.7,PIT_Z0:1.2,PIT_Z1:5.5},Im=(i,e,t=0,n=0)=>{const r=Math.max(t,n)*N.NOTICE_SPACING;return N.ENTRY+Math.max(i,e,1)*N.DOOR_SPACING+(r?r+.4:0)+N.END_ZONE};function Lm(i){const e=new Map(i.classes.map(g=>[g.id,g])),t={};for(const g of i.classes)t[g.id]=[];for(const g of i.classes)g.supers.length&&t[g.supers[0]]?.push(g.id);for(const g of i.classes){const E=new Set(t[g.id]);t[g.id]=g.subs.filter(D=>E.has(D))}const n=new Map;function r(g){if(n.has(g))return n.get(g);const E=t[g],D=E.filter(z=>t[z].length),L=[];let B=D.reduce((z,te)=>z+o(te),0),X=0;for(const z of E)t[z].length||(X<B?(L.push(z),X+=o(z)):(D.push(z),B+=o(z)));const Z={south:D,north:L,southSum:B,northSum:X};return n.set(g,Z),Z}const s=new Map;function o(g){if(s.has(g))return s.get(g);const E=t[g];let D=N.STRIP;if(E.length){const{southSum:L,northSum:B}=r(g);D=Math.max(N.STRIP,N.STAIR_SLOT+Math.max(L,B))}return s.set(g,D),D}const a={},l={};function c(g,E,D,L=!1){const B=e.get(g),X=t[g],Z=X.length?E+.2-N.PIT_X0:E+N.STRIP/2;if(a[g]={x:Z,level:D,y:-4*D,flip:L,corridorLen:Im(B.out.length,B.in.length,B.notes.length,B.examples.length)},X.length){const{south:z,north:te,southSum:$,northSum:V}=r(g);let Q=E+N.STAIR_SLOT;for(const Ne of z)c(Ne,Q,D+1,!1),Q+=o(Ne);let me=E+N.STAIR_SLOT;for(const Ne of te)c(Ne,me,D+1,!0),me+=o(Ne);const ye=new Set(X);l[g]={parentId:g,level:D+1,y:-4*(D+1),x0:E+.2,x1:E+N.STAIR_SLOT+Math.max($,V,5),stairX:Z+(N.PIT_X0+N.PIT_X1)/2,homeChildIds:X,southIds:z,northIds:te,portalChildIds:B.subs.filter(Ne=>!ye.has(Ne))}}}const u=g=>g.rootIds.reduce((E,D)=>E+o(D),0),h=i.wings.reduce((g,E)=>g+u(E),0);let f=0;const p=new Map;for(const g of i.wings){const E=f<h/2;p.set(g.key,E?"south":"north"),E&&(f+=u(g))}const x=[],v={south:6,north:6};for(const g of i.wings){const E=p.get(g.key),D=v[E];for(const L of g.rootIds)c(L,v[E],0),v[E]+=o(L);x.push({key:g.key,x0:D,x1:v[E],rootIds:g.rootIds,street:E}),v[E]+=N.WING_GAP}const m=Math.max(v.south,v.north)-N.WING_GAP+6;for(const g of x){if(g.street!=="north")continue;const E=g.x0+g.x1;for(const L of i.classes){if(L.wing!==g.key)continue;const B=a[L.id];B.x=E-B.x,B.flip=!B.flip,B.mirror=!0}const D=new Set(i.classes.filter(L=>L.wing===g.key).map(L=>L.id));for(const L of Object.values(l))D.has(L.parentId)&&([L.x0,L.x1]=[E-L.x1,E-L.x0],L.stairX=E-L.stairX,L.mirror=!0)}const d=[],T=[];for(const g of i.classes){const E=a[g.id];!E.mirror&&E.flip&&d.push(E),E.mirror&&!E.flip&&T.push(E)}let w=28;const A=2,C=N.CORRIDOR_W/2+.3,R=N.LOBBY_W/2+.15,P=(g,E,D,L)=>Math.abs(g.x-E.x)<D+L;for(const g of d)for(const E of T)g.level===E.level&&(P(g,E,C,C)&&(w=Math.max(w,12+g.corridorLen+E.corridorLen+A)),P(g,E,C,R)&&(w=Math.max(w,12+g.corridorLen+A)),P(g,E,R,C)&&(w=Math.max(w,12+E.corridorLen+A)));w=Math.ceil(w);const G=N.STREET_Z1+w+N.STREET_Z0+4;for(const g of i.classes){const E=a[g.id];E.mirror=!!E.mirror,E.oz=E.mirror?E.flip?G:G-17:E.flip?17:0}const M=[];for(const g of i.classes)for(const E of g.supers.slice(1))M.push({childId:g.id,parentId:E});return{areas:a,landings:l,homeChildren:t,nonPrimaryUp:M,wings:x,street:{x0:0,x1:m},loop:{C:w,K:G,xEnd:m,south:{z0:N.STREET_Z0,z1:N.STREET_Z1},north:{z0:N.STREET_Z1+w,z1:N.STREET_Z1+w+4},connectors:{west:[.2,3.8],east:[m-3.8,m-.2]}}}}const rn="__atrium",Dm=(i,e)=>i===null&&e===null?"":`${i??0}..${e===-1?"*":e??"*"}`,ol=(i,e)=>{if(i===null&&e===null)return"";const t=e===null||String(e)==="-1"?"*":String(e);return`${i??0}..${t}`},Yr=(i,e,t,n)=>`${[ol(n.oppMin,n.oppMax),i].filter(Boolean).join(" ")} — ${e} → ${[ol(n.min,n.max),t].filter(Boolean).join(" ")}`;class Jr{constructor(e,t,n,r=!1){this.group=e,this.origin=t,this.signs=n,this.f=r?-1:1,e.rotation.y=r?Math.PI:0}group;origin;signs;colliders=[];walkables=[];trims=[];plates=[];glass=[];leds=[];seats=[];f;local(e,t,n){return new O(this.origin.x+this.f*e,this.origin.y+t,this.origin.z+this.f*n)}batches=new Map;box(e,t,n,r,s,o,a,l={solid:!0}){const c={w:e,h:t,d:n,x:s,y:o,z:a,worldUV:l.vinyl||l.worldUV},u=this.batches.get(r);u?u.push(c):this.batches.set(r,[c]);const h=this.origin.x+this.f*s,f=this.origin.z+this.f*a,p=new Et(new O(h-e/2,this.origin.y+o-t/2,f-n/2),new O(h+e/2,this.origin.y+o+t/2,f+n/2));if(l.solid&&this.colliders.push(p),l.walkable&&this.walkables.push(p),l.trim)for(const x of l.trim)this.trimFace(x,e,t,n,s,o,a)}trimFace(e,t,n,r,s,o,a){const l=o-n/2,c=.05,u=e.startsWith("x")?{w:c,d:Math.max(.3,r-.1)}:{w:Math.max(.3,t-.1),d:c},h=c/2+.005,f=e==="x+"?s+t/2+h:e==="x-"?s-t/2-h:s,p=e==="z+"?a+r/2+h:e==="z-"?a-r/2-h:a;this.trims.push({...u,h:tr.skirtH,x:f,y:l+tr.skirtH/2,z:p},{...u,h:tr.railH,x:f,y:l+tr.railCentre,z:p})}led(e,t,n,r=.6,s=.6){this.leds.push({w:r,h:.035,d:s,x:e,y:n,z:t})}oakSpec(e){this.trims.push(e)}steelSpec(e){this.plates.push(e)}chairSpots=[];peopleGeos=[];sit(e,t,n,r,s){const o=Am(s);r===-1&&o.rotateY(Math.PI),o.translate(e,t,n),this.peopleGeos.push(o)}stand(e,t,n,r,s){const o=Rm(s);o.rotateY(r),o.translate(e,t,n),this.peopleGeos.push(o)}chair(e,t,n,r=1){this.chairSpots.push({x:e,y:t,z:n,face:r});const s=t+.45;this.seats.push({w:.44,h:.06,d:.4,x:e,y:s,z:n}),this.seats.push({w:.44,h:.48,d:.05,x:e,y:s+.36,z:n-r*.19});for(const[o,a]of[[-.18,-.16],[.18,-.16],[-.18,.16],[.18,.16]])this.plates.push({w:.035,h:.44,d:.035,x:e+o,y:t+.22,z:n+a});this.colliders.push(new Et().setFromPoints([this.local(e-.26,t,n-.26),this.local(e+.26,t+.95,n+.26)]))}doorFurniture(e,t,n,r){const o=e.startsWith("x"),a=o?{w:.02,d:.28}:{w:.28,d:.02},l=o?{w:.02,d:N.DOOR_W-.25}:{w:N.DOOR_W-.25,d:.02},c=o?{w:.02,d:.1}:{w:.1,d:.02},u=.06,h=e==="x+"?t+u:e==="x-"?t-u:t,f=e==="z+"?r+u:e==="z-"?r-u:r,p=.42;this.glass.push({...a,h:.42,x:h,y:n+1.5,z:f}),this.plates.push({...l,h:.25,x:h,y:n+.13,z:f}),this.plates.push({...c,h:.3,x:o?h:t+p,y:n+1.05,z:o?r+p:f})}populate(e,t){if(e!=="off"){const n=e==="full"?.4:.2,r=ur(t);for(const s of this.chairSpots)r()<n&&this.sit(s.x,s.y+.03,s.z,s.face,Math.floor(r()*99991))}if(this.peopleGeos.length){const n=Bi(this.peopleGeos);this.peopleGeos.forEach(s=>s.dispose());const r=new Pt(n,Io);r.matrixAutoUpdate=!1,this.group.add(r),this.peopleGeos=[]}}finalize(){for(const[e,t]of this.batches){const n=t.map(o=>{const a=new Fn(o.w,o.h,o.d);return o.worldUV&&wm(a,o.w,o.h,o.d),a.translate(o.x,o.y,o.z),a}),r=Bi(n);n.forEach(o=>o.dispose());const s=new Pt(r,e);s.matrixAutoUpdate=!1,this.group.add(s)}this.batches.clear();for(const e of[ji(this.trims,de.oak),ji(this.plates,de.steel),ji(this.glass,de.glass),ji(this.leds,de.led),ji(this.seats,de.chair)])e&&this.group.add(e)}sign(e,t,n,r,s,o,a,l){const c=bm(this.signs,e,t,this.local(n,r,s),a,l);return c.position.set(n,r,s),c.rotation.y=o,c.matrixAutoUpdate=!1,c.updateMatrix(),this.group.add(c),c}}function Um(i,e,t){const{byId:n,layout:r}=e,s=new Cn;s.name=`area:${i.label}`,s.position.copy(t);const o=r.areas[i.id].flip,a=o?Math.PI:0,l=new Jr(s,t,e.signs,o),c=[],u=Xn(i.wing),h=r.areas[i.id].corridorLen,f=N.CORRIDOR_W,p=N.ROOM_H,x=N.LOBBY_W,v=N.LOBBY_D,m=r.landings[i.id],d=i.supers.length===0,T=-h/2;l.box(f,.1,h,de.floor,0,-.05,T,{walkable:!0,vinyl:!0}),l.box(f,.1,h,de.ceiling,0,p+.05,T,{worldUV:!0}),l.box(.15,p,h,de.wall,f/2+.075,p/2,T,{solid:!0,trim:["x-"]}),l.box(.15,p,h,de.wall,-f/2-.075,p/2,T,{solid:!0,trim:["x+"]}),l.box(f+.3,p,.15,de.endWall,0,p/2,-h-.075,{solid:!0,trim:["z+"]});for(let ne=0;ne<Math.floor(h/3);ne++)l.led(0,-(ne+.6)*3,p-.02,.35,1.3);m?(l.box(x/2-N.PIT_X1,.1,v,de.floor,(N.PIT_X1+x/2)/2,-.05,v/2,{walkable:!0,vinyl:!0}),l.box(N.PIT_X1-N.PIT_X0,.1,N.PIT_Z0,de.floor,(N.PIT_X0+N.PIT_X1)/2,-.05,N.PIT_Z0/2,{walkable:!0,vinyl:!0}),l.box(N.PIT_X1-N.PIT_X0,.1,v-N.PIT_Z1,de.floor,(N.PIT_X0+N.PIT_X1)/2,-.05,(N.PIT_Z1+v)/2,{walkable:!0,vinyl:!0})):l.box(x,.1,v,de.floor,0,-.05,v/2,{walkable:!0,vinyl:!0}),l.box(x,.1,v,de.ceiling,0,p+.05,v/2,{worldUV:!0}),l.box(.15,p,v,de.wall,x/2+.075,p/2,v/2,{solid:!0,trim:["x-"]}),l.box(.15,p,v,de.wall,-x/2-.075,p/2,v/2,{solid:!0,trim:["x+"]});const w=(x-f)/2;l.box(w,p,.15,de.wall,f/2+w/2,p/2,-.075,{solid:!0,trim:["z+","z-"]}),l.box(w,p,.15,de.wall,-2.5,p/2,-.075,{solid:!0,trim:["z+","z-"]}),l.box(2,p,.15,de.wall,-2.5,p/2,v+.075,{solid:!0,trim:["z-","z+"]}),l.box(2,p,.15,de.wall,2.5,p/2,v+.075,{solid:!0,trim:["z-","z+"]}),l.box(3,p-N.DOOR_H-.3,.15,de.wall,0,(p+N.DOOR_H+.3)/2,v+.075,{});for(const ne of[-1.8,1.8])for(const he of[2,5])l.led(ne,he,p-.02);const A=d?N.STREET_H:N.ROOM_H,C=d?2.7:2.4,R=d?0:.4;for(const ne of[1,-1])l.sign(1.6,.44,R+ne*.015,C,v+1.35,ne*Math.PI/2,()=>pt({widthPx:800,heightPx:220,title:i.label,subtitle:i.roomNumber?`Room ${i.roomNumber}`:`${i.wing} wing`,titleSize:62}),`hang:${i.label}:${ne}`);for(const ne of[R-.6,R+.6])l.steelSpec({w:.03,h:A-C-.22,d:.03,x:ne,y:(A+C+.22)/2,z:v+1.35});const P=new gn({color:new qe(u)});l.box(.18,.012,v+h,P,0,.012,(v-h)/2,{}),l.sign(2.6,.7,0,p-.5,.08,0,()=>pt({widthPx:1024,heightPx:276,title:i.label,subtitle:[i.roomNumber?`Room ${i.roomNumber}`:null,`${i.wing} wing · ${i.floor?`level −${i.floor}`:"ground"}`].filter(Boolean).join(" · "),titleSize:96}),`name:${i.label}`);const G=i.supers.map(ne=>n.get(ne)?.label??"?");l.sign(2.9,.62,0,N.DOOR_H+.55,v-.09,Math.PI,()=>pt({widthPx:1152,heightPx:246,title:d?"⌂ Hospital Street":`Stairs ↑ ${G[0]}`,subtitle:d?"reception · all wings":`landing · stairs at the west end${G.length>1?` · also: ${G.slice(1).join(", ")}`:""}`,titleSize:74}),`back:${i.label}`),l.sign(1.9,1.5,2.5,1.62,.01,0,()=>pt({widthPx:1024,heightPx:810,title:i.label,subtitle:[i.plural?`plural: ${i.plural}`:null,i.alsoKnownAs.length?`also: ${i.alsoKnownAs.join("; ")}`:null,i.roomNumber?`Room ${i.roomNumber}`:null].filter(Boolean).join(" · "),body:i.description??"Definition pending.",footer:i.source?`Source: ${i.source}`:void 0,fitBody:!0,titleSize:88,align:"left"}),`poster:${i.label}`),e.illustrations?.has(sl(i.label))&&(l.oakSpec({w:1.3,h:1.38,d:.05,x:-2.5,y:1.62,z:-.02}),l.sign(1.2,1.28,-2.5,1.62,.01,0,()=>Po(`art/illustrations/${sl(i.label)}.jpg`,1.2/1.28),`illu:${i.label}`));const M=i.self.length;i.deprecated.length&&l.sign(.9,.42,-1.44,1.9,-1.4,Math.PI/2,()=>Mm(i.deprecated),`old:${i.label}`);const g=Math.max(i.out.length,i.in.length,1)*N.DOOR_SPACING,E=-(N.ENTRY+g+.2),D=(ne,he)=>{const we=ne.match(/(\d+)/);return we?`${he} ${we[1]}`:he};let L=0;const B=(ne,he,we,I,Je)=>{const Be=ne==="right"?1:-1,tt=E-(he+.5)*N.NOTICE_SPACING;l.oakSpec({w:.05,h:1.34,d:1.06,x:Be*(f/2-.035),y:1.55,z:tt}),l.sign(.94,1.22,Be*(f/2-.075),1.55,tt,Be>0?-Math.PI/2:Math.PI/2,()=>vm(we,I,Je),`notice:${i.label}:${we}`),L++};i.notes.forEach((ne,he)=>B("left",he,D(ne.key,"Note"),Gi,ne.text)),i.examples.forEach((ne,he)=>B("right",he,D(ne.key,"Example"),tl,ne.text));const X=i.notes.length-i.examples.length,Z=Math.min(Math.abs(X),2);for(let ne=0;ne<Z;ne++){const he=X>0?1:-1,we=(X>0?i.examples.length:i.notes.length)+ne,I=E-(we+.5)*N.NOTICE_SPACING,Je=(i.id.charCodeAt(0)+i.id.charCodeAt(3)*31+ne*7>>>0)%997,Be=e.art.length?e.art[Je%e.art.length]:null;l.oakSpec({w:.05,h:1.02,d:1.36,x:he*(f/2-.035),y:1.68,z:I}),l.sign(1.28,.94,he*(f/2-.075),1.68,I,he>0?-Math.PI/2:Math.PI/2,()=>Be?Po(`art/${Be.file}`):Wl(Je),`print:${i.label}:${ne}`),l.sign(.44,.13,he*(f/2-.075),1.05,I,he>0?-Math.PI/2:Math.PI/2,()=>Be?Xr(Be.title,`${Be.artist} · ${Be.licence} · Wikimedia Commons`):Xr("Untitled study","Procedural print — placeholder"),`placard:${i.label}:${ne}`)}l.chair(2.35,0,.42,1),l.chair(2.95,0,.42,1),l.chair(-2.35,0,.42,1),l.chair(-2.95,0,.42,1);const z=ne=>-(N.ENTRY+(ne+.5)*N.DOOR_SPACING),te=(ne,he,we,I,Je,Be,tt,Se)=>{const y=ne==="right"?1:-1,_=y*(f/2),F=z(he);l.box(.08,N.DOOR_H,N.DOOR_W,de.door,_-y*.05,N.DOOR_H/2,F,{}),l.doorFurniture(y>0?"x-":"x+",_-y*.05,0,F);const ee=y*.75;for(const re of[1,-1])l.sign(1.3,.56,ee,2.42,F+re*.015,re>0?0:Math.PI,()=>pt({widthPx:760,heightPx:328,title:tt,subtitle:Se,titleSize:50}),`doorsign:${Je}:${re}`);for(const re of[ee-.45,ee+.45])l.steelSpec({w:.03,h:p-2.69,d:.03,x:re,y:(p+2.69)/2,z:F});c.push({kind:we,areaId:i.id,elementId:I,label:Je,targetIds:[Be],triggerPos:l.local(_-y*.45,0,F),radius:.75,halfX:.4,halfZ:.55,auto:!0,exitPos:l.local(_-y*1.35,0,F),exitYaw:(y>0?Math.PI/2:-Math.PI/2)+a})};i.out.forEach((ne,he)=>{const we=n.get(ne.targetId)?.label??"?";te("right",he,"door-out",ne.elementId,ne.label,ne.targetId,we,Yr(i.label,ne.label,we,ne))}),i.in.forEach((ne,he)=>{const we=n.get(ne.sourceId)?.label??"?";te("left",he,"door-in",ne.elementId,ne.label,ne.sourceId,we,Yr(we,ne.label,i.label,ne))});const $=ne=>e.art.length?e.art[ne%e.art.length]:null,V=ne=>(i.id.charCodeAt(1)*17+i.id.charCodeAt(5)*5+ne*31>>>0)%997,Q=Math.max(i.out.length,i.in.length,1),me=(ne,he)=>{const we=ne==="right"?1:-1;for(let I=he;I<Q;I+=2){const Je=V(I*2+(we>0?1:0));Dn(l,$(Je),Je,we*(f/2-.075),1.68,z(I),we>0?-Math.PI/2:Math.PI/2,`${i.label}:${ne}:${I}`)}};i.out.length<Q&&me("right",i.out.length),i.in.length<Q&&me("left",i.in.length);{const ne=V(99);Dn(l,$(ne),ne,f/2-.075,1.68,-1.15,-Math.PI/2,`${i.label}:entry`)}if(i.self.forEach((ne,he)=>{const we=f/2-.8-he*(N.DOOR_W+.2);l.box(N.DOOR_W,N.DOOR_H,.08,de.door,we,N.DOOR_H/2,-h+.06,{}),l.doorFurniture("z+",we,0,-h+.06),l.sign(1.3,.4,we,N.DOOR_H+.4,-h+.07,0,()=>pt({widthPx:768,heightPx:236,title:`${ne.label} ${Dm(ne.min,ne.max)}`,subtitle:`→ ${i.label}`,titleSize:56}),`selfsign:${ne.label}`),c.push({kind:"door-self",areaId:i.id,elementId:ne.elementId,label:ne.label,targetIds:[i.id],triggerPos:l.local(we,0,-h+.5),radius:.7,halfX:.55,halfZ:.45,auto:!0})}),!M){for(const ne of[-1,1]){const he=ne*.44;l.box(.85,N.DOOR_H,.08,de.door,he,N.DOOR_H/2,-h+.06,{}),l.steelSpec({w:.7,h:.05,d:.05,x:he,y:1.05,z:-h+.13}),l.steelSpec({w:.7,h:.22,d:.02,x:he,y:.13,z:-h+.11})}l.steelSpec({w:.04,h:N.DOOR_H,d:.03,x:0,y:N.DOOR_H/2,z:-h+.11}),l.sign(1.1,.34,0,N.DOOR_H+.35,-h+.07,0,()=>pt({widthPx:640,heightPx:198,title:"FIRE EXIT",subtitle:"emergency use only",background:tl,titleSize:78,align:"center"}),`fire:${i.label}`)}const ye=i.supers.length>0||i.subs.length>0;let Ne,He,q;const se=[],ie=[];{const ne=Lo(i,n),he=ne.length?Math.max(...ne.map(we=>we.level)):0;for(let we=he;we>=1;we--)for(const I of ne.filter(Je=>Je.level===we)){const Je=n.get(I.id);se.push({text:`▲${we} ${Je?.label??"?"}`,chip:Xn(Je?.wing??"")}),ie.push(I.id)}se.push({text:`● ${i.label}`,strong:!0,chip:u}),ie.push(null);for(const we of i.subs){const I=n.get(we);se.push({text:`▼1 ${I?.label??"?"}`,chip:Xn(I?.wing??"")}),ie.push(we)}se.push({text:"⌂ Reception"}),ie.push(rn)}const ge={widthPx:850,heightPx:750,title:ye?"Lift":"Exit",subtitle:i.label,rows:se,rowSize:se.length>10?30:38,columns:se.length>10?2:1},pe=(()=>{const ne=Co(ge,se.length);return se.flatMap((he,we)=>ne[we]&&ie[we]?[{rect:ne[we],id:ie[we],label:he.text.replace(/^[▲▼●⌂]\S* ?/u,"")}]:[])})();let Ve;ye&&(l.box(.08,2.4,5.15-4.85,de.liftDoor,2+.04,2.4/2,(4.85+5.15)/2),l.box(.08,2.4,6.45-6.15,de.liftDoor,2+.04,2.4/2,(6.15+6.45)/2),l.box(.08,2.4-N.DOOR_H,1,de.liftDoor,2+.04,(2.4+N.DOOR_H)/2,5.65,{}),l.box(3.42-2,2.4,.08,de.liftDoor,2.71,2.4/2,4.85+.04),l.box(3.42-2,2.4,.08,de.liftDoor,2.71,2.4/2,6.45-.04),l.box(3.42-2,.06,6.45-4.85,de.liftDoor,2.71,2.4+.03,5.65,{}),l.led(2.71,5.65,2.4-.02,.5,.5),q={doors:new Pm(s,2+.1,5.65),doorwayPos:l.local(2+.05,0,5.65)},l.steelSpec({w:.06,h:2.12,d:.09,x:2-.01,y:1.06,z:5.12}),l.steelSpec({w:.06,h:2.12,d:.09,x:2-.01,y:1.06,z:6.18}),l.steelSpec({w:.06,h:.09,d:1.15,x:2-.01,y:2.14,z:5.65}),l.steelSpec({w:.16,h:.02,d:1.05,x:2+.02,y:.012,z:5.65}),l.steelSpec({w:.03,h:.26,d:.16,x:2-.015,y:1.12,z:4.99}),l.sign(.1,.2,2-.035,1.12,4.99,-Math.PI/2,()=>pt({widthPx:64,heightPx:128,title:"▲",subtitle:"▼",titleSize:40,align:"center"}),`liftcall:${i.label}`),l.sign(.72,.24,2-.015,2.27,5.65,-Math.PI/2,()=>pt({widthPx:384,heightPx:128,title:"LIFT",subtitle:i.floor?`level −${i.floor}`:"ground",titleSize:56,align:"center"}),`liftind:${i.label}`),l.steelSpec({w:1.24,h:.05,d:.04,x:2.71+.04,y:.92,z:4.85+.13}),l.steelSpec({w:1.24,h:.05,d:.04,x:2.71+.04,y:.92,z:6.45-.13}),l.steelSpec({w:.04,h:.05,d:1.44,x:3.42-.13,y:.92,z:5.65}),l.sign(.42,.15,2.71+.35,2.02,4.85+.09,0,()=>pt({widthPx:336,heightPx:120,title:"MAX 8 PERSONS · 610 kg",titleSize:30,align:"center",background:"#e8e9e4",color:"#3a4046"}),`liftload:${i.label}`),l.sign(.4,.14,2.71-.2,1.78,6.45-.09,Math.PI,()=>pt({widthPx:320,heightPx:112,title:"NO SMOKING",titleSize:40,align:"center",background:"#f4f4f1",color:"#b3261e"}),`liftsmoke:${i.label}`),Ve=l.sign(.95,1.05,2.71-.08,1.3,4.85+.09,0,()=>nr(ge),`liftcab:${i.label}`),Ne=l.local(2.71,0,5.65),He=Math.PI/2+a,c.push({kind:"lift",areaId:i.id,label:"Lift",targetIds:[],triggerPos:Ne.clone(),radius:.75,auto:!1,prompt:"E — Lift: select destination"}));const lt=l.sign(1.7,1.5,x/2-.09,1.7,3.1,-Math.PI/2,()=>nr(ge),`liftboard:${i.label}`);let $e;if(ye&&($e=[{kind:"lift",mesh:lt,cells:pe}],Ve&&$e.push({kind:"lift",mesh:Ve,cells:pe})),i.supers.slice(1).forEach((ne,he)=>{const we=n.get(ne),I=6.35-he*1.15;l.box(.1,N.DOOR_H,1,de.door,-3.5+.06,N.DOOR_H/2,I,{}),l.doorFurniture("x+",-3.5+.06,0,I),l.sign(1.35,.42,-3.5+.1,N.DOOR_H+.4,I,Math.PI/2,()=>pt({widthPx:768,heightPx:240,title:`Stairs ↑ ${we?.label??"?"}`,subtitle:`${we?.wing??"?"} wing`,titleSize:56}),`upportal:${we?.label}`),c.push({kind:"stair-up",areaId:i.id,label:`Stairs ↑ ${we?.label??"?"}`,targetIds:[ne],triggerPos:l.local(-3.5+.5,0,I),radius:.7,halfX:.45,halfZ:.55,auto:!0})}),m?Nm(i,l,c,e):i.subs.length&&i.subs.forEach((ne,he)=>{const we=n.get(ne),I=4.6-he*1.15;l.box(.1,N.DOOR_H,1,de.door,-3.5+.06,N.DOOR_H/2,I,{}),l.doorFurniture("x+",-3.5+.06,0,I),l.sign(1.35,.42,-3.5+.1,N.DOOR_H+.4,I,Math.PI/2,()=>pt({widthPx:768,heightPx:240,title:`↓ ${we?.label??"?"}`,subtitle:`homed in ${we?.wing??"?"} wing`,titleSize:56}),`downportal:${we?.label}`),c.push({kind:"stair-down",areaId:i.id,label:`Stairs ↓ ${we?.label??"?"}`,targetIds:[ne],triggerPos:l.local(-3.5+.5,0,I),radius:.7,halfX:.45,halfZ:.55,auto:!0})}),i.subs.length){const ne=i.subs.map(he=>n.get(he)?.label??"?");l.sign(1.9,.85,-3.5+.09,2.45,3.3,Math.PI/2,()=>nr({widthPx:900,heightPx:400,title:"Stairs ↓",rows:ne.map(he=>({text:he})),rowSize:ne.length>6?34:44,columns:ne.length>8?2:1}),`stairsdown:${i.label}`)}const et=[new Et().setFromPoints([l.local(-x/2-.3,-.5,-.2),l.local(x/2+.3,2.5,v+.2)]),new Et().setFromPoints([l.local(-f/2-.4,-.5,-h-.5),l.local(f/2+.4,2.5,0)])];if(m){const ne=o?-1:1;et.push(new Et().setFromPoints([l.local(N.PIT_X0-.2,-4-.5,N.PIT_Z0-.2),l.local(N.PIT_X1+.2,2.5,v+.2)]),new Et().setFromPoints([new O(m.x0-.3,t.y-N.STOREY-.5,t.z+ne*5.4),new O(m.x1+.3,t.y-N.STOREY+2.5,t.z+ne*(N.LANDING_Z1+.3))]))}return l.populate(e.people,i.id.charCodeAt(0)*131+i.id.charCodeAt(4)*17+i.id.charCodeAt(8)>>>0),l.finalize(),{id:i.id,wc:i,label:i.label,group:s,colliders:l.colliders,walkables:l.walkables,interactables:c,spawnPos:l.local(0,0,4.6),spawnYaw:a,liftPos:Ne,liftYaw:He,lift:q,boards:$e,notices:L,boxes:et}}function Nm(i,e,t,n){const{byId:r,layout:s}=n,o=s.landings[i.id],a=e.origin,l=N.STOREY,c=N.PIT_X1-N.PIT_X0,u=c/2-.1,h=N.PIT_X0+u/2,f=N.PIT_X1-u/2,p=.8,x=N.PIT_Z1-N.PIT_Z0-p,v=12,m=x/v;for(let $=0;$<v;$++){const V=-(($+1)*(l/2))/v;e.box(u,.09,m+.02,de.oak,h,V-.045,N.PIT_Z1-($+.5)*m,{walkable:!0})}e.box(c,.1,p,de.oak,(N.PIT_X0+N.PIT_X1)/2,-l/2-.05,N.PIT_Z0+p/2,{walkable:!0});for(let $=0;$<v;$++){const V=-l/2-($+1)*(l/2)/v;e.box(u,.09,m+.02,de.oak,f,V-.045,N.PIT_Z0+p+($+.5)*m,{walkable:!0})}e.box(c,.1,N.LOBBY_D-N.PIT_Z1+.1,de.floor,(N.PIT_X0+N.PIT_X1)/2,-l-.05,(N.PIT_Z1+N.LOBBY_D)/2,{walkable:!0,vinyl:!0});const d=l+N.ROOM_H;e.box(.1,d,N.LOBBY_D-N.PIT_Z0,de.wall,N.PIT_X0-.05,-l+d/2-N.ROOM_H,(N.PIT_Z0+N.LOBBY_D)/2),e.box(.1,l,N.PIT_Z1-N.PIT_Z0,de.wall,N.PIT_X1+.05,-l/2,(N.PIT_Z0+N.PIT_Z1)/2),e.box(.1,l,N.LOBBY_D-N.PIT_Z1,de.wall,N.PIT_X1+.05,-l/2,(N.PIT_Z1+N.LOBBY_D)/2),e.box(c+.2,l,.1,de.wall,(N.PIT_X0+N.PIT_X1)/2,-l/2,N.PIT_Z0-.05);const T=tr.railCentre,w=($,V,Q,me,ye)=>{const Ne=Math.abs(Q-$)>Math.abs(me-V),He=Ne?Q-$:me-V;e.oakSpec({w:Ne?He:.06,h:.06,d:Ne?.06:He,x:($+Q)/2,y:ye+T,z:(V+me)/2});for(let q=.15;q<He;q+=.3)e.oakSpec({w:.035,h:T-.03,d:.035,x:Ne?$+q:$,y:ye+(T-.03)/2,z:Ne?V:V+q});e.colliders.push(new Et().setFromPoints([e.local(Math.min($,Q)-.05,ye,Math.min(V,me)-.05),e.local(Math.max($,Q)+.05,ye+T+.05,Math.max(V,me)+.05)]))};w(N.PIT_X1+.04,N.PIT_Z0,N.PIT_X1+.04,N.PIT_Z1,0),w(N.PIT_X0,N.PIT_Z0-.04,N.PIT_X1,N.PIT_Z0-.04,0),w(N.PIT_X1-u-.2,N.PIT_Z1+.04,N.PIT_X1,N.PIT_Z1+.04,0);const A=($,V,Q)=>{e.oakSpec({w:.09,h:T+.17,d:.09,x:$,y:Q+(T+.17)/2,z:V}),e.oakSpec({w:.13,h:.035,d:.13,x:$,y:Q+T+.17,z:V})};A(N.PIT_X1+.04,N.PIT_Z0-.04,0),A(N.PIT_X1+.04,N.PIT_Z1+.04,0),A(N.PIT_X1-u-.2,N.PIT_Z1+.04,0);{const $=(N.PIT_X0+N.PIT_X1)/2,V=Math.atan2(l/2,x),Q=Math.hypot(x,l/2)+.15,me=N.PIT_Z1,ye=N.PIT_Z0+p,Ne=(me+ye)/2,He=ie=>T-l/2*((me-ie)/x),q=(ie,ge,pe)=>e.oakSpec({w:.07,h:.07,d:Q,x:ie,y:ge,z:Ne,rx:pe});q($,T-l/4,-V),q($,T-3*l/4,V),q(N.PIT_X0+.08,T-l/4,-V),q(N.PIT_X1-.08,T-3*l/4,V),A($,me+.04,0),A($,ye-.06,-l/2),A($,me+.06,-l);const se=ie=>T-l+l/2*((me-ie)/x);for(let ie=ye+.15;ie<me;ie+=.3)for(const ge of[He(ie),se(ie)])e.oakSpec({w:.035,h:T-.06,d:.035,x:$,y:ge-.03-(T-.06)/2,z:ie});e.colliders.push(new Et().setFromPoints([e.local($-.06,-l,N.PIT_Z0+.8),e.local($+.06,1,N.PIT_Z1)]))}const C=s.areas[i.id].flip?-1:1,R=$=>C*($-a.x),P=-l,[G,M]=[R(o.x0),R(o.x1)].sort(($,V)=>$-V),g=M-G,E=(G+M)/2,D=(N.LANDING_Z0+N.LANDING_Z1)/2;e.box(g,.1,3,de.floor,E,P-.05,D,{walkable:!0,vinyl:!0}),e.box(g,.1,3,de.ceiling,E,P+N.ROOM_H+.05,D,{worldUV:!0}),e.box(.15,N.ROOM_H,3.3,de.wall,G-.075,P+N.ROOM_H/2,D,{solid:!0,trim:["x+"]}),e.box(.15,N.ROOM_H,3.3,de.wall,M+.075,P+N.ROOM_H/2,D,{solid:!0,trim:["x-"]});for(let $=0;$<Math.floor(g/3.5);$++)e.led(G+($+.5)*3.5,D,P+N.ROOM_H-.02,.35,1.3);const L=$=>{const V=R(s.areas[$].x);return[V-N.LOBBY_W/2,V+N.LOBBY_W/2]},B=($,V,Q)=>{const me=[],ye=[...Q].sort((He,q)=>He[0]-q[0]);let Ne=G;for(const[He,q]of ye)He>Ne&&(e.box(He-Ne,N.ROOM_H,.15,de.wall,(Ne+He)/2,P+N.ROOM_H/2,$,{solid:!0,trim:[V]}),me.push([Ne,He])),Ne=Math.max(Ne,q);return M>Ne&&(e.box(M-Ne,N.ROOM_H,.15,de.wall,(Ne+M)/2,P+N.ROOM_H/2,$,{solid:!0,trim:[V]}),me.push([Ne,M])),me},X=o.northIds.map(L),Z=B(N.LANDING_Z0-.075,"z+",[[N.PIT_X0,N.PIT_X1],...o.southIds.map(L)]);B(N.LANDING_Z1+.075,"z-",X);for(const[$,V]of Z)if(!(V-$<4.5))for(let Q=$+2.3;Q<=V-2.3;Q+=6.5){const me=(Math.round(Q*13)+i.id.charCodeAt(2)>>>0)%997;Dn(e,n.art.length?n.art[me%n.art.length]:null,me,Q,P+1.7,N.LANDING_Z0+.01,0,`${i.label}:land:${Math.round(Q)}`)}e.sign(2.4,.6,(N.PIT_X0+N.PIT_X1)/2,P+N.DOOR_H+.5,N.LANDING_Z1-.09,Math.PI,()=>pt({widthPx:1024,heightPx:256,title:`Stairs ↑ ${i.label}`,subtitle:`${i.wing} wing · ${i.floor?`level −${i.floor}`:"ground"}`,titleSize:72}),`landingup:${i.label}`);let z=N.PIT_X1+1.6;const te=$=>{for(const[V,Q]of X)if($>V-.85&&$<Q+.85)return Q+.95;return $};o.portalChildIds.forEach($=>{const V=r.get($);let Q=te(z);for(;Q!==z;)z=Q,Q=te(z);z=Math.min(z,M-1),Q=z,z+=2,e.box(.08,N.DOOR_H,N.DOOR_W,de.door,Q,P+N.DOOR_H/2,N.LANDING_Z1-.05,{}),e.doorFurniture("z-",Q,P,N.LANDING_Z1-.05),e.sign(1.5,.45,Q,P+N.DOOR_H+.45,N.LANDING_Z1-.09,Math.PI,()=>pt({widthPx:768,heightPx:230,title:`↓ ${V?.label??"?"}`,subtitle:`homed in ${V?.wing??"?"} wing`,titleSize:58}),`downportal:${V?.label}`),t.push({kind:"stair-down",areaId:i.id,label:`Stairs ↓ ${V?.label??"?"}`,targetIds:[$],triggerPos:e.local(Q,-l,N.LANDING_Z1-.5),radius:.7,halfX:.55,halfZ:.45,auto:!0})});for(let $=0;$<3;$++){const V=M-.8-$*.6;if(V<z+.8)break;X.some(([Q,me])=>V>Q-.45&&V<me+.45)||e.chair(V,P,N.LANDING_Z1-.45,-1)}}function Dn(i,e,t,n,r,s,o,a){const l=Math.sin(o),c=Math.cos(o),u=Math.abs(l)>.5;i.oakSpec({w:u?.05:1.36,h:1.02,d:u?1.36:.05,x:n-l*.045,y:r,z:s-c*.045}),i.sign(1.28,.94,n,r,s,o,()=>e?Po(`art/${e.file}`):Wl(t),`pic:${a}`),i.sign(.44,.13,n,r-.62,s,o,()=>e?Xr(e.title,`${e.artist} · ${e.licence} · Wikimedia Commons`):Xr("Untitled study","Procedural print — placeholder"),`picplacard:${a}`)}function Lo(i,e){const t=new Map;let n=[i.id],r=0;for(;n.length;){r++;const s=[];for(const o of n)for(const a of e.get(o)?.supers??[])t.has(a)||(t.set(a,r),s.push(a));n=s}return[...t].map(([s,o])=>({id:s,level:o}))}const oi="__theatre";function Fm(i,e,t){const n=new Cn;n.name="area:theatre";const r=new Jr(n,new O(0,0,0),i),s=-24,o=-4,a=20,l=33.5,c=(s+o)/2,u=(a+l)/2,h=4.5,f=5,p=1.7,x=.35,v=-f*x,m=v+.4,d=de.wall.clone(),T=de.ceiling.clone(),w=de.floor.clone(),A=de.led.clone(),C=new Tt({color:2830648}),R=new Tt({color:9264970}),P=new Tt({color:6715727}),G=new Tt({color:13623528,transparent:!0,opacity:.3}),M=[d,T,w,C].map(V=>({m:V,base:V.color.clone()})),g=V=>{for(const Q of M)Q.m.color.copy(Q.base).multiplyScalar(V?1:.3);A.color.set(V?16251391:4212047)},E=-15;r.box(3,.1,5,de.floor,E,-.05,17.5,{walkable:!0,vinyl:!0}),r.box(3,.1,5,de.ceiling,E,3.05,17.5,{worldUV:!0});for(const[V,Q]of[[E-1.575,"x+"],[E+1.575,"x-"]]){r.box(.15,1,5,de.wall,V,.5,17.5,{solid:!0,trim:[Q]}),r.box(.08,1.7,5,G,V,1.85,17.5,{solid:!0}),r.box(.15,.3,5,de.wall,V,2.85,17.5,{});for(const me of[16.2,17.5,18.8])r.steelSpec({w:.18,h:1.7,d:.07,x:V,y:1.85,z:me})}for(const V of[16.4,18.6])r.led(E,V,2.98);r.sign(2.6,.62,E,2.55,a-.09,Math.PI,()=>pt({widthPx:1152,heightPx:260,title:"Postgraduate Medical Centre",subtitle:"lecture theatre · seminars & presentations",titleSize:74}),"theatre-door");const D=h+2.4,L=h-D/2;r.box(.15,D,l-a,d,s-.075,L,u,{solid:!0}),r.box(.15,D,l-a,d,o+.075,L,u,{solid:!0}),r.box(o-s+.3,D,.15,d,c,L,l+.075,{solid:!0}),r.box(-16-s,h+.2,.15,d,(s+-16)/2,h/2-.1,a-.075,{solid:!0}),r.box(o- -14,h+.2,.15,d,(-14+o)/2,h/2-.1,a-.075,{solid:!0}),r.box(2,h-2.3,.15,d,E,(h+2.3)/2,a-.075,{}),r.box(o-s,.1,l-a,T,c,h+.05,u,{worldUV:!0});for(const V of[s+.11,o-.11])r.box(.06,.8,l-a-3,de.daylight,V,3.7,u,{});r.box(o-s,.1,2,w,c,-.05,a+1,{walkable:!0,vinyl:!0});for(let V=0;V<f;V++){const Q=-x*(V+1),me=a+2+p*V;r.box(o-s,.1,p,w,c,Q-.05,me+p/2,{walkable:!0,vinyl:!0}),r.box(o-s,x,.06,C,c,Q+x/2,me+.03,{})}const B=a+2+p*f;r.box(o-s,.1,1,w,c,v-.05,B+.5,{walkable:!0,vinyl:!0}),r.box(17,.5,1.85,de.oak,c,m-.25,B+1+.925,{walkable:!0});for(let V=0;V<f;V++){const Q=-x*(V+1),me=a+2+p*V+.9;for(let ye=-22.8;ye<=-16.45;ye+=.62)r.chair(ye,Q,me,1);for(let ye=-13.55;ye<=-5.2;ye+=.62)r.chair(ye,Q,me,1)}const X=l-.075;r.box(6.7,4.1,.06,C,c,.85,X-.035,{});const Z=new gn({color:16777215}),z=new Pt(new ki(6,3.375),Z);z.position.set(c,.84,X-.075),z.rotation.y=Math.PI,z.matrixAutoUpdate=!1,z.updateMatrix(),n.add(z),r.sign(5,.7,c,3.35,X-.08,Math.PI,()=>pt({widthPx:1600,heightPx:224,title:"Postgraduate Medical Centre",subtitle:"slides: ← → · PageUp/PageDown (clickers work) · or tap the screen",titleSize:76}),"proscenium"),r.box(.42,1.05,.42,de.oak,-17.5,m+.525,B+1.7,{solid:!0}),r.oakSpec({w:.62,h:.05,d:.5,x:-17.5,y:m+1.08,z:B+1.7}),r.steelSpec({w:.05,h:.3,d:.05,x:-17.28,y:m+1.25,z:B+1.62}),r.sign(1.7,.5,E,2.65,a+.085,0,()=>pt({widthPx:900,heightPx:240,title:"→ Reception",subtitle:"B returns to your last stop",titleSize:66}),"theatre-exit");const te=V=>e.length?e[V%e.length]:null;Dn(r,te(5),5,-19.5,1.7,a+.085,0,"theatre:r1"),Dn(r,te(11),11,-10.5,1.7,a+.085,0,"theatre:r2");for(const V of[-20,c,-8])for(const Q of[21.5,24.5,27.5,30.5])r.box(.6,.035,1.3,A,V,h-.02,Q,{});r.box(.12,7,l-a+.3,R,s-.21,1,u,{}),r.box(.12,7,l-a+.3,R,o+.21,1,u,{}),r.box(o-s+.7,7,.12,R,c,1,l+.21,{}),r.box(-16.6-(s-.35),7,.12,R,(s-.35+-16.6)/2,1,a-.21,{}),r.box(o+.35- -13.4,7,.12,R,(-13.4+o+.35)/2,1,a-.21,{}),r.box(3.2,1.3,.12,R,E,3.85,a-.21,{}),r.box(o-s+.9,.18,l-a+.9,R,c,h+.24,u,{});const $=(V,Q,me,ye)=>r.box(Q-V,.06,ye-me,P,(V+Q)/2,-.09,(me+ye)/2,{});return $(-30,s-.35,15.2,38),$(o+.35,2,15.2,38),$(s-.35,-16.7,15.2,a-.3),$(-13.3,o+.35,15.2,a-.3),$(s-.35,o+.35,l+.35,38),t!=="off"&&r.stand(-17.5,m,B+2.15,Math.PI,4271),r.populate(t,6101),r.finalize(),g(!0),{id:oi,wc:null,label:"Postgraduate Medical Centre",group:n,colliders:r.colliders,walkables:r.walkables,interactables:[],boards:[{kind:"screen",mesh:z,cells:[{rect:[0,0,.35,1],id:"prev",label:"previous slide"},{rect:[.35,0,1,1],id:"next",label:"next slide"}]}],spawnPos:new O(E,0,a+1.2),spawnYaw:Math.PI,boxes:[new Et(new O(s-.3,-2.5,a-.3),new O(o+.3,h+.3,l+.3)),new Et(new O(E-1.7,-.5,15),new O(E+1.7,3.2,a))],screen:z,setHouseLights:g,lecternPos:new O(-16.6,m,B+1.9),lecternYaw:0}}function Om(i,e,t,n){const r=new Cn;r.name="area:atrium";const s=new Jr(r,new O(0,0,0),e),o=-26,a=0,l=3,c=15,u=N.STREET_H,h=(o+a)/2,f=(l+c)/2;s.box(a-o,.1,c-l,de.floor,h,-.05,f,{walkable:!0,vinyl:!0}),s.box(a-o,.1,c-l,de.ceiling,h,u+.05,f,{worldUV:!0}),s.box(a-o+.3,1,.15,de.wall,h,.5,l-.075,{solid:!0,trim:["z+"]}),s.box(a-o+.3,1.7,.08,de.daylight,h,1.85,l-.075,{solid:!0}),s.box(a-o+.3,u-2.7,.15,de.wall,h,(u+2.7)/2,l-.075,{});for(let R=o+2;R<a-.5;R+=2)s.steelSpec({w:.07,h:1.7,d:.18,x:R,y:1.85,z:l-.075});s.box(-16-o+.3,u,.15,de.wall,(o-.15+-16)/2,u/2,c+.075,{solid:!0,trim:["z-"]}),s.box(a- -14+.3,u,.15,de.wall,(-14+a+.15)/2,u/2,c+.075,{solid:!0,trim:["z-"]}),s.box(2,u-2.3,.15,de.wall,-15,(u+2.3)/2,c+.075,{}),s.box(.15,u,c-l,de.wall,o-.075,u/2,f,{solid:!0,trim:["x+"]}),s.box(.15,u,N.STREET_Z0-l,de.wall,a+.075,u/2,(l+N.STREET_Z0)/2,{solid:!0,trim:["x-"]}),s.box(.15,u,c-N.STREET_Z1,de.wall,a+.075,u/2,(N.STREET_Z1+c)/2,{solid:!0,trim:["x-"]});for(let R=o+3;R<a-1;R+=4.5)for(const P of[5.2,9,12.8])s.led(R,P,u-.02);s.box(1.1,1.1,5.2,de.oak,o+4.5,.55,f),s.box(4.2,.46,.55,de.oak,-10,.23,4.4),s.box(4.2,.5,.09,de.oak,-10,.7,4.4-.24);for(let R=0;R<5;R++)s.chair(-5.8+R*.62,0,14.35,-1);for(let R=0;R<3;R++)s.chair(-17.9+R*.62,0,14.35,-1);const p=R=>t.length?t[R%t.length]:null;Dn(s,p(3),3,o+.09,1.8,4.6,Math.PI/2,"atrium:w1"),Dn(s,p(9),9,o+.09,1.8,13.4,Math.PI/2,"atrium:w2"),Dn(s,p(6),6,-3.4,1.8,c-.09,Math.PI,"atrium:n1"),s.sign(7,1.5,o+.09,2.6,f,Math.PI/2,()=>pt({widthPx:1792,heightPx:384,title:"ContSys Hospital",subtitle:`${i.meta.label} · ${i.classes.length} concepts · welcome — walk the model`,titleSize:150,align:"center"}),"title"),s.sign(3.2,.7,a-.09,N.ROOM_H+.55,(N.STREET_Z0+N.STREET_Z1)/2,-Math.PI/2,()=>pt({widthPx:1280,heightPx:280,title:"Hospital Street →",subtitle:"all wings · concepts A–Z on the directory",titleSize:88}),"to-street"),s.sign(2.6,.6,-15,2.62,c-.09,Math.PI,()=>pt({widthPx:1152,heightPx:252,title:"Postgraduate Medical Centre →",subtitle:"lecture theatre · seminars & presentations",titleSize:70}),"to-theatre");const x=[...i.wings.map(R=>({text:R.annex?R.label:`${R.label} wing`,sub:`${R.classCount} concepts`,chip:Xn(R.key)})),{text:"Postgraduate Medical Centre",sub:"lecture theatre",chip:"#005eb8"}],v={widthPx:1024,heightPx:724,title:"Hospital directory",subtitle:"wings west to east — tap one to visit its entrance",rows:x,rowSize:40},m=s.sign(3.4,2.4,-20,1.9,c-.09,Math.PI,()=>nr(v),"directory-wings"),d=Co(v,x.length),T={widthPx:2048,heightPx:1152,title:"Concepts A–Z",subtitle:"tap a concept to go there · or press M anywhere for the porter",rows:i.classes.map(R=>({text:R.label,sub:R.roomNumber??void 0,chip:Xn(R.wing)})),rowSize:14,columns:5},w=s.sign(6.4,3.6,-9,1.9,c-.09,Math.PI,()=>nr(T),"directory-az"),A=Co(T,i.classes.length),C=[{kind:"directory",mesh:m,cells:[...i.wings.flatMap((R,P)=>d[P]?[{rect:d[P],id:R.rootIds[0],label:R.annex?R.label:`${R.label} wing`}]:[]),...d[i.wings.length]?[{rect:d[i.wings.length],id:oi,label:"Postgraduate Medical Centre"}]:[]]},{kind:"directory",mesh:w,cells:i.classes.flatMap((R,P)=>A[P]?[{rect:A[P],id:R.id,label:R.label}]:[])}];return n!=="off"&&(s.stand(o+3.7,0,f,Math.PI/2,137),s.sit(-9.4,.02,4.55,1,553),s.sit(-10.6,.02,4.55,1,887)),s.populate(n,9001),s.finalize(),{id:rn,wc:null,label:"Reception",group:r,colliders:s.colliders,walkables:s.walkables,interactables:[],boards:C,spawnPos:new O(-14,0,f),spawnYaw:-Math.PI/2,boxes:[new Et(new O(o-.3,-.5,l-.3),new O(a+.1,2.5,c+.3))]}}const kr="__street";function Bm(i,e,t,n,r){const s=new Cn;s.name="area:street";const o=new Jr(s,new O(0,0,0),t),a=e.loop,l=0,c=a.xEnd,u=c-l,h=(l+c)/2,f=N.STREET_H,p=a.south.z1,x=a.north.z0,v=[a.connectors.west,a.connectors.east],m=new Map(i.classes.map(M=>[M.id,M])),d=new Map(i.wings.map(M=>[M.key,M])),T=new Tt({color:13623528,transparent:!0,opacity:.3}),w=new Tt({color:6715727}),A=M=>{const g=M==="south"?a.south:a.north,E=g.z0,D=g.z1,L=(E+D)/2,B=M==="south"?E-.075:D+.075,X=M==="south"?D+.075:E-.075,Z=M==="south"?"z+":"z-",z=M==="south"?"z-":"z+",te=M==="south"?0:Math.PI;o.box(u,.1,D-E,de.floor,h,-.05,L,{walkable:!0,vinyl:!0}),o.box(u,.1,D-E,de.ceiling,h,f+.05,L,{worldUV:!0});for(let ie=l+2;ie<c-1;ie+=4)o.led(ie,E+1.3,f-.02,.35,1.3),o.led(ie,D-1.3,f-.02,.35,1.3);const $=[];let V=l;for(const[ie,ge]of v)ie>V&&$.push([V,ie]),V=Math.max(V,ge);c>V&&$.push([V,c]);for(const[ie,ge]of $){const pe=(ie+ge)/2,Ve=ge-ie;o.box(Ve,1,.15,de.wall,pe,.5,X,{solid:!0,trim:[z]}),o.box(Ve,1.7,.08,T,pe,1.85,X,{solid:!0}),o.box(Ve,f-2.7,.15,de.wall,pe,(f+2.7)/2,X,{});for(let lt=ie+2;lt<ge-.5;lt+=2)o.steelSpec({w:.07,h:1.7,d:.18,x:lt,y:1.85,z:X})}for(const[ie,ge]of v){const pe=(ie+ge)/2;o.box(ge-ie,f-3,.15,de.wall,pe,(f+3)/2,X,{}),o.sign(2.7,.6,pe,2.62,X+(M==="south"?-.08:.08),M==="south"?Math.PI:0,()=>pt({widthPx:1152,heightPx:252,title:`Cloister → ${M==="south"?"north":"south"} side`,subtitle:"across the courtyard · shorter way round",titleSize:68}),`cloister:${M}:${Math.round(pe)}`)}const Q=[];for(const ie of e.wings)if(ie.street===M)for(const ge of ie.rootIds)Q.push({x:e.areas[ge].x,id:ge,wingKey:ie.key});Q.sort((ie,ge)=>ie.x-ge.x);const me=M==="south"?E+.46:D-.46,ye=M==="south"?1:-1,Ne=M==="south"?E+.075:D-.075,He=(ie,ge)=>{const pe=ge-ie,Ve=(ie+ge)/2;if(pe>=12&&(o.chair(Ve-.35,0,me,ye),o.chair(Ve+.35,0,me,ye)),pe>=9)for(const lt of[Ve-3.2,Ve+3.2]){const $e=(Math.round(lt*7)>>>0)%997,et=n.length?n[$e%n.length]:null;Dn(o,et,$e,lt,1.78,Ne,te,`street:${M}:${Math.round(lt)}`)}};let q=l;for(const ie of Q){const ge=ie.x-N.LOBBY_W/2,pe=ie.x+N.LOBBY_W/2;ge>q&&(o.box(ge-q,f,.15,de.wall,(q+ge)/2,f/2,B,{solid:!0,trim:[Z]}),He(q,ge)),o.box(N.LOBBY_W,f-N.ROOM_H,.15,de.wall,ie.x,(f+N.ROOM_H)/2,B,{}),q=pe}c>q&&(o.box(c-q,f,.15,de.wall,(q+c)/2,f/2,B,{solid:!0,trim:[Z]}),He(q,c));const se=M==="south"?E+.02:D-.02;Q.forEach(ie=>{const ge=m.get(ie.id),pe=d.get(ie.wingKey);o.sign(3.2,.7,ie.x,N.ROOM_H+.45,se,te,()=>pt({widthPx:1280,heightPx:280,title:pe?.annex?ge?.label??"?":`${pe?.label??"?"} wing`,subtitle:pe?.annex?`${pe.label} · ${ge?.roomNumber?`Room ${ge.roomNumber}`:""}`:`${pe?.classCount??"?"} concepts · enter for ${ge?.label??"?"}`,titleSize:86}),`street:${ge?.label}`)}),o.box(.15,f,D-E+.3,de.wall,c+.075,f/2,L,{solid:!0,trim:["x-"]}),M==="north"&&o.box(.15,f,D-E+.3,de.wall,l-.075,f/2,L,{solid:!0,trim:["x+"]}),o.sign(3.4,.8,l+.4,2.7,L,-Math.PI/2,()=>pt({widthPx:1280,heightPx:300,title:"Hospital Street",subtitle:`${M} side · wings this way →`,titleSize:96}),`street-name:${M}`)};A("south"),A("north");const[C]=a.connectors.west,R=e.wings.filter(M=>M.street==="south").length;let P=0,G=0;for(const M of e.wings){const g=new gn({color:new qe(Xn(M.key))}),E=e.areas[M.rootIds[0]].x;if(M.street==="south"){const D=a.south.z0+.4+P*.24;P++,o.box(E-l,.012,.16,g,(l+E)/2,.012,D,{}),o.box(.16,.012,D-a.south.z0,g,E,.012,(a.south.z0+D)/2,{})}else{const D=C+.55+G*.62,L=a.south.z0+.4+(R+G)*.24,B=a.north.z1-.4-G*.24;G++,o.box(D-l,.012,.16,g,(l+D)/2,.012,L,{}),o.box(.16,.012,B-L,g,D,.012,(L+B)/2,{}),o.box(E-D,.012,.16,g,(D+E)/2,.012,B,{}),o.box(.16,.012,a.north.z1-B,g,E,.012,(B+a.north.z1)/2,{})}}for(const[M,g]of v){const E=(M+g)/2,D=x-p,L=(p+x)/2;o.box(g-M,.1,D,de.floor,E,-.05,L,{walkable:!0,vinyl:!0}),o.box(g-M,.1,D,de.ceiling,E,f+.05,L,{worldUV:!0});for(const B of[M-.075,g+.075]){o.box(.15,1,D,de.wall,B,.5,L,{solid:!0,trim:[B<E?"x+":"x-"]}),o.box(.08,1.7,D,T,B,1.85,L,{solid:!0}),o.box(.15,f-2.7,D,de.wall,B,(f+2.7)/2,L,{});for(let X=p+2;X<x-.5;X+=2)o.steelSpec({w:.18,h:1.7,d:.07,x:B,y:1.85,z:X})}for(let B=p+2;B<x-1;B+=4)o.led(E,B,f-.02,.35,1.3)}return o.box(c-2,.06,x-p-.4,w,(2+c)/2,-.09,(p+x)/2,{}),x-.2>38&&o.box(32,.06,x-.2-38,w,-14,-.09,(38+x-.2)/2,{}),o.populate(r,4211),o.finalize(),{id:kr,wc:null,label:"Hospital Street",group:s,colliders:o.colliders,walkables:o.walkables,interactables:[],spawnPos:new O(l+3,0,(a.south.z0+a.south.z1)/2),spawnYaw:-Math.PI/2,boxes:[new Et(new O(l-.3,-.5,a.south.z0-.2),new O(c+.3,2.5,a.south.z1+.3)),new Et(new O(l-.3,-.5,a.north.z0-.3),new O(c+.3,2.5,a.north.z1+.2)),...v.map(([M,g])=>new Et(new O(M-.2,-.5,p),new O(g+.2,2.5,x)))]}}const fn=1920,Pi=1080;function zm(i,e,t,n){i.fillStyle=Gi,i.fillRect(0,0,fn,Pi),i.fillStyle="#ffffff",i.textAlign="center",i.font="bold 118px Arial",i.fillText(e,fn/2,470),i.font="54px Arial",i.globalAlpha=.92,i.fillText(t,fn/2,580),i.font="34px Arial",i.globalAlpha=.7,i.fillText(n,fn/2,990),i.globalAlpha=1}function al(i,e,t){i.fillStyle="#f4f6f7",i.fillRect(0,0,fn,Pi),i.fillStyle=Gi,i.fillRect(0,0,fn,190),i.fillStyle="#ffffff",i.textAlign="left",i.font="bold 78px Arial",i.fillText(e,110,128),i.fillStyle="#16212a",i.font="46px Arial",t.forEach((n,r)=>i.fillText(n,110,330+r*105))}function km(){return[{kind:"builtin",draw:i=>zm(i,"Postgraduate Medical Centre","Lecture Theatre · ContSys Hospital","a walkable model of the continuity-of-care concept system")},{kind:"builtin",draw:i=>al(i,"Bring your own slides",["1.  Export your deck as PNG or JPG images (1920 × 1080 works best).","2.  Copy them into the site’s  slides/  folder.","3.  List them in order in  slides/manifest.json :",'         ["01.png", "02.png", "03.png"]',"4.  Video clips (.mp4, .webm) can be listed too — they play here.","5.  Redeploy. This screen then presents your deck."])},{kind:"builtin",draw:i=>al(i,"Presenting & filming",["← →  or  PageUp / PageDown change slides — presenter clickers work.","Tap or click the screen: right side = next, left side = back.","H  hides the whole interface for a clean recording.","L  dims the house lights.","Add  ?start=theatre  to the address to begin at the lectern.","B  returns to your last stop when you’re done."])}]}class Hm{entries=[];index=0;cache=new Map;video=null;videoTex=null;mat;constructor(e){this.mat=e.material}get count(){return this.entries.length}get label(){return`Slide ${this.index+1} / ${this.entries.length}`}async load(){try{const e=await fetch("slides/manifest.json");if(e.ok){const t=await e.json(),n=Array.isArray(t)?t:t?.slides??[];this.entries=n.map(r=>({kind:/\.(mp4|webm|mov)$/i.test(r)?"video":"image",src:`slides/${r}`}))}}catch{}this.entries.length||(this.entries=km()),this.show(0)}next(){this.show(Math.min(this.index+1,this.entries.length-1))}prev(){this.show(Math.max(this.index-1,0))}show(e){if(!this.entries.length)return;this.index=e;const t=this.entries[e];t.kind==="video"?this.mat.map=this.playVideo(t.src):(this.video?.pause(),this.mat.map=this.texture(e),this.entries[e+1]?.kind==="image"&&this.texture(e+1),this.entries[e-1]?.kind==="image"&&this.texture(e-1)),this.mat.needsUpdate=!0}texture(e){const t=this.cache.get(e);if(t)return t;const n=document.createElement("canvas");n.width=fn,n.height=Pi;const r=n.getContext("2d");r.fillStyle="#0d1114",r.fillRect(0,0,fn,Pi);const s=new vn(n);s.colorSpace=mt,s.generateMipmaps=!1,s.minFilter=St;const o=this.entries[e];if(o.kind==="builtin")o.draw(r),s.needsUpdate=!0;else if(o.kind==="image"){const a=new Image;a.onload=()=>{const l=Math.min(fn/a.width,Pi/a.height),c=a.width*l,u=a.height*l;r.drawImage(a,(fn-c)/2,(Pi-u)/2,c,u),s.needsUpdate=!0},a.src=o.src}return this.cache.set(e,s),s}playVideo(e){this.video||(this.video=document.createElement("video"),this.video.playsInline=!0,this.videoTex=new au(this.video),this.videoTex.colorSpace=mt,this.videoTex.generateMipmaps=!1,this.videoTex.minFilter=St);const t=this.video;return t.src.endsWith(e)||(t.src=e),t.currentTime=0,t.muted=!1,t.play().catch(()=>{t.muted=!0,t.play().catch(()=>{})}),this.videoTex}}const wi=new Qt(0,0,0,"YXZ"),Ai=new O,Gm={type:"change"},Vm={type:"lock"},Wm={type:"unlock"},ll=.002,cl=Math.PI/2;class Xm extends Su{constructor(e,t=null){super(e,t),this.isLocked=!1,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.pointerSpeed=1,this._onMouseMove=Ym.bind(this),this._onPointerlockChange=$m.bind(this),this._onPointerlockError=qm.bind(this),this.domElement!==null&&this.connect(this.domElement)}connect(e){super.connect(e),this.domElement.ownerDocument.addEventListener("mousemove",this._onMouseMove),this.domElement.ownerDocument.addEventListener("pointerlockchange",this._onPointerlockChange),this.domElement.ownerDocument.addEventListener("pointerlockerror",this._onPointerlockError)}disconnect(){this.domElement.ownerDocument.removeEventListener("mousemove",this._onMouseMove),this.domElement.ownerDocument.removeEventListener("pointerlockchange",this._onPointerlockChange),this.domElement.ownerDocument.removeEventListener("pointerlockerror",this._onPointerlockError)}dispose(){this.disconnect()}getDirection(e){return e.set(0,0,-1).applyQuaternion(this.object.quaternion)}moveForward(e){if(this.enabled===!1)return;const t=this.object;Ai.setFromMatrixColumn(t.matrix,0),Ai.crossVectors(t.up,Ai),t.position.addScaledVector(Ai,e)}moveRight(e){if(this.enabled===!1)return;const t=this.object;Ai.setFromMatrixColumn(t.matrix,0),t.position.addScaledVector(Ai,e)}lock(e=!1){this.domElement.requestPointerLock({unadjustedMovement:e})}unlock(){this.domElement.ownerDocument.exitPointerLock()}}function Ym(i){if(this.enabled===!1||this.isLocked===!1)return;const e=this.object;wi.setFromQuaternion(e.quaternion),wi.y-=i.movementX*ll*this.pointerSpeed,wi.x-=i.movementY*ll*this.pointerSpeed,wi.x=Math.max(cl-this.maxPolarAngle,Math.min(cl-this.minPolarAngle,wi.x)),e.quaternion.setFromEuler(wi),this.dispatchEvent(Gm)}function $m(){this.domElement.ownerDocument.pointerLockElement===this.domElement?(this.dispatchEvent(Vm),this.isLocked=!0):(this.dispatchEvent(Wm),this.isLocked=!1)}function qm(){console.error("THREE.PointerLockControls: Unable to use Pointer Lock API")}const ei=1.7,Dr=.3,Zm=4.2,Km=8.5,jm=.5,Jm=7;class Qm{camera;controls;keys=new Set;colliders=[];walkables=[];touch={f:0,s:0};constructor(e){this.camera=new jt(70,innerWidth/innerHeight,.05,160),this.camera.position.set(0,ei,0),this.camera.rotation.order="YXZ",this.controls=new Xm(this.camera,e),addEventListener("keydown",t=>this.keys.add(t.code)),addEventListener("keyup",t=>this.keys.delete(t.code)),addEventListener("blur",()=>this.keys.clear())}setTouchMove(e,t){this.touch.f=e,this.touch.s=t}enableDragLook(e){let t=!1,n=0,r=0;e.addEventListener("pointerdown",s=>{this.controls.isLocked||(t=!0,n=s.clientX,r=s.clientY,e.setPointerCapture(s.pointerId))}),e.addEventListener("pointermove",s=>{if(!t||this.controls.isLocked)return;const o=this.camera.rotation;o.y-=(s.clientX-n)*.0042,o.x=Math.max(-1.45,Math.min(1.45,o.x-(s.clientY-r)*.0042)),n=s.clientX,r=s.clientY});for(const s of["pointerup","pointercancel"])e.addEventListener(s,()=>t=!1)}dash(e=12){const t=this.camera.rotation.y,n=-Math.sin(t),r=-Math.cos(t),s=this.camera.position;let o=0;for(let a=0;a<Math.ceil(e/.4);a++){const l=this.feetY,c=s.x+n*.4,u=s.z+r*.4;if(this.collides(c,u,l))break;const h=this.groundAt(c,u,l);if(h===-1/0)break;s.x=c,s.z=u,s.y=h+ei,o+=.4}return o}setColliders(e){this.colliders=e}setWalkables(e){this.walkables=e}get position(){return this.camera.position}get feetY(){return this.camera.position.y-ei}get floorPosition(){return new O(this.camera.position.x,this.feetY,this.camera.position.z)}teleport(e,t){this.camera.position.set(e.x,(e.y??0)+ei,e.z),this.camera.rotation.set(0,t,0)}groundAt(e,t,n){let r=-1/0;for(const s of this.walkables){if(e<s.min.x-.05||e>s.max.x+.05||t<s.min.z-.05||t>s.max.z+.05)continue;const o=s.max.y;o<=n+jm&&o>r&&(r=o)}return r}collides(e,t,n){const r=new Et(new O(e-Dr,n+.25,t-Dr),new O(e+Dr,n+1.75,t+Dr));return this.colliders.some(s=>s.intersectsBox(r))}snapGround(){const e=this.camera.position,t=this.groundAt(e.x,e.z,this.feetY+.01);t>-1/0&&(e.y=t+ei)}update(e){const t=this.camera.position,n=this.feetY,r=Number(this.keys.has("KeyW"))-Number(this.keys.has("KeyS"))+this.touch.f,s=Number(this.keys.has("KeyD"))-Number(this.keys.has("KeyA"))+this.touch.s;if(r||s){const a=Math.min(1,Math.hypot(r,s)),c=(this.keys.has("ShiftLeft")||this.keys.has("ShiftRight")||a>.92?Km:Zm)*a,u=this.camera.rotation.y,h=-Math.sin(u)*r+Math.cos(u)*s,f=-Math.cos(u)*r-Math.sin(u)*s,p=Math.hypot(h,f)||1,x=h/p*c*e,v=f/p*c*e;this.collides(t.x+x,t.z,n)||(t.x+=x),this.collides(t.x,t.z+v,n)||(t.z+=v)}const o=this.groundAt(t.x,t.z,n);o>-1/0&&(o>=n?t.y=o+ei:t.y=Math.max(o,n-Jm*e)+ei)}}let wn=null,$r=!1;const Tn=()=>$r;function e0(){return wn||(wn=document.createElement("div"),wn.id="menu-root",document.body.appendChild(wn),wn)}function t0(){!wn||!$r||($r=!1,wn.replaceChildren(),wn.style.display="none")}function ul(i,e,t,n){const r=e0();r.replaceChildren(),r.style.display="flex",$r=!0;const s=document.createElement("div");s.className="menu-panel";const o=document.createElement("div");o.className="menu-head",o.innerHTML='<div class="menu-title"></div><div class="menu-sub"></div>',o.querySelector(".menu-title").textContent=i,o.querySelector(".menu-sub").textContent=e,s.appendChild(o);let a=null;n.searchable&&(a=document.createElement("input"),a.className="menu-filter",a.placeholder="Type to search…",s.appendChild(a));const l=document.createElement("div");l.className="menu-list",s.appendChild(l);const c=document.createElement("div");c.className="menu-foot",c.textContent="↑↓ choose · Enter go · Esc close",s.appendChild(c),r.appendChild(s);let u=[],h=0;const f=m=>{removeEventListener("keydown",v,!0),t0(),m!==null?n.onPick(m):n.onClose?.()},p=()=>{const m=a?.value.trim().toLowerCase()??"";u=t.filter(d=>!m||`${d.label} ${d.sub??""}`.toLowerCase().includes(m)),h=Math.min(h,Math.max(0,u.length-1)),l.replaceChildren(...u.map((d,T)=>{const w=document.createElement("div");w.className="menu-item"+(d.value===null?" info":"")+(d.strong?" strong":"")+(T===h&&d.value!==null?" active":""),d.chip&&(w.style.borderLeftColor=d.chip);const A=document.createElement("span");if(A.textContent=d.label,w.appendChild(A),d.sub){const C=document.createElement("span");C.className="menu-item-sub",C.textContent=d.sub,w.appendChild(C)}return d.value!==null&&(w.addEventListener("click",()=>f(d.value)),w.addEventListener("mousemove",()=>{h!==T&&(h=T,p())})),w})),l.querySelector(".active")?.scrollIntoView({block:"nearest"})},x=m=>{if(!u.length)return;let d=h;for(let T=0;T<u.length&&(d=(d+m+u.length)%u.length,u[d].value===null);T++);h=d,p()},v=m=>{if(m.code==="Escape")m.preventDefault(),m.stopPropagation(),f(null);else if(m.code==="ArrowDown")m.preventDefault(),x(1);else if(m.code==="ArrowUp")m.preventDefault(),x(-1);else if(m.code==="Enter"){m.preventDefault();const d=u[h];d&&d.value!==null&&f(d.value)}else a&&requestAnimationFrame(p)};addEventListener("keydown",v,!0),a?.addEventListener("input",()=>{h=0,p()}),p(),h=Math.max(0,u.findIndex(m=>m.value!==null)),p(),a?.focus()}const n0=700,i0=document.getElementById("app"),ni=document.getElementById("start"),hl=document.getElementById("fade"),Ds=document.getElementById("toast"),Ri=document.getElementById("prompt"),r0=document.getElementById("area-sign"),s0=document.querySelector("#area-sign .label"),o0=document.querySelector("#area-sign .room");let fl=0;function Ot(i){Ds.textContent=i,Ds.style.opacity="1",clearTimeout(fl),fl=window.setTimeout(()=>Ds.style.opacity="0",2200)}function Ci(){hl.style.opacity="1",setTimeout(()=>hl.style.opacity="0",160)}async function a0(){const i=await fetch("world.json").then(b=>{if(!b.ok)throw new Error(`world.json ${b.status} — run \`npm run world\` first`);return b.json()}),e=new Map(i.classes.map(b=>[b.id,b])),t=new Map(i.classes.map(b=>[b.label,b])),n=new Map(i.wings.map(b=>[b.key,b.annex?b.label:`${b.label} wing`])),r=Lm(i),s=await fetch("art/manifest.json").then(b=>b.ok?b.json():[]).catch(()=>[]),o=await fetch("art/illustrations/manifest.json").then(b=>b.ok?b.json():null).then(b=>b?new Set(b.map(H=>H.slug)):null).catch(()=>null),a=navigator.maxTouchPoints>0&&Math.min(screen.width,screen.height)<=500,l=new URLSearchParams(location.search).get("people"),c=l==="off"||l==="low"||l==="full"?l:a?"low":"full",u=matchMedia("(prefers-reduced-motion: reduce)").matches,h=new nu;h.background=new qe(6055792),h.fog=a?new Wr(6055792,42,120):new Wr(6055792,55,150),h.add(new du(16777215,12172994,1)),h.add(new _u(16777215,.38));const f=new gu(16777215,.4);f.position.set(3,8,2),h.add(f);let p;try{p=new xm({antialias:!a})}catch{throw new Error("3D graphics (WebGL) could not start in this browser. On iPhone/iPad, Lockdown Mode blocks WebGL — allow this site under Settings → Privacy & Security → Lockdown Mode → Configure Web Browsing, or try another device.")}p.setSize(innerWidth,innerHeight),p.setPixelRatio(Math.min(devicePixelRatio,a?1.5:2)),p.domElement.style.touchAction="none",p.domElement.style.userSelect="none",i0.appendChild(p.domElement);const x=new Sm,v=new Map,m={byId:e,signs:x,layout:r,art:s,illustrations:o,people:c},d=Om(i,x,s,c);v.set(d.id,d);const T=Bm(i,r,x,s,c);v.set(T.id,T);const w=Fm(x,s,c);v.set(w.id,w);const A=new Hm(w.screen);A.load();for(const b of i.classes){const H=r.areas[b.id],Y=Um(b,m,new O(H.x,H.y,H.oz));v.set(Y.id,Y)}for(const b of v.values())h.add(b.group);const C=[...v.values()].flatMap(b=>b.colliders),R=[...v.values()].flatMap(b=>b.walkables),P=[...v.values()].flatMap(b=>b.interactables),G=new Map;for(const b of P)if(b.elementId){const H=G.get(b.elementId)??[];H.push(b),G.set(b.elementId,H)}function M(b){if(b.kind!=="door-self")return G.get(b.elementId)?.find(H=>H!==b)}const g=new Qm(p.domElement);g.setColliders(C),g.setWalkables(R),g.teleport(d.spawnPos,d.spawnYaw),h.add(g.camera),a&&(g.camera.far=130,g.camera.updateProjectionMatrix());const E=[];if(c!=="off"&&!u){const b=ur(20260703),H=(ae,ue,Ue)=>{const Xe=new Cm(ue,Ue,1+Math.floor(b()*99991));h.add(Xe.group),E.push({w:Xe,owner:ae})},Y=c==="full"?7:3;for(let ae=0;ae<Y;ae++){const ue=4+(r.street.x1-70)*ae/Math.max(1,Y-1),Ue=ae%2?r.loop.north.z0+2:9;H(T,new O(ue,0,Ue),new O(Math.min(ue+55,r.street.x1-4),0,Ue))}if(c==="full"){let ae=0;for(const[Ue,Xe]of Object.entries(r.landings)){if(Xe.x1-Xe.x0<18||ae>=12)continue;const _t=v.get(Ue);if(!_t)continue;const yt=Xe.mirror?r.loop.K-8.5:8.5;H(_t,new O(Xe.x0+1.2,Xe.y,yt),new O(Xe.x1-1.2,Xe.y,yt)),ae++}let ue=0;for(const Ue of i.classes){const Xe=r.areas[Ue.id];if(Xe.corridorLen<24||ue>=8)continue;const _t=v.get(Ue.id);if(!_t)continue;const yt=Xe.oz+(Xe.flip?.8:-.8),an=Xe.oz+(Xe.flip?Xe.corridorLen-2:-(Xe.corridorLen-2));H(_t,new O(Xe.x,Xe.y,yt),new O(Xe.x,Xe.y,an)),ue++}}}const D=a?140:175;function L(){const b=g.position,H=g.floorPosition.y;for(const Y of v.values()){let ae=1/0;for(const Ue of Y.boxes)ae=Math.min(ae,Ue.distanceToPoint(b));const ue=Y.wc?r.areas[Y.wc.id].y:0;Y.group.visible=ae<D&&(Math.abs(ue-H)<N.STOREY/2||ae<30)}}L();let B=d;function X(b){B=b;const H=b.wc;s0.textContent=b.label,o0.textContent=H?[H.roomNumber?`Room ${H.roomNumber}`:null,`${n.get(H.wing)??H.wing} · ${H.floor?`level −${H.floor}`:"ground"}`].filter(Boolean).join(" · "):i.meta.label,r0.style.borderLeft=`8px solid ${H?Xn(H.wing):"#ffffff"}`}X(d),new URLSearchParams(location.search).get("start")==="theatre"&&(g.teleport(w.lecternPos,w.lecternYaw),X(w));{const b=new URLSearchParams(location.search).get("concept")?.trim().toLowerCase();if(b){const H=i.classes.find(ae=>ae.label.toLowerCase()===b),Y=H&&v.get(H.id);Y?(g.teleport(Y.spawnPos,Y.spawnYaw),X(Y),L()):Ot(`No concept called “${b}” — press M for the porter`)}}let Z=!1;function z(b){const H=B.lift;H&&(Z||(H.doors.target=g.floorPosition.distanceTo(H.doorwayPos)<2.1?1:0),H.doors.update(b))}let te=null;const $=()=>{if(!te)try{te=new AudioContext}catch{}};addEventListener("pointerdown",$,{once:!0}),addEventListener("keydown",$,{once:!0});function V(){if(!te)return;const b=te.currentTime+.05;for(const[H,Y]of[[1318.5,0],[1046.5,.14]]){const ae=te.createOscillator(),ue=te.createGain();ae.type="sine",ae.frequency.value=H,ue.gain.setValueAtTime(1e-4,b+Y),ue.gain.linearRampToValueAtTime(.045,b+Y+.015),ue.gain.exponentialRampToValueAtTime(1e-4,b+Y+.55),ae.connect(ue).connect(te.destination),ae.start(b+Y),ae.stop(b+Y+.6)}}const Q=b=>(b.max.x-b.min.x)*(b.max.y-b.min.y)*(b.max.z-b.min.z);function me(b){let H,Y=1/0;for(const ae of v.values())for(const ue of ae.boxes)ue.containsPoint(b)&&Q(ue)<Y&&(H=ae,Y=Q(ue));return H}const ye=navigator.maxTouchPoints>0||"ontouchstart"in window||matchMedia("(pointer: coarse)").matches,Ne=matchMedia("(pointer: coarse)").matches;if(ye){document.body.classList.add("touch");const b=ni.querySelector(".badge"),H=ni.querySelector("p");b&&(b.textContent=Ne?"Tap to enter":"Click or tap to enter"),H&&(H.textContent="Left pad or WASD to walk · drag to look · ⏩ jumps ahead · ℹ reads · ⌖ porter · double-click captures the mouse")}ni.addEventListener("pointerup",b=>{ye||b.pointerType==="touch"?ni.style.display="none":g.controls.lock()}),p.domElement.addEventListener("dblclick",()=>g.controls.lock()),g.controls.addEventListener("lock",()=>ni.style.display="none"),g.controls.addEventListener("unlock",()=>{!Tn()&&!Be&&(ni.style.display="flex")});let He=0;const q=[];function se(){const b=g.floorPosition;q.push({x:b.x,y:b.y,z:b.z,yaw:g.camera.rotation.y,areaId:B.id}),q.length>60&&q.shift()}function ie(){if(Tn()||Be||Z)return;const b=q.pop();if(!b){Ot("No earlier stop to go back to");return}const H=v.get(b.areaId);g.teleport({x:b.x,y:b.y,z:b.z},b.yaw),H&&X(H),J=re(g.floorPosition),L(),Ci(),Ot(`Back → ${H?.label??"previous stop"}`),He=performance.now()}function ge(b,H){const Y=v.get(b);Y&&(se(),g.teleport(Y.spawnPos,Y.spawnYaw),X(Y),J=re(g.floorPosition),L(),Ci(),H&&Ot(H),He=performance.now())}function pe(b,H){b?.lift?(Z=!0,b.lift.doors.target=0,setTimeout(()=>{Z=!1,g.floorPosition.distanceTo(b.lift.doorwayPos)<1.7?Ve(H):Ot("The lift left without you")},650)):Ve(H)}function Ve(b){const H=v.get(b);H&&(H.liftPos?(se(),g.teleport(H.liftPos,H.liftYaw??0),X(H),J=re(g.floorPosition),L(),Ci(),Ot(`Lift → ${H.label}`),He=performance.now(),V()):ge(b,`Lift → ${H.label}`))}function lt(b){const H=b.targetIds[0],Y=v.get(H);if(Y){if(se(),b.kind==="door-self")g.teleport(Y.spawnPos,Y.spawnYaw),Ot(`${b.label} — back where you started (a pig's ear)`);else{const ae=M(b);ae?.exitPos?g.teleport(ae.exitPos,ae.exitYaw??0):g.teleport(Y.spawnPos,Y.spawnYaw),Ot(`${b.label} → ${Y.label}`)}X(Y),J=re(g.floorPosition),L(),Ci(),He=performance.now()}}const $e=(b,H="")=>{const Y=e.get(b);return{label:`${H}${Y?.label??b}`,sub:Y?[Y.roomNumber,`${n.get(Y.wing)??Y.wing} · ${Y.floor?`level −${Y.floor}`:"ground"}`].filter(Boolean).join(" · "):void 0,chip:Y?Xn(Y.wing):void 0,value:b}};function et(b){const H=e.get(b.areaId),Y=g.controls.isLocked;Y&&g.controls.unlock();const ae=Ue=>{Y&&g.controls.lock(),Ue?.()},ue=[];if(H){const Ue=Lo(H,e).sort((Xe,_t)=>_t.level-Xe.level);ue.push(...Ue.map(Xe=>$e(Xe.id,`▲${Xe.level}  `))),ue.push({label:`●  ${H.label}`,sub:"you are here",strong:!0,value:null}),ue.push(...H.subs.map(Xe=>$e(Xe,"▼1  ")))}ue.push({label:"⌂  Reception",sub:"ground floor",value:rn}),ul("Lift",H?.label??"",ue,{onPick:Ue=>ae(()=>pe(v.get(b.areaId),Ue)),onClose:()=>ae()})}function ne(){const b=g.controls.isLocked;b&&g.controls.unlock();const H=[...i.classes].sort((Y,ae)=>Y.label.localeCompare(ae.label)).map(Y=>$e(Y.id));H.unshift({label:"⌂  Reception",sub:"the atrium",value:rn},{label:"▤  Postgraduate Medical Centre",sub:"lecture theatre",value:oi}),ul("Porter service","where would you like to go?",H,{searchable:!0,onPick:Y=>{b&&g.controls.lock(),ge(Y,`Porter → ${v.get(Y)?.label}`)},onClose:()=>{b&&g.controls.lock()}})}const he=document.getElementById("reader"),we=he.querySelector("h2"),I=he.querySelector("header .meta"),Je=he.querySelector(".reader-body");let Be=!1,tt=!1;const Se=b=>b.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");function y(){Be=!1,he.style.display="none",tt&&g.controls.lock()}function _(){const b=B.wc;we.textContent=B.label,I.textContent=b?[b.roomNumber?`Room ${b.roomNumber}`:null,`${n.get(b.wing)??b.wing}`,b.floor?`level −${b.floor}`:"ground"].filter(Boolean).join(" · "):i.meta.label;let H="";if(!b)H=B.id===rn?`<p>Reception for the ContSys Hospital — a walkable model of ${Se(i.meta.label)}. The hospital street runs east; every wing's entrance opens off it. The Postgraduate Medical Centre (lecture theatre) is through the north door. Press M (or ⌖) for the porter.</p>`:B.id===oi?`<p>The Postgraduate Medical Centre: a raked lecture theatre for seminars and video presentations.</p>
               <h3>Presenting</h3>
               ...
               <h3>Your own deck</h3>
               <p>Export slides as PNG/JPG (1920×1080), copy them into <code>slides/</code>, and list them in <code>slides/manifest.json</code> — video clips (.mp4) can be listed too.</p>`:"<p>The hospital street: a racetrack loop of two parallel streets joined by glazed cloisters across the courtyard — take whichever way round is shorter. Wing entrances open off the outside of each street; the courtyard holds the lawn and the Postgraduate Medical Centre.</p>";else{H+=`<p>${Se(b.description??"Definition pending.")}</p>`;const Y=[];b.plural&&Y.push(`<strong>Plural:</strong> ${Se(b.plural)}`),b.alsoKnownAs.length&&Y.push(`<strong>Also known as:</strong> ${Se(b.alsoKnownAs.join("; "))}`),b.deprecated.length&&Y.push(`<strong>Deprecated terms:</strong> ${Se(b.deprecated.join("; "))}`),b.termClause&&Y.push(`<strong>Clause:</strong> ${Se(b.termClause)}`),b.source&&Y.push(`<span class="small"><strong>Source:</strong> ${Se(b.source)}</span>`),Y.length&&(H+=`<p>${Y.join("<br>")}</p>`),b.notes.length&&(H+=`<h3>Notes</h3><ol>${b.notes.map(ue=>`<li>${Se(ue.text)}</li>`).join("")}</ol>`),b.examples.length&&(H+=`<h3>Examples</h3><ol>${b.examples.map(ue=>`<li>${Se(ue.text)}</li>`).join("")}</ol>`);const ae=ue=>Se(e.get(ue)?.label??"?");(b.out.length||b.self.length)&&(H+=`<h3>Outbound associations (doors on the right wall)</h3><ul>${[...b.out.map(ue=>`<li>${Se(Yr(b.label,ue.label,e.get(ue.targetId)?.label??"?",ue))}</li>`),...b.self.map(ue=>`<li>${Se(ue.label)} → ${Se(b.label)} (end wall)</li>`)].join("")}</ul>`),b.in.length&&(H+=`<h3>Inbound associations (doors on the left wall)</h3><ul>${b.in.map(ue=>`<li>${Se(Yr(e.get(ue.sourceId)?.label??"?",ue.label,b.label,ue))}</li>`).join("")}</ul>`),b.supers.length&&(H+=`<h3>Generalisations (stairs up)</h3><ul>${b.supers.map(ue=>`<li>${ae(ue)}</li>`).join("")}</ul>`),b.subs.length&&(H+=`<h3>Specialisations (stairs down)</h3><ul>${b.subs.map(ue=>`<li>${ae(ue)}</li>`).join("")}</ul>`)}Je.innerHTML=H,tt=g.controls.isLocked,tt&&g.controls.unlock(),he.style.display="flex",Be=!0}he.addEventListener("click",b=>{b.target===he&&y()});let F=null;function ee(){Tn()||Be||F?.kind==="lift"&&et(F)}function re(b){const H=new Set;for(const Y of B.interactables){if(Math.abs(Y.triggerPos.y-b.y)>2)continue;const ae=Math.abs(b.x-Y.triggerPos.x),ue=Math.abs(b.z-Y.triggerPos.z);Y.halfX!==void 0?ae<=Y.halfX&&ue<=(Y.halfZ??Y.halfX)&&H.add(Y):ae*ae+ue*ue<=Y.radius*Y.radius&&H.add(Y)}return H}let J=new Set;function De(){if(Z){F=null,Ri.style.opacity="0";return}const b=performance.now(),H=re(g.floorPosition);let Y=null;for(const ae of H){if(!ae.auto){Y=ae;continue}if(!J.has(ae)&&!(b-He<n0)){ae.kind==="stair-up"||ae.kind==="stair-down"?ge(ae.targetIds[0],`${ae.label} (portal)`):lt(ae);return}}J=H,F=Y,Ri.textContent=Y?Y.prompt??`E — ${Y.label}`:"",Ri.style.opacity=Y?"1":"0"}const xe=new Mu,Pe=new st;function Ge(b,H){const Y=B.boards;if(!Y?.length)return null;g.camera.updateMatrixWorld(),Pe.set(b,H),xe.setFromCamera(Pe,g.camera);for(const ae of Y){ae.mesh.updateWorldMatrix(!0,!1);const ue=xe.intersectObject(ae.mesh,!1)[0];if(!(!ue?.uv||ue.distance>(ae.kind==="screen"?16:4.2)))for(const Ue of ae.cells){const[Xe,_t,yt,an]=Ue.rect;if(ue.uv.x>=Xe&&ue.uv.x<=yt&&ue.uv.y>=_t&&ue.uv.y<=an)return{...Ue,kind:ae.kind}}}return null}function ce(b,H){if(Z||Tn()||Be||performance.now()-He<400)return!1;const Y=Ge(b,H);if(!Y)return!1;if(Y.kind==="screen")Y.id==="next"?A.next():A.prev(),Ot(A.label);else if(Y.kind==="lift"){const ae=B;ae.liftPos&&g.floorPosition.distanceTo(ae.liftPos)<1.2?pe(ae,Y.id):Ve(Y.id)}else ge(Y.id,`→ ${v.get(Y.id)?.label??Y.label}`);return!0}p.domElement.addEventListener("click",()=>{g.controls.isLocked&&ce(0,0)});let ve=0,Ce=0,Le=0;p.domElement.addEventListener("pointerdown",b=>{ve=b.clientX,Ce=b.clientY,Le=performance.now()}),p.domElement.addEventListener("pointerup",b=>{g.controls.isLocked||Math.hypot(b.clientX-ve,b.clientY-Ce)>8||performance.now()-Le>600||ce(b.clientX/innerWidth*2-1,-(b.clientY/innerHeight)*2+1)}),addEventListener("keydown",b=>{if(Be){(b.code==="Escape"||b.code==="KeyR")&&y();return}Tn()||(b.code==="KeyE"&&ee(),b.code==="KeyR"&&_(),b.code==="KeyM"&&ne(),b.code==="KeyB"&&ie(),b.code==="KeyF"&&g.dash(12)>.3&&Ci(),b.code==="KeyH"&&(document.body.classList.toggle("filming")||Ot("Interface restored")),B.id===oi&&((b.code==="ArrowRight"||b.code==="PageDown")&&(b.preventDefault(),A.next(),Ot(A.label)),(b.code==="ArrowLeft"||b.code==="PageUp")&&(b.preventDefault(),A.prev(),Ot(A.label)),b.code==="KeyL"&&(_e=!_e,w.setHouseLights(_e),Ot(_e?"House lights up":"House lights dimmed — L restores"))))});let _e=!0;if(Ri.addEventListener("click",ee),g.enableDragLook(p.domElement),ye){const b=document.getElementById("joy"),H=document.getElementById("joy-knob");let Y=null;const ae=()=>{Y=null,H.style.transform="",g.setTouchMove(0,0)},ue=Ue=>{const Xe=b.getBoundingClientRect();let _t=Ue.clientX-(Xe.left+Xe.width/2),yt=Ue.clientY-(Xe.top+Xe.height/2);if(!Number.isFinite(_t)||!Number.isFinite(yt))return;const an=Math.hypot(_t,yt),Oe=44;an>Oe&&(_t*=Oe/an,yt*=Oe/an),H.style.transform=`translate(${_t}px, ${yt}px)`,g.setTouchMove(-yt/Oe,_t/Oe)};b.addEventListener("pointerdown",Ue=>{Ue.preventDefault(),Y=Ue.pointerId,ue(Ue);try{b.setPointerCapture(Ue.pointerId)}catch{}}),b.addEventListener("pointermove",Ue=>{Ue.pointerId===Y&&(Ue.preventDefault(),ue(Ue))}),b.addEventListener("pointerup",ae),b.addEventListener("pointercancel",ae),document.getElementById("btn-read").addEventListener("click",()=>Be?y():_()),document.getElementById("btn-porter").addEventListener("click",()=>{!Tn()&&!Be&&ne()}),document.getElementById("btn-dash").addEventListener("click",()=>{!Tn()&&!Be&&g.dash(12)>.3&&Ci()}),document.getElementById("btn-back").addEventListener("click",ie)}const Ze=new vu;let U=0;const Me={logic:0,render:0},fe=performance.now();let Te=12,le=0;p.setAnimationLoop(()=>{const b=performance.now(),H=Math.min(Ze.getDelta(),.05);Tn()||g.update(H),z(H);for(const ue of E){const Ue=ue.owner.group.visible;ue.w.group.visible=Ue,Ue&&ue.w.update(H)}const Y=me(g.floorPosition);if(Y&&Y!==B&&X(Y),De(),g.controls.isLocked&&!Z&&!Tn()){const ue=Ge(0,0);ue&&(Ri.textContent=ue.kind==="screen"?`Click — ${ue.label}`:`Click — ${ue.kind==="lift"?"lift to":"go to"} ${ue.label}`,Ri.style.opacity="1")}if(U+=H,U>.4&&(U=0,x.update(g.position,a?40:55,a?100:120,a?5:8),L(),performance.now()-fe>12e3&&E.length)){if(le===0&&Te>26){le=1;for(let ue=E.length-1;ue>=0;ue-=2)h.remove(E[ue].w.group),E.splice(ue,1);Ot("Trimmed ward activity to keep things smooth")}else if(le===1&&Te>30){le=2;for(const ue of E)h.remove(ue.w.group);E.length=0,Ot("Paused ward activity for performance")}}const ae=performance.now();p.render(h,g.camera),Me.logic=ae-b,Me.render=performance.now()-ae,Te=Te*.96+(Me.logic+Me.render)*.04}),addEventListener("resize",()=>{g.camera.aspect=innerWidth/innerHeight,g.camera.updateProjectionMatrix(),p.setSize(innerWidth,innerHeight)});function oe(){const b={areas:i.classes.length+3,doorOut:i.classes.reduce((Oe,ot)=>Oe+ot.out.length,0),doorIn:i.classes.reduce((Oe,ot)=>Oe+ot.in.length,0),doorSelf:i.classes.reduce((Oe,ot)=>Oe+ot.self.length,0),notices:i.classes.reduce((Oe,ot)=>Oe+ot.notes.length+ot.examples.length,0),stairUpPortals:i.classes.reduce((Oe,ot)=>Oe+Math.max(0,ot.supers.length-1),0),stairDownPortals:i.classes.reduce((Oe,ot)=>Oe+(ot.subs.length-(r.homeChildren[ot.id]?.length??0)),0),lifts:i.classes.filter(Oe=>Oe.supers.length||Oe.subs.length).length,realStairwells:Object.keys(r.landings).length},H=Oe=>P.filter(ot=>ot.kind===Oe).length,Y={areas:v.size,doorOut:H("door-out"),doorIn:H("door-in"),doorSelf:H("door-self"),notices:[...v.values()].reduce((Oe,ot)=>Oe+(ot.notices??0),0),stairUpPortals:H("stair-up"),stairDownPortals:H("stair-down"),lifts:H("lift"),realStairwells:Object.keys(r.landings).length},ae=P.filter(Oe=>(Oe.kind==="door-out"||Oe.kind==="door-in")&&!M(Oe)),ue=new Map,Ue=(Oe,ot)=>{ue.has(Oe)||ue.set(Oe,new Set),ue.get(Oe).add(ot)};Ue(rn,kr),Ue(rn,oi),Ue(oi,rn);for(const Oe of r.wings)for(const ot of Oe.rootIds)Ue(kr,ot),Ue(ot,kr);for(const[Oe,ot]of Object.entries(r.homeChildren))for(const zt of ot)Ue(Oe,zt),Ue(zt,Oe);for(const Oe of P){for(const ot of Oe.targetIds)Ue(Oe.areaId,ot);if(Oe.kind==="lift"){const ot=e.get(Oe.areaId);for(const zt of Lo(ot,e))Ue(Oe.areaId,zt.id);for(const zt of ot.subs)Ue(Oe.areaId,zt);Ue(Oe.areaId,rn)}}const Xe=new Set([rn]),_t=[rn];for(;_t.length;)for(const Oe of ue.get(_t.pop())??[])Xe.has(Oe)||(Xe.add(Oe),_t.push(Oe));const yt=[...v.keys()].filter(Oe=>!Xe.has(Oe)).map(Oe=>v.get(Oe).label);return{pass:Y.areas===b.areas&&Y.doorOut===b.doorOut&&Y.doorIn===b.doorIn&&Y.doorSelf===b.doorSelf&&Y.notices===b.notices&&Y.stairUpPortals===b.stairUpPortals&&Y.stairDownPortals===b.stairDownPortals&&Y.lifts===b.lifts&&ae.length===0&&yt.length===0,expect:b,built:Y,unpaired:ae.length,unreachable:yt,signs:x.count}}window.__hospital={world:i,layout:r,player:g,areas:v,interactables:P,audit:oe,openSearch:ne,perf:()=>({...Me,avg:+Te.toFixed(1),drawCalls:p.info.render.calls,triangles:p.info.render.triangles}),people:()=>({tier:c,walkers:E.length,demoteStage:le}),tickPeople(b=.1,H=1){for(let Y=0;Y<H;Y++)for(const ae of E)ae.w.update(b)},tickDoors(b=.1,H=1){for(let Y=0;Y<H;Y++)z(b);return B.lift?+B.lift.doors.openness.toFixed(2):null},bench(b=30){const H=performance.now();for(let Y=0;Y<b;Y++)p.render(h,g.camera);return{msPerFrame:+((performance.now()-H)/b).toFixed(2),drawCalls:p.info.render.calls,triangles:p.info.render.triangles}},currentArea:()=>B.label,pick:(b,H)=>Ge(b,H),tapPick:(b,H)=>ce(b,H),slides:()=>({label:A.label,total:A.count}),nextSlide:()=>(A.next(),A.label),prevSlide:()=>(A.prev(),A.label),houseLights:b=>w.setHouseLights(b),goto(b){const H=b==="Reception"?d:b==="Hospital Street"?T:b==="Postgraduate Medical Centre"?w:t.get(b)&&v.get(t.get(b).id)||null;return H?(ge(H.id),H.label):`unknown area: ${b}`},walk(b){const H=Math.ceil(Math.abs(b)/.1);for(let ae=0;ae<H;ae++){const ue=g.camera.rotation.y,Ue=g.camera.position;Ue.x+=-Math.sin(ue)*.1*Math.sign(b),Ue.z+=-Math.cos(ue)*.1*Math.sign(b),g.snapGround();const Xe=me(g.floorPosition);Xe&&Xe!==B&&X(Xe),De()}const Y=g.camera.position;return{x:+Y.x.toFixed(2),y:+(Y.y-1.7).toFixed(2),z:+Y.z.toFixed(2),area:B.label}}},console.info(`[hospital] built ${v.size} areas, ${P.length} interactables, ${x.count} signs, loop ${Math.round(r.street.x1)}m × 2 + ${r.loop.C}m courtyard`)}a0().catch(i=>{console.error(i);const e=document.createElement("p");e.style.cssText="color:#fff;padding:24px;font-family:Arial",e.textContent=String(i),ni.replaceChildren(e)});
